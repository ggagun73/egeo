...
public class EgovComIndexController implements ApplicationContextAware, InitializingBean {
	...
	public String setLeftMenu(ModelMap model) {
		...
		if (map == null) {
			 ...
			 */
			try {
				Class<?> loginController = Class.forName("egovframework.let.uat.uia.web.EgovLoginController");
				...
				LOGGER.error("No egovframework.let.uat.uia.web.EgovLoginController!!");
			}
