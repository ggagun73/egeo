package usolver.admin.log.lgm.web;
...
public class EgovSysLogController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/admin/log/lgm/SelectSysLogList.do")
	public String selectSysLogInf(@ModelAttribute("searchVO") SysLog sysLog,
		...
		return "usolver/admin/log/lgm/EgovSysLogList";
	}
	...
	public String selectSysLog(@ModelAttribute("searchVO") SysLog sysLog,
		...
		return "usolver/admin/log/lgm/EgovSysLogInqire";
	}
