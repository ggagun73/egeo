...
public class EgovWebLogController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/admin/log/wlg/SelectWebLogList.do")
	public String selectWebLogInf(@ModelAttribute("searchVO") WebLog webLog,
		...
		model.addAttribute("menu", "webLog");
		
		return "usolver/admin/log/wlg/EgovWebLogList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/admin/log/wlg/InqireWebLog.do")
	public String selectWebLog(@ModelAttribute("searchVO") WebLog webLog,	
			@RequestParam("requstId") String requstId, HttpServletRequest request,	ModelMap model
			) throws Exception{
		...
		return "usolver/admin/log/wlg/EgovWebLogInqire";
	}
