...
import usolver.admin.author.vo.AuthorRoleManage;
...
public class EgovAuthorRoleController {
    ...
    /**
	 * 권한 롤 관계 화면 이동
	 * @return "egovframework/com/admin/author/EgovDeptAuthorList"
	 * @exception Exception
	 */
    @RequestMapping("/admin/author/EgovAuthorRoleListView.do")
    public String selectAuthorRoleListView() throws Exception {

        return "usolver/admin/author/EgovAuthorRoleManage";
    } 
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/admin/author/EgovAuthorRoleList.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value="/admin/author/EgovAuthorRoleWriteProc.do")
	public String authorRoleWriteProc(@RequestParam("authorCode") String authorCode,
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value="/admin/author/EgovAuthorRoleInsert.do")
	public String insertAuthorRole(@RequestParam("authorCode") String authorCode,
		...
		return "forward:/admin/author/EgovAuthorRoleList.do";
	}    
}