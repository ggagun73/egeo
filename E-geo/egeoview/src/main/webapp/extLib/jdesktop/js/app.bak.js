...
var nJDSKApp = (function(w,d,$){
	return{
		...
		init: function()
		{
			...
			nJDSK.iconHelper.addIcon('resIcon','Normal Resizable window','/extLib/jdesktop/images/bws_logo2k9.png',function(e){
				e.preventDefault();
				// get some html text via ajax
				$.get('/html/usolver/xct.html?ver='+nJDSK.uniqid(),function(msg){
			...
			nJDSK.iconHelper.addIcon('iconTest2','About Glassy','/extLib/jdesktop/images/bws_logo2k9.png',function(e){
				e.preventDefault();
			...
			nJDSK.iconHelper.addIcon('resIconGlassy','Glassy Resizable window','/extLib/jdesktop/images/bws_logo2k9.png',function(e){
				e.preventDefault();
				$.get('/html/usolver/xct.html',function(msg){
			...
			// this icon creates a glassy resizable window (content area is translucent)
			nJDSK.iconHelper.addIcon('resIconFormWindow','Basic HTML Form elements','/extLib/jdesktop/images/bws_logo2k9.png',function(e){
				e.preventDefault();
			...
			nJDSK.iconHelper.addIcon('resIconX','Resizable window with toolbar items','/extLib/jdesktop/images/bws_logo2k9.png',function(e){
				e.preventDefault();
				$.get('/html/usolver/xct.html?ver='+nJDSK.uniqid(),function(msg){
					// create window
					...
					newWindow.toolbarHelper.addItem(
							...
							'UpDir',
							'UpDir',
							'/extLib/jdesktop/images/icons/silk/arrow_up.png',
							function(sender)
							{
								nJDSK.alert(
									'Message',
					...
					newWindow.toolbarHelper.addItem(
							...
							'Refresh',
							'Refresh',
							'/extLib/jdesktop/images/icons/silk/arrow_refresh.png',
							function(sender)
							{
								nJDSK.alert(
									'Message',
					...
					newWindow.toolbarHelper.addItem(
							...
							'resIconX_AddNew',
							'Add New',
							'/extLib/jdesktop/images/icons/silk/page.png',
							function(sender)
							{
								nJDSK.alert(
									'Message',
					...
					newWindow.toolbarHelper.addItem(
							...
							'Edit',
							'Edit',
							'/extLib/jdesktop/images/icons/silk/page_edit.png',
							function(sender)
							{
								nJDSK.alert(
									'Message',
					...
					newWindow.toolbarHelper.addItem(
							...
							'Delete',
							'Delete',
							'/extLib/jdesktop/images/icons/silk/page_delete.png',
							function(sender)
							{
								nJDSK.alert(
									'Message',
					...
					newWindow.toolbarHelper.addItem(
							...
							'CreateFolder',
							'Create Folder',
							'/extLib/jdesktop/images/icons/silk/folder_add.png',
							function(sender)
							{
								nJDSK.alert(
									'Message',
			...
			nJDSK.iconHelper.addIcon('resIconX1','Text','/extLib/jdesktop/images/bws_logo2k9.png',function(e){
				e.preventDefault();
			...
			nJDSK.iconHelper.addIcon('resIconEvents','Window with events','/extLib/jdesktop/images/bws_logo2k9.png',function(e){
				e.preventDefault();
				$.get('/html/usolver/xct.html',function(msg){
