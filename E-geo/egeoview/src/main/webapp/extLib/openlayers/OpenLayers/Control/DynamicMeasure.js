...
OpenLayers.Control.DynamicMeasure = OpenLayers.Class(OpenLayers.Control.Measure, {
	...
	mapMouseMove: function(){
	    ...
	    if(this.mouseDirection.x === "right" && (this.curMouseX >= (windowWidth-35))) //���콺�� ���� ���κп� ���� ����� ��
	    {
	    ...
	    else if(this.mouseDirection.y === "bottom" && (this.curMouseY >= (windowHeight-35))) //���콺�� �ϴ� ���κп� ���� ����� ��
	    {
	    ...
	    else if(this.mouseDirection.x === "left" && (this.curMouseX <= (windowLeftPos+35))) //���콺�� ���� ���κп� ���� ����� ��
	    {
	    	this.movingExtent = new OpenLayers.Bounds(mapExtent.left-moveDistX, mapExtent.bottom, mapExtent.right-moveDistX, mapExtent.top);
	    }
	    else if(this.mouseDirection.y === "top" && this.curMouseY <= windowTopPos+35) //���콺�� ��� ���κп� ���� ����� ��
    	{
	    	this.movingExtent = new OpenLayers.Bounds(mapExtent.left, mapExtent.bottom+moveDistY, mapExtent.right, mapExtent.top+moveDistY);
    	}
	    else{
