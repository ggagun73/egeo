...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		$("<div class='loading ui-state-default ui-state-active' id='load_"+this.id+"'><img src='/images/usolver/com/book/progress_bar.gif'></div>").insertBefore(gv);   /* 검색중을 이미지로 변경 */
		...
		setPager = function (pgid, tp){
			...
			// *** 지노시스템 변경분 : 하단 페이저의 위치 구성: 검색결과를 왼쪽에 위치
