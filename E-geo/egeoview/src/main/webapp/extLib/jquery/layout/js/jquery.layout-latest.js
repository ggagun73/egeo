 ...
 */
	...
	var lang = {
		Pane:		"Pane"
	,	Open:		"열기"	// eg: "Open Pane"
	,	Close:		"닫기"
	,	Resize:		"창크기조절"
	,	Slide:		"창을 오픈한 후 마우스가 벗어나면 자동으로 닫힙니다"
	,	Pin:		"Pin"
	,	Unpin:		"Un-Pin"
	,	selector:	"selector"
	...
	,	resizeWithWindowDelay:		100			// delay calling resizeAll because makes window resizing very jerky
	...
	,	defaults: { // default options for 'all panes' - will be overridden by 'per-pane settings'
		...
		,	togglerLength_open:		35			// Length = WIDTH of toggler button on north/south sides - HEIGHT on east/west sides
		...
		//2011-07-05 최원석 레이아웃 조절에 따른 지도 화면 조절 -> 빼도 상관 없나?
		,	onopen_end:				null		// CALLBACK when pane ENDS being Opened
		,	onclose_start:			null		// CALLBACK when pane STARTS to Close
		//2011-07-05 최원석 레이아웃 조절에 따른 지도 화면 조절 -> 빼도 상관 없나?
		,	onclose_end:			null		// CALLBACK when pane ENDS being Closed
		,	onresize_start:			null		// CALLBACK when pane STARTS being Resized ***FOR ANY REASON***
		,	onresize_end:			fn_resize_content		// CALLBACK when pane ENDS being Resized ***FOR ANY REASON***
	...
	,	north: {
			paneSelector:			".ui-layout-top"
		,	size:					0		// eg: "auto", "30%", 200
		,	resizerCursor:			"n-resize"	// custom = url(myCursor.cur)
		,	customHotkey:			""			// EITHER a charCode OR a character
		}
	,	south: {
			paneSelector:			".ui-layout-bottom"
		,	size:					0
		,	resizerCursor:			"s-resize"
		,	customHotkey:			""
		}
	,	east: {
			paneSelector:			".ui-layout-right"
		,	size:					0
		,	resizerCursor:			"e-resize"
		,	customHotkey:			""
		}
	,	west: {
			paneSelector:			".ui-layout-left"
		,	size:					0
	...
	var _c = {
		allPanes:		"north,south,center" 	//초기값 : "north,south,west,east,center"
 ...
 */
	...
	*/
	var calcNewCenterPaneDims = function () {
		...
		//alert("jquery.layout-latest.js 1135 line calcNewCenterPaneDims center 크기값-->"+d.width + ' / '+ d.height);
		return d;
	};
 ...
 */
	...
	*/
	var _create = function (_params) {
		...
		initPanes(_params);		// size & position panes - calls initHandles() - which calls initResizable()
	...
	*/
	...
	var initPanes = function (_allPains) {
		// NOTE: do north & south FIRST so we can measure their height - do center LAST
		//alert(_allPains);
		/*
		 * pain 직접 지정 가능하도록 수정
		 * */ 
		$.each(_allPains.split(","), function (idx, pane) {
			addPane( pane );
		});
 ...
 */
	...
	*/
	var manualSizePane = function (pane, size, skipCallback) {
		...
		//2011-07-05 최원석 화면 리사이징에 따른 지도 화면 조절
		fn_resize_content();
	}
 ...
 */ 
	...
	*/
	...
	function initPanes_control(){
		alert('initPanes_control');
		initPanes();
	};
