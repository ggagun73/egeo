...
var fn_init_map = function (_oRes, _bUserStyle, _sUserId, _sInitExtent) {
	...
	fn_create_indexMap({layers : "BML_BADM_AS", styles : "", maxResolution : 500, projection : new OpenLayers.Projection(CONFIG.fn_get_dataHouseCrs())});	
...
var fn_init_wms = function () {
	...
	var sDefaultThemeList = "EMPTY_LAYER";  
	sThemeList =  "EMPTY_LAYER";  //2017-10-18 CJH
	var sSldBody;
	//debugger;
	if (!sThemeList && sThemeList.length <= 0) {
		sThemeList = ""; //sDefaultThemeList;
