...
USV.CONFIG = (function(_mod_config, $, undefined){
	...
	*/
	...
	var oGisEngineInfo = {
		...
		"GeoServer" : {
			"prefix" 			: "egeo",
			"serviceUrl" 		: "http://192.168.0.201:8181/geoserver/egeo/ows?",             // "http://192.168.0.201:8181/geoserver/egeo/ows?", 2017-10-18 CJH       -------"http://192.168.0.201:8282/geoserver/Oracle/wms?"
			"wfsServiceUrl" 	: "http://192.168.0.201:8181/geoserver/egeo/wfs?",
	...
	*/
	var oGetMapInfo = { //378731.059	206080.510	423310.164	249646.356
			...
			//"serviceExtent" : new NUTs.Bounds(155467, 418809,241430, 477468),	//지도서비스 최대 영역 Obj //전국 -30000, -60000, 494288, 988576 2017-10-18 CJH
