...
USV.CONFIG = (function(_mod_config, $, undefined){
	...
	*/
	...
	var oGisEngineInfo = {
		...
		"GeoServer" : {
			"prefix" 			: "usolver",
			"serviceUrl" 		: "http://www.muhanit.kr:18181/geoserver/usolver/ows?",
			"wfsServiceUrl" 	: "http://www.muhanit.kr:18181/geoserver/usolver/wfs?",
	...
	*/
	...
	//var sGeometryField 			= "THE_GEOM";		//<-- GeoServer
	...
	*/
	var oGetMapInfo = { //378731.059	206080.510	423310.164	249646.356
			//"serviceExtent" : new NUTs.Bounds(-30000, -60000, 494288, 988576),	//지도서비스 최대 영역 Obj //전국 -30000, -60000, 494288, 988576
			//"serviceExtent" : new NUTs.Bounds(378731.059,206080.51,423310.164,249646.356),	//지도서비스 최대 영역 Obj //전국 -30000, -60000, 494288, 988576
			//"initExtent" : new GBounds(401804.0065,232426.369543,402439.5065,232673.369543),	//지도서비스 초기 영역 Obj  - 울산특정지역
			//"initExtent" : new NUTs.Bounds(402356.15,232450.25,403181.65,232838.25),	//지도서비스 초기 영역 Obj 
			...
			//"initExtent" : new NUTs.Bounds(202372.20, 427345.14, 215271.20, 438945.14 ),	//wipco_demo 지역(EPSG:5181 기준)  //210671.20667800243, 432945.1482755236
			/* 울산 */
			"serviceExtent" : new NUTs.Bounds(378731.059,206080.51,423310.164,249646.356),	//지도서비스 최대 영역 Obj //전국 -30000, -60000, 494288, 988576 
			...
			/* 대전 */
			//"serviceExtent" : new NUTs.Bounds(-20037508.34, -20037508.34, 20037508.34, 20037508.34),	
			//"indexExtent" : new NUTs.Bounds(14124688.84, 4309298.98, 14200147.60, 4401901.11 ),		
			//"initExtent" : new NUTs.Bounds(14156857.931, 4341545.417, 14211412.365, 4362428.014 ),	//wipco_demo 지역(EPSG:900913 기준)  //210671.20667800243, 432945.1482755236
			
			
			//"maxResolution" : "156543.0339",																//vworld - 지도서비스 GetMap maxResolution 
			//"zoomLevels" : "19",																			//vworld - 지도서비스 레벨 개수 
			"maxResolution" : "2048",																//지도서비스 GetMap maxResolution 
