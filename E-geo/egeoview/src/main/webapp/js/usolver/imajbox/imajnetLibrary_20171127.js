...
var Imajnet = {
    ...
    init: function(a) {
        ...
        "undefined" !== typeof ImajnetMap && ImajnetMap && (-1 !== a.serverUrl.indexOf("test.imajnet.net") ? ("undefined" !== typeof ImajnetMap && (ImajnetMap.cartographicServerDomains = [Nigsys.getProtocolString() + "//testcarto1.imajnet.net", Nigsys.getProtocolString() + "//testcarto2.imajnet.net", Nigsys.getProtocolString() + "//testcarto3.imajnet.net", Nigsys.getProtocolString() + "//testcarto4.imajnet.net", Nigsys.getProtocolString() + "//testcarto5.imajnet.net"]), ImajnetAPI.imageServerDomains = [Nigsys.getProtocolString() + "//testimage1.imajnet.net", Nigsys.getProtocolString() + "//testimage2.imajnet.net", Nigsys.getProtocolString() + "//testimage3.imajnet.net", Nigsys.getProtocolString() + "//testimage4.imajnet.net", Nigsys.getProtocolString() + "//testimage5.imajnet.net"]) : -1 !== a.serverUrl.indexOf("web.imajnet.net") || -1 !== a.serverUrl.indexOf("app.imajnet.net") || a.useProductionServerDomains ? ("undefined" !== typeof ImajnetMap && (ImajnetMap.cartographicServerDomains = [Nigsys.getProtocolString() + "//carto1.imajnet.net",
                Nigsys.getProtocolString() + "//carto2.imajnet.net", Nigsys.getProtocolString() + "//carto3.imajnet.net", Nigsys.getProtocolString() + "//carto4.imajnet.net", Nigsys.getProtocolString() + "//carto5.imajnet.net"
            ]), ImajnetAPI.imageServerDomains = [Nigsys.getProtocolString() + "//image1.imajnet.net", Nigsys.getProtocolString() + "//image2.imajnet.net", Nigsys.getProtocolString() + "//image3.imajnet.net", Nigsys.getProtocolString() + "//image4.imajnet.net", Nigsys.getProtocolString() + "//image5.imajnet.net"]) : -1 !== a.serverUrl.indexOf("immergis.fr") ?
            ("undefined" !== typeof ImajnetMap && (ImajnetMap.cartographicServerDomains = [Nigsys.getProtocolString() + "//carto1.immergis.fr", Nigsys.getProtocolString() + "//carto2.immergis.fr", Nigsys.getProtocolString() + "//carto3.immergis.fr", Nigsys.getProtocolString() + "//carto4.immergis.fr", Nigsys.getProtocolString() + "//carto5.immergis.fr"]), ImajnetAPI.imageServerDomains = [Nigsys.getProtocolString() + "//image1.immergis.fr", Nigsys.getProtocolString() + "//image2.immergis.fr", Nigsys.getProtocolString() + "//image3.immergis.fr",
                Nigsys.getProtocolString() + "//image4.immergis.fr", Nigsys.getProtocolString() + "//image5.immergis.fr"
            ]) : ImajnetMap.cartographicServerDomains = [Nigsys.getProtocolString() + "//" + window.location.hostname, Nigsys.getProtocolString() + "//" + window.location.hostname, Nigsys.getProtocolString() + "//" + window.location.hostname, Nigsys.getProtocolString() + "//" + window.location.hostname, Nigsys.getProtocolString() + "//" + window.location.hostname]);
    ...
    imajnetOrientedImagesIsActive: function() {
        return Imajnet.clickMode ==
            Imajnet.CLICK_MODE_ORIENTED_IMAGES
    },
    ...
    activateImajnetControl: function(a, b) {
        ...
        "closestImage" == b ? (ImajnetUI.disableToolControls(), Imajnet.clickMode = Imajnet.CLICK_MODE_CLOSEST_IMAGE, ImajnetClickMode.hideOrientedImages()) : "clickMode" == b ? (ImajnetUI.disableToolControls(),
            Imajnet.clickMode = Imajnet.CLICK_MODE_ORIENTED_IMAGES, 12 > ImajnetPlugin.getCurrentZoomLevel() && (ImajnetPlugin.zoomMapTo(12), ImajnetMap.currentPosition && ImajnetPlugin.centerMapToPosition(ImajnetMap.currentPosition))) : "showClipboard" == b ? (ImajnetUI.showItem(ImajnetUI.clipboardContainerId, Nigsys.browserIsIE7() ? 350 : null), ImajnetUI.addActiveState(a)) : "searchLRS" == b ? LRS.openLRSDialog() : "searchAddress" == b ? Address.openSearchDialog() : "showNews" == b && ImajnetNews.init(!1);
...
Imajnet.buildDate = "2017-09-19T10:29:20Z";
var ApplicationStorage = {
    writeObject: function(d, a, b, c) {
        d = (b ? b + "_" : "") + (c ? c + "_" : "") + d;
        try {
            "undefined" === typeof a && (console.error("Write to storage: " + a), a = null), window.localStorage.setItem(d, JSON.stringify(a))
        } catch (e) {
    ...
    writeSessionObject: function(d, a,
        b, c) {
        try {
    ...
    writeObjectInCookie: function(d, a, b, c) {
        try {
            ...
            console.error("LocalStorage - Unable to serialize json: - " +
                e)
        }
    },
...
var ImajnetUrl = {
    ...
    readUrl: function(b) {
        ...
        if (a[this.ZOOM_URL_PARAM_NAME]) {
            if (c = parseInt(a[this.ZOOM_URL_PARAM_NAME]), 0 > c || 25 < c) a[this.ZOOM_URL_PARAM_NAME] = this.urlParams[this.ZOOM_URL_PARAM_NAME], b && this.changeUrlParam(this.ZOOM_URL_PARAM_NAME,
    ...
    changeLocale: function(b) {
        ...
        if (-1 === a.indexOf(this.LOCALE_URL_PARAM_NAME)) b = (a ? b + (a + "\x26") : b + "?") + (this.LOCALE_URL_PARAM_NAME + "\x3d" + this.urlParams[this.LOCALE_URL_PARAM_NAME] + "\x26");
        else
            for (var a = a.split("\x26"), c = 0; c < a.length; c++) - 1 !== a[c].indexOf(this.LOCALE_URL_PARAM_NAME) ? (0 == c && (b += "?"), b += this.LOCALE_URL_PARAM_NAME + "\x3d" + this.urlParams[this.LOCALE_URL_PARAM_NAME] + "\x26") : b += a[c] + "\x26";
...
var Nigsys = {
    ...
    getHighestSquareUnit: function(a, c) {
        if ("m" == c) {
            ...
            var d = Math.pow(LRS.feetInAMile,
                2);
    ...
    getElementWidth: function(a) {
        return a.style.width ? parseInt(a.style.width.replace("px",
            "")) : 0
    },
    ...
    getCheckboxHTML: function(a, c, d, e, f, h) {
        ...
        d || (d = "");
        e || (e = "");
        return "undefined" !== typeof CommonCore && CommonCore.isMobile ? '\x3cdiv class\x3d"left"\x3e\x3cinput type\x3d"checkbox" name\x3d"' + a + '" id\x3d"' +
    ...
    bindClickEvent: function(a, c, d) {
        ...
        if (Nigsys.isTouchDevice() && "tap" !== e) a.on("tap", d, function(a) {
            Nigsys.disableEventPropagation(a);
            c(a)
        })
    },
    ...
    getStatusErrorText: function(a) {
        return a ==
            ...
            jQuery.imajnet.login.error.noInternetConnection : jQuery.imajnet.login.error.unableToConnect : jQuery.imajnet.login.error.unknown
    },
    initLogoOverlay: function() {
        "undefined" === typeof isImajnetMode || isImajnetMode() || (jQuery("body").append(Nigsys.logoOverlayDiv), Nigsys.logoOverlay = jQuery("#logoOverlay"))
    },
    getCookieWarningNotificationInfoOkHTML: function() {
        return '\x3cdiv id\x3d"cookieWarningNotification"\x3e' + jQuery.app.cookieWarning + '\x3cinput type\x3d"button" id\x3d"cookieWarningNotificationOk" value\x3d"' +
            jQuery.imajnet.button.ok + '" /\x3e\x3c/div\x3e'
    },
    getNotificationInfoOkHTML: function(a) {
        return '\x3cdiv id\x3d"' + a + '"\x3e\x3cinput type\x3d"hidden" value\x3d"notificationInfoOk" /\x3e\x3ca class\x3d"ui-notify-cross ui-notify-close" href\x3d"javascript: void(0);"\x3ex\x3c/a\x3e\x3ch1\x3e#{title}\x3c/h1\x3e\x3cdiv\x3e\x3cimg src\x3d"' + Imajnet.imajnetPath + 'img/warningNotify.png" class\x3d"notificationImage" align\x3d"top"/\x3e\x26nbsp;#{text}\x3c/div\x3e\x3cdiv style\x3d"text-align: center;"\x3e\x3cinput type\x3d"button" value\x3d"' +
            jQuery.imajnet.button.ok + '" /\x3e\x3c/div\x3e\x3c/div\x3e'
    },
    getNotificationHTML: function() {
        return '\x3cdiv id\x3d"notification" class\x3d"notification"\x3e\x3cdiv id\x3d"notificationInfo"\x3e\x3cinput type\x3d"hidden" value\x3d"notificationInfo" /\x3e\x3ca class\x3d"ui-notify-cross ui-notify-close" href\x3d"javascript: void(0);"\x3ex\x3c/a\x3e\x3ch1\x3e#{title}\x3c/h1\x3e\x3cdiv\x3e\x3cimg src\x3d"' + Imajnet.imajnetPath + 'img/warningNotify.png" class\x3d"notificationImage" align\x3d"top"/\x3e\x26nbsp;#{text}\x3c/div\x3e\x3c/div\x3e' +
            ...
            '" onclick\x3d"Nigsys.closeConfirmDialog();" /\x3e\x3cinput id\x3d"confirmNo_#{type}" type\x3d"button" value\x3d"' + jQuery.imajnet.button.no + '" onclick\x3d"Nigsys.closeConfirmDialog();" /\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e'
    },
    initNotification: function() {
        Nigsys.notification || ("undefined" !== typeof CommonCore && CommonCore.isMobile || jQuery("body").append(this.getNotificationHTML()), Nigsys.notification = jQuery("#notification").notify({
            click: function(a, c) {
                c.close()
            }
        }))
    },
    showNotificationError: function(a,
        c, d, e, f, h) {
    ...
    showLoginError: function(a) {
        a && ("undefined" === typeof isImajnetMode || isImajnetMode() ? jQuery(Nigsys.loginNotification.element).show() : Login.hideLoginLoading(), Nigsys.errorNotification = Nigsys.showNotificationError("",
            a, "centerLoginError",
            function(a, d) {
    ...
    getLoginContent: function() {
        return '\x3cdiv\x3e\x3cdiv class\x3d"imajnetLoginItem"\x3e\x3cdiv class\x3d"left imajnetLoginLeft"\x3e\x3clabel for\x3d"username"\x3e' +
    ...
    showLoginNotification: function(a) {
        Nigsys.loginNotification && jQuery(Nigsys.loginNotification.element).is(":visible") || (Nigsys.initLoginContainers(), "undefined" !== typeof isImajnetMode && !isImajnetMode() && Nigsys.logoOverlay && Nigsys.logoOverlay.show(), "undefined" !== typeof CommonCore && CommonCore.isMobile && Nigsys.initModalOverlay("#content"),
            Nigsys.modalOverlay.show(), Nigsys.loginNotification ? jQuery(Nigsys.loginNotification.element).show() : Nigsys.loginNotification = Nigsys.notificationLoginContainer.notify("create", "notificationLogin", {
                text: a
            }, {
                expires: !1,
                ...
                open: function(a, d) {
                    ...
                    "undefined" === typeof isImajnetMode || isImajnetMode() ? Nigsys.bindClickEvent(e, ImajnetProtocol.doLogin) :
                        ("undefined" === typeof isImajnetMode || isImajnetMode() || (Nigsys.bindClickEvent(e, Login.doLogin), Nigsys.bindEnterEvent(Login.doLogin)), "undefined" !== typeof CommonCore && CommonCore.isMobile && e.button().button("refresh"))
                },
                click: function(a, d) {
                    return !1
                }
    ...
    disableEventPropagation: function(a) {
        a && (a.stopPropagation ?
            a.stopPropagation() : window.event && (window.event.cancelBubble = !0))
    },
    disableEventPropagationFull: function(a) {
        a && (a.stopPropagation ? (a.stopPropagation(), a.stopImmediatePropagation(), a.preventDefault()) : window.event && (window.event.cancelBubble = !0))
    },
    getRad: function(a) {
    ...
    distanceBetweenPoints: function(a, c) {
        ...
        for (var d = Object({
                ...
                }), e = d.a, f = d.b, d = d.f, h = this.getRad(c.lon - a.lon), k = Math.atan((1 - d) * Math.tan(this.getRad(a.lat))),
                l = Math.atan((1 - d) * Math.tan(this.getRad(c.lat))), m = Math.sin(k), k = Math.cos(k), n = Math.sin(l), l = Math.cos(l), p = h, y = 2 * Math.PI, z = 20; 1E-12 < Math.abs(p - y) && 0 < --z;) {
            var q = Math.sin(p),
                t = Math.cos(p),
        ...
        return 1E3 *
            ((f * (1 + e / 16384 * (4096 + e * (-768 + e * (320 - 175 * e)))) * (A - d * u * (q + d / 4 * (t * (-1 + 2 * q * q) - d / 6 * q * (-3 + 4 * u * u) * (-3 + 4 * q * q))))).toFixed(3) / 1E3)
    },
    ...
    positionExistingElement: function(a, c, d, e) {
        ...
        if ("map" != d) {
            var l = null;
            "string" === typeof d ? l = "popupImajnetControlsLayer" == d ? jQuery("#imajnetImageLayer") : jQuery("#" + d) : (0 === d.prop("id").indexOf("LRSSchematic") && (f = !0, "portrait" == LRSSchematic.orientation ?
                (h = a.offsetY + LRSSchematic.titleHeight, k = a.offsetX) : h = a.offsetY), l = d);
        ...
        if ("string" === typeof d) p = jQuery("#" + d);
            ...
            if (f) {
                ...
                "landscape" == LRSSchematic.orientation ? (c = d.parent().parent().parent().width(),
                    n = ImajnetLRSGUIWidth * n.length, h += p * ImajnetLRSGUIWidth) : (c = ImajnetLRSGUIWidth * n.length, n = d.parent().parent().parent().height(), k += p * ImajnetLRSGUIWidth)
            }
            p = d
        }
        d = (c ? c : p.width()) - 10;
        ...
        n = e.width();
        p = e.height();
        f ? (h + p > c ? h = "landscape" == LRSSchematic.orientation ? LRSSchematic.container.scrollTop() : h - (p + m + 30) : h + p > LRSSchematic.container.scrollTop() + LRSSchematic.container.height() && (h = LRSSchematic.container.scrollTop()), k + n > d || k ? k = "portrait" == LRSSchematic.orientation ? LRSSchematic.container.scrollLeft() :
            k - n - l - 30 : n > LRSSchematic.container.scrollLeft() + LRSSchematic.container.width() && (k = LRSSchematic.container.scrollLeft()), e.css({
                top: 0 < h ? h : 0,
                left: 0 < k ? k : 0
        ...
        if (c = "undefined" !== typeof ImajnetUser ? ImajnetUser.getUsername() : CommonCore.userInfo ? CommonCore.userInfo.username : null) {
            ...
            if (d && !(11 > d.length))
                for (var e in d.cookies)
                    if (0 === e.indexOf(a + "_") && e != a + "_" + c && (Nigsys.deleteCookie(e), d.length--, 11 > d.length)) break
        }
    },
    ...
    getCookie: function(a, c) {
        ...
        if (!d) return null;
        if ("undefined" !==
            typeof Storage) return ApplicationStorage.readObject(c, d, a);
    ...
    setCookie: function(a, c, d) {
        ...
        if (e)
            if ("undefined" !== typeof Storage) ApplicationStorage.writeObject(c, d, e, a);
            else {
    ...
    setIPLocationCookie: function(a,
        c) {
        var d = {},
    ...
    getViewportSize: function() {
        var a, c;
        "undefined" != typeof window.innerWidth ? (a = window.innerWidth, c = window.innerHeight) : "undefined" != typeof document.documentElement && "undefined" != typeof document.documentElement.clientWidth && 0 != document.documentElement.clientWidth ? (a = document.documentElement.clientWidth,
            c = document.documentElement.clientHeight) : (a = document.getElementsByTagName("body")[0].clientWidth, c = document.getElementsByTagName("body")[0].clientHeight);
        return {
            w: a,
            h: c
        }
    ...
    getUserPositionError: function() {
        ...
        ImajnetMap.POIArray && ImajnetMap.POIArray[0] ? (ImajnetAPI.setImajnetImage({
            ...
            }), ImajnetPlugin.centerMapToPosition(ImajnetMap.POIArray[0].position)) :
            ImajnetUrl.goToLocation("43.59936957234748,1.43908554574678")
    },
    goToClosestPOI: function(a) {
        ...
        if (-1 != d) return ImajnetZoom.left = -1, Nigsys.showLoading(ImajnetUI.imageContainer), ImajnetAPI.setImajnetImage({
            position: ImajnetMap.POIArray[d].position
        }), ImajnetPlugin.centerMapToPosition(ImajnetMap.POIArray[d].position), !0;
        Nigsys.getUserPositionError();
        return !1
    },
    getUserPositionSuccess: function(a, c) {
        if ("undefined" === typeof OpenLayersForProjection) return null;
        var d = (new OpenLayersForProjection.Format.KML).read(a.responseText),
            e = null,
            f;
        for (f in d)
    ...
    getUserPosition: function() {
        ...
        for (d = a.length - 1; 0 <= d; d--)
            if (Nigsys.getUserPositionAjaxRequest(a[d])) return;
        Nigsys.getUserPositionError()
    },
    ...
    positionNotification: function(a) {
        if (a && "center" != a)
            if ("centerLoginError" == a)
                ...
                } else Nigsys.positionLoginNotificationErrorCenter(null, -220);
        else "rightBottom" == a && (a = jQuery("#notification"), c = Nigsys.getWindowSize(), a.offset({
    ...
    closeConfirmDialog: function() {
        try {
            Nigsys.confirmDialog.close(), Nigsys.modalOverlay.hide()
        } catch (a) {}
    },
    ...
    addYearsToJavaFormattedDate: function(a,
        c) {
        if (!a) return "";
        var d = a.indexOf("-");
    ...
    formatJavascriptDateObjectToJava: function(a) {
        return a ? a.getFullYear() + "-" + Nigsys.addZero(a.getMonth() +
            1) + "-" + Nigsys.addZero(a.getDate()) + Nigsys.dateT + Nigsys.addZero(a.getHours()) + ":" + Nigsys.addZero(a.getMinutes()) + ":00" + Nigsys.dateZ : ""
    },
    addZero: function(a) {
        return 10 > a ? "0" + a : a
    },
    ...
    appendDateTimePickerToElement: function(a, c, d, e, f) {
        a = jQuery(a);
        if (a.length) {
            var h = a.prop("id"); - 1 === h.indexOf("_created") && -1 === h.indexOf("_modified") && (!d && a.val() && (d = a.val()), "xsd:date" == c || "xsd:dateTime" == c ? "undefined" ===
                typeof CommonCore || !CommonCore.isMobile || "xsd:date" != c && "xsd:dateTime" != c ? (f = jQuery.extend(Object({
                    dateFormat: "dd MM yy",
                    ...
                    changeMonth: !0,
                    changeYear: !0,
                    monthNames: [jQuery.imajnet.dateTime.month1, jQuery.imajnet.dateTime.month2, jQuery.imajnet.dateTime.month3, jQuery.imajnet.dateTime.month4, jQuery.imajnet.dateTime.month5, jQuery.imajnet.dateTime.month6, jQuery.imajnet.dateTime.month7, jQuery.imajnet.dateTime.month8,
                        jQuery.imajnet.dateTime.month9, jQuery.imajnet.dateTime.month10, jQuery.imajnet.dateTime.month11, jQuery.imajnet.dateTime.month12
                    ],
                ...
                })) : (d && (d = d.replace(Nigsys.dateZ, "")), e = a.attr("onchange"), a.parent().html('\x3cinput type\x3d"date" data-clear-btn\x3d"false" id\x3d"' + h + '" class\x3d"' + ("xsd:date" == c ? "datePicker" : "") +
                    ("xsd:dateTime" == c ? " dateTimePicker" : "") + '" size\x3d"39" value\x3d"' + Nigsys.formattedDateToInput(d) + '"' + (e ? ' onchange\x3d"' + e + '"' : "") + "\x3e")) : (a.unbind("keypress"), a.unbind("click"), "undefined" !== typeof CommonCore && CommonCore.isMobile || a.datetimepicker("destroy")))
        }
    },
    ...
    getComboboxInputContainer: function(a) {
        ...
        for (var c = 0; c < a[0].children.length; c++)
            if (a[0].children[c].children[0] && -1 !== a[0].children[c].children[0].className.indexOf("ui-combobox-input")) return jQuery(a[0].children[c].children[0]);
    ...
    refreshComboboxContainer: function(a,
        c) {
        var d = Nigsys.getComboboxInputContainer(a);
    ...
    addObjectToArray: function(a,
        c) {
        for (var d = 0; d < a.length; d++)
            if (a[d].id == c.id) return !1;
        a.push(c)
    },
    ...
    getFunctionNameAndArguments: function(a) {
        ...
        return {
            name: a[0],
            arguments: Nigsys.replaceAll(Nigsys.replaceAll(c,
                ", ", ","), "'", "").split(",")
        }
    },
    ...
    convertToHexFromRgba: function(a, c) {
        if (a) return c || (c = 1), a = a.replace("#", ""), r = parseInt(a.substring(0,
            2), 16), g = parseInt(a.substring(2, 4), 16), b = parseInt(a.substring(4, 6), 16), result = "rgba(" + r + "," + g + "," + b + "," + c + ")"
    },
    ...
    doAjaxRequest: function(a, c, d, e, f, h, k) {
        ...
        var l = "",
            l = !Nigsys.ajaxMustAppendDataToUrl(a) || k && k.postData ? c : c + d; - 1 === l.indexOf("http") && (l = applicationUrl + l.replace("platform-web/mvc", ""));
        return jQuery.ajax({
            type: a,
            url: l,
    ...
    doAjaxRequestDeferred: function(a, c, d, e, f, h, k) {
        ...
        var m = "",
            m = !Nigsys.ajaxMustAppendDataToUrl(a) || k && k.postData ?
            c : c + d; - 1 === m.indexOf("http") && (m = applicationUrl + m);
    ...
    getAjaxRequest: function(a, c, d, e, f) {
        ...
        jQuery.ajax({
            ...
            cache: !1,
            success: function(a) {
                if ("function" != typeof c) h.resolve(a, f);
                else try {
                    c(a, f).done(function() {
                        h.resolve(a, f)
                    }).fail(function() {
            ...
            error: function(a) {
                if ("function" != typeof e) h.reject(a, f);
                else try {
                    e(a, f).done(function() {
                        h.resolve(a, f)
                    }).fail(function() {
    ...
    getArea: function(a) {
        var c =
            0;
        if (a && 2 < a.length) {
            for (var d = c = 0, e = a.length; d < e - 1; d++) var f = a[d],
                h = a[d + 1],
                c = c + (f.x + h.x) * (h.y - f.y);
            c = -c / 2
        }
    ...
    getGeodesicAreaNotFinished: function(a) {
        ...
        for (var c = c / a.length, e = d / a.length, d = Array(a.length), f = a.length; f--;) a.lat[f] -= c, a.lon[f] -= e, 0 <= lons[f] && 0 <= a.lat[f] ? d[f] = Math.abs(180 * Math.atan(lat[f] / lons[f]) / Math.PI) : 0 > lons[f] && 0 <= lat[f] ? d[f] = 90 + Math.abs(180 * Math.atan(lat[f] / lons[f]) / Math.PI) : 0 > lons[f] &&
            0 > lats[f] ? d[f] = 180 + Math.abs(180 * Math.atan(lat[f] / lons[f]) / Math.PI) : 0 <= lons[f] && 0 > lats[f] && (d[f] = 270 + Math.abs(180 * Math.atan(lat[f] / lons[f]) / Math.PI));
        for (f = 0; f < d.length; f++)
            for (var h = 0; h < d.length - 1; h++) a = d[h], c = lat[h], e = lon[h], a < d[h + 1] && (d[h] = d[h + 1], lat[h] = lat[h + 1], lons[h] = lons[h + 1], d[h + 1] = a, lat[h + 1] = c, lon[h + 1] = e);
    ...
    signedArea: function(a) {
        for (var c =
                0, d = a[0].x, e = 1; e < a.length - 1; e++) c += (a[e].x - d) * (a[e - 1].y - a[e + 1].y);
        return c / 2
    },
    computeLonLatPointsArea: function(a) {
        for (var c = new jsts.geom.GeometryFactory, d = [], e = 0; e < a.length; e++) d.push(new jsts.geom.Coordinate(a[e].lon, a[e].lat));
    ...
    downloadFromURL: function(a) {
        ...
        c.href = a;
        c.download = a.substr(a.lastIndexOf("/") +
            1);
...
var dockingLeftContainerSize = 20,
    ...
    ImajnetDocking = function(b, d, e, f, c) {
        ...
        d = '\x3cdiv id\x3d"imajnetDockingRightContainer_' + f + '" class\x3d"' + (this.css.notResizable ?
            "" : e) + '"\x3e' + d + "\x3c/div\x3e";
        k = "";
        k = "Bottom" == this.direction ? d + b : b + d;
        jQuery("#imajnetDockingMainContainer_" + f).remove();
        this.container.append('\x3cdiv id\x3d"imajnetDockingMainContainer_' + f + '" class\x3d"imajnetDockingMainContainer imajnetDockingMainContainer_' + this.direction + '" style\x3d"' + (c.left || 0 == c.left ? "left: " + c.left + "px;" : "") + (c.right || 0 == c.right ? "right: " + c.right + "px;" : "") + (c.top || 0 == c.top ? "top: " + c.top + "px;" : "") + (c.bottom || 0 == c.bottom ? "bottom: " + c.bottom + "px;" : "") + '"\x3e' + k + '\x3cdiv class\x3d"clear' +
            e + '"\x3e\x3c/div\x3e\x3c/div\x3e');
        ...
        this.onDockingButtonDisabled = function(g, h) {
            Nigsys.setCookie("IMAJNET", "DOCKING_" +
                this.type, "false");
            ...
            }) : Nigsys.onMobile() || ("header" == this.type ? (this.rightContainer.removeClass("overflowVisible"), this.mainContainer.bind("mouseenter", {
                type: this.type
            }, this.expandTopContainer), this.mainContainer.bind("mouseleave", {
                type: this.type
            }, this.collapseTopContainer), CommonCore.applyContainerDimension(0, !0)) : (this.mainContainer.bind("mouseenter", {
                type: this.type
            }, this.expandContainer), this.mainContainer.bind("mouseleave", {
                type: this.type
        ...
        this.onDockingButtonEnabled = function(g, h) {
            ...
            }) : "header" == this.type ? (this.rightContainer.addClass("overflowVisible"), this.mainContainer.unbind({
        ...
        this.onDockingButtonPressed = function(g) {
            ...
            l.dockingButtonIsEnabled(h) ? (l.onDockingButtonDisabled(h, a), Nigsys.onMobile() && (g.preventDefault(), l.collapseContainer({
                data: {
                    type: a
                }
            }))) : (l.onDockingButtonEnabled(h, a), Nigsys.onMobile() && (g.preventDefault(), l.expandContainer({
                data: {
                    type: a
                }
            })))
        ...
        "header" != this.type && (this.getDirectionData = function(g) {
            ...
            b <= l / 2 && c <= a / 2 ? b < c ? (h.direction = "Left", h.css = {
                ...
                a / 2 ? l - b < c ? (h.direction = "Right", h.css = {
                    right: 0,
                    top: g.position.top
                }) : (h.direction = "Top", h.css = {
                    left: g.position.left,
            ...
            start: function(g, h) {
                ...
                if (g.originalEvent.target.id != a.leftContainer.attr("id")) return !1;
            ...
            stop: function(g, h) {
                ...
                if (b.direction && b.css) {
                    ...
                    if ("imageLRSGUI" == a.type) {
                        ...
                        ImajnetUI.LRSGUI.orientation !=
                            d && (ImajnetUI.LRSGUI.orientation = d, ImajnetUI.LRSGUI.redraw())
                    }
                    ...
                    var e = a.mainContainer.parent(),
                        ...
                        f = e.height(),
                        e = {};
                    "undefined" === typeof a.css.left ? a.mainContainer.css("left", "auto") : (a.css.left + b > d && (a.css.left = d - b), a.mainContainer.css("left", a.css.left), e.left = a.css.left);
                    "undefined" === typeof a.css.top ? a.mainContainer.css("top", "auto") : (a.css.top + c > f && (a.css.top = f - c), a.mainContainer.css("top", a.css.top), e.top = a.css.top);
                    ...
                    "undefined" ===
                    typeof a.css.bottom ? a.mainContainer.css("bottom", "auto") : (a.css.bottom + c > f && (a.css.bottom = f - c), a.mainContainer.css("bottom", a.css.bottom), e.bottom = a.css.bottom);
                    a.previousCss = a.css;
                    b = jQuery("#imajnetDockingButton_" + a.type); - 1 !== b.prop("style").background.indexOf("Collapsed") ? a.setPinCollapsedImageUrl(b) : a.setPinExpandedImageUrl(b);
                    Nigsys.setCookie("IMAJNET", "DOCKING_" + a.type + "_position", e);
                    if (a.css.notResizable) b = 0 < a.rightContainer.height(), a.cornerTitle(b), "Left" != a.direction && "Right" != a.direction ||
                        b ? removeVertically(a) : setVertically(a);
                    else if (a.leftContainer.uncorner(), a.rightContainer.uncorner(), a.corner(), a.rightContainer.height() ? (a.leftContainer.uncorner(), b = null, c = !1, "Left" == a.direction || "Right" == a.direction ? (c = a.leftContainer.hasClass("Top") || a.leftContainer.hasClass("Bottom"), onExpandComplete(a)) : (b = onExpandComplete, c = a.leftContainer.hasClass("Left") || a.leftContainer.hasClass("Right")), c && a.expandContainer({
                            data: {
                                type: a.type
                            }
                        }, b)) : onExpandComplete(a), a.mainContainer.removeClass("imajnetDockingMainContainer_Left").removeClass("imajnetDockingMainContainer_Right").removeClass("imajnetDockingMainContainer_Top").removeClass("imajnetDockingMainContainer_Bottom").addClass("imajnetDockingMainContainer_" +
        ...
        this.resize = function(b) {
            var c = ImajnetUI.docking[this.type],
                a;
        ...
        this.expandContainer = function(b, c) {
            if (b.data.type) {
                ...
                var d = 0,
                    ...
                    f = 0,
                    k = 0;
                a.css.notResizable ? (a.cornerTitle(!0), removeVertically(a), d = a.css.height, a.leftContainer.animate({
                    width: d
                }, 0), e = dockingLeftContainerSize, f = a.css.height, k = a.css.width) : "Left" == a.direction || "Right" == a.direction ? (e = a.css.height, f = a.css.width, k = a.css.height) : (e = dockingLeftContainerSize, f = a.css.height, k = a.css.width);
        ...
        this.collapseContainer = function(b) {
            if (b.data.type) {
                ...
                if ("mapControls" == b.data.type) jQuery("#mapControlsContainer").css("position", "static");
                ...
                c.css.notResizable ? (c.cornerTitle(!1), "Left" == c.direction || "Right" == c.direction ? setVertically(c) : removeVertically(c)) : c.leftContainer.animate({
        ...
        this.expandTopContainer = function(b) {
            0 != b.pageY && (jQuery("#imajnetSettingsMenu li div select").show(), b = ImajnetUI.docking[b.data.type], b.rightContainer.stop(1), b.rightContainer.animate({
        ...
        if (ImajnetUI.docking[b]) {
            ...
            if (e) {
                ...
                if (("Top" == d.direction || "Bottom" == d.direction) && d.css.left + f > e) {
                    var c = e - f; - 1 < c && d.mainContainer.css("left", e - f)
                }
            }
            if (e = d.container.height() - ("imageLRSGUI" == d.type ? 55 : 0)) f = d.css.height, ("Left" == d.direction || "Right" == d.direction) && d.css.top + f > e && (c = e - f, -1 < c && d.mainContainer.css("top", c))
        }
}
...
CheckDockingCookie = function(b) {
    ...
    if (d) {
        ...
        if ("true" == e || null === e && !d.css.notResizable) d.expandContainer({
            data: {
                type: b
            }
        }), d.onDockingButtonEnabled(jQuery("#imajnetDockingButton_" + b), b);
        else d.onDockingButtonDisabled(jQuery("#imajnetDockingButton_" + b), b);
...
var ImajnetTimeframe = {
    ...
    setTimeframe: function(a) {
        ...
        a && a.from && a.to ? ImajnetMap.currentPosition && (ImajnetZoom.left = -1, Nigsys.showLoading(ImajnetUI.imageContainer), ImajnetAPI.setImajnetImage({
...
var ImajnetUI = {
    ...
    showNotificationInfoOk: function(a, b, c, d, e, f) {
        Nigsys.notification.html("");
        a =
            Nigsys.notification.notify("create", "notificationInfoOk", {
                title: a,
                text: b
            }, {
                expires: !1,
    ...
    getPreviewImageResolution: function() {
        var a =
            ...
            b = ImajnetUI.imajnetImage.attr("src"),
            c;
    ...
    setSliderDraggableContainment: function() {
        if (ImajnetUI.imajnetImageContainer) {
            var a = ImajnetUI.imajnetImageContainer.offset(),
                b = ImajnetUI.imajnetImageContainerSize.width +
                ImajnetImageSwitcher.dragArrowWidth,
                c = a.left - b,
                d = c;
    ...
    onImageMouseDown: function() {
        if (!(Nigsys.isPositionMode() || Nigsys.isMeasurementMode() || Nigsys.isPolyligneMode())) {
            ...
            ImajnetMap.lastLoadedImagePosition && (ImajnetMap.setCurrentPosition(ImajnetMap.lastLoadedImagePosition), ImajnetMap.setImajboxMarkerPosition({
                position: ImajnetMap.lastLoadedImagePosition
            }, !0), ImageControler.currentImageControl.doRequests(ImajnetMap.currentPosition))
        }
    },
    onImageClick: function(a) {
        Nigsys.disableEventPropagationFull(a);
        if (ImajnetUI.zoomCancel) ImajnetUI.zoomCancel = !1;
        else if (ImajnetZoom.imageWasDragged && Nigsys.browserIsIE7()) ImajnetZoom.imageWasDragged = !1;
    ...
    onImageDblClick: function(a) {
        if (a.target && ("popupImajnetImage" == a.target.id || "svg" == a.target.nodeName.toLowerCase()) && !Nigsys.isPositionMode() && !Nigsys.isMeasurementMode())
            if (1 == ImageControler.currentSurveyTrace.moveImageToClickPosition) ImageControler.currentSurveyTrace.onImageDbClick(a);
    ...
    navigateOnSwipe: function(a, b, c, d, e) {
        ...
        if ("down" == b) ImajnetUI.onDragEnd(0, a, "getNext");
        else if ("up" == b) ImajnetUI.onDragEnd(0, a, "getPrevious")
    },
                ...
                this.imajnetImageSliderInnerContainer.draggable({
                    ...
                    drag: function(a, c) {
                        ...
                        if (0 < d && ImajnetImageSwitcher.dragLeftPosition) ImajnetUI.sliderLeftImage && ImajnetUI.sliderLeftImage.attr("src") || ImajnetUI.sliderLeftImageContainer.hasClass("imajnetLayerNoImage") || (ImajnetUI.sliderLeftImageContainer.html(ImajnetUI.getSliderLeftImage("")), ImajnetUI.sliderLeftImage = jQuery("#imajnetLayerLeftImage"), ImajnetImageSwitcher.loadImageForSlider(ImajnetUI.sliderLeftImage,
                            ImajnetImageSwitcher.dragLeftPosition)), d > ImajnetUI.imajnetImageContainerSize.width / 3 && ImajnetUI.imajnetImage.addClass("opacity30");
                        else if (0 > d && ImajnetImageSwitcher.dragRightPosition) return ImajnetUI.sliderRightImage && ImajnetUI.sliderRightImage.attr("src") || ImajnetUI.sliderLeftImageContainer.hasClass("imajnetLayerNoImage") || (ImajnetUI.sliderRightImageContainer.html(ImajnetUI.getSliderRightImage("")), ImajnetUI.sliderRightImage = jQuery("#imajnetLayerRightImage"), ImajnetImageSwitcher.loadImageForSlider(ImajnetUI.sliderRightImage,
    ...
    resizeImageElement: function(a, b) {
        if (ImajnetUI.fullSizeAspectRatio) {
            ...
            var d = -(c / 2);
            ImajnetUI.getLargeImageWidthOverflow() && (-1 == ImajnetZoom.left || ImajnetZoom.left < 2 * d) && (ImajnetZoom.left = d); - 0 == ImajnetZoom.left && (ImajnetZoom.left = 0);
    ...
    ImajnetLRSGUI = function(c) {
        c = {
            ...
            clickHandler: function(a) {
                if (this.isAfterDrag && !Nigsys.browserIsOpera()) this.isAfterDrag = !1;
                else {
                    var b = 0,
                ...
                for (var c = Object({
                    ...
                    if (k >= this.minBound && k <= this.maxBound)
                        if (d = k - this.minBound, d >= c.y) {
                            ...
                            d = l * (1 - (d - c.y) / f);
                            break
                        } else h = ImajnetLRSGUICommon.roadsPRData[this.currentRoadId].pr[e].prNumber, d = l * (c.y - d) / f;
            ...
            getPRNumberIndex: function(a) {
                for (var b = 0; b < this.prLength; b++)
                    if (ImajnetLRSGUICommon.roadsPRData[this.currentRoadId].pr[b].prNumber == a) return b;
                return -1
            },
            getPRNumberCumulatedFromPreviousIndex: function(a, b) {
                for (var c = 0; c < this.prLength; c++)
                    if (ImajnetLRSGUICommon.roadsPRData[this.currentRoadId].pr[c].prNumber ==
                        a) {
            ...
            drawRoad: function(a) {
                ...
                if (this.redrawRoad || !this.minBound || !this.maxBound || g < this.minBound + 10 || g >
                    ...
                    if (Nigsys.browserIsOpera() || Nigsys.isWindows())
                        if (a = 6, this.PRTextOffset = 9, Nigsys.browserIsIE8() || Nigsys.browserIsIE7()) this.PRTextOffset = 6;
                    ImageControler.currentGraphic.clearLRSGUI(this);
            ...
            onGetRoadSuccess: function(a, b) {
                if (a.pr) b && b.LRSObject && b.LRSObject.resetData(a.pr.length), a.roadId && a.roadId == b.LRSObject.currentRoadId && (ImajnetLRSGUICommon.roadsPRData[b.LRSObject.currentRoadId] = a, ImajnetLRSGUICommon.onImajnetImageRoadChange(b.LRSObject),
                    b.LRSObject.resetZoom(), b.LRSObject.drawRoad(null));
                else if (b && b.LRSObject) b.LRSObject.onGetRoadError(a, b)
            },
            ...
            draw: function(a) {
                ...
                return ImajnetLRSGUICommon.roadsPRData[this.currentRoadId] ? (this.resetData(ImajnetLRSGUICommon.roadsPRData[this.currentRoadId].pr.length), this.resetZoom(), ImajnetLRSGUICommon.onImajnetImageRoadChange(this), this.drawRoad(null), b.resolve(), b.promise()) : LRSRequest.getRoad(this.linearPosition.road.id, this.onGetRoadSuccess, this.onGetRoadError, {
                    LRSObject: this
                })
            },
            show: function() {
...
var ImajnetMap = {
    ...
    RESOLUTIONS: [
	156543.0339, 78271.51695, 39135.758475, 19567.8792375, 9783.93961875, 4891.969809375, 2445.9849046875, 1222.99245234375, 611.496226171875, 305.7481130859375, 152.87405654296876, 
	76.43702827148438, 38.21851413574219,19.109257067871095, 9.554628533935547, 4.777314266967774, 2.388657133483887, 1.1943285667419434, .5971642833709717
    ],
    viewAngle: 80,
    ...
    getPolyligneFeatureWrapper: function(a) {
        ...
        for (a = 0; a < b.length; a++)
            if (b[a].type != ImajnetMap.MARKER_TYPE_POLYLIGNE_POSITION) return b[a]
    },
    getFeatureWrapperById: function(a) {
        for (var b = 0, c = ImajnetMap.featureWrappers.length; b <
            c; ++b)
            if (ImajnetMap.featureWrappers[b].id == a) return ImajnetMap.featureWrappers[b];
        return null
    },
    ...
    setOrientationMarker: function(a,
        ...
        if (a && a.lon && a.lat && a.orientation) {
            ...
            if (-1 == d) a = ImajnetMap.cutTriangleMargins(a);
            else if (-4 == d) wideImageTriangleGeometry = a;
            else {
    ...
    setImajboxMarkerPosition: function(a, b) {
        ...
        var c = null,
            d = null;
        a.position ? (c = a.position.lon, d = a.position.lat) : a.parameter && a.parameter.coordinates && (c = a.parameter.coordinates.lon, d = a.parameter.coordinates.lat);
        if (c && d) {
            ...
            b && (c = a.position ? a.position : a.parameter.coordinates) && (ImajnetZoom.imageIsZoomed() && ImajnetZoom.resetZoom(), ImajnetMap.setOrientationMarker(c, ImajnetMap.imajboxTriangleDimension, Nigsys.defaultObjectsColor, -1), ImajnetPlugin.centerMapToPosition(c, !0))
        }
    },
    addClickedPointToMap: function(a) {
        a =
            ImajnetPlugin.addMarker(ImajnetMap.photogrammetryPositionsLayer, {
                lon: a.lon,
                lat: a.lat,
    ...
    clearClickedPointFromMap: function() {
        if (ImajnetMap.photogrammetryPositionsLayer) {
            ...
            a &&
                a[0] && ImajnetPlugin.removeMarker(ImajnetMap.photogrammetryPositionsLayer, a[0]);
    ...
    clearPhotogrammetryObject: function(a) {
        ...
        if (b) {
            if (0 == a) this.clearClickedPointFromMap();
            else if (b.getType() == ImajnetMap.MARKER_TYPE_POSITION || b.getType() == ImajnetMap.MARKER_TYPE_POLYLIGNE_POSITION) ImajnetPlugin.removeMarker(this.photogrammetryPositionsLayer, b);
            else if (b.getType() == ImajnetMap.FEATURE_TYPE_MEASUREMENT) ImajnetPlugin.removeFeatures(this.imajnetDragFeaturesLayer,
                Array(b));
    ...
    clearPhotogrammetryObjects: function() {
        ...
        if (this.imajnetDragFeaturesLayer) {
            ...
            a.length &&
                (ImajnetPlugin.removeFeatures(this.imajnetDragFeaturesLayer, a), this.deleteFeatureWrapperObject(this.FEATURE_TYPE_POLYGON))
        }
    ...
    drawPolylignePoints: function(a) {
        for (var b = 0; b < a.points.length; b++) ImajnetMap.addPoint(a.points[b].id, a.type, a.points[b].photogrammetryPosition3D.coordinates, a.points[b].linkToNext)
    },
    ...
    POIChanged: function(a) {
        ...
        "" != a && (a = this.POIArray[a]) && ("undefined" !== typeof ImajnetUI &&
            Nigsys.showLoading(ImajnetUI.imageContainer), ImajnetZoom.left = -1, ImajnetAPI.setImajnetImage({
                position: a.position
            }), ImajnetPlugin.centerMapToPosition(a.position), jQuery(ImajnetEvents.mappingObject).bind(ImajnetEvents.positionChangeEventName, ImajnetMap.POIImajnetPositionChangeHandler))
    },
    onPOIReceived: function(a) {
        ...
        if (!a || !a.poi || 1 > a.poi.length) jQuery("#imajnetPOI").length && jQuery("#imajnetPOI").html('\x3coption value\x3d""\x3e' + jQuery.imajnet.map.poi.optionDefault +
            "\x3c/option\x3e");
        else if (ImajnetMap.POIArray = a.poi, jQuery("#imajnetPOI").length) {
    ...
    ImajnetAPI = {
        ...
        getPreviousImageFromCache: function(a) {
            for (var b = 0; b < ImajnetAPI.previousPositionCache.length; b++)
                if (ImajnetAPI.previousPositionCache[b].imageId ==
        ...
        getNextImageFromCache: function(a) {
            for (var b = 0; b < ImajnetAPI.nextPositionCache.length; b++)
                if (ImajnetAPI.nextPositionCache[b].imageId == a) return ImajnetAPI.nextPositionCache[b].orderImagePosition;
            return null
        },
        ...
        onSetImajnetImage: function(a, b) {
            if (ImajnetUI) {
                ...
                if (a)
                    if (Imajnet.activateImajnet(), a.position) ImajnetMap.setCurrentPosition(a.position), ImageControler.currentPhotogrammetry.init(), ImageControler.currentImageControl.loadImage(a);
                    else {
        ...
        isImageValid: function(a) {
            ...
            for (var b = 0; b < ImajnetAPI.orderedImagesId.length; b++)
                if (ImajnetAPI.orderedImagesId[b] == a) return ImajnetAPI.orderedImagesId.splice(0, b + 1), !0;
            return !1
        },
        ...
        setImajnetImage: function(a, b) {
            ...
            if (!a || !a.position) return ImajnetAPI.orderedImagesId = [], ImageControler.currentImageControl &&
                (ImageControler.setCurrentImageControl({
                    imageType: "flat"
                }), ImajnetAPI.onSetImajnetImage(a, b)), c.resolve(), c.promise();
        ...
        doOnPositionOrderReceived: function(a) {
            if (ImajnetZoom.canZoom()) ImajnetUI.stopSwipeNavigation(!0);
            else try {
                var b = JSON.parse(a);
                b && b.position && b.parameter && b.parameter.order && !b.parameter.useCameraOrientation && (ImajnetAPI.previousPositionCache.length >= ImajnetAPI.MAX_CACHE_IMAGE_POSITIONS && (ImajnetAPI.previousPositionCache = []), ImajnetAPI.nextPositionCache.length >= ImajnetAPI.MAX_CACHE_IMAGE_POSITIONS && (ImajnetAPI.nextPositionCache = []), b.parameter.order == ImajnetAPI.NEXT ? (ImajnetAPI.nextPositionCache.push({
            ...
            if (a) {
                var c = null,
                    c = "CUBE" == ImageControler.currentImageType ? CubePlugin.getRealImageCoordinatesFromMousePosition(a.x,
                        a.y) : ImajnetZoom.getRealImageCoordinates(a.x, a.y),
                    d = {};
                d.imagePoint = {
                    img: b,
                    imgCoord: c
            ...
            return {
                ...
                complete: function(a) {
                    ...
                    if (200 == a.status)
                        ...
                        } else e && e.resolve(a.responseText, g);
                    else {
                        if (401 != a.status)
                            if (403 == a.status) ImajnetAPI.onError(a, g), "function" === typeof f && f(a, g);
                            else if ("function" ===
                            typeof f) {
...
var ImajnetProtocol = {
    ...
    loginTimeout: function() {
        Nigsys.loginNotification && Nigsys.loginNotification.isOpen &&
            (Nigsys.showLoginError(jQuery.imajnet.login.error.unknown), jQuery("#imajnetLoginButton").prop("disabled", !1), jQuery("#imajnetLoginRequestAccess").prop("disabled", !1), jQuery("#imajnetLoginForgotPassword").prop("disabled", !1), jQuery(document).bind("keydown", ImajnetUI.clickLogin))
    },
    getErrorMessage: function(a) {
        var b = "";
        return b = (b = a.getResponseHeader("authenticationException")) ? b == ImajnetResponse.header.UNAUTHETICATED ? jQuery.imajnet.login.error.header.unauthenticated : b == ImajnetResponse.header.UNAUTHORISED ?
            jQuery.imajnet.login.error.header.unauthorized : b == ImajnetResponse.header.ACCOUNT_LOCKED ? jQuery.imajnet.login.error.header.accountLocked : b == ImajnetResponse.header.ACCOUNT_DISABLED ? jQuery.imajnet.login.error.header.accountDisabled : b == ImajnetResponse.header.ACCOUNT_EXPIRED ? jQuery.imajnet.login.error.header.accountExpired : b == ImajnetResponse.header.CREDENTIALS_EXPIRED ? jQuery.imajnet.login.error.header.credentialsExpired : b == ImajnetResponse.header.INVALID_APPLICATION_KEY ? jQuery.imajnet.login.error.header.invalidApplicationKey :
            b == ImajnetResponse.header.INVALID_SESSION_TYPE ? jQuery.imajnet.login.error.header.invalidSessionType : jQuery.imajnet.login.error.header.unauthenticated : Nigsys.getStatusErrorText(a.status)
    },
    ...
    imajnetLogin: function(a, b, c) {
        ...
        if (!Imajnet.serverUrl) return console.error("Imajnet server url not defined"),
            d.reject(), d.promise();
        jQuery.ajax({
            type: "GET",
            ...
            complete: function(a, b) {
                ...
                //if (ImajnetProtocol.loginStatus == ImajnetResponse.OK) {
                    Nigsys.onMobile() && Nigsys.isSafari() && jQuery("#container").css("position",
                        "fixed");
                ...
                //} 
                //else 
                //	ImajnetPlugin.imajnetLoginError(a), d.reject();
    ...
    imajnetLogout: function(a) {
        ...
        a && "undefined" !== typeof ImajnetUrl &&
            (ImajnetUrl.deleteUrlParams(), ImajnetUrl.applyUrlParams(!0));
    ...
    requestAccess: function() {
        -1 != applicationDomain.indexOf("test.imajnet.net") || -1 != applicationDomain.indexOf("web.imajnet.net") ?
            window.open("https://imajnet.net/registration") : window.open("http://" + window.location.hostname + "/registration")
    },
    doLogin: function() {
...
var ImajnetSettings = {
    ...
    getSettingsFromCookie: function() {
        ...
        if (a)
            for (var b in a) this.imajnetSettings[b] = "imageRetrievalOptions" == b && this.imageRetrievalOptions[a[b]] || "unit" == b ? a[b] : a[b] >= this.rangeImajnetSettings[b].low && a[b] <= this.rangeImajnetSettings[b].high ?
...
var ImajnetLRSSettings = {
        ...
        for (var a in this.defaultLRSSettings)
            if ("display" !=
                ...
                for (var b in this.defaultLRSSettings[a])
                    for (var c in this.defaultLRSSettings[a][b]) jQuery("#" + a + "_" + b + "_" + c).val(this.defaultLRSSettings[a][b][c]);
    ...
    getLRSSettingsFromCookie: function() {
        ...
        if (a)
            for (var b in a)
                for (var c in a[b])
                    for (var d in a[b][c]) this.LRSSettings[b][c][d] = a[b][c][d];
        ...
        for (var a in this.LRSSettings)
            if ("display" != a)
                for (var b in this.LRSSettings[a])
                    for (var c in this.LRSSettings[a][b]) this.LRSSettings[a][b][c] = jQuery("#" + a + "_" + b + "_" + c).val();
    ...
    getLRSSettingsPopupHTML: function() {
        var a = '\x3cdiv id\x3d"' + ("undefined" === typeof ImajnetUI ? "" : ImajnetUI.settingsLRSContainerId) + '"\x3e\x3cdiv class\x3d"LRSSubtitle"\x3e' + jQuery.imajnet.settings.display.title + '\x3c/div\x3e\x3cdiv class\x3d"optionsGroup left LRSSettingsReferentialItemContainer"\x3e\x3cspan class\x3d"popupContentContainerTitle"\x3e' +
            ...
            b = Object.keys(ImajnetLRSSettings.LRSSettings).length,
            c = 0,
            d;
        for (d in this.LRSSettings)
            if ("display" != d)
                for (var e in this.LRSSettings[d]) 0 == c % 2 && (0 != c && (a += '\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e'), a += '\x3cdiv class\x3d"LRSItemContainer"\x3e\x3cdiv class\x3d"LRSSubtitle"\x3e' +
...
var ImajnetZoom = {
    ...
    shiftZoomEnd: function(a) {
        if ("undefined" !==
            ...
            if (!ImajnetZoom.canZoom() && !ImajnetZoom.isZoomMode() || .5 > b || .5 > c) ImajnetUI.hideShiftBox(), ImajnetUI.imajnetZoomOnShiftBox.hide();
            else {
    ...
    onZoomAddHighImageSuccess: function(a, b, c) {
        ...
        ImajnetZoom.zoomBigImageLoaded = !0; - 1 == ImajnetZoom.zoomedImagesCache.indexOf(ImajnetMap.currentPosition.id) && ImajnetZoom.zoomedImagesCache.push(ImajnetMap.currentPosition.id)
    },
    ...
    zoomOnScroll: function(a, b) {
        ...
        if (!(0 < b && this.zoomLevel == this.maxZoomLevel)) {
            ...
            if (0 < b) - 1 !== ImajnetUI.imajnetImage.attr("src").indexOf(ImajnetSettings.imajnetImageResolutions[3]) || this.zoomBigImageLoaded || ImajnetAPI.preloadImage(ImajnetUI.imajnetImage, ImajnetAPI.buildImageURLWithResolution(ImajnetMap.currentPosition,
                ImajnetSettings.imajnetImageResolutions[3]), this.onZoomAddHighImageSuccess, this.onZoomAddHighImageError), this.zoomLevel++;
            else {
                if (1 >= this.zoomLevel) {
                    this.resetZoom();
...
var ImajnetClickMode = {
    ...
    drawOrientedImages: function(a) {
        if (null !==
            this.positions && null !== this.requestedPosition)
...
var ImajnetProjection = {
            ...
            if ((!Nigsys.isPolyligneMode() || 1 != ImageControler.currentPhotogrammetry.currentStep % 2) && a.projection.pointProjections)
                if (c.projection.pointProjections)
                    for (b = 0; b < a.projection.pointProjections.length; b++)
                        ...
                        } else d.push(a.projection.pointProjections[b]);
            else
                for (b = 0; b < a.projection.pointProjections.length; b++)(f = ImageControler.currentPhotogrammetry.getObjectById(a.projection.pointProjections[b].id)) ?
                        ...
                        if (a.projection.shapeProjections[b]) {
                            if (f = ImageControler.currentPhotogrammetry.getObjectById(a.projection.shapeProjections[b].id)) {
                                ...
                                for (g = 0; g < c.projection.shapeProjections.length; g++)
                                    if (c.projection.shapeProjections[g] &&
                                        ...
                                        if (h && h.getType() == ImajnetMap.FEATURE_TYPE_PROJECTION) c.projection.shapeProjections[g] = a.projection.shapeProjections[b];
                ...
                for (var b = 0; b < c.length; b++)
                    if (c[b]) {
                        ...
                        if ((d = ImajnetMap.getFeatureWrapperById(c[b].id)) && 0 <= c[b].coordinates.z)
                            if (0 == c[b].id) ImageControler.currentPhotogrammetry.appendMapMarker(c[b].id, c[b].coordinates);
                            else {
        ...
        ImajnetPlugin.drawUserProjections(ImajnetMap.currentPosition.id).done(function(c, b) {
            b && jQuery.each(b, function(b, a) {
                if (ImajnetMap.getFeatureWrapperById(a.id))
                    for (var c =
                            0; c < ImajnetMap.featureWrappers.length; c++)
    ...
    projectDataRequest: function(a) {
        ...
        jQuery.when(this.projectImajnetDataRequest(a), this.projectUserDataRequest()).always(function() {
            ...
            if (!a) a = ImajnetProjection.userProjections;
    ...
    transform: function(a, b, c) {
        if (b && c)
            if (b instanceof OpenLayers.Projection || (b = new OpenLayers.Projection(b)),
                c instanceof OpenLayers.Projection || (c = new OpenLayers.Projection(c)), b.proj && c.proj) a = Proj4js.transform(b.proj, c.proj, a);
            else {
                b = b.getCode();
                c = c.getCode();
...
OpenLayersForProjection.Renderer.Canvas = OpenLayersForProjection.Class(OpenLayersForProjection.Renderer, {
    ...
    drawPoint: function(a, b, c) {
        if (!1 !== b.graphic)
            ...
            else if (b.graphicName && "circle" != b.graphicName) this.drawNamedSymbol(a,
            b, c);
        else {
    ...
    drawPolygon: function(a, b, c) {
        ...
        for (var e = 1; e < d; ++e) this.canvas.globalCompositeOperation = "destination-out", this.hitDetection && (this.hitContext.globalCompositeOperation = "destination-out"), this.drawLinearRing(a[e], OpenLayersForProjection.Util.applyDefaults({
            stroke: !1,
            fillOpacity: 1
        }, b), c), this.canvas.globalCompositeOperation = "source-over", this.hitDetection && (this.hitContext.globalCompositeOperation = "source-over"), this.drawLinearRing(a[e], OpenLayersForProjection.Util.applyDefaults({
                fill: !1
            },
            b), c)
    },
    ...
    redraw: function() {
        if (!this.locked) {
            ...
            this.hitDetection && this.hitContext.clearRect(0, 0, b, a);
            var a = [],
                c, d, e = this.map.baseLayer && this.map.baseLayer.wrapDateLine &&
    ...
    addMsTouchListenerMove: function(a, b, c) {
        ...
        OpenLayersForProjection.Event.observe(a, "MSPointerMove", function(a) {
            if (a.pointerType != a.MSPOINTER_TYPE_MOUSE || 0 != a.buttons)
                if (1 != d.length || d[0].pageX != a.pageX ||
                    d[0].pageY != a.pageY) {
...
OpenLayersForProjection.Format.XML = OpenLayersForProjection.Class(OpenLayersForProjection.Format, {
    ...
    contentType: function(a) {
        ...
        if (c && b) d = OpenLayersForProjection.Format.XML.CONTENT_TYPE.MIXED;
        else {
    ...
    setAttributeNS: function(a, b, c, d) {
        ...
        else if (this.xmldom) b ? (b = a.ownerDocument.createNode(2,
...
OpenLayersForProjection.Format.KML = OpenLayersForProjection.Class(OpenLayersForProjection.Format.XML, {
    ...
    parseGeometry: {
        point: function(a) {
            ...
            b = null;
            if (1 < a.length) 2 == a.length && (a[2] = null), b = new OpenLayersForProjection.Geometry.Point(a[0], a[1], a[2]);
        ...
        linestring: function(a, b) {
            ...
            if (0 < c.length) {
                for (var c = this.getChildValue(c[0]),
                        c = c.replace(this.regExes.trimSpace, ""), c = c.replace(this.regExes.trimComma, ","), d = c.split(this.regExes.splitSpace), e = d.length, f = Array(e), g, h, k = 0; k < e; ++k)
                    if (g = d[k].split(","), h = g.length, 1 < h) 2 == g.length && (g[2] = null), f[k] = new OpenLayersForProjection.Geometry.Point(g[0], g[1], g[2]);
                    else throw "Bad LineString point coordinates: " + d[k];
                if (e) d = b ? new OpenLayersForProjection.Geometry.LinearRing(f) : new OpenLayersForProjection.Geometry.LineString(f);
...
var CubePlugin = {
    ...
    onDocumentMouseClick: function(a) {
        if (1 == CubePlugin.mouseMoved) CubePlugin.mouseMoved = !1;
        else {
    ...
    onDocumentMouseWheel: function(a, c, b) {
        b ||
            (b = Nigsys.getDelta(a, b));
        if (!c && !ImajnetZoom.canZoom() && !ImajnetZoom.isZoomMode()) 0 < b ? ImageControler.currentImageControl.getNext(!1) : ImageControler.currentImageControl.getPrevious(!1);
        else if (b) {
            if (a = CubePlugin.getIntersection(CubePlugin.scene, a.originalEvent.offsetX, a.originalEvent.offsetY)) {
                ...
                if (0 < b) {
                    ...
                    ImajnetZoom.firstZoom && (CubePlugin.loadCubeImages("high"), ImajnetZoom.firstZoom = !1);
...
CubeImage.loadImage = function(a) {
    ...
    if (b) {
        ...
        if (CubePlugin.cubeMesh) CubePlugin.loadCubeImages();
        else {
            CubePlugin.init();
            animate();
            var c = Array(6),
                d = [];
            for (a = 0; a < CubePlugin.cubeFacesArray.length; a++) d.push(CubePlugin.getMaterialFromUrlDeferred(ImajnetAPI.buildImageURL(b, null, CubePlugin.cubeFacesArray[a]), {
                position: a
            }).done(function(a, b) {
                c[b.position] = a
            }))
...
var SurveyTrace = {
    ...
    draw: function(a) {
        ...
        a && (!SurveyTrace.surveyTraceIsActive || Nigsys.isPositionMode() || Nigsys.isMeasurementMode() || Nigsys.isPolyligneMode() || this.getSurveyTrace(a.id, {
            draw: !0
        }), this.currentPositionId = a.id, this.viewerCurrentPosition = a, ImageControler.currentSurveyTrace.customDraw())
    },
            ...
            if (0 <= this.projections[a].coordinates.z) {
                ...
                var e = this.getSequenceColor(this.positions[a].traceId),
                    ...
                    l = Imajnet.imajnetPath + "img/orientation/" + "A1_up.png?'+Imajnet.version+' A1_right_up.png?'+Imajnet.version+' A1_right.png?'+Imajnet.version+' A1_right_down.png?'+Imajnet.version+' A1_down.png?'+Imajnet.version+' A1_Left_down.png?'+Imajnet.version+' A1_Left.png?'+Imajnet.version+' A1_Left_up.png?'+Imajnet.version+'".split(" ")[this.calculateOrientationIndex(this.viewerCurrentPosition.orientation.yaw,
                        this.positions[a].orientation.yaw)],
                    b = 150,
...
var Photogrammetry = {
    ...
    getImageObjectList: function(a) {
        for (var b = 0; b < ImageControler.currentPhotogrammetry.objects.length; b++)
            if (void 0 !== a && ImageControler.currentPhotogrammetry.objects[b].positionId ==
    ...
    getImagePreviousObject: function(a) {
        for (var b = 0; b < ImageControler.currentPhotogrammetry.objects.length; b++)
            for (var c = 0; c < ImageControler.currentPhotogrammetry.objects[b].data.length; c++)
                if (-1 !== jQuery.inArray(ImageControler.currentPhotogrammetry.objects[b].data[c].type, ImajnetPolyligne.typesArray) && ImageControler.currentPhotogrammetry.objects[b].data[c].id == a - 1) return ImageControler.currentPhotogrammetry.objects[b].data[c];
        return null
    },
    ...
    getImageObjectLinkToNext: function(a, b) {
        for (var c = [], d = 0; d <
            ImageControler.currentPhotogrammetry.objects.length; d++)
            for (var e = 0; e < ImageControler.currentPhotogrammetry.objects[d].data.length; e++) - 1 !== jQuery.inArray(ImageControler.currentPhotogrammetry.objects[d].data[e].type, ImajnetPolyligne.typesArray) && ImageControler.currentPhotogrammetry.objects[d].data[e].type == b && (ImageControler.currentPhotogrammetry.objects[d].data[e].id == a + 1 ? c.push(ImageControler.currentPhotogrammetry.objects[d].data[e]) : ImageControler.currentPhotogrammetry.objects[d].data[e].id == a -
    ...
    getMesurementValueById: function(a) {
        for (var b = 0; b < this.objects.length; b++)
            for (var c = 0; c < this.objects[b].data.length; c++)
                if (this.objects[b].data[c].id == a && this.objects[b].data[c].measurementResult && this.objects[b].data[c].measurementResult.measurement) return this.objects[b].data[c].measurementResult.measurement;
        return ""
    },
    objectIsMeasurement: function(a) {
        for (var b = 0; b < this.objects.length; b++)
            for (var c = 0; c < this.objects[b].data.length; c++)
                if (this.objects[b].data[c].id ==
            ...
            for (var b = 0; b < this.existingProjections.length; b++)
                if (this.existingProjections[b].parameter.pointOfView.id == ImajnetMap.currentPosition.id && this.existingProjections[b].projection.shapeProjections)
                    for (var c = 0; c < this.existingProjections[b].projection.shapeProjections.length; c++)
                        if (this.existingProjections[b].projection.shapeProjections[c] && this.existingProjections[b].projection.shapeProjections[c].id ==
    ...
    getImageIndexInCacheArrayByImageId: function(a) {
        for (var b = 0; b < ImageControler.currentPhotogrammetry.existingProjections.length; b++)
            if (ImageControler.currentPhotogrammetry.existingProjections[b].parameter.pointOfView.id == a) return ImageControler.currentPhotogrammetry.existingProjections[b];
        return null
    },
    ...
    getObjectById: function(a) {
        for (var b = 0; b < this.objects.length; b++)
            for (var c = 0; c < this.objects[b].data.length; c++)
                if (this.objects[b].data[c].id == a) return this.objects[b].data[c];
        return null
    },
    ...
    addImageTag: function(a) {
        ...
        a = {
            position: ImajnetMap.currentPosition,
            coordinates: ImajnetZoom.getRealImageCoordinates(a.clientX -
                b.left, a.clientY - b.top),
    ...
    getLastObjectId: function() {
        for (var a = 1, b = 0; b < this.objects.length; b++)
            for (var c = 0; c < this.objects[b].data.length; c++)
                if (this.objects[b].data[c].id >=
                    a && (a = this.objects[b].data[c].id + 1), this.objects[b].data[c].points)
                    for (var d = 0; d < this.objects[b].data[c].points.length; d++) this.objects[b].data[c].points[d].id >= a && (a = this.objects[b].data[c].points[d].id + 1);
        return a
    },
    ...
    drawConstraints: function() {
        ...
        if (this.currentConstraintData && jQuery.isArray(this.currentConstraintData) &&
            this.firstImagePosition && !this.photogrammetryIsDenied() && (!Nigsys.isPolyligneMode() || 1 != ImageControler.currentPhotogrammetry.currentStep % 2))
            for (var a = 0; a < this.currentConstraintData.length; a++) ImageControler.currentGraphic.drawConstraint(this.currentConstraintData[a])
    },
        ...
        if (null !== ImajnetMap.currentPosition) {
            ...
            if (null != a && (!Nigsys.isPolyligneMode() || -1 !=
                ...
                a: for (; b < a.length; b++) {
                    ...
                    if (a[b].coordinates) Nigsys.isPolyligneMode() || ImageControler.currentPhotogrammetry.appendImageTag(a[b].id, a[b].coordinates);
                    else if (void 0 !== a[b].photogrammetryPosition3D) Nigsys.isPolyligneMode() || 0 != a[b].id && ImageControler.currentGraphic.appendPinPoint(a[b].parameter.imagePoint.imgCoord1, c);
                    ...
                    } else Nigsys.isPolyligneMode() || (ImageControler.currentGraphic.init(), ImageControler.currentPhotogrammetry.drawLine(ImajnetMap.getFeatureWrapperById(a[b].id), [{
    ...
    objectFromCurrentImage: function(a, b) {
        ...
        for (var c = 0; c < this.objects[a].data[b].points.length; c++)
            if (this.objects[a].data[b].points[c].parameter.imagePoint.img1.id != ImajnetMap.currentPosition.id) return !1;
        return !0
    },
    ...
    getImajnetObjectsToProject: function() {
        ...
        if (null != ImajnetMap.currentPosition && 0 < this.objects.length) {
            for (var a = [], b = [], c = [], d = ImageControler.currentPhotogrammetry.getImageIndexInCacheArrayByImageId(ImajnetMap.currentPosition.id), e = 0; e < this.objects.length; e++)
                for (var f =
                        0; f < this.objects[e].data.length; f++)
                    if (!this.objectFromCurrentImage(e, f)) {
                        ...
                        if (this.objects[e].data[f].photogrammetryPosition3D && -1 === jQuery.inArray(this.objects[e].data[f].type, ImajnetPolyligne.typesArray)) {
                                ...
                                if (d.projection && d.projection.pointProjections)
                                    for (var g = 0; g < d.projection.pointProjections.length; g++) {
                                        ...
                                        for (g = 0; g < d.projection.shapeProjections.length; g++)
                                            if (d.projection.shapeProjections[g] &&
                            ...
                            if (d && d.projection && d.projection.shapeProjections)
                                for (g = 0; g < d.projection.shapeProjections.length; g++)
                                    if (d.projection.shapeProjections[g] && d.projection.shapeProjections[g].projections &&
                            ...
                            if (d && d.projection && d.projection.shapeProjections && d.projection.shapeProjections.length) {
                                for (var k =
                                        null, g = 0; g < d.projection.shapeProjections.length; g++)
            ...
            if (ImageControler.currentPhotogrammetry.existingProjections[b].projection) {
                ...
                if (ImageControler.currentPhotogrammetry.existingProjections[b].projection.pointProjections)
                    for (var d = 0; d < ImageControler.currentPhotogrammetry.existingProjections[b].projection.pointProjections.length; d++)
                        if (ImageControler.currentPhotogrammetry.existingProjections[b].projection.pointProjections[d] &&
                ...
                if (!c && ImageControler.currentPhotogrammetry.existingProjections[b].projection.shapeProjections)
                    for (d = 0; d < ImageControler.currentPhotogrammetry.existingProjections[b].projection.shapeProjections.length; d++)
                        if (ImageControler.currentPhotogrammetry.existingProjections[b].projection.shapeProjections[d] &&
    ...
    getDataToExport: function() {
        ...
        jQuery.each(this.objects, function(e, h) {
            jQuery.each(h.data, function(e, f) {
                if (void 0 !== f.coordinates) a.push(f);
                else if (f.photogrammetryPosition3D) 0 !=
                    f.id && b.push({
    ...
    drawObjectClipboard: function(a, b) {
        if (Photogrammetry.clipboardActive && void 0 !== a && null !== a && 0 != a.id) {
            ...
            if (a.photogrammetryPosition3D || a.measurementResult) {
                ...
                if (0 > e || 1 < e) d = '\x3cdiv title\x3d"' + jQuery.imajnet.map.clipboard.precisionUnknown + '"\x3e?\x3c/div\x3e';
                else
                    for (var e = Math.round(5 * e), f = 0; 5 > f; f++) d += "\x3cdiv style\x3d\"background-image: url('" +
...
FlatPhotogrammetry.drawLine = function(a, b) {
    ...
    a && (a.style ||
        ...
        x: d[1].x,
        y: d[1].y
    }), ImajnetUI.popupImajnetControlsLayer.append('\x3cdiv id\x3d"measurementText_' +
    ...
    if (b)
        if (-1 !== jQuery.inArray(b.getType().replace("Feature", ""), ImajnetPolyligne.typesArray)) {
            if (a = ImajnetMap.getPolyligneFeatureWrappers(a))
                for (b = 0; b < a.length; b++) ImageControler.currentGraphic.clearItem(a[b].getId())
        } else ImageControler.currentGraphic.clearItem(a);
    else ImageControler.currentGraphic.clearItem(a)
};
...
CubeGraphic.drawLine = function(a, b, c, d, e, f) {
    ...
    this.svg.path("M " + a + " " + b + " L " + c + " " + d).attr({
        ...
        b.stroke == Nigsys.differentTracePinPointColor ? (ImageControler.currentPhotogrammetry.highlightPinPoint(this.objectIdToHighlight),
            ...
            })) : (ImageControler.currentPhotogrammetry.highlightMeasurement(this.objectIdToHighlight), this.attr({
            stroke: Nigsys.hoverObjectsColor
        }))
    }).mouseout(function() {
        var a = this.attr();
        jQuery("#imajnetPhotogrammetryLRS_" + this.data("id")).hide();
        a.stroke == Nigsys.differentTracePinPointHoverColor ? (ImageControler.currentPhotogrammetry.deselectHighlightPinPoint(this.objectIdToHighlight), this.attr({
...
var ImajnetPolyligne = {
    ...
    getCurrentObjectMiddlePoint: function(a) {
        for (var c =
                ImajnetPolyligne.getTotalDistance(a) / 2, b = 0, d = 0; d < a.points.length; d++)
    ...
    onFinish: function(a) {
        if (Imajnet.imajnetIsActive() && -1 != ImajnetPolyligne.currentAddObjectId)
            if (ImageControler.currentPhotogrammetry && ImageControler.currentPhotogrammetry.setRedStep(3),
                a = ImageControler.currentPhotogrammetry.getObjectById(ImajnetPolyligne.currentAddObjectId), ImajnetPolyligne.currentAddObjectId = -1, "polyligne" == ImajnetPolyligne.type && 2 > a.points.length || "polygon" == ImajnetPolyligne.type && 3 > a.points.length) ImageControler.currentPhotogrammetry.deletePhotogrammetryItem(a.id);
            else {
                ImageControler.currentPhotogrammetry.getObjectLRS(a);
...
var ImajnetImageSwitcher = {
    ...
    getFrontOrientedImageIndex: function(a, b) {
        if (0 != a) return b;
        for (var d =
                0; d < this.orientedImages[a].length; d++)
            if (this.orientedImages[a][d].id == this.frontOrientedImages[b].id) return d
    },
    ...
    goToImage: function(a) {
        ...
        this.orientedImages[a][b] && (Nigsys.showLoading(ImajnetUI.imageContainer), ImajnetAPI.setImajnetImage({
    ...
    goToOrderedImage: function(a) {
        ...
        this.orderedImages[a] && (Nigsys.showLoading(ImajnetUI.imageContainer), ImajnetAPI.setImajnetImage({
    ...
    orderedImageMouseOver: function(a, b) {
        ...
        jQuery("#orderedImageDate_" + a).addClass("orderedImageDateBorder"); - 1 > a || (ImajnetImageSwitcher.orderedImagesMainContainer.show(), this.loadImage(0, a, !0))
    },
    ...
    dragSliderLeft: function() {
        ImajnetImageSwitcher.dragLeftPosition && (ImajnetZoom.left = -1, ImajnetUI.imajnetImageSliderInnerContainer.css("left",
            0), Nigsys.showLoading(ImajnetUI.imageContainer), ImajnetAPI.setImajnetImage({
            position: ImajnetImageSwitcher.dragLeftPosition
        }))
    },
    dragSliderRight: function() {
        ImajnetImageSwitcher.dragRightPosition && (ImajnetZoom.left = -1, ImajnetUI.imajnetImageSliderInnerContainer.css("left", -2 * (ImajnetUI.imageContainer.width() + ImajnetImageSwitcher.dragArrowWidth)), Nigsys.showLoading(ImajnetUI.imageContainer), ImajnetAPI.setImajnetImage({
...
Address = {
    ...
    getAddressFromString: function(a) {
        ...
        if (this.currentSearchOption == this.OPTIONS_OSM) a = jQuery.trim(jQuery("#searchAddressInput").val()), "" !== a ? this.getAddressOSMForString(a) : jQuery("#searchResultsDiv").html('\x3cdiv class\x3d"error"\x3e' + jQuery.imajnet.map.popupSearchAddress.noResultsFound + "\x3c/div\x3e");
...
LRS = {
    ...
    getRoadType: function(a) {
        ...
        for (var b = 0; b < LRS.roadsData.roads.length; b++)
            if (LRS.roadsData.roads[b].id == a) return LRS.roadsData.roads[b].unit;
        return LRS.defaultUnit
    },
    getCachedLRSByObjectId: function(a) {
        for (var b in LRS.cachedPoints)
            if (LRS.cachedPoints[b].id == a) return LRS.cachedPoints[b];
        return null
    },
    ...
    transformReceivedLinearPosition: function(a) {
        if (jQuery.isArray(a))
            for (var b = 0; b < a.length; b++) LRS.transformReceivedLinearPositionItem(a[b]);
        else LRS.transformReceivedLinearPositionItem(a)
    },
    getTopologyRequestData: function(a) {
        ...
        if (b.prNumber > c.prNumber || b.prNumber == c.prNumber && b.relativeAbscisa > c.relativeAbscisa) var d = b,
            b = c,
            c = d;
        return {
    ...
    getLRSForGPS: function(a, b, c) {
        ...
        void 0 !== d && d ? b(d) : (d = {}, d.position = a, d.range = ImajnetSettings.rangeLRS, LRSRequest.getLRSForGPS(JSON.stringify(d), b, c))
    },
    ...
    numbersOnly: function(a, b) {
        jQuery("#searchLRSSubmit").prop("disabled", !1);
        if ("searchRelative" == b) LRS.isSearchRelative = !0;
    ...
    getLRSForPointsHTML: function(a, b, c) {
        ...
        b.road.name &&
            (d += '\x3cdiv class\x3d"left LRSFeatureItemName featureLRSRoadLabel"\x3e\x3cb\x3e' + a.roadLabel + '\x3c/b\x3e:\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left"\x3e' + b.road.name + '\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e');
        LRS.getRoadUnitType(b.road.unit);
        b.cumulatedAbscisa && (d += '\x3cdiv class\x3d"featureLRSCumulatedAbscisaLabel"' + (ImajnetLRSSettings.LRSSettings.display.addressAndLRS.imajnetSettingsLRSShowCumulated ? "" : ' style\x3d"display: none;"') + '\x3e\x3cdiv class\x3d"left LRSFeatureItemName"\x3e\x3cb\x3e' +
            a.cumulatedAbscisaLabel + '\x3c/b\x3e:\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left"\x3e' + Math.round(b.cumulatedAbscisa) + '\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e');
        b.relativeAbscisa || (b.relativeAbscisa = 0);
        b.keyPoint && (b.keyPoint.prNumber || 0 == b.keyPoint.prNumber) && (d += '\x3cdiv class\x3d"left LRSFeatureItemName featureLRSRelativePointLabel"\x3e\x3cb\x3e' + a.relativePointLabel + '\x3c/b\x3e:\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left"\x3e(' + b.keyPoint.prNumber + "+" + Math.round(b.relativeAbscisa) +
            ')\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e');
        return d
    },
...
LRSRequest = {
    ...
    doLinearPositionRequest: function(a, d, c, b) {
        if (LRS.noRoads) "function" === typeof c && c(null);
        else return ImajnetAPI.doImajnetRequest("GET", "/api/lrs/linearposition/" + encodeURIComponent(a), null, function(a, c) {
    ...
    getLRSForPointRequest: function(a,
        ...
        this.LRSFeatureAjaxRequest = ImajnetAPI.doImajnetRequestDeferred("POST", "/api/lrs/linearposition/batch/", null, null, null, null, null, !1, {
            ...
            if (c)
                for (var f = 0; f < a.linearPosition.length; f++) LRS.transformReceivedLinearPosition(a.linearPosition[f].linearPosition);
