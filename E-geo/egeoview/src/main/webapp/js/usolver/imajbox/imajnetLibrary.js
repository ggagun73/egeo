...
var Imajnet = {
    ...
    appendImajnetHTMLElements: function(a) {
        ImajnetUI.imageContainer && ImajnetUI.imageContainer.length || jQuery("#" + a).append('\x3cdiv id\x3d"' + ImajnetUI.imageContainerId + '" class\x3d"imajnetItem"\x3e\x3c/div\x3e\x3cdiv id\x3d"' + ImajnetUI.helpContainerId + '" class\x3d"imajnetItem"\x3e\x3c/div\x3e\x3cdiv id\x3d"' + ImajnetUI.aboutImajnetContainerId + '" class\x3d"imajnetItem"\x3e\x3c/div\x3e\x3cdiv id\x3d"' + ImajnetUI.settingsContainerId + '" class\x3d"imajnetItem"\x3e\x3c/div\x3e\x3cdiv id\x3d"' + ImajnetUI.settingsLRSContainerId + '" class\x3d"imajnetItem"\x3e\x3c/div\x3e\x3cdiv id\x3d"' + ImajnetUI.sequenceDetailsId + '" class\x3d"imajnetItem"\x3e\x3c/div\x3e\x3cdiv id\x3d"' + ImajnetUI.imageDetailsId + '" class\x3d"imajnetItem"\x3e\x3c/div\x3e\x3cdiv id\x3d"' + ImajnetUI.groundPlaneDetailsId + '" class\x3d"imajnetItem"\x3e\x3c/div\x3e')
    },
    setImajnetPath: function() {
        var a = this.imajnetPath.lastIndexOf("/");
        if (-1 === a || a !== this.imajnetPath.length - 1)
            this.imajnetPath += "/"
    },
    setLanguage: function(a) {
        this.setImajnetPath();
        this.locale = a;
        return jQuery.getScript(Imajnet.imajnetPath + "js/i18n/locale-" + (a ? a : "en") + ".js")
    },
    init: function(a) {
        this.options = a;
        var b = jQuery.Deferred();
        if (!a)
            return alert("No options supplied"),
            ImajnetPlugin.imajnetLoginError(),
            b.reject(),
            b.promise();
        var d = "";
        a.serverUrl ? (this.serverUrl = a.serverUrl,
        -1 == this.serverUrl.indexOf("http") && (this.serverUrl = window.location.protocol + "//" + window.location.hostname + this.serverUrl),
        this.serverUrl.lastIndexOf("/") === this.serverUrl.length - 1 && this.serverUrl.substring(0, this.serverUrl.length - 2)) : d += "Parameter not supplied: serverUrl!\x3cbr/\x3e";
        this.cartographicServerUrl = a.cartographicServerUrl;
        "undefined" !== typeof ImajnetMap && ImajnetMap && (-1 !== a.serverUrl.indexOf("test.imajnet.net") ? ("undefined" !== typeof ImajnetMap && (ImajnetMap.cartographicServerDomains = [Nigsys.getProtocolString() + "//testcarto1.imajnet.net", Nigsys.getProtocolString() + "//testcarto2.imajnet.net", Nigsys.getProtocolString() + "//testcarto3.imajnet.net", Nigsys.getProtocolString() + "//testcarto4.imajnet.net", Nigsys.getProtocolString() + "//testcarto5.imajnet.net"]),
        ImajnetAPI.imageServerDomains = [Nigsys.getProtocolString() + "//testimage1.imajnet.net", Nigsys.getProtocolString() + "//testimage2.imajnet.net", Nigsys.getProtocolString() + "//testimage3.imajnet.net", Nigsys.getProtocolString() + "//testimage4.imajnet.net", Nigsys.getProtocolString() + "//testimage5.imajnet.net"]) : -1 !== a.serverUrl.indexOf("web.imajnet.net") || -1 !== a.serverUrl.indexOf("app.imajnet.net") || a.useProductionServerDomains ? ("undefined" !== typeof ImajnetMap && (ImajnetMap.cartographicServerDomains = [Nigsys.getProtocolString() + "//carto1.imajnet.net", Nigsys.getProtocolString() + "//carto2.imajnet.net", Nigsys.getProtocolString() + "//carto3.imajnet.net", Nigsys.getProtocolString() + "//carto4.imajnet.net", Nigsys.getProtocolString() + "//carto5.imajnet.net"]),
        ImajnetAPI.imageServerDomains = [Nigsys.getProtocolString() + "//image1.imajnet.net", Nigsys.getProtocolString() + "//image2.imajnet.net", Nigsys.getProtocolString() + "//image3.imajnet.net", Nigsys.getProtocolString() + "//image4.imajnet.net", Nigsys.getProtocolString() + "//image5.imajnet.net"]) : -1 !== a.serverUrl.indexOf("immergis.fr") && ("undefined" !== typeof ImajnetMap && (ImajnetMap.cartographicServerDomains = [Nigsys.getProtocolString() + "//carto1.immergis.fr", Nigsys.getProtocolString() + "//carto2.immergis.fr", Nigsys.getProtocolString() + "//carto3.immergis.fr", Nigsys.getProtocolString() + "//carto4.immergis.fr", Nigsys.getProtocolString() + "//carto5.immergis.fr"]),
        ImajnetAPI.imageServerDomains = [Nigsys.getProtocolString() + "//image1.immergis.fr", Nigsys.getProtocolString() + "//image2.immergis.fr", Nigsys.getProtocolString() + "//image3.immergis.fr", Nigsys.getProtocolString() + "//image4.immergis.fr", Nigsys.getProtocolString() + "//image5.immergis.fr"]));
        if (ImajnetUser.data && this.imajnetIsActive())
            return ImajnetPlugin.imajnetLoginSuccess(),
            ImajnetProtocol.imajnetLoginSuccess(activateImajnet),
            b.resolve(),
            b.promise();
        if (d)
            return alert(d),
        ...
        try {
            a.map && (ImajnetMap.map = a.map),
            ImajnetMap.key = "cartographicKey"
        } catch (c) {}
        a.metadata ? Imajnet.metadata = a.metadata : Imajnet.metadata || (Imajnet.metadata = document.domain);
        a.applicationKey && (Imajnet.applicationKey = a.applicationKey);
    ...
    activateImajnetControl: function(a, b) {
        ...
        for (var d = !1, c = 0, e = ImajnetUI.controlActivatorContainers.length; c < e; ++c)
            ImajnetUI.controlActivatorContainers[c].controlName == b && (d = !0);
        "closestImage" == b ? (ImajnetUI.disableToolControls(),
        Imajnet.clickMode = Imajnet.CLICK_MODE_CLOSEST_IMAGE,
        ImajnetClickMode.hideOrientedImages()) : "clickMode" == b ? (ImajnetUI.disableToolControls(),
        Imajnet.clickMode = Imajnet.CLICK_MODE_ORIENTED_IMAGES,
        12 > ImajnetPlugin.getCurrentZoomLevel() && (ImajnetPlugin.zoomMapTo(12),
        ImajnetMap.currentPosition && ImajnetPlugin.centerMapToPosition(ImajnetMap.currentPosition))) : "showClipboard" == b ? (ImajnetUI.showItem(ImajnetUI.clipboardContainerId, Nigsys.browserIsIE7() ? 350 : null),
        ImajnetUI.addActiveState(a)) : "searchLRS" == b ? LRS.openLRSDialog() : "searchAddress" == b ? Address.openSearchDialog() : "showNews" == b && ImajnetNews.init(!1);
    ...
    deactivateImajnetControl: function(a, b) {
        if (!Imajnet.imajnetIsActive())
            return !1;
        "closestImage" == b ? Imajnet.clickMode = null : "clickMode" == b ? (ImajnetClickMode.hideOrientedImages(),
        Imajnet.clickMode = null) : "showClipboard" == b ? (ImajnetUI.hideItem(ImajnetUI.clipboardExportContainerId),
        ImajnetUI.hideItem(ImajnetUI.clipboardContainerId)) : "searchLRS" == b ? LRS.closeLRSDialog() : "searchAddress" == b ? Address.hideAddress() : "showNews" == b && ImajnetNews.close();
        ImajnetUI.removeActiveState(a)
    },
    deactivateImajnetControls: function() {
        for (var a = 0, b = ImajnetUI.controlActivatorContainers.length; a < b; ++a)
            this.deactivateImajnetControl(ImajnetUI.controlActivatorContainers[a].buttonElement, ImajnetUI.controlActivatorContainers[a].controlName);
        ImajnetUI.disableToolControls()
    },
    activateImajnet: function() {
        if (!Imajnet.imajnetIsActive() && (Imajnet.imajnetIsActiveBoolean = !0,
        "undefined" !== typeof ImajnetUI && ImajnetUI && ImajnetUI.addToolControls(),
        this.enableImajnetExtension(),
        "undefined" !== typeof ImajnetNews && ImajnetNews.init(!0),
        "undefined" !== typeof ImajnetPlugin))
            ImajnetPlugin.onImajnetActivated()
    },
    ...
    deactivateImajnet: function(a, b, d) {
        ...
        if (!a && !Imajnet.imajnetIsActive())
            return ImajnetPlugin.onImajnetDeactivated(),
            c.resolve(),
            c.promise();
        Imajnet.imajnetIsActiveBoolean = !1;
        Imajnet.clickMode = null;
        jQuery(document).unbind("vmouseup", ImajnetZoom.shiftZoomEnd);
        d && (ImajnetUrl.changeUrlParam(ImajnetUrl.LOCATION_URL_PARAM_NAME, "", !0),
        ImajnetUrl.changeUrlParam(ImajnetUrl.SURVEY_TRACE_URL_PARAM_NAME, "", !0));
...
Imajnet.version = "1.1.0";
Imajnet.buildDate = "2017-10-02T15:46:00Z";
var ApplicationStorage = {
    writeObject: function(d, a, b, c) {
        d = (b ? b + "_" : "") + (c ? c + "_" : "") + d;
        try {
            "undefined" === typeof a && (console.error("Write to storage: " + a),
            a = null),
    ...
    readObject: function(d, a, b) {
        try {
            return JSON.parse(window.localStorage.getItem((a ? a + "_" : "") + (b ? b + "_" : "") + d))
        } catch (c) {
            return console.error("LocalStorage - Unable to parse json: " + c),
            null
        }
    },
    writeSessionObject: function(d, a, b, c) {
        try {
            window.sessionStorage.setItem((b ? b + "_" : "") + (c ? c + "_" : "") + d, JSON.stringify(a))
        } catch (e) {
            console.error("SesisonStorage - Unable to serialize json: - " + e)
        }
    },
    readSessionObject: function(d, a, b) {
        try {
            return JSON.parse(window.sessionStorage.getItem((a ? a + "_" : "") + (b ? b + "_" : "") + d))
        } catch (c) {
            return console.error("SessionStorage - Unable to parse json: " + c),
            null
        }
    },
    writeObjectInCookie: function(d, a, b, c) {
        try {
            window.localStorage.setItem((b ? b + "_" : "") + (c ? c + "_" : "") + d, JSON.stringify(a))
        } catch (e) {
            console.error("LocalStorage - Unable to serialize json: - " + e)
        }
    },
    readObjectFromCookie: function(d, a, b) {
        try {
            return JSON.parse(window.localStorage.getItem((a ? a + "_" : "") + (b ? b + "_" : "") + d))
        } catch (c) {
            return console.error("LocalStorage - Unable to parse json: " + c),
...
var ImajnetUrl = {
    ...
    readUrl: function(b) {
        ...
        a[this.GROUP_URL_PARAM_NAME] = this.getUrlParamValue(this.GROUP_URL_PARAM_NAME);
        ...
        if (a[this.ZOOM_URL_PARAM_NAME]) {
            if (c = parseInt(a[this.ZOOM_URL_PARAM_NAME]),
            0 > c || 25 < c)
                a[this.ZOOM_URL_PARAM_NAME] = this.urlParams[this.ZOOM_URL_PARAM_NAME],
                b && this.changeUrlParam(this.ZOOM_URL_PARAM_NAME, a[this.ZOOM_URL_PARAM_NAME], !0)
        } else
            a[this.ZOOM_URL_PARAM_NAME] = this.DEFAULT_ZOOM_LEVEL;
        a[this.SURVEY_TRACE_URL_PARAM_NAME] = this.getUrlParamValue(this.SURVEY_TRACE_URL_PARAM_NAME);
        a[this.SURVEY_TRACE_URL_PARAM_NAME] && a[this.SURVEY_TRACE_URL_PARAM_NAME] != this.SURVEY_TRACE_ACTIVE_PARAM_VALUE && (a[this.SURVEY_TRACE_URL_PARAM_NAME] = this.urlParams[this.SURVEY_TRACE_URL_PARAM_NAME],
        b && this.changeUrlParam(this.SURVEY_TRACE_URL_PARAM_NAME, a[this.SURVEY_TRACE_URL_PARAM_NAME], !0));
        return a
    },
    applyCenterFromUrl: function(b) {
        var a = this.getUrlParamValue(this.POSITION_URL_PARAM_NAME).split(",");
    ...
    changeLocale: function(b) {
        this.urlParams[this.LOCALE_URL_PARAM_NAME] = b;
        b = "";
        var a = window.location.search;
        if (-1 === a.indexOf(this.LOCALE_URL_PARAM_NAME))
            b = (a ? b + (a + "\x26") : b + "?") + (this.LOCALE_URL_PARAM_NAME + "\x3d" + this.urlParams[this.LOCALE_URL_PARAM_NAME] + "\x26");
        else
            for (var a = a.split("\x26"), c = 0; c < a.length; c++)
                -1 !== a[c].indexOf(this.LOCALE_URL_PARAM_NAME) ? (0 == c && (b += "?"),
                b += this.LOCALE_URL_PARAM_NAME + "\x3d" + this.urlParams[this.LOCALE_URL_PARAM_NAME] + "\x26") : b += a[c] + "\x26";
    ...
    applyUrlParams: function(b) {
        try {
            ...
            a[this.SURVEY_TRACE_URL_PARAM_NAME] != this.urlParams[this.SURVEY_TRACE_URL_PARAM_NAME] && (this.urlParams[this.SURVEY_TRACE_URL_PARAM_NAME] = a[this.SURVEY_TRACE_URL_PARAM_NAME],
            a[this.SURVEY_TRACE_URL_PARAM_NAME] == this.SURVEY_TRACE_ACTIVE_PARAM_VALUE ? SurveyTrace.surveyTraceIsActive = !0 : b && (SurveyTrace.surveyTraceIsActive = !1,
            ...
            if (a[this.IMAGE_URL_PARAM_NAME]) {
                ...
                a[this.LOCATION_URL_PARAM_NAME] && a[this.LOCATION_URL_PARAM_NAME] != this.urlParams[this.LOCATION_URL_PARAM_NAME] && (this.urlParams[this.LOCATION_URL_PARAM_NAME] = a[this.LOCATION_URL_PARAM_NAME],
                this.applyImajnetLocation(this.urlParams[this.LOCATION_URL_PARAM_NAME]))
        } catch (e) {
            console.error(e)
        }
    },
    ...
    writeUrl: function(b) {
        var a = "";
        b[this.WORKSPACE_URL_PARAM_NAME] && (a += this.WORKSPACE_URL_PARAM_NAME + this.paramsAssign + b[this.WORKSPACE_URL_PARAM_NAME] + this.paramsSeparator);
        ...
        b[this.TIME_URL_PARAM_NAME] && (a += this.TIME_URL_PARAM_NAME + this.paramsAssign + b[this.TIME_URL_PARAM_NAME] + this.paramsSeparator);
        b[this.MAP_URL_PARAM_NAME] && (a += this.MAP_URL_PARAM_NAME + this.paramsAssign + b[this.MAP_URL_PARAM_NAME] + this.paramsSeparator);
        if (b[this.ZOOM_URL_PARAM_NAME] || 0 == b[this.ZOOM_URL_PARAM_NAME])
            a += this.ZOOM_URL_PARAM_NAME + this.paramsAssign + b[this.ZOOM_URL_PARAM_NAME] + this.paramsSeparator;
        ...
        b = "";
        if (c && "#" != c)
            for (var c = c.replace("#", "").split(this.paramsSeparator), d = 0; d < c.length; d++)
...
var ImajnetResponse = {
    ...
    header: {
        ...
        UNAUTHORIZED_SESSION_TYPE: "UNAUTHORIZED_SESSION_TYPE"
    }
};
...
var Nigsys = {
    ...
    isOutsideViewport: function(a) {
        var c = ImajnetPlugin.getMapExtent();
        return c ? a[0] < c[0] || a[0] > c[2] || a[1] < c[1] || a[1] > c[3] : !1
    },
    ...
    getHighestUnit: function(a, c) {
        if ("m" == c) {
            if (1E3 < a)
                return (a / 1E3).toFixed(3) + " km"
        } else if ("feet" == c && a > LRS.feetInAMile)
            return (a / LRS.feetInAMile).toFixed(3) + " mile";
    ...
    getMeasurementUnit: function() {
        return Imajnet.unit ? Imajnet.unit : "undefined" !== typeof isImajnetMode && isImajnetMode() ? Nigsys.getMeasurementUnitFromImajnet() : "undefined" !== typeof CommonCore && CommonCore.userInfo && CommonCore.userInfo.customer && CommonCore.userInfo.customer.unit ? CommonCore.userInfo.customer.unit : Nigsys.getMeasurementUnitFromImajnet()
    },
    getHighestSquareUnit: function(a, c) {
        if ("m" == c) {
            if (1E6 < a)
                return (a / 1E6).toFixed(3) + " km\x3csup\x3e2\x3c/sup\x3e"
        } else if ("feet" == c) {
            var d = Math.pow(LRS.feetInAMile, 2);
            if (a > d)
                return (a / d).toFixed(3) + " mile\x3csup\x3e2\x3c/sup\x3e"
        }
        return a.toFixed(3) + " " + Nigsys.getUnitText(c) + "\x3csup\x3e2\x3c/sup\x3e"
    },
    ...
    getProtocolString: function() {
        return "undefined" !== typeof Imajnet ? OpenLayersForProjection.String.startsWith(Imajnet.serverUrl, "https:") ? "https:" : "http:" : !CommonCore.isMobile || MainCore.isWeb ? window.location.protocol : "http:"
    },
    isNumber: function(a) {
    ...
    getStatusErrorText: function(a) {
        return a == ImajnetResponse.UNAUTHORIZED ? jQuery.imajnet.login.error.header.unauthorized : a == ImajnetResponse.FORBIDDEN ? jQuery.imajnet.login.error.header.unauthenticated : a == ImajnetResponse.MOVED_TEMPORARILY ? jQuery.imajnet.login.error.movedTemporarily : a == ImajnetResponse.SERVICE_UNAVAILABLE ? "undefined" === typeof isImajnetMode || isImajnetMode() ? jQuery.imajnet.login.error.serviceUnavailable : jQuery.app.login.serviceUnavailable : a == ImajnetResponse.NO_INTERNET_CONNECTION ? "undefined" !== typeof CommonCore && CommonCore.isMobile ? jQuery.imajnet.login.error.noInternetConnection : jQuery.imajnet.login.error.unableToConnect : jQuery.imajnet.login.error.unknown
    },
    initLogoOverlay: function() {
        "undefined" === typeof isImajnetMode || isImajnetMode() || (jQuery("body").append(Nigsys.logoOverlayDiv),
        Nigsys.logoOverlay = jQuery("#logoOverlay"))
    },
    ...
    showNotificationError: function(a, c, d, e, f, h) {
        ...
        return Nigsys.notification.notify("create", "notificationError", {
            title: a,
            text: c
        }, {
            ...
            click: function(a, c) {
                "function" === typeof h && h(a, c)
            }
        })
    },
    showLoginError: function(a) {
        a && ("undefined" === typeof isImajnetMode || isImajnetMode() ? jQuery(Nigsys.loginNotification.element).show() : Login.hideLoginLoading(),
        Nigsys.errorNotification = Nigsys.showNotificationError("", a, "centerLoginError", function(a, d) {
    ...
    getLoginWithHTML: function() {
        return '\x3cdiv id\x3d"notificationLoginInnerContainer"\x3e\x3cdiv class\x3d"imajnetLoginTitle"\x3e\x3ch1\x3e' + jQuery.imajnet.login.title + "\x3c/h1\x3e\x3c/div\x3e\x3cdiv\x3e" + Nigsys.getLoginContent() + '\x3cdiv style\x3d"margin-top: 10px;"\x3e\x3cinput type\x3d"button" id\x3d"imajnetLoginButton" value\x3d"' + jQuery.imajnet.login.button + '" /\x3e\x26nbsp;\x3cinput type\x3d"button" id\x3d"imajnetLoginRequestAccess" onclick\x3d"ImajnetProtocol.requestAccess();" value\x3d"' + jQuery.imajnet.login.requestAccess.title + '" /\x3e\x3cinput type\x3d"button" id\x3d"imajnetLoginForgotPassword" onclick\x3d"ImajnetProtocol.forgotPassword();" value\x3d"' + jQuery.imajnet.login.forgotPassword.title + '" /\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e'
    },
    showImajnetLoading: function() {
        var a = Nigsys.getWindowSize();
        jQuery("body").append('\x3cdiv id\x3d"imajnetLoadingImageContainer"\x3e\x3cdiv class\x3d"imajnetLoadingImage" style\x3d"padding-top: ' + (a.height / 2 - 27) + 'px;"\x3e\x3cimg src\x3d"' + ImajnetUI.getImagesPath() + 'img/loading.gif" id\x3d"imajnetLoadingImage" class\x3d"imajnetLoadingImage" width\x3d"54" height\x3d"55" /\x3e\x3c/div\x3e\x3c/div\x3e')
    },
    ...
    extentToPolygon: function(a) {
        return new ol.geom.Polygon([[[a[0], a[1]], [a[2], a[1]], [a[2], a[3]], [a[0], a[3]], [a[0], a[1]]]])
    },
    positionLoginNotification: function() {
        var a = Nigsys.loginNotificationWidth;
        jQuery("#notificationLoginContainer").width(a);
        Nigsys.positionLoginNotificationCenter(a)
    },
    showLoginNotification: function(a) {
        Nigsys.loginNotification && jQuery(Nigsys.loginNotification.element).is(":visible") || (Nigsys.initLoginContainers(),
        "undefined" !== typeof isImajnetMode && !isImajnetMode() && Nigsys.logoOverlay && Nigsys.logoOverlay.show(),
        "undefined" !== typeof CommonCore && CommonCore.isMobile && Nigsys.initModalOverlay("#content"),
        Nigsys.modalOverlay.show(),
        Nigsys.loginNotification ? jQuery(Nigsys.loginNotification.element).show() : Nigsys.loginNotification = Nigsys.notificationLoginContainer.notify("create", "notificationLogin", {
            text: a
        }, {
            expires: !1,
            beforeopen: function(a, d) {
            ...
            open: function(a, d) {
                ...
                "undefined" === typeof isImajnetMode || isImajnetMode() ? Nigsys.bindClickEvent(e, ImajnetProtocol.doLogin) : ("undefined" === typeof isImajnetMode || isImajnetMode() || (Nigsys.bindClickEvent(e, Login.doLogin),
                Nigsys.bindEnterEvent(Login.doLogin)),
    ...
    disableEventPropagationFull: function(a) {
        ...
        a.preventDefault()) : window.event && (window.event.cancelBubble = !0))
    },
    getRad: function(a) {
        return a * Math.PI / 180
    },
    distanceBetweenPoints: function(a, c) {
        ...
        }), e = d.a, f = d.b, d = d.f, h = this.getRad(c.lon - a.lon), k = Math.atan((1 - d) * Math.tan(this.getRad(a.lat))), l = Math.atan((1 - d) * Math.tan(this.getRad(c.lat))), m = Math.sin(k), k = Math.cos(k), n = Math.sin(l), l = Math.cos(l), p = h, y = 2 * Math.PI, z = 20; 1E-12 < Math.abs(p - y) && 0 < --z; ) {
            var q = Math.sin(p)
              , t = Math.cos(p)
              , u = Math.sqrt(l * q * l * q + (k * n - m * l * t) * (k * n - m * l * t));
            if (0 == u)
                return 0;
            var t = m * n + k * l * t
              , A = Math.atan2(u, t)
              , w = Math.asin(k * l * q / u)
              , v = Math.cos(w) * Math.cos(w)
              , q = t - 2 * m * n / v
              , x = d / 16 * v * (4 + d * (4 - 3 * v))
              , y = p
        ...
        return 1E3 * ((f * (1 + e / 16384 * (4096 + e * (-768 + e * (320 - 175 * e)))) * (A - d * u * (q + d / 4 * (t * (-1 + 2 * q * q) - d / 6 * q * (-3 + 4 * u * u) * (-3 + 4 * q * q))))).toFixed(3) / 1E3)
    },
    distanceBetweenPointsOL: function(a, c) {
        return a.lat == c.lat && a.lon == c.lon ? 0 : Nigsys.distanceTo({
            x: a.lon,
            y: a.lat
        }, {
            x: c.lon,
    ...
    positionExistingElement: function(a, c, d, e) {
        var f = !1
          , h = a.clientY ? a.clientY : a.target ? a.target.offsetTop : 0
          , k = 0
          , k = ("undefined" === typeof isImajnetMode || isImajnetMode() || "undefined" !== typeof MapMethodsCore && MapMethodsCore.layoutData) && ("map" == d || d.selector && -1 !== d.selector.indexOf("LRSSchematicItemLayerData")) ? a.offsetX : a.clientX ? a.clientX : a.target ? a.target.offsetLeft : 0;
        if ("map" != d) {
            var l = null;
            "string" === typeof d ? l = "popupImajnetControlsLayer" == d ? jQuery("#imajnetImageLayer") : jQuery("#" + d) : (0 === d.prop("id").indexOf("LRSSchematic") && (f = !0,
            "portrait" == LRSSchematic.orientation ? (h = a.offsetY + LRSSchematic.titleHeight,
            k = a.offsetX) : h = a.offsetY),
            l = d);
            f || (h -= l.offset().top,
            k -= l.offset().left)
        }
        ...
        l = c.width(),
        m = c.height(),
        l && m || (m = Nigsys.getSVGChildElementSize(c),
        l = m.width,
        m = m.height),
        a = a.top);
        var h = h + m
        ...
        if ("string" === typeof d)
            ...
            if (f) {
                ...
                for (c = p = 0; c < n.length && d.prop("id") != n[c].id; c++)
                    p++;
                "landscape" == LRSSchematic.orientation ? (c = d.parent().parent().parent().width(),
                n = ImajnetLRSGUIWidth * n.length,
                h += p * ImajnetLRSGUIWidth) : (c = ImajnetLRSGUIWidth * n.length,
                n = d.parent().parent().parent().height(),
        ...
        n = e.width();
        p = e.height();
        f ? (h + p > c ? h = "landscape" == LRSSchematic.orientation ? LRSSchematic.container.scrollTop() : h - (p + m + 30) : h + p > LRSSchematic.container.scrollTop() + LRSSchematic.container.height() && (h = LRSSchematic.container.scrollTop()),
        k + n > d || k ? k = "portrait" == LRSSchematic.orientation ? LRSSchematic.container.scrollLeft() : k - n - l - 30 : n > LRSSchematic.container.scrollLeft() + LRSSchematic.container.width() && (k = LRSSchematic.container.scrollLeft()),
        e.css({
            top: 0 < h ? h : 0,
            left: 0 < k ? k : 0
        })) : (c < h + p && (h -= p + m + 30),
        ...
        e.css("max-width", d),
        e.css("left", 0 < k ? k : 0),
        Nigsys.browserIsIE8() || Nigsys.browserIsIE7() || e.corner())
    },
    ...
    stringContains: function(a, c) {
        return "string" == typeof a && -1 !== a.indexOf(c)
    },
    ...
    deleteCookies: function(a) {
        var c = "";
        if (c = "undefined" !== typeof ImajnetUser ? ImajnetUser.getUsername() : CommonCore.userInfo ? CommonCore.userInfo.username : null) {
            var d = Nigsys.getAllCookiesArray();
            if (d && !(11 > d.length))
                for (var e in d.cookies)
                    if (0 === e.indexOf(a + "_") && e != a + "_" + c && (Nigsys.deleteCookie(e),
                    d.length--,
                    11 > d.length))
                        break
        }
    ...
    getCookie: function(a, c) {
        ...
        if ("undefined" !== typeof Storage)
            return ApplicationStorage.readObject(c, d, a);
    ...
    setCookie: function(a, c, d) {
        ...
        if (e)
            if ("undefined" !== typeof Storage)
                ApplicationStorage.writeObject(c, d, e, a);
            else {
                var f = Nigsys.getUserCookies(e, a);
                f || (f = {});
                f[c] = d;
                jQuery.cookie(a + "_" + e, JSON.stringify(f), {
                    expires: 30
                })
            }
    },
    ...
    setIPLocationCookie: function(a, c) {
        var d = {}
          , e = jQuery.cookie("IMAJNET_IP_LOCATIONS");
        e && (d = JSON.parse(e));
        d[a] = c;
        jQuery.cookie("IMAJNET_IP_LOCATIONS", JSON.stringify(d), {
            expires: 30
        })
    },
    ...
    getViewportSize: function() {
        var a, c;
        "undefined" != typeof window.innerWidth ? (a = window.innerWidth,
        c = window.innerHeight) : "undefined" != typeof document.documentElement && "undefined" != typeof document.documentElement.clientWidth && 0 != document.documentElement.clientWidth ? (a = document.documentElement.clientWidth,
        c = document.documentElement.clientHeight) : (a = document.getElementsByTagName("body")[0].clientWidth,
    ...
    getWindowSize: function() {
        var a = 0
          , c = 0;
        1 != (window.devicePixelRatio || 1) ? (c = Nigsys.getViewportSize(),
        a = c.w,
        c = c.h) : window.innerWidth ? (a = window.innerWidth,
        c = window.innerHeight) : 0 != document.documentElement.clientWidth ? (a = document.documentElement.clientWidth,
        c = document.documentElement.clientHeight) : (a = document.body.clientWidth,
    ...
    setSliderValues: function(a, c, d) {
        a && "undefined" !== typeof c && c && (a.slider("option", {
            min: c.min,
            max: c.max
        }),
        a.slider("values", 0, parseInt(c.min)),
        a.slider("values", 1, parseInt(c.max)),
        d.html(c.min + " - " + c.max))
    },
    getUserPositionError: function() {
        Nigsys.showLoading(ImajnetUI.imageContainer);
        ImajnetZoom.left = -1;
        ImajnetMap.POIArray && ImajnetMap.POIArray[0] ? (ImajnetAPI.setImajnetImage({
            position: ImajnetMap.POIArray[0].position
        }),
        ImajnetPlugin.centerMapToPosition(ImajnetMap.POIArray[0].position)) : ImajnetUrl.goToLocation("43.59936957234748,1.43908554574678")
    },
    goToClosestPOI: function(a) {
        ...
        if (-1 != d)
            return ImajnetZoom.left = -1,
            Nigsys.showLoading(ImajnetUI.imageContainer),
            ImajnetAPI.setImajnetImage({
                position: ImajnetMap.POIArray[d].position
            }),
            ImajnetPlugin.centerMapToPosition(ImajnetMap.POIArray[d].position),
            !0;
        Nigsys.getUserPositionError();
        return !1
    },
    getUserPositionSuccess: function(a, c) {
        if ("undefined" === typeof OpenLayersForProjection)
            return null;
        var d = (new OpenLayersForProjection.Format.KML).read(a.responseText), e = null, f;
        for (f in d)
            if ("OpenLayers.Geometry.Point" == d[f].geometry.CLASS_NAME) {
                e = Object({
                    lon: d[f].geometry.x,
                    lat: d[f].geometry.y
                });
    ...
    getUserPositionAjaxRequest: function(a) {
        var c = !1
          , d = Imajnet.serverUrl.substring(0, Imajnet.serverUrl.lastIndexOf("/service"));
        jQuery.ajax({
            type: "GET",
            url: d + "/geomaplookup?ip\x3d" + a + "\x26kml\x3dtrue",
            timeout: 5E3,
            async: !1,
    ...
    getUserPosition: function() {
        ...
        var a = remoteAddress.split(",")
          , c = Nigsys.getIPLocationsCookie();
        if (c)
            for (var c = JSON.parse(c), d = a.length - 1; 0 <= d; d--)
                if (void 0 !== c[a[d]]) {
                    if (c[a[d]] && Nigsys.goToClosestPOI(c[a[d]]))
                        return;
                    a.splice(d, 1)
                }
        for (d = a.length - 1; 0 <= d; d--)
            if (Nigsys.getUserPositionAjaxRequest(a[d]))
                return;
        Nigsys.getUserPositionError()
    },
    ...
    setRadioValue: function(a, c) {
        for (var d = jQuery("input:radio[name\x3d" + a + "]"), e = 0; e < d.length; e++)
            d[e].checked = d[e].value == c,
            CommonCore.updateCustomCheckbox(jQuery(d[e]))
    },
    positionNotificationInCenter: function(a, c, d, e) {
        d = Nigsys.getWindowSize();
        e.width() > d.width - 10 && (a = d.width - 10,
        e.width(a));
        a || (a = e.width());
        c || (c = e.height());
    ...
    positionLoginNotificationCenter: function(a) {
        if ("undefined" !== typeof CommonCore && CommonCore.isMobile) {
            ...
            Nigsys.positionNotificationInCenter(a, 206, jQuery(document), jQuery("#notificationLoginContainer"))
    },
    positionNotification: function(a) {
        if (a && "center" != a)
            if ("centerLoginError" == a)
                if ("undefined" !== typeof CommonCore && CommonCore.isMobile) {
                    a = jQuery("#notification");
                    var c = Nigsys.getWindowSize();
                    a.offset({
                        top: 420,
                        left: (c.width - a.width()) / 2
                    })
                } else
                    Nigsys.positionLoginNotificationErrorCenter(null, -220);
            else
                "rightBottom" == a && (a = jQuery("#notification"),
                c = Nigsys.getWindowSize(),
                a.offset({
                    top: c.height - a.height() - 10,
                    left: c.width - a.width() - 10
                }));
        else
            Nigsys.positionNotificationCenter()
    },
    showConfirmDialog: function(a, c, d, e, f) {
        ...
        Nigsys.confirmDialog = Nigsys.notification.notify("create", "notificationConfirm", {
            text: a,
            type: c
        }, {
            expires: !1,
    ...
    showSessionExpiredNotification: function(a, c, d, e, f) {
        Nigsys.sessionExpired || ("undefined" !== typeof CommonCore && CommonCore.isMobile && Nigsys.initModalOverlay("#content"),
        Nigsys.modalOverlay.show(),
        Nigsys.notification.html(""),
        Nigsys.sessionExpiredNotification = Nigsys.notification.notify("create", "notificationSessionExpired", {
            text: a,
            type: c
        }, {
            expires: !1,
    ...
    addIddleTimeout: function() {
        try {
            jQuery.idleTimeout(document, null, {
                idleAfter: Nigsys.sessionTimeout,
                titleMessage: "",
                onIdle: Nigsys.onIddle
            })
        } catch (a) {}
    },
    ...
    formatGeoserverDateAndTime: function(a) {
        if (!a)
            return "";
        if (-1 === a.indexOf(Nigsys.dateT))
            return Nigsys.formatGeoserverDate(a);
        var c = a.split(Nigsys.dateT)[0].split("-")
          , c = c[2] + " " + Nigsys.getMonthFromNumber(c[1]) + " " + c[0]
    ...
    formatJavascriptDateObjectToJava: function(a) {
        return a ? a.getFullYear() + "-" + Nigsys.addZero(a.getMonth() + 1) + "-" + Nigsys.addZero(a.getDate()) + Nigsys.dateT + Nigsys.addZero(a.getHours()) + ":" + Nigsys.addZero(a.getMinutes()) + ":00" + Nigsys.dateZ : ""
    },
    addZero: function(a) {
        return 10 > a ? "0" + a : a
    },
    ...
    valueIsValidDateTimepicker: function(a) {
        ...
        try {
            var d = a.split(" ")
              , e = parseInt(d[0])
              , f = parseInt(Nigsys.getMonthDigit(d[1]))
              , h = parseInt(d[2])
              , k = d[3];
            a = !0;
            if (k) {
                var l = k.split(Nigsys.timeFormat.charAt(2))
                  , m = parseInt(l[0])
                  , n = parseInt(l[1]);
                a = 0 <= m && 24 >= m && 0 <= n && 59 >= n
            }
    ...
    endDateIsBeforeStartDate: function(a, c) {
        var d = !1;
        try {
            var e = Nigsys.getDateNormalObject(a, "-")
              , f = Nigsys.getDateNormalObject(c, "-")
    ...
    appendDateTimePickerToElement: function(a, c, d, e, f) {
        ...
        if (a.length) {
            var h = a.prop("id");
            -1 === h.indexOf("_created") && -1 === h.indexOf("_modified") && (!d && a.val() && (d = a.val()),
            "xsd:date" == c || "xsd:dateTime" == c ? "undefined" === typeof CommonCore || !CommonCore.isMobile || "xsd:date" != c && "xsd:dateTime" != c ? (f = jQuery.extend(Object({
                dateFormat: "dd MM yy",
                ...
                changeMonth: !0,
                changeYear: !0,
                monthNames: [jQuery.imajnet.dateTime.month1, jQuery.imajnet.dateTime.month2, jQuery.imajnet.dateTime.month3, jQuery.imajnet.dateTime.month4, jQuery.imajnet.dateTime.month5, jQuery.imajnet.dateTime.month6, jQuery.imajnet.dateTime.month7, jQuery.imajnet.dateTime.month8, jQuery.imajnet.dateTime.month9, jQuery.imajnet.dateTime.month10, jQuery.imajnet.dateTime.month11, jQuery.imajnet.dateTime.month12],
            ...
            "xsd:date" == c && (f.showTimepicker = !1),
            a.datetimepicker(f),
            e || (d = Nigsys.formatGeoserverDateTime(d, c)),
            Nigsys.valueIsValidDateTimepicker(d) ? a.datetimepicker("setDate", d) : a.val(""),
            a.keypress(function(a) {
                return !1
            }),
            a.click(function(a) {
                jQuery(a.target).datepicker("show")
            })) : (d && (d = d.replace(Nigsys.dateZ, "")),
            e = a.attr("onchange"),
            a.parent().html('\x3cinput type\x3d"date" data-clear-btn\x3d"false" id\x3d"' + h + '" class\x3d"' + ("xsd:date" == c ? "datePicker" : "") + ("xsd:dateTime" == c ? " dateTimePicker" : "") + '" size\x3d"39" value\x3d"' + Nigsys.formattedDateToInput(d) + '"' + (e ? ' onchange\x3d"' + e + '"' : "") + "\x3e")) : (a.unbind("keypress"),
            a.unbind("click"),
            "undefined" !== typeof CommonCore && CommonCore.isMobile || a.datetimepicker("destroy")))
        }
    },
    ...
    getComboboxInputContainer: function(a) {
        a = a.parent();
        if (!a || !a[0] || !a[0].children)
            return Nigsys.getEmptyCombobox();
        for (var c = 0; c < a[0].children.length; c++)
            if (a[0].children[c].children[0] && -1 !== a[0].children[c].children[0].className.indexOf("ui-combobox-input"))
                return jQuery(a[0].children[c].children[0]);
        return Nigsys.getEmptyCombobox()
    },
    ...
    changeComboboxDisabledState: function(a, c) {
        c ? (a.parent().find("input.ui-autocomplete-input").autocomplete("option", "disabled", !0).prop("disabled", !0),
        a.parent().find("a.ui-button").button("disable")) : (a.parent().find("input.ui-autocomplete-input").autocomplete("option", "disabled", !1).prop("disabled", !1),
        a.parent().find("a.ui-button").button("enable"))
    },
    bindComboboxToSelect: function(a, c, d) {
        a.combobox({
            permisive: d && d.permisive ? !0 : !1,
            selected: function(a, f) {
                "function" === typeof c && (d.selectedValue = f.item.value,
                c(a, d))
            }
        })
    },
    ...
    isDeferred: function(a) {
        return "undefined" !== typeof a && a ? "function" === typeof a.state : !1
    },
    ...
    getFunctionNameAndArguments: function(a) {
        ...
        return {
            name: a[0],
            arguments: Nigsys.replaceAll(Nigsys.replaceAll(c, ", ", ","), "'", "").split(",")
        }
    },
    callFunctionFromString: function(a) {
        a = Nigsys.getFunctionNameAndArguments(a);
        var c = a.name.split(".");
        if (1 == c.length)
            return window[c[0]].apply(this, a.arguments);
        if (2 == c.length)
            return window[c[0]][c[1]].apply(this, a.arguments)
    },
    ...
    doAjaxRequest: function(a, c, d, e, f, h, k) {
        ...
        var l = ""
          , l = !Nigsys.ajaxMustAppendDataToUrl(a) || k && k.postData ? c : c + d;
        -1 === l.indexOf("http") && (l = applicationUrl + l.replace("platform-web/mvc", ""));
        return jQuery.ajax({
            type: a,
            url: l,
            ...
            dataType: "json",
            cache: "undefined" !== typeof k && k && k && k.cache ? k.cache : !1,
    ...
    doAjaxRequestDeferred: function(a, c, d, e, f, h, k) {
        ...
        var m = ""
          , m = !Nigsys.ajaxMustAppendDataToUrl(a) || k && k.postData ? c : c + d;
        -1 === m.indexOf("http") && (m = applicationUrl + m);
        c = k && k.filePath ? k.filePath : !1;
        CommonCore.isMobile && c && !MainCore.isWeb ? appCache.loadFileContent(null, c, m, k && k.forceServerReload ? k.forceServerReload : !1).done(function(a) {
            ...
            complete: function(a, c) {
                ...
                "function" === typeof h && h(a, k);
                200 == a.status || 201 == a.status || 204 == a.status ? ("function" === typeof e && e(d, k),
                l.resolve(d, k)) : ("function" === typeof f && f(a, k),
                l.reject(a, k))
            }
        });
        return l.promise()
    ...
    getArea: function(a) {
        var c = 0;
        if (a && 2 < a.length) {
            for (var d = c = 0, e = a.length; d < e - 1; d++)
                var f = a[d]
                  , h = a[d + 1]
                  , c = c + (f.x + h.x) * (h.y - f.y);
            c = -c / 2
    ...
    getGeodesicAreaNotFinished: function(a) {
        for (var c = 0, d = 0, e = a.length; e--; )
            c += a.lat[e],
            d += a.lon[e];
        for (var c = c / a.length, e = d / a.length, d = Array(a.length), f = a.length; f--; )
            a.lat[f] -= c,
            a.lon[f] -= e,
            0 <= lons[f] && 0 <= a.lat[f] ? d[f] = Math.abs(180 * Math.atan(lat[f] / lons[f]) / Math.PI) : 0 > lons[f] && 0 <= lat[f] ? d[f] = 90 + Math.abs(180 * Math.atan(lat[f] / lons[f]) / Math.PI) : 0 > lons[f] && 0 > lats[f] ? d[f] = 180 + Math.abs(180 * Math.atan(lat[f] / lons[f]) / Math.PI) : 0 <= lons[f] && 0 > lats[f] && (d[f] = 270 + Math.abs(180 * Math.atan(lat[f] / lons[f]) / Math.PI));
        for (f = 0; f < d.length; f++)
            for (var h = 0; h < d.length - 1; h++)
                ...
                lat[h + 1] = c,
                lon[h + 1] = e);
        for (c = a = d = 0; c < lats.length; c++)
            c != lats.length - 1 ? (d += lats[c] * lons[c + 1],
            a += lons[c] * lats[c + 1]) : (d += lats[c] * lons[0],
            a += lons[c] * lats[0]);
        console.log("Area: " + (d - a) / 2)
    },
    signedArea: function(a) {
        for (var c = 0, d = a[0].x, e = 1; e < a.length - 1; e++)
            c += (a[e].x - d) * (a[e - 1].y - a[e + 1].y);
        return c / 2
    },
    computeLonLatPointsArea: function(a) {
        for (var c = new jsts.geom.GeometryFactory, d = [], e = 0; e < a.length; e++)
            d.push(new jsts.geom.Coordinate(a[e].lon,a[e].lat));
    ...
    getGeometryLength: function(a) {
        a = (new jsts.io.WKTReader).read(a);
        return a.getLength()
    },
...
var dockingLeftContainerSize = 20
  , dockingRightContainerSize = 36
  , ImajnetDocking = function(b, d, e, f, c) {
    onParentScroll = null;
    var k = Nigsys.getCookie("IMAJNET", "DOCKING_" + f + "_position");
    k && (delete c.left,
    delete c.top,
    delete c.right,
    delete c.bottom,
    "undefined" !== typeof k.left && (c.left = k.left),
    "undefined" !== typeof k.top && (c.top = k.top),
    "undefined" !== typeof k.right && (c.right = k.right),
    "undefined" !== typeof k.bottom && (c.bottom = k.bottom),
    0 == c.left ? e = "Left" : 0 == c.top ? e = "Top" : 0 == c.right ? e = "Right" : 0 == c.bottom && (e = "Bottom"));
    this.container = b;
    this.previousCss = c;
    this.direction = e;
    this.type = f;
    this.css = c;
    b = '\x3cdiv id\x3d"imajnetDockingLeftContainer_' + f + '" class\x3d"' + (this.css.notResizable ? "" : e) + '"\x3e' + ("header" != f ? '\x3cdiv id\x3d"imajnetDockingButton_' + f + '" class\x3d"imageDockingButton left"\x3e\x3c/div\x3e' : "") + '\x3cdiv id\x3d"imajnetDockingLeftTitleContainer_' + f + '" class\x3d"imajnetDockingLeftTitleContainer left"\x3e\x3c/div\x3e\x3c/div\x3e';
    d = '\x3cdiv id\x3d"imajnetDockingRightContainer_' + f + '" class\x3d"' + (this.css.notResizable ? "" : e) + '"\x3e' + d + "\x3c/div\x3e";
    k = "";
    k = "Bottom" == this.direction ? d + b : b + d;
    jQuery("#imajnetDockingMainContainer_" + f).remove();
    this.container.append('\x3cdiv id\x3d"imajnetDockingMainContainer_' + f + '" class\x3d"imajnetDockingMainContainer imajnetDockingMainContainer_' + this.direction + '" style\x3d"' + (c.left || 0 == c.left ? "left: " + c.left + "px;" : "") + (c.right || 0 == c.right ? "right: " + c.right + "px;" : "") + (c.top || 0 == c.top ? "top: " + c.top + "px;" : "") + (c.bottom || 0 == c.bottom ? "bottom: " + c.bottom + "px;" : "") + '"\x3e' + k + '\x3cdiv class\x3d"clear' + e + '"\x3e\x3c/div\x3e\x3c/div\x3e');
    resizeChildElements(this);
    this.positionOnTop = function(g) {
        this.mainContainer.css("top", g)
    }
    ;
    this.setPinCollapsedImageUrl = function(g) {
        g.css("background-image", "url('" + ImajnetUI.getImagesPath() + "img/imageIcons/toolbarPinPointCollapsed.png')")
    }
    ;
    this.setPinExpandedImageUrl = function(g) {
        g.css("background-image", "url('" + ImajnetUI.getImagesPath() + "img/imageIcons/toolbarPinPointExpanded.png')")
    }
    ;
    this.onDockingButtonDisabled = function(g, h) {
        Nigsys.setCookie("IMAJNET", "DOCKING_" + this.type, "false");
        this.setPinCollapsedImageUrl(g);
        this.css.notResizable ? this.collapseContainer({
            data: {
                type: h
            }
        }) : Nigsys.onMobile() || ("header" == this.type ? (this.rightContainer.removeClass("overflowVisible"),
        this.mainContainer.bind("mouseenter", {
            type: this.type
        }, this.expandTopContainer),
        this.mainContainer.bind("mouseleave", {
            type: this.type
        }, this.collapseTopContainer),
        CommonCore.applyContainerDimension(0, !0)) : (this.mainContainer.bind("mouseenter", {
            type: this.type
    ...
    ;
    this.onDockingButtonEnabled = function(g, h) {
        Nigsys.setCookie("IMAJNET", "DOCKING_" + this.type, "true");
        this.setPinExpandedImageUrl(g);
        this.css.notResizable ? this.expandContainer({
            data: {
                type: h
            }
        }) : "header" == this.type ? (this.rightContainer.addClass("overflowVisible"),
        this.mainContainer.unbind({
    ...
    ;
    this.dockingButtonIsEnabled = function(g) {
        return -1 !== g.css("background-image").indexOf("Expanded")
    }
    ;
    this.onDockingButtonPressed = function(g) {
        var h = jQuery(g.target)
          , a = h.attr("id").replace("imajnetDockingButton_", "")
          , l = ImajnetUI.docking[a];
        l.dockingButtonIsEnabled(h) ? (l.onDockingButtonDisabled(h, a),
        Nigsys.onMobile() && (g.preventDefault(),
        l.collapseContainer({
            data: {
                type: a
            }
        }))) : (l.onDockingButtonEnabled(h, a),
        Nigsys.onMobile() && (g.preventDefault(),
        l.expandContainer({
            data: {
                type: a
    ...
    ;
    Nigsys.bindClickEvent(jQuery("#imajnetDockingButton_" + f), this.onDockingButtonPressed);
    this.mainContainer = jQuery("#imajnetDockingMainContainer_" + f);
    this.leftContainer = jQuery("#imajnetDockingLeftContainer_" + f);
    this.rightContainer = jQuery("#imajnetDockingRightContainer_" + f);
    this.leftContainer.addClass("imajnetDockingLeftContainer");
    this.rightContainer.addClass("imajnetDockingRightContainer");
    "header" != this.type && (this.getDirectionData = function(g) {
        var h = {
            direction: "",
            css: null
        }
          , a = this.mainContainer.parent()
          , l = a.width()
          , a = a.height()
          , b = g.position.left - this.mainContainer.parent().scrollLeft()
          , c = g.position.top - this.mainContainer.parent().scrollTop();
        this.rightContainer.width() && this.rightContainer.height() && (this.leftContainer.hasClass("Left") || this.leftContainer.hasClass("Right") ? (b += this.css.width / 2,
        c += this.css.height / 2) : (b += this.css.height / 2,
        c += this.css.width / 2));
        b <= l / 2 && c <= a / 2 ? b < c ? (h.direction = "Left",
        h.css = {
            left: 0,
            top: g.position.top
        }) : (h.direction = "Top",
        h.css = {
            ...
            top: 0
        }) : b >= l / 2 && c <= a / 2 ? l - b < c ? (h.direction = "Right",
        h.css = {
            right: 0,
            top: g.position.top
        }) : (h.direction = "Top",
        h.css = {
            left: g.position.left,
            top: 0
        }) : b <= l / 2 && c >= a / 2 ? b < a - c ? (h.direction = "Left",
        h.css = {
            left: 0,
            top: g.position.top
        }) : (h.direction = "Bottom",
        h.css = {
            left: g.position.left,
            bottom: 0
        }) : b >= l / 2 && c >= a / 2 && (l - b < a - c ? (h.direction = "Right",
        h.css = {
            right: 0,
            top: g.position.top
        }) : (h.direction = "Bottom",
    ...
    this.mainContainer.draggable({
        ...
        scroll: !1,
        start: function(g, h) {
            var a = ImajnetUI.docking[jQuery(g.target).attr("id").replace("imajnetDockingMainContainer_", "")];
            if (g.originalEvent.target.id != a.leftContainer.attr("id"))
                return !1;
            jQuery(g.target).css("right", "auto")
        },
        stop: function(g, h) {
            var a = ImajnetUI.docking[jQuery(g.target).attr("id").replace("imajnetDockingMainContainer_", "")]
            ...
            if (b.direction && b.css) {
                ...
                if ("imageLRSGUI" == a.type) {
                    ...
                    ImajnetUI.LRSGUI.orientation != d && (ImajnetUI.LRSGUI.orientation = d,
                    ImajnetUI.LRSGUI.redraw())
                }
                a.css.left = b.css.left;
                a.css.top = b.css.top;
                a.css.right = b.css.right;
                ...
                c = b = 0;
                "Left" != a.direction && "Right" != a.direction || a.css.notResizable ? (b = a.css.height,
                c = a.css.width) : (b = a.css.width,
                c = a.css.height);
                resizeChildElements(a);
                var e = a.mainContainer.parent()
                  , d = e.width()
                  , f = e.height()
                  , e = {};
                "undefined" === typeof a.css.left ? a.mainContainer.css("left", "auto") : (a.css.left + b > d && (a.css.left = d - b),
                a.mainContainer.css("left", a.css.left),
                e.left = a.css.left);
                "undefined" === typeof a.css.top ? a.mainContainer.css("top", "auto") : (a.css.top + c > f && (a.css.top = f - c),
                a.mainContainer.css("top", a.css.top),
                e.top = a.css.top);
                "undefined" === typeof a.css.right ? a.mainContainer.css("right", "auto") : (a.css.right + b > d && (a.css.right = d - b),
                a.mainContainer.css("right", a.css.right),
                e.right = a.css.right);
                "undefined" === typeof a.css.bottom ? a.mainContainer.css("bottom", "auto") : (a.css.bottom + c > f && (a.css.bottom = f - c),
                a.mainContainer.css("bottom", a.css.bottom),
                e.bottom = a.css.bottom);
                a.previousCss = a.css;
                ...
                if (a.css.notResizable)
                    b = 0 < a.rightContainer.height(),
                    a.cornerTitle(b),
                    "Left" != a.direction && "Right" != a.direction || b ? removeVertically(a) : setVertically(a);
                else if (a.leftContainer.uncorner(),
                a.rightContainer.uncorner(),
                a.corner(),
                a.rightContainer.height() ? (a.leftContainer.uncorner(),
                b = null,
                c = !1,
                "Left" == a.direction || "Right" == a.direction ? (c = a.leftContainer.hasClass("Top") || a.leftContainer.hasClass("Bottom"),
                onExpandComplete(a)) : (b = onExpandComplete,
                c = a.leftContainer.hasClass("Left") || a.leftContainer.hasClass("Right")),
                c && a.expandContainer({
                    data: {
                        type: a.type
                    }
                }, b)) : onExpandComplete(a),
                a.mainContainer.removeClass("imajnetDockingMainContainer_Left").removeClass("imajnetDockingMainContainer_Right").removeClass("imajnetDockingMainContainer_Top").removeClass("imajnetDockingMainContainer_Bottom").addClass("imajnetDockingMainContainer_" + a.direction),
                a.onParentScroll)
                    a.onParentScroll()
            }
        }
    ...
    this.corner = function() {
        Nigsys.browserIsIE7() || Nigsys.browserIsIE8() || "header" == this.type || ("Left" == this.direction ? (this.leftContainer.corner("right"),
        this.rightContainer.corner("right")) : "Top" == this.direction ? (this.leftContainer.corner("bottom"),
        this.rightContainer.corner("bottom")) : "Right" == this.direction ? (this.leftContainer.corner("left"),
        this.rightContainer.corner("left")) : "Bottom" == this.direction && (this.leftContainer.corner("top"),
        this.rightContainer.corner("top")))
    }
    ;
    this.cornerTitle = function(b) {
        Nigsys.browserIsIE7() || Nigsys.browserIsIE8() || "header" == this.type || (this.leftContainer.uncorner(),
        this.rightContainer.uncorner(),
        "Left" == this.direction ? (this.leftContainer.corner("tr"),
        b || this.leftContainer.corner("br"),
        this.rightContainer.corner("br")) : "Top" == this.direction ? b ? this.rightContainer.corner("bottom") : this.leftContainer.corner("bottom") : "Right" == this.direction ? (this.leftContainer.corner("tl"),
        b || this.leftContainer.corner("bl"),
        this.rightContainer.corner("bl")) : "Bottom" == this.direction && (b ? this.rightContainer.corner("top") : this.leftContainer.corner("top")))
    }
    ;
    this.corner();
    ...
    this.expandContainer = function(b, c) {
        if (b.data.type) {
            ...
            Nigsys.browserIsIE7() || Nigsys.browserIsIE8() || a.leftContainer.uncorner();
            ...
            var d = 0
              ...
              , f = 0
              , k = 0;
            a.css.notResizable ? (a.cornerTitle(!0),
            removeVertically(a),
            d = a.css.height,
            a.leftContainer.animate({
                width: d
            }, 0),
            e = dockingLeftContainerSize,
            f = a.css.height,
            k = a.css.width) : "Left" == a.direction || "Right" == a.direction ? (e = a.css.height,
            f = a.css.width,
            k = a.css.height) : (e = dockingLeftContainerSize,
            f = a.css.height,
            k = a.css.width);
            ...
            a.leftContainer.animate({
                height: e
            }, getAnimateTime(a), function() {
                "Right" == a.direction && ("imajnetTimeframe" == a.type ? a.mainContainer.width(f) : a.mainContainer.width(d + f))
            });
            e = Object({
                height: k
            });
            "header" != a.type && jQuery.extend(e, Object({
                width: f
            }));
    ...
    this.collapseContainer = function(b) {
        if (b.data.type) {
            var c = ImajnetUI.docking[b.data.type];
            c.rightContainer.stop(1);
            c.leftContainer.stop(1);
            if ("mapControls" == b.data.type)
                jQuery("#mapControlsContainer").css("position", "static");
            else if (c.css.notResizable) {
                b = c.leftContainer.children(".imajnetDockingLeftTitleContainer");
                var a = b.html();
                a && (-1 === a.indexOf("\x26nbsp;") && b.html(a + "\x26nbsp;"),
                c.leftContainer.css("width", "auto"))
            }
            c.css.notResizable ? (c.cornerTitle(!1),
            "Left" == c.direction || "Right" == c.direction ? setVertically(c) : removeVertically(c)) : c.leftContainer.animate({
                height: dockingLeftContainerSize
            }, null, function() {
                c.corner()
            });
            b = Object({
            ...
            "header" != c.type && jQuery.extend(b, Object({
                width: 0
            }));
    ...
    this.expandTopContainer = function(b) {
        0 != b.pageY && (jQuery("#imajnetSettingsMenu li div select").show(),
        b = ImajnetUI.docking[b.data.type],
        b.rightContainer.stop(1),
        b.rightContainer.animate({
            height: "Left" == b.direction || "Right" == b.direction ? b.css.height : b.css.width
        }))
    }
    ;
...
function keepDockingInsideParent() {
    for (var b in ImajnetUI.docking)
        if (ImajnetUI.docking[b]) {
            var d = ImajnetUI.docking[b]
              , e = d.container.width();
            if (e) {
                var f = d.css.height;
                if (("Top" == d.direction || "Bottom" == d.direction) && d.css.left + f > e) {
                    var c = e - f;
                    -1 < c && d.mainContainer.css("left", e - f)
                }
            }
            if (e = d.container.height() - ("imageLRSGUI" == d.type ? 55 : 0))
                f = d.css.height,
                ("Left" == d.direction || "Right" == d.direction) && d.css.top + f > e && (c = e - f,
                -1 < c && d.mainContainer.css("top", c))
        }
}
...
function setVertically(b) {
    var d = b.leftContainer.children(".imajnetDockingLeftTitleContainer")
      , e = 15 * d.html().length;
    d.height(e).addClass("textVertically");
    b.leftContainer.addClass("textVertically");
    b.leftContainer.animate({
        height: e + dockingLeftContainerSize
    }, null, function() {
        b.corner()
    })
}
...
CheckDockingCookie = function(b) {
    ...
    if (d) {
        ...
        if ("true" == e || null === e && !d.css.notResizable)
            d.expandContainer({
                data: {
                    type: b
                }
            }),
            d.onDockingButtonEnabled(jQuery("#imajnetDockingButton_" + b), b);
        else
            d.onDockingButtonDisabled(jQuery("#imajnetDockingButton_" + b), b);
...
var ImajnetTimeframe = {
    ...
    setTimeframeTo: function(a) {
        a = jQuery("#imajnetTimeframeFromDate");
        var b = jQuery("#imajnetTimeframeToDate");
        Nigsys.endDateIsBeforeStartDate(Nigsys.formatJavascriptDateToJava(a.val()).replace(Nigsys.dateZ, ""), Nigsys.formatJavascriptDateToJava(b.val()).replace(Nigsys.dateZ, "")) && a.val(b.val())
    },
    ...
    getTimeframeFromInput: function() {
        var a = jQuery("#imajnetTimeframeFromDate").val()
          , b = jQuery("#imajnetTimeframeToDate").val();
        return a && b ? Object({
    ...
    setTimeframe: function(a) {
        ...
        a && a.from && a.to ? ImajnetMap.currentPosition && (ImajnetZoom.left = -1,
        Nigsys.showLoading(ImajnetUI.imageContainer),
        ImajnetAPI.setImajnetImage({
            position: ImajnetMap.currentPosition
        }),
        ImajnetPlugin.redrawLayer(ImajnetMap.imajnetLayer)) : ImajnetPlugin.redrawLayer(ImajnetMap.imajnetLayer)
    }
};
var ImajnetEvents = {
    mappingObject: {},
...
var ImajnetUI = {
    ...
    imajnetImageContainerSize: {
        width: 480,
        height: 400
    },
    imajnetImageContainerInitialSize: {
        width: 480,
        height: 400
    },
    imageAspectRatio: 1,
    ...
    searchLRSContainerIdDefault: "searchLRSContainer",
    searchAddressContainer: null,
    searchAddressContainerId: null,
    searchAddressContainerIdDefault: "searchAddressPopup",
    clipboardContainer: null,
    clipboardContainerId: null,
    clipboardContainerIdDefault: "popupPhotogrammetryClipboard",
    clipboardExportContainer: null,
    clipboardExportContainerId: null,
    clipboardExportContainerIdDefault: "popupPhotogrammetryClipboardExport",
    newsContainer: null,
    newsContainerId: null,
    newsContainerIdDefault: "popupNews",
    ...
    docking: {
        ...
        imageLRSGUI: null,
        imajnetButtons: null,
        imajnetMapButtons: null,
        imajnetTimeframe: null,
        mapToolsButtons: null,
        mapEditButtons: null
    },
    ...
    initContainer: function(a) {
        ImajnetUI[a + "Id"] || (ImajnetUI[a + "Id"] = ImajnetUI[a + "IdDefault"],
        jQuery("body").append('\x3cdiv id\x3d"' + ImajnetUI[a + "Id"] + '"\x3e\x3c/div\x3e'));
        ImajnetUI[a] = jQuery("#" + ImajnetUI[a + "Id"]);
        ImajnetUI[a].addClass("imajnetItem")
    },
    addMobileCss: function() {
        var a = Nigsys.getWindowSize().width;
        1150 < a || (jQuery("#imajnetSettingsMenu").width(930 < a ? a : 930),
        jQuery("#imajnetDockingRightContainer_header").css({
            "overflow-x": "auto",
            "overflow-y": "hidden"
        }),
        jQuery("#imajnetPOI").width(80),
        jQuery("#logoutButton").css("margin-top", -1))
    },
    init: function() {
        ImajnetUI.imageContainer && (Photogrammetry.exportToItemContent = '\x3cdiv class\x3d"leftLabel left"\x3e' + jQuery.imajnet.map.clipboard.popupExport.to + ':\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left"\x3e\x3cinput type\x3d"text" class\x3d"imajnetExportTo" /\x3e\x3c/div\x3e',
        FlatPhotogrammetry.exportToItemContent = Photogrammetry.exportToItemContent,
        CubePhotogrammetry.exportToItemContent = Photogrammetry.exportToItemContent,
        this.createImageContainer(),
        this.initLRSGUIDocking(ImajnetLRSGUIWidth, ImajnetLRSGUIHeight),
        this.LRSGUI = ImajnetLRSGUI({
            id: "imajnetLRSGUI",
    ...
    initContainers: function() {
        ImajnetUI.imageContainer || (CubePlugin && CubePlugin.cubeGeometry && (CubePlugin.cubeGeometry = null),
        ImajnetUI.imageContainer = jQuery("#" + ImajnetUI.imageContainerId),
        ImajnetUI.imageContainer.hide(),
        ImajnetUI.imageContainer.addClass("imajnetImageContainer").css("position", "relative"),
        ImajnetUI.initContainer("clipboardContainer"),
        ImajnetUI.initContainer("clipboardExportContainer"),
        ImajnetUI.initAddressContainer(),
        ImajnetUI.initLRSContainer(),
        ImajnetUI.clipboardExportContainer.hide(),
        ImajnetUI.initContainer("newsContainer"),
        ImajnetUI.clipboardContainer.hide(),
        ImajnetUI.helpContainer = jQuery("#" + ImajnetUI.helpContainerId),
        ImajnetUI.helpContainer.hide(),
        ImajnetUI.aboutImajnetContainer = jQuery("#" + ImajnetUI.aboutImajnetContainerId),
        ImajnetUI.aboutImajnetContainer.hide(),
        ImajnetUI.settingsContainer = jQuery("#" + ImajnetUI.settingsContainerId),
        ImajnetUI.settingsContainer.addClass("popupImajnetSettings"),
        ImajnetUI.settingsContainer.hide(),
        ImajnetUI.settingsLRSContainer = jQuery("#" + ImajnetUI.settingsLRSContainerId),
        ImajnetUI.settingsLRSContainer.hide(),
        ImajnetUI.sequenceDetails = jQuery("#" + ImajnetUI.sequenceDetailsId),
        ImajnetUI.sequenceDetails.hide(),
        ImajnetUI.imageDetails = jQuery("#" + ImajnetUI.imageDetailsId),
        ImajnetUI.imageDetails.hide(),
        ImajnetUI.groundPlaneDetails = jQuery("#" + ImajnetUI.groundPlaneDetailsId),
        ImajnetUI.groundPlaneDetails.hide(),
        ImajnetUI.appendClipboarContainerHTML(),
        "function" === typeof ImajnetUI.imageContainer.disableSelection && (ImajnetUI.imageContainer.disableSelection(),
        ImajnetUI.imageContainer.parent().disableSelection()))
    },
    ...
    showNotificationInfoOk: function(a, b, c, d, e, f) {
        Nigsys.notification.html("");
        a = Nigsys.notification.notify("create", "notificationInfoOk", {
            title: a,
            text: b
        }, {
            expires: !1,
    ...
    showSequenceDetails: function() {
        ...
        ImajnetMap.currentPosition ? ImajnetAPI.doImajnetRequest("GET", "/api/sequence/details?image\x3d" + ImajnetMap.currentPosition.id, null, ImajnetUI.sequenceDetailsReceived) : (jQuery("#sequenceDetailsName").val(""),
        jQuery("#sequenceDetailsProject").val(""),
        jQuery("#sequenceDetailsOperator").val(""),
        jQuery("#sequenceDetailsRepository").val(""),
        jQuery("#sequenceDetailsLocation").val(""))
    },
    ...
    showDeleteSequence: function() {
        ImajnetUI.closeAllMenus();
        ImajnetMap.currentPosition && ImajnetAPI.doImajnetRequest("GET", "/api/sequence/details?image\x3d" + ImajnetMap.currentPosition.id, null, function(a) {
            window.open(ImajnetUI.getManagerUrl() + "app/data/sequence?operation\x3ddelete\x26sequenceid\x3d" + JSON.parse(a).sequence.id, "_blank")
        })
    },
    ...
    showHelp: function() {
        ...
        jQuery("#helpImajnetTraceImage").attr("src", Imajnet.imajnetPath + "img/imageIcons/imajnetTrace.png?" + Imajnet.version);
    ...
    getPreviewImageResolution: function() {
        var a = ImajnetSettings.imajnetImageResolutions[ImajnetSettings.imajnetSettings.imageQuality], b = ImajnetUI.imajnetImage.attr("src"), c;
        for (c in ImajnetSettings.imajnetImageResolutions)
            if (-1 != b.indexOf(ImajnetSettings.imajnetImageResolutions[c])) {
    ...
    computeImageAspectRatio: function() {
        ...
        if (a) {
            var a = a.toUpperCase()
              , b = ImajnetZoom[a + "_RESOLUTION_WIDTH"]
              , a = ImajnetZoom[a + "_RESOLUTION_HEIGHT"];
            if (b && a) {
                ImajnetUI.imageAspectRatio = b / a;
                if (1.2 < ImajnetUI.imageAspectRatio || "CUBE" == ImageControler.currentImageType)
                    ImajnetUI.imageAspectRatio = 1.1941463414634146;
    ...
    getImageDimensions: function(a, b) {
        ...
        c > b && (c = b,
        a = c * ImajnetUI.getImageAspectRatio());
        return Object({
            width: parseInt(a),
            height: parseInt(c)
        })
    ...
    getImageContainerDimesions: function() {
        var a = this.imajnetImageContainerSize
          , b = ImajnetPlugin.getMapSize();
        if (b && b.h) {
            var c = ImajnetUI.getImageAspectRatio();
            c && (a.height = b.h - 150,
            a.width = a.height ? parseInt(a.height * c) - 2 : Nigsys.browserIsIE7() ? 480 : null)
        }
        a.height < this.imajnetImageContainerInitialSize.height && (a.height = this.imajnetImageContainerInitialSize.height);
    ...
    setSliderDraggableContainment: function() {
        if (ImajnetUI.imajnetImageContainer) {
            var a = ImajnetUI.imajnetImageContainer.offset()
              , b = ImajnetUI.imajnetImageContainerSize.width + ImajnetImageSwitcher.dragArrowWidth
              , c = a.left - b
              , d = c;
    ...
    onImageMouseDown: function() {
        if (!(Nigsys.isPositionMode() || Nigsys.isMeasurementMode() || Nigsys.isPolyligneMode())) {
            ...
            for (var a = 0; a < ImajnetUI.imagesLoadQueue.length; )
                ImajnetUI.imagesLoadQueue[a].onload = null,
                a++;
            ImajnetUI.imagesLoadQueue = [];
            ImajnetMap.lastLoadedImagePosition && (ImajnetMap.setCurrentPosition(ImajnetMap.lastLoadedImagePosition),
            ImajnetMap.setImajboxMarkerPosition({
                position: ImajnetMap.lastLoadedImagePosition
            }, !0),
            ImageControler.currentImageControl.doRequests(ImajnetMap.currentPosition))
        }
    },
    onImageClick: function(a) {
        Nigsys.disableEventPropagationFull(a);
        if (ImajnetUI.zoomCancel)
            ImajnetUI.zoomCancel = !1;
        else if (ImajnetZoom.imageWasDragged && Nigsys.browserIsIE7())
            ImajnetZoom.imageWasDragged = !1;
        else if (!(Nigsys.isPolyligneMode() && "path" == a.target.nodeName && "constraintLine" != a.target.id || "imajnetErrorsPopupOKButton" == a.target.id || a.shiftKey)) {
            var b = ImajnetUI.imajnetImageContainer.offset()
              , c = a.pageX - b.left
              , b = a.pageY - b.top;
            switch (ImajnetUI.activeControlButton) {
            case "imajnetPosition":
                ImajnetPosition.positionObject(c, b);
                break;
    ...
    onImageDblClick: function(a) {
        if (a.target && ("popupImajnetImage" == a.target.id || "svg" == a.target.nodeName.toLowerCase()) && !Nigsys.isPositionMode() && !Nigsys.isMeasurementMode())
            if (1 == ImageControler.currentSurveyTrace.moveImageToClickPosition)
                ImageControler.currentSurveyTrace.onImageDbClick(a);
            else
                ImageControler.currentPhotogrammetry.addImageTag(a)
    },
    ...
    imageContainerMouseMove: function(a) {
        ...
        ImajnetUI.mouseMoveTimeout = setTimeout(function() {
            var b = a.target.parentNode.getBoundingClientRect();
            ImajnetAPI.lastMouseCoordinates = {
                x: a.pageX - b.left,
                y: a.pageY - b.top
            };
    ...
    onDragEnd: function(a, b, c) {
        a = parseInt(a);
        b = parseInt(b);
        a >= b || (a == b - 1 && ImageControler.currentImageControl.resetFastNavigation(),
        window.ImageControler.currentImageControl[c](!1),
        a++,
        ImajnetUI.imageNavigationTimer = setTimeout("ImajnetUI.onDragEnd('" + a + "', '" + b + "', '" + c + "')", ImajnetUI.swipeImageTimeout))
    },
    stopSwipeNavigation: function(a) {
        ImajnetUI.imageNavigationTimer && (ImajnetUI.imajnetImageContainer.off("vmousedown", ImajnetUI.onImageMouseDown),
        clearTimeout(ImajnetUI.imageNavigationTimer),
        ImajnetUI.imageNavigationTimer = null,
        ImajnetAPI.imajnetOrderRequest && (ImajnetAPI.imajnetOrderRequest.abort(),
        ImajnetAPI.imajnetOrderRequest = null),
    ...
    navigateOnSwipe: function(a, b, c, d, e) {
        if (1 < e)
            return !0;
        ImajnetUI.imageNavigationTimer && (clearTimeout(ImajnetUI.imageNavigationTimer),
        ImajnetUI.imageNavigationTimer = null);
        if ("up" !== b && "down" !== b || 0 < ImajnetZoom.zoomLevel || ImajnetUI.imajnetZoomOnShiftBox.is(":visible"))
            return !0;
        a = 1;
        c *= 1E3 / window.screen.availHeight;
        100 < c && (d = (c / d).toFixed(4),
        a = Math.floor(30 * d + .5),
        1 > a && (a = 1));
        1 < a && (ImageControler.currentImageControl.setFastNavigation(),
        ImajnetUI.imajnetImageContainer.on("vmousedown", ImajnetUI.onImageMouseDown));
        if ("down" == b)
            ImajnetUI.onDragEnd(0, a, "getNext");
        else if ("up" == b)
            ImajnetUI.onDragEnd(0, a, "getPrevious")
    },
    addSwipeHandlers: function() {
        if (Nigsys.onMobile() || Nigsys.isTouchDevice())
            if (ImajnetUI.imajnetImageContainer.swipe({
                swipe: function(a, b, c, d, e) {
                    ImajnetUI.navigateOnSwipe(a, b, c, d, e)
                },
                threshold: 10,
                pinchIn: function(a, b, c, d, e, f, g) {
        ...
        ImajnetUI.imajnetImageSliderContainer.on({
            vmousedown: function(a) {
                if ("svg" == a.target.nodeName || "popupImajnetImage" == a.target.id)
                    ImajnetUI.swipeDragXStartPosition = a.offsetY,
                    ImajnetUI.swipeDragXStartTime = new Date,
                    a.preventDefault()
            },
            vmouseup: function(a) {
                if ("svg" == a.target.nodeName || "popupImajnetImage" == a.target.id) {
    ...
    createImageContainer: function() {
        if (this.imageContainer) {
                ...
                this.imajnetImageSliderInnerContainer.draggable({
                    ...
                    drag: function(a, c) {
                        if (-1 != ImajnetUI.dragImageSliderPrevX) {
                            ...
                            if (ImajnetUI.imajnetImage.width() > ImajnetUI.imajnetImageContainerSize.width && 1 == ImajnetUI.dragImageSliderCount && ("left" == d && 0 == ImajnetUI.imajnetImage.position().left || "right" == d && ImajnetZoom.imageDragRightReachEnd()))
                                return ImajnetUI.disableDraggable(ImajnetUI.imajnetImageSliderInnerContainer),
                                ImajnetUI.enableImageDrag(),
                                ImajnetUI.dragImageSliderPrevX = -1,
                        ...
                        if (0 < d && ImajnetImageSwitcher.dragLeftPosition)
                            ImajnetUI.sliderLeftImage && ImajnetUI.sliderLeftImage.attr("src") || ImajnetUI.sliderLeftImageContainer.hasClass("imajnetLayerNoImage") || (ImajnetUI.sliderLeftImageContainer.html(ImajnetUI.getSliderLeftImage("")),
                            ImajnetUI.sliderLeftImage = jQuery("#imajnetLayerLeftImage"),
                            ImajnetImageSwitcher.loadImageForSlider(ImajnetUI.sliderLeftImage, ImajnetImageSwitcher.dragLeftPosition)),
                            d > ImajnetUI.imajnetImageContainerSize.width / 3 && ImajnetUI.imajnetImage.addClass("opacity30");
                        else if (0 > d && ImajnetImageSwitcher.dragRightPosition)
                            return ImajnetUI.sliderRightImage && ImajnetUI.sliderRightImage.attr("src") || ImajnetUI.sliderLeftImageContainer.hasClass("imajnetLayerNoImage") || (ImajnetUI.sliderRightImageContainer.html(ImajnetUI.getSliderRightImage("")),
                            ImajnetUI.sliderRightImage = jQuery("#imajnetLayerRightImage"),
                            ImajnetImageSwitcher.loadImageForSlider(ImajnetUI.sliderRightImage, ImajnetImageSwitcher.dragRightPosition)),
                            -1 * d > ImajnetUI.imajnetImageContainerSize.width / 3 && ImajnetUI.imajnetImage.addClass("opacity30"),
                            !0
                    },
                    stop: function(a, c) {
                        ImajnetUI.imajnetImage.removeClass("opacity30");
                        var d = !1
                          , e = c.position.left - c.originalPosition.left;
                        e > ImajnetUI.imajnetImageContainerSize.width / 3 ? (ImajnetImageSwitcher.dragSliderLeft(),
                        d = !0) : -1 * e > ImajnetUI.imajnetImageContainerSize.width / 3 && (ImajnetImageSwitcher.dragSliderRight(),
                        d = !0);
            ...
            this.imajnetImageContainer.append('\x3cdiv id\x3d"imajnetErrorsPopup" onclick\x3d"ImajnetUI.hideError();"\x3e\x3cdiv id\x3d"imajnetErrorsPopupText"\x3e\x3c/div\x3e\x3cbr/\x3e\x3cinput type\x3d"button" id\x3d"imajnetErrorsPopupOKButton" value\x3d"' + jQuery.imajnet.button.ok + '" onclick\x3d"jQuery(\'ImajnetErrorsPopup\').hide();"/\x3e\x3c/div\x3e');
            try {
                ...
                this.popupImajnetControlsLayer.draggable({
                    ...
                    stop: function(a, c) {
                        ImageControler.currentGraphic.constraintSVG || (ImajnetZoom.imageWasDragged = !0,
                        ImajnetZoom.onImageDragStop(a, c))
                    }
                })
            } catch (b) {}
    ...
    appendControls: function() {
        ...
        ImajnetUI.docking.imageButtons = new ImajnetDocking(ImajnetUI.imageContainer,'\x3cdiv class\x3d"imajnetControlsLayerButtonsItem" id\x3d"imajnetPositionButtonContainer"\x3e\x3cimg src\x3d"' + Imajnet.imajnetPath + "img/imageIcons/imajnet3dPosition.png?" + Imajnet.version + '" onclick\x3d"ImajnetPosition.showHidePosition(); Nigsys.disableEventPropagation(event);"  title\x3d"' + jQuery.imajnet.map.position.title + '" /\x3e\x3c/div\x3e\x3cdiv class\x3d"imajnetControlsLayerButtonsItem" id\x3d"imajnetMeasurementButtonContainer"\x3e\x3cimg src\x3d"' + Imajnet.imajnetPath + "img/imageIcons/imajnetRuler.png?" + Imajnet.version + '" onclick\x3d"ImajnetMeasurement.showHideMeasurement(); Nigsys.disableEventPropagation(event);" title\x3d"' + jQuery.imajnet.map.measurement.title + '" /\x3e\x3c/div\x3e\x3cdiv class\x3d"imajnetControlsLayerButtonsItem" id\x3d"imajnetPolyligneButtonContainerpolyligne"\x3e\x3cimg src\x3d"' + Imajnet.imajnetPath + "img/imageIcons/imajnetPolyligne.png?" + Imajnet.version + '" onclick\x3d"ImajnetPolyligne.showHide(\'polyligne\'); Nigsys.disableEventPropagation(event);" title\x3d"' + jQuery.imajnet.map.polyligne.title + '" /\x3e\x3c/div\x3e\x3cdiv class\x3d"imajnetControlsLayerButtonsItem" id\x3d"imajnetPolyligneButtonContainerpolygon"\x3e\x3cimg src\x3d"' + Imajnet.imajnetPath + "img/imageIcons/imajnetPolygon.png?" + Imajnet.version + '" onclick\x3d"ImajnetPolyligne.showHide(\'polygon\'); Nigsys.disableEventPropagation(event);" title\x3d"' + jQuery.imajnet.map.polygon.title + '" /\x3e\x3c/div\x3e\x3cdiv class\x3d"imajnetControlsLayerButtonsItem" id\x3d"imajnetTraceSurveyButtonContainer" onclick\x3d"Nigsys.disableEventPropagation(event);" title\x3d"' + jQuery.imajnet.settings.surveyTrace + '"\x3e\x3cimg src\x3d"' + Imajnet.imajnetPath + "img/imageIcons/imajnetTrace.png?" + Imajnet.version + '" onclick\x3d"ImageControler.currentSurveyTrace.showHideSurveyTrace(); Nigsys.disableEventPropagation(event);" /\x3e\x3c/div\x3e\x3cdiv class\x3d"imajnetControlsLayerButtonsItem" id\x3d"imajnetZoomButtonContainer"\x3e\x3cimg src\x3d"' + Imajnet.imajnetPath + "img/imageIcons/imajnetZoom.png?" + Imajnet.version + '" onclick\x3d"ImajnetZoom.activateDeactivateZoom(); Nigsys.disableEventPropagation(event);" title\x3d"' + jQuery.imajnet.image.zoomButton + '" /\x3e\x3c/div\x3e\x3cdiv class\x3d"imajnetControlsLayerButtonsItem" id\x3d"imajnetSaveImage" style\x3d"margin-bottom: 4px;"\x3e\x3cimg src\x3d"' + Imajnet.imajnetPath + "img/imageIcons/imajnetSnapshot.png?" + Imajnet.version + '"  onclick\x3d"ImajnetUI.donwloadImajnetImage(); Nigsys.disableEventPropagation(event);"  title\x3d"' + jQuery.imajnet.image.save + '" /\x3e\x3c/div\x3e',"Right","imageButtons",{
            width: 32,
            height: 200,
            right: 0,
            top: 10
    ...
    showImage: function() {
        ...
        ImajnetZoom.imageIsZoomed() ? (this.setImageContainerSize(this.imajnetImageContainer.width(), this.imajnetImageContainer.height()),
        ImajnetZoom.resetZoom()) : ImajnetZoom.setDraggableContainment()
    },
    hideImage: function() {
    ...
    setSlidersWidth: function(a) {
        ...
        jQuery(".imajnetImageSliderItem").css("width", a);
    ...
    getLargeImageWidthOverflow: function() {
        return !ImajnetUI.fullSizeAspectRatio || 1.2 > ImajnetUI.fullSizeAspectRatio ? 0 : ImajnetZoom.HIGH_RESOLUTION_WIDTH / ImajnetZoom.HIGH_RESOLUTION_HEIGHT - ImajnetUI.imageAspectRatio
    },
    onImageResize: function() {
        if (ImajnetUI.imageContainer) {
            var a = ImajnetUI.imageContainer.parent().width()
              , b = ImajnetUI.imageContainer.parent().height();
            jQuery(".imajnetPopupTitleBar").length && (b -= jQuery(".imajnetPopupTitleBar").height());
            a && b || (a = ImajnetUI.imajnetImageContainerSize.width,
            b = ImajnetUI.imajnetImageContainerSize.height);
    ...
    resizeImageElement: function(a, b) {
        if (ImajnetUI.fullSizeAspectRatio) {
            ...
            ImajnetZoom.left && -1 != ImajnetZoom.left ? ImajnetZoom.moveToLeft(ImajnetZoom.left) : c || ImajnetZoom.moveToLeft(0);
            this.imajnetImage.css("height", b);
            this.imajnetSurveyTraceContainer.css("width", a);
            this.imajnetSurveyTraceContainer.css("height", b);
            this.imajnetImageContainerInitialSize = {
                width: a,
                height: b
            }
        }
    ...
    resizeImageElements: function(a, b, c) {
        ...
        this.imajnetImage.hasClass("popupImajnetDefaultImage") && this.imajnetImage.css("margin-top", (b - 445) / 2);
        ImajnetZoom.imageIsZoomed() ? ImajnetZoom.left < -(a * this.getLargeImageWidthOverflow()) ? (ImajnetZoom.resetZoom(),
        ImajnetZoom.left = -(a * this.getLargeImageWidthOverflow())) : ImajnetZoom.resetZoom() : (ImajnetZoom.width = ImajnetUI.imajnetImageContainerInitialSize.width,
        ImajnetZoom.height = ImajnetUI.imajnetImageContainerInitialSize.height);
        ...
        ImageControler.currentPhotogrammetry.onResize(a, b);
        ImajnetZoom.setDraggableContainment();
        if (this.LRSGUI)
            this.LRSGUI.onResize();
        if ("CUBE" == ImageControler.currentImageType)
            CubePlugin.onWindowResize()
    },
    ...
    showAndPositionInside: function(a, b) {
        var c = a.position();
        c.top + b.height() > CommonCore.mapContainer.height() ? b.css("top", -(b.height() - 20)) : b.css("top", 0);
    ...
    disableToolControls: function() {
        for (var a = 0, b = this.controlActivatorContainers.length; a < b; ++a)
            "showClipboard" != this.controlActivatorContainers[a].controlName && "showLRS" != this.controlActivatorContainers[a].controlName && this.removeActiveState(this.controlActivatorContainers[a].buttonElement)
    },
    hideShiftBox: function() {
        ImajnetUI.imajnetZoomOnShiftBox && (ImajnetUI.imajnetZoomOnShiftBox.width(0),
        ImajnetUI.imajnetZoomOnShiftBox.height(0),
        ImajnetUI.imajnetZoomOnShiftBox.hide())
    },
    ...
    removeImageElements: function() {
        ...
        ImajnetUI[ImajnetUI.clipboardContainerId] = null;
    ...
    imajnetKeydownHandler: function(a) {
        try {
            "textareaEditComment" != a.target.className && (ImajnetUI.allowKeyUp = !0,
            90 == a.keyCode ? (ImajnetUI.imajnetImageContainer.off("vclick", ImajnetUI.onImageClick),
            ImajnetZoom.isZoomMode() || (ImajnetAPI.lastNavigationPositionImageId = "",
            ImajnetZoom.zKeyPressed = !0,
            ImajnetZoom.doWhenActivateZoom())) : 16 == a.keyCode && (ImajnetUI.imajnetImageContainer.off("vclick", ImajnetUI.onImageClick),
            ImajnetZoom.isZoomMode() || (ImajnetAPI.lastNavigationPositionImageId = "",
    ...
    imajnetKeyupHandler: function(a) {
        try {
            ImageControler.currentImageControl.isFastNavigation && (ImageControler.currentImageControl.resetFastNavigation(),
            ImageControler.currentImageControl.doRequests(ImajnetMap.currentPosition)),
            ImajnetZoom.zKeyPressed = !1,
            ImajnetZoom.shiftKeyPressed = !1,
            !ImajnetUI.allowKeyUp || 16 != a.keyCode && 90 != a.keyCode || (ImajnetUI.allowKeyUp = !1,
            ImajnetUI.imajnetZoomOnShiftBox.is(":visible") && (ImajnetUI.zoomCancel = !0),
            ImajnetUI.imajnetImageContainer.off("vclick").on("vclick", ImajnetUI.onImageClick),
            ImajnetZoom.isZoomMode() || (jQuery(".popupImajnetImage").removeClass("zoomCursor"),
            ImajnetZoom.doWhenDeactivateZoom(),
            ImajnetUI.imajnetImageContainer.off("vmousedown", ImajnetZoom.onShiftZoomStart),
            ImajnetUI.imajnetImageContainer.off("vmousemove", ImajnetZoom.shiftZoomMouseMove),
            0 == ImajnetZoom.zoomLevel ? ImajnetUI.enableDraggable(ImajnetUI.imajnetImageSliderInnerContainer) : (ImajnetUI.enableImageAllDrag(),
    ...
    imajnetAddImageDate: function(a) {
        if (ImajnetUI.imageContainer && ImajnetUI.imageContainer.length) {
            this.imageDateContainer || (ImajnetUI.imageContainer.append('\x3cdiv id\x3d"imageDateContainer" class\x3d"addressAndLRS"\x3e\x3c/div\x3e'),
            this.imageDateContainer = jQuery("#imageDateContainer"));
            a = Nigsys.formatImajnetImageDate(a);
            if (!jQuery("#imajnetImageLRSInTitle").length) {
                var b = ImajnetUI.imageContainer.parent().children(":first")
                  , c = b.attr("class");
                c && -1 !== c.indexOf("ui-dialog-titlebar") && (b.append('\x3cspan id\x3d"imajnetImageLRSInTitle"\x3e\x3c/span\x3e'),
                Nigsys.browserIsIE7() && jQuery("#imajnetImageLRSInTitle").css("margin-top", 7))
            }
            b = jQuery("#popupImajnetDate");
            b.length ? b.html(a) : (b = ImajnetUI.imageContainer.parent().children(":first").children(":first"),
            (c = b.attr("class")) && -1 !== c.indexOf("ui-dialog-title") && b.html(b.html() + '\x3cspan id\x3d"popupImajnetDate" class\x3d"left"\x3e' + a + "\x3c/span\x3e"));
            a ? (this.imageDateContainer.html(a),
            this.showDateContainer()) : this.hideDateContainer();
            ImajnetUI.imageDate = a
        } else
            this.hideDateContainer()
    },
    appendClipboarContainerHTML: function() {
        ImajnetUI.clipboardContainer.append('\x3cdiv id\x3d"' + ImajnetUI.clipboardContainerId + 'Content" class\x3d"scrollable"\x3e\x3cdiv style\x3d"width: 100%; text-align: center; margin-top: 10px;"\x3e' + jQuery.imajnet.map.clipboard.noItems + '\x3c/div\x3e\x3c/div\x3e\x3cdiv id\x3d"popupImajnetClipboardButtonsContainer"\x3e\x3cinput type\x3d"button" id\x3d"popupImajnetClipboardClearButton" value\x3d"' + jQuery.imajnet.map.clipboard.clearButton + '" onclick\x3d"ImageControler.currentPhotogrammetry.deletePhotogrammetryObjects();" disabled\x3d"disabled" class\x3d"dialogButton buttonDelete" /\x3e\x3cinput type\x3d"button" id\x3d"popupImajnetClipboardExportButton" value\x3d"' + jQuery.imajnet.map.clipboard.exportButton + '" onclick\x3d"ImageControler.currentPhotogrammetry.showExport();" disabled\x3d"disabled" class\x3d"dialogButton buttonExport" /\x3e\x3c/div\x3e')
    },
    doOnKeyDown: function(a) {
        "imajnetPOI" == a.target.id && (a.preventDefault(),
        a.stopImmediatePropagation(),
        a.stopPropagation());
        "undefined" !== typeof isImajnetMode && isImajnetMode() && "HTML" != a.target.tagName && "BODY" != a.target.tagName && "DIV" != a.target.tagName && "IMG" != a.target.tagName || (38 == a.keyCode ? (ImageControler.currentImageControl.setFastNavigation(),
        ImageControler.currentImageControl.getNext(!1),
        a = jQuery(".menu"),
        a.length && a.menu("collapseAll", null, !0)) : 40 == a.keyCode ? (ImageControler.currentImageControl.setFastNavigation(),
        ImageControler.currentImageControl.getPrevious(!1),
        a = jQuery(".menu"),
        a.length && a.menu("collapseAll", null, !0)) : 37 == a.keyCode ? ImajnetImageSwitcher.dragSliderLeft() : 39 == a.keyCode && ImajnetImageSwitcher.dragSliderRight())
    },
...
var ImajnetLRSGUIWidth = 100
  , ImajnetLRSGUIHeight = 400
  , ImajnetLRSGUICommon = {
    roadsPRData: {},
    getContainerSize: function(c, a, b) {
        return "portrait" == c ? {
            width: a,
            height: b
        } : {
    ...
    onImajnetImageRoadChange: function(c) {
        if (c === ImajnetUI.LRSGUI) {
            if ("undefined" !== typeof LRSSchematic && LRSSchematic.LRSGUI) {
                var a = ImajnetLRSGUICommon.roadsPRData[c.currentRoadId].roadId
                  , b = jQuery("#LRSSchematicRoads");
                b.val(a);
                c.linearPosition && (LRSSchematic.LRSGUI.linearPosition = Nigsys.cloneObject(c.linearPosition));
                LRSSchematic.onRoadChange(a, LRSSchematic.LRSGUI.linearPosition);
                (c = Nigsys.getComboboxInputContainer(b)) && c.val(b.find("option:selected").attr("title"))
            }
        } else
            c.computetMiddlePRIfNotDefined()
    }
}
    ...
    c = {
        ...
        onGoToClickedPoint: function(a) {
            LRSRequest.search(Object({
                ...
                prNumber: a.prNumber,
                relativeAbscisa: a.relativeAbscisa
            }), !0)
        },
        goToClickedPoint: function(a) {
            if (a = this.getClickedPosition(a, !0))
                this.onGoToClickedPoint(a)
        },
        ...
        clickHandler: function(a) {
            if (this.isAfterDrag && !Nigsys.browserIsOpera())
                this.isAfterDrag = !1;
            else {
                var b = 0
                  , b = "portrait" == this.orientation ? a.offsetY : a.offsetX;
        ...
        mouseWheelHandler: function(a, b) {
            if (!Nigsys.scrollDeltaIsValid(b))
                return !1;
        ...
        positionTop: function() {
            if (ImajnetUI.docking.imageLRSGUI && !Nigsys.getCookie("IMAJNET", "DOCKING_imageLRSGUI_position")) {
                var a = (ImajnetUI.imageContainer.height() - this.containerHeight - 55) / 2;
                0 > a && (a = 0);
        ...
        resizeHeight: function() {
            ...
            return this.containerHeight != a ? (this.containerHeight = a,
            this.positionTop(),
            !0) : !1
        },
        redraw: function() {
        ...
        onResize: function() {
            "undefined" === typeof keepDockingInsideParent || this.resizeHeight() ? ("object" === typeof ImajnetUI && "object" === typeof ImajnetUI.LRSGUI && this === ImajnetUI.LRSGUI && ImajnetUI.initLRSGUIDocking(this.containerWidth, this.containerHeight),
            this.redraw()) : keepDockingInsideParent()
        },
        firstTouch: null,
        lastTouch: null,
        ...
        initSize: function(a) {
            this.container && (this.isZoomMode = this.isDragMode = !1,
            this.container.width(a.width),
            this.dragContainer.width(a.width),
            this.container.height(a.height),
            this.dragContainer.height(a.height),
            "imajnetLRSGUI" == this.containerId && this.dragContainer.css("top", -a.height),
            a = this.containerHeight,
            this.roadStrokeWidth = a / 66,
            10 < this.roadStrokeWidth && (this.roadStrokeWidth = 10),
            this.roadXOffset = parseInt(this.containerWidth / 3),
            this.orientationSize = a / 26,
            this.PRLineLineIndicatorWidth = a / 9,
            this.PRTextLineIndicatorWidth = a / 20,
            this.PRDivisionOffset = parseInt(this.containerWidth / 4),
            this.PRDivisionsFontSize = this.PRFontSize)
        },
        removeLRSGUI: function() {
            this.LRSGUISVG && (this.LRSGUISVG.remove(),
            this.LRSGUISVG = null)
        },
        init: function() {
            ...
            if (Nigsys.onMobile())
                ...
                b.swipe({
                    swipe: function(b, f, c, d, g) {
                        ...
                        d = 1,
                        "down" == f && (d = -1),
                        a.lastDragPositionOffset = "portrait" == a.orientation ? b.clientY + d * c : b.clientX + d * c,
                        a.mouseMoveHandler(b))
                    },
                    threshold: 10,
                    pinchIn: function(b, c, h, d, g, e, k) {
                        a.isDragMode = !1;
                        b.clientX = b.changedTouches[0].clientX;
                        b.clientY = b.changedTouches[0].clientY;
                        b.originalEvent = {
                            clientX: b.changedTouches[0].screenX,
                            clientY: b.changedTouches[0].screenY
                        };
                ...
                b.off().on({
                    ...
                    "mousewheel DOMMouseScroll": function(b, c) {
                        ...
                        if (!Nigsys.scrollDeltaIsValid(c))
                            return !1;
        ...
        drag: function(a) {
            ...
            5 < a ? this.getPROffset(0) >= this.minBound + this.prSize || (this.dragOffset += a,
            this.drawRoad(-a),
            this.lastDragPositionOffset = this.dragPositionOffset) : -5 > a && !(this.getPROffset(this.prLength - 1) <= this.maxBound - 5) && (this.dragOffset += a,
            this.drawRoad(-a),
            this.lastDragPositionOffset = this.dragPositionOffset)
        },
        ...
        getMinZoomLevel: function(a) {
            a = null;
            for (var b in Nigsys.zoomMap)
                if (Nigsys.zoomMap[b] * (this.prLength - 1) > this.containerHeight) {
                    a = b;
                    break
                }
            return parseInt(a)
        ...
        zoom: function(a, b) {
            ...
            if (!(0 > b && 0 > this.containerHeight * (Math.pow(this.getZoomRatio(), c) * (1 - 1 / this.prLength) - 1) + this.prSize + 5)) {
                this.isZoomMode = !0;
                var f = c = 0;
                "portrait" == this.orientation ? (c = a.originalEvent.clientY,
                f = this.container.offset().top) : (c = a.originalEvent.clientX,
                f = this.container.offset().left);
                this.zoomPositionOffset = c - f;
                this.zoomPositionOffset < this.prSize && this.getPROffset(0) >= this.minBound + this.prSize && (this.zoomPositionOffset = this.prSize,
                this.resetZoom());
                this.zoomPositionOffset > this.containerHeight - 5 && this.getPROffset(this.prLength - 1) <= this.maxBound - 5 && (this.zoomPositionOffset = this.containerHeight - 5,
                this.resetZoom());
        ...
        zoomIn: function() {
            this.currentZoomLevel >= this.maxZoomLevel || (this.lastZoomLevel = this.currentZoomLevel,
            this.currentZoomLevel++,
            this.zoomPositionOffset > this.containerHeight / 2 ? (this.zoomPositionOffset = this.containerHeight - this.zoomPositionOffset,
            this.sign = 1) : this.sign = -1,
            0 < this.zoolLevelOnSamePosition && (this.zoomOffset = this.lastSign ? this.sign * this.lastSign * this.lastZoomOffset * this.getCurrentZoomFactorOnSamePosition() : this.lastZoomOffset * this.getCurrentZoomFactorOnSamePosition()),
            this.zoomOffset += (this.getCurrentZoomFactorOnSamePosition() - 1) * (this.containerHeight / 2 - this.zoomPositionOffset) - this.sign * (this.dragOffset - this.minBoundOffset + this.maxBoundOffset) * this.getCurrentZoomFactorOnSamePosition(),
            this.drawRoad(this.sign * this.zoomOffset))
        },
        zoomOut: function() {
            this.currentZoomLevel <= this.maxZoomLevel - this.zeroBasedMaxZoomLevel || this.currentZoomLevel <= this.getMinZoomLevel(0) || (this.lastZoomLevel = this.currentZoomLevel,
            this.currentZoomLevel--,
            this.zoomPositionOffset > this.containerHeight / 2 ? (this.zoomPositionOffset = this.containerHeight - this.zoomPositionOffset,
            this.sign = -1) : this.sign = 1,
            0 != this.zoolLevelOnSamePosition && (this.zoomOffset = this.lastSign ? this.sign * this.lastSign * this.lastZoomOffset / this.getCurrentZoomFactorOnSamePosition() : this.lastZoomOffset / this.getCurrentZoomFactorOnSamePosition()),
            this.zoomOffset += (1 - 1 / this.getCurrentZoomFactorOnSamePosition()) * (this.containerHeight / 2 - this.zoomPositionOffset) - this.sign * (this.dragOffset - this.minBoundOffset + this.maxBoundOffset) / this.getCurrentZoomFactorOnSamePosition(),
            this.drawRoad(this.sign * this.zoomOffset))
        },
        ...
        KMToPixelZoomByZoom: function(a) {
            return this.getZoomedDimensionByZoom(a) / this.prLength
        },
        KMToPixel: function() {
        ...
        getClickedPosition: function(a, b) {
            if (!ImajnetLRSGUICommon.roadsPRData[this.currentRoadId])
                return null;
            for (var c = Object({
                x: 0,
                y: a
                ...
                var k = this.getPROffset(e)
                  , l = this.getPRNumberCumulatedFromPreviousIndex(this.linearPosition.keyPoint.prNumber, g);
                if (k >= this.minBound && k <= this.maxBound)
                    if (d = k - this.minBound,
                    d >= c.y) {
                        ...
                        h = ImajnetLRSGUICommon.roadsPRData[this.currentRoadId].pr[e].prNumber,
                        d = l * (c.y - d) / f;
                else if (k >= this.minBound) {
                    k = this.getPROffset(e - 1);
                    h = ImajnetLRSGUICommon.roadsPRData[this.currentRoadId].pr[e - 1] ? ImajnetLRSGUICommon.roadsPRData[this.currentRoadId].pr[e - 1].prNumber : -1;
                    d = l * (this.minBound + c.y - k) / f;
                    break
                }
            }
        ...
        getPRNumberIndex: function(a) {
            for (var b = 0; b < this.prLength; b++)
                if (ImajnetLRSGUICommon.roadsPRData[this.currentRoadId].pr[b].prNumber == a)
                    return b;
            return -1
        },
        getPRNumberCumulatedFromPreviousIndex: function(a, b) {
            for (var c = 0; c < this.prLength; c++)
                if (ImajnetLRSGUICommon.roadsPRData[this.currentRoadId].pr[c].prNumber == a) {
                    if (ImajnetLRSGUICommon.roadsPRData[this.currentRoadId].pr[c + 1] && ImajnetLRSGUICommon.roadsPRData[this.currentRoadId].pr[c + 1].relativeDistance)
                        return LRS.transformFromMeters(ImajnetLRSGUICommon.roadsPRData[this.currentRoadId].pr[c + 1].relativeDistance, b);
                    break
                }
            return LRS.transformFromMeters("feet" == b ? LRS.metersInAMile : 1E3, b)
        },
        computeStartEndPR: function(a) {
            if (!this.PRStart || this.PRStart > a)
                this.PRStart = a;
        ...
        drawRoad: function(a) {
            ...
            if (-1 == h)
                ...
                b.reject(),
                b;
            var d = this.KMToPixelZoom()
              , g = this.getPROffset(h) + d * this.PRStart / f;
            this.roadRedraw = !1;
            if (this.redrawRoad || !this.minBound || !this.maxBound || g < this.minBound + 10 || g > this.maxBound - 10 || this.isZoomMode || this.isDragMode) {
                this.redrawRoad = !1;
                this.isDragMode ? this.minBound += a : this.isZoomMode ? this.minBound = this.getPROffset(this.zoomBoxIndex) + d * this.centerLinearPosition.relativeAbscisa / f - this.containerHeight / 2 + a : (this.roadRedraw = !0,
                this.dragOffset = 0,
                this.minBound = g - this.containerHeight / 2,
                this.centerLinearPosition = Nigsys.cloneObject(this.linearPosition),
                this.zoomBoxIndex = h,
                this.zoomOffset = 0);
                this.maxBound = this.minBound + this.containerHeight;
                a = this.getPROffset(0);
                a > this.minBound + this.prSize && (a = a - this.minBound - this.prSize,
                this.isDragMode ? this.dragOffset -= a : (this.isZoomMode && (this.dragOffset = 0),
                this.minBoundOffset = a,
                this.maxBoundOffset = 0),
                this.dragZoomLevel = this.currentZoomLevel,
                this.minBound += a,
                this.maxBound = this.minBound + this.containerHeight);
                a = this.getPROffset(this.prLength - 1);
                a < this.maxBound - 5 && (a = this.maxBound - a - 5,
                this.isDragMode ? this.dragOffset += a : (this.isZoomMode && (this.dragOffset = 0),
                this.maxBoundOffset = a,
                this.minBoundOffset = 0),
                this.dragZoomLevel = this.currentZoomLevel,
                this.minBound -= a,
                this.maxBound = this.minBound + this.containerHeight);
                a = 4;
                if (Nigsys.browserIsOpera() || Nigsys.isWindows())
                    if (a = 6,
                    this.PRTextOffset = 9,
                    Nigsys.browserIsIE8() || Nigsys.browserIsIE7())
                        this.PRTextOffset = 6;
                ImageControler.currentGraphic.clearLRSGUI(this);
                ...
                for (g = this.PREnd = this.PRStart = 0; g < this.prLength; g++) {
                    var e = this.getPROffset(g) - this.minBound
                      ...
                      , f = this.getPRNumberCumulatedFromPreviousIndex(g, c);
                    0 > e && 0 < e + d ? (this.computeStartEndPR(k),
                    ImageControler.currentGraphic.drawPRDivisions(this, {
                        x: this.roadXOffset + this.PRDivisionOffset,
                        y: e
                    }, d, f)) : 0 <= e && e <= this.containerHeight + this.prSize && (this.computeStartEndPR(k),
                    ImageControler.currentGraphic.drawPR(this, {
                        x: this.roadXOffset - this.prSize / 2,
                        y: e
                    }, k, a),
                    e <= this.containerHeight && ImageControler.currentGraphic.drawPRDivisions(this, {
                        x: this.roadXOffset + this.PRDivisionOffset,
                        y: e
                    }, d, f))
                }
                this.PRStart--;
                this.PREnd++;
                "undefined" !== typeof LRSSchematic && LRSSchematic && LRSSchematic.LRSGUI && !LRSSchematic.exportRatio && (LRSSchematic.LRSGUI.linearPosition.keyPoint || (LRSSchematic.LRSGUI.linearPosition.keyPoint = {}),
                LRSSchematic.LRSGUI.linearPosition.keyPoint.prNumber = Math.ceil(this.PRStart + (this.PREnd - this.PRStart) / 2),
                LRSSchematic.LRSGUI.linearPosition.relativeAbscisa = 0);
                this.isFirstDraw && (Nigsys.browserIsOpera() || jQuery("svg text tspan:first-child").attr("dy", 3),
                this.isFirstDraw = !1);
            ...
            ImageControler.currentGraphic.drawLRSGUIImageOrientation(this, {
                x: this.roadXOffset,
                y: c
            }, h);
            return b.promise()
        ...
        computetMiddlePRIfNotDefined: function() {
            this.linearPosition.keyPoint.prNumber || (ImajnetUI.LRSGUI && ImajnetUI.LRSGUI.linearPosition && ImajnetUI.LRSGUI.linearPosition.road.id == this.linearPosition.road.id ? (this.linearPosition.keyPoint.prNumber = ImajnetUI.LRSGUI.linearPosition.keyPoint.prNumber,
            this.linearPosition.relativeAbscisa = ImajnetUI.LRSGUI.linearPosition.relativeAbscisa) : (this.linearPosition.keyPoint.prNumber = ImajnetLRSGUICommon.roadsPRData[this.currentRoadId].pr[parseInt(ImajnetLRSGUICommon.roadsPRData[this.currentRoadId].pr.length / 2)].prNumber,
            this.linearPosition.relativeAbscisa = 0))
        },
        onGetRoadSuccess: function(a, b) {
            if (a.pr)
                b && b.LRSObject && b.LRSObject.resetData(a.pr.length),
                a.roadId && a.roadId == b.LRSObject.currentRoadId && (ImajnetLRSGUICommon.roadsPRData[b.LRSObject.currentRoadId] = a,
                ImajnetLRSGUICommon.onImajnetImageRoadChange(b.LRSObject),
                b.LRSObject.resetZoom(),
                b.LRSObject.drawRoad(null));
            else if (b && b.LRSObject)
                b.LRSObject.onGetRoadError(a, b)
        },
        onGetRoadError: function(a, b) {
            b && b.LRSObject && b.LRSObject.hide()
        },
        resetData: function(a) {
            this.currentRoadId != this.lastRoadId && (this.lastRoadId = this.currentRoadId,
            this.maxBoundOffset = this.minBoundOffset = this.maxBound = this.minBound = 0,
            this.prLength = a,
            this.maxZoomLevel = this.zeroBasedMaxZoomLevel,
            this.startZoomLevel = this.defaultZoomLevel,
            this.startZoomLevel < this.getMinZoomLevel() && (this.startZoomLevel = this.getMinZoomLevel()),
            this.dragZoomLevel = this.currentZoomLevel = this.startZoomLevel,
            "undefined" !== typeof LRSSchematic && LRSSchematic.setZoomLevelsSelectHTML())
        },
        draw: function(a) {
            var b = jQuery.Deferred();
            this.LRSResponse = a;
            this.linearPosition = this.getFirstLRS(this.LRSResponse.linearPosition, this.linearPosition);
            if (!this.linearPosition || !this.linearPosition.road || !this.linearPosition.road.id)
                return b.resolve(),
                b.promise();
            ...
            return ImajnetLRSGUICommon.roadsPRData[this.currentRoadId] ? (this.resetData(ImajnetLRSGUICommon.roadsPRData[this.currentRoadId].pr.length),
            this.resetZoom(),
            ImajnetLRSGUICommon.onImajnetImageRoadChange(this),
            this.drawRoad(null),
            b.resolve(),
            b.promise()) : LRSRequest.getRoad(this.linearPosition.road.id, this.onGetRoadSuccess, this.onGetRoadError, {
                LRSObject: this
            })
        },
        show: function() {
            Nigsys.isPositionMode() || Nigsys.isMeasurementMode() || Nigsys.isPolyligneMode() || (this.container && this.container.show(),
            this.dragContainer && this.dragContainer.show(),
            "undefined" !== typeof ImajnetUI && ImajnetUI.docking.imageLRSGUI && this === ImajnetUI.LRSGUI && ImajnetUI.docking.imageLRSGUI.mainContainer.show())
        },
        hide: function() {
...
var ImajnetMap = {
    ...
    imajboxMarkerLayer: null,
    imajboxMarkerLayerName: "ImageBox marker",
    dragBoxFeature: null,
    ...
    getImajnetTileUrl: function(a) {
        if (!a)
            return ImajnetProtocol.getUsernameForUrl(Imajnet.serverUrl + '/api/tile/%7B"tile":%7B"x":{x},"y":{y},"zoom":{z}%7D,"timeframe":' + ImajnetTimeframe.getTimeframe() + "%7D");
        ...
        b = null;
        b = null !== ImajnetMap.cartographicServerDomains ? ImajnetMap.selectUrl(a, ImajnetMap.cartographicServerDomains) + "/service" + a : Imajnet.serverUrl + a;
        return ImajnetProtocol.getUsernameForUrl(b)
    },
    URL_HASH_FACTOR: (Math.sqrt(5) - 1) / 2,
    selectUrl: function(a, b) {
        for (var c = 1, d = 0, e = a.length; d < e; d++)
            c = c * a.charCodeAt(d) * ImajnetMap.URL_HASH_FACTOR,
            c -= Math.floor(c);
        return b[Math.floor(c * b.length)]
    },
    doOnMapClick: function(a, b) {
        Imajnet.clickMode == Imajnet.CLICK_MODE_CLOSEST_IMAGE || b ? ImajnetAPI.getClosestPosition(a.lat, a.lon, Imajnet.searchRadius[ImajnetPlugin.getCurrentZoomLevel()]) : Imajnet.clickMode == Imajnet.CLICK_MODE_ORIENTED_IMAGES && ImajnetClickMode.showOrientedImages(a.lon, a.lat, ImajnetClickMode.orientedImagesReceived, ImajnetClickMode.orientedImagesError)
    },
    onMapClick: function(a, b) {
        a && this.doOnMapClick(a, b)
    },
    mapClickHandler: function(a) {
        if (Imajnet.imajnetClosestPositionIsActive() || Imajnet.imajnetOrientedImagesIsActive())
            ImajnetMap.onMapClick(a)
    },
    ...
    hideImajboxMarker: function() {
        if (this.allWFS) {
            ...
            //@20171127
            //a.length && (ImajnetPlugin.removeMarkerFeatures(this.allWFS, a),
            a.length && (ImajnetPlugin.removeMarkerFeatures(this.imajboxMarkerLayer, a),
            this.deleteFeatureWrapperObject(this.MARKER_TYPE_IMAJBOX))
        }
    },
    hideOrientation: function() {
        if (this.imajnetOrientationLayer) {
            ...
            a.length && (ImajnetPlugin.removeFeatures(this.imajnetOrientationLayer, a),
            this.deleteFeatureWrapperObject(this.FEATURE_TYPE_IMAGE_ORIENTATION))
        }
    },
    hideLargeImageOrientation: function() {
        if (this.imajnetOrientationLayer) {
            var a = this.getFeatureWrappersByType(this.FEATURE_TYPE_LARGE_IMAGE_ORIENTATION);
            a.length && (ImajnetPlugin.removeFeatures(this.imajnetOrientationLayer, a),
            this.deleteFeatureWrapperObject(this.FEATURE_TYPE_LARGE_IMAGE_ORIENTATION))
        }
    },
    getPolyligneFeatureWrapper: function(a) {
        ...
        for (a = 0; a < b.length; a++)
            if (b[a].type != ImajnetMap.MARKER_TYPE_POLYLIGNE_POSITION)
                return b[a]
    },
    getFeatureWrapperById: function(a) {
        for (var b = 0, c = ImajnetMap.featureWrappers.length; b < c; ++b)
            if (ImajnetMap.featureWrappers[b].id == a)
                return ImajnetMap.featureWrappers[b];
        return null
    },
    ...
    getFeatureWrappersByType: function(a) {
        for (var b = [], c = 0, d = this.featureWrappers.length; c < d; ++c)
            this.featureWrappers[c].getType() == a && b.push(this.featureWrappers[c]);
        return b
    },
    deleteFeatureWrapperObject: function(a) {
        for (var b = 0; b < this.featureWrappers.length; b++)
            this.featureWrappers[b].getType() == a && (this.featureWrappers.splice(b, 1),
            b--)
    },
    deleteFeatureWrapperObjectById: function(a) {
        for (var b = 0; b < this.featureWrappers.length; b++)
            if (this.featureWrappers[b].getId() == a) {
                this.featureWrappers.splice(b, 1);
                break
            }
    },
    hideSurveyTrace: function() {
        this.imajnetSurveyTraceLayer && (ImajnetPlugin.removeAllFeatures(this.imajnetSurveyTraceLayer),
        this.deleteFeatureWrapperObject(this.FEATURE_TYPE_SURVEY_TRACE))
    },
    ...
    hideOrientedImages: function() {
        if (this.imajnetDragFeaturesLayer) {
            ...
            a.length && (ImajnetPlugin.removeFeatures(this.imajnetDragFeaturesLayer, a),
            this.deleteFeatureWrapperObject(this.FEATURE_TYPE_ORIENTED_IMAGES))
        }
    },
    ...
    getTriangleCoordinates: function(a, b, c, d) {
        var e = [];
        e.push(a);
        for (var g = d = 90 - b / 2 + d; g <= b + d; )
            e.push(ImajnetMap.getPointOnCircle(a, c, g)),
            g += 1;
        e.push(a);
        return e
    },
    getTriangle: function(a, b, c, d) {
        ...
        c = 0;
        for (d = b.length; c < d - 1; ++c)
            b[c] = Nigsys.transformImajnetOrientationPoint(b[c], new Proj4js.Proj("EPSG:900913"), new Proj4js.Proj("EPSG:4326"));
        return b
    },
    setOrientationMarker: function(a, b, c, d) {
        if (a && a.lon && a.lat && a.orientation) {
            var e = a.orientation.viewAngle
              , g = a.orientation.yaw;
            if (-1 == d) {
                ...
                if ("FLAT" == ImageControler.currentImageType) {
                    if (ImajnetUI.getLargeImageWidthOverflow() ? (ImajnetMap.setOrientationMarker(a, b, "#CCCCCC", -4),
                    ImajnetUI.fullSizeAspectRatio > ImajnetUI.imageAspectRatio && 100 > e && (f = f * ImajnetUI.imageAspectRatio / ImajnetUI.fullSizeAspectRatio),
                    e = 0 == ImajnetZoom.zoomLevel ? f : f * (1 - ImajnetZoom.zoomLevel / (ImajnetZoom.maxZoomLevel + 1))) : (ImajnetMap.setOrientationMarker(a, b, "#CCCCCC", -4),
                    e *= 1 - ImajnetZoom.zoomLevel / (ImajnetZoom.maxZoomLevel + 1)),
                    f = a.orientation.viewAngle - e) {
                        var h = 0;
                        if (h = ImajnetUI.imajnetImage.width() - ImajnetUI.imajnetImageContainerSize.width)
                            h = 1 + 2 * ImajnetUI.imajnetImage.position().left / h,
                            g += h * f / 2
                    }
                } else
                    ImajnetMap.setOrientationMarker(a, b, "#CCCCCC", -4),
                    f = ImajnetMap.defaultViewAngle,
                    ImajnetUI.fullSizeAspectRatio > ImajnetUI.imageAspectRatio && 100 > e && (f = f * ImajnetUI.imageAspectRatio / ImajnetUI.fullSizeAspectRatio),
                    e = 0 == ImajnetZoom.zoomLevel ? f : f * (1 - ImajnetZoom.zoomLevel / (ImajnetZoom.maxZoomLevel + 1)),
                    g -= CubePlugin.yow
            } else
                void 0 === d && (d = -1);
            ...
            if (-1 == d)
                a = ImajnetMap.cutTriangleMargins(a);
            else if (-4 == d)
                wideImageTriangleGeometry = a;
            else {
                f = Nigsys.cloneObject(a[0]);
                b = this.getTriangleCoordinates(f, e, b / 5, g);
                e = 0;
                for (g = b.length; e < g - 1; ++e)
                    b[e] = Nigsys.transformImajnetOrientationPoint(b[e], new Proj4js.Proj("EPSG:900913"), new Proj4js.Proj("EPSG:4326"));
                a = [a, b]
            }
            switch (d) {
            case -4:
                ...
                if (c = ImajnetPlugin.addFeature(ImajnetMap.imajnetOrientationLayer, a, {
                    ...
                    c.setType(ImajnetMap.FEATURE_TYPE_LARGE_IMAGE_ORIENTATION),
            ...
            case -3:
                if (c = ImajnetPlugin.addFeature(ImajnetMap.imajnetImageSwitcherLayer, a, {
                    ...
                    c.setType(ImajnetMap.FEATURE_TYPE_IMAGE_SWITCHER),
                    ImajnetMap.addToFeatureWrappersArray(c);
                break;
            case -2:
                if (c = ImajnetPlugin.addFeature(ImajnetMap.imajnetSurveyTraceLayer, a, {
                    type: "MultiPolygon",
                    fillColor: c,
                    strokeWidth: .5
                }))
                    c.setType(ImajnetMap.FEATURE_TYPE_SURVEY_TRACE),
                    ImajnetMap.addToFeatureWrappersArray(c);
                break;
            case -1:
                if (c = ImajnetPlugin.addFeature(ImajnetMap.imajnetOrientationLayer, a, {
                    ...
                    c.setType(ImajnetMap.FEATURE_TYPE_IMAGE_ORIENTATION),
                    ImajnetMap.addToFeatureWrappersArray(c);
                break;
            default:
                if (c = ImajnetPlugin.addFeature(ImajnetMap.imajnetDragFeaturesLayer, a, {
                    ...
                    c.setId(d),
                    c.setType(ImajnetMap.FEATURE_TYPE_ORIENTED_IMAGES),
                    ImajnetMap.addToFeatureWrappersArray(c)
            }
        }
    },
    ...
    setImajboxMarkerPosition: function(a, b) {
        ...
        var c = null
          , d = null;
        a.position ? (c = a.position.lon,
        d = a.position.lat) : a.parameter && a.parameter.coordinates && (c = a.parameter.coordinates.lon,
        d = a.parameter.coordinates.lat);
        if (c && d) {
            //if (c = ImajnetPlugin.addMarker(ImajnetMap.allWFS, {
            if (c = ImajnetPlugin.addMarker(ImajnetMap.imajboxMarkerLayer, {
                lon: c,
                lat: d,
                ...
                c.setType(ImajnetMap.MARKER_TYPE_IMAJBOX),
                ImajnetMap.addToFeatureWrappersArray(c);
            b && (c = a.position ? a.position : a.parameter.coordinates) && (ImajnetZoom.imageIsZoomed() && ImajnetZoom.resetZoom(),
            ImajnetMap.setOrientationMarker(c, ImajnetMap.imajboxTriangleDimension, Nigsys.defaultObjectsColor, -1),
            ImajnetPlugin.centerMapToPosition(c, !0))
        }
    },
    ...
    clearClickedPointFromMap: function() {
        if (ImajnetMap.photogrammetryPositionsLayer) {
            var a = ImajnetMap.getFeatureWrappersByType(ImajnetMap.MARKER_TYPE_TARGET_POINT);
    ...
    clearPhotogrammetryObject: function(a) {
        ...
        if (b) {
            ...
            else if (b.getType() == ImajnetMap.MARKER_TYPE_POSITION || b.getType() == ImajnetMap.MARKER_TYPE_POLYLIGNE_POSITION)
                ImajnetPlugin.removeMarker(this.photogrammetryPositionsLayer, b);
            else if (b.getType() == ImajnetMap.FEATURE_TYPE_MEASUREMENT)
                ImajnetPlugin.removeFeatures(this.imajnetDragFeaturesLayer, Array(b));
            else if (-1 !== jQuery.inArray(b.getType().replace("Feature", ""), ImajnetPolyligne.typesArray)) {
                b = this.getPolyligneFeatureWrappers(a);
                if (!b)
                    return;
                for (var c = 0; c < b.length; c++)
                    b[c].getType() == ImajnetMap.MARKER_TYPE_POLYLIGNE_POSITION ? ImajnetPlugin.removeMarker(this.photogrammetryPositionsLayer, b[c]) : ImajnetPlugin.removeFeatures(this.imajnetDragFeaturesLayer, Array(b[c])),
                    this.deleteFeatureWrapperObjectById(b[c].getId())
            }
    ...
    clearPhotogrammetryObjects: function() {
        ...
        if (this.imajnetDragFeaturesLayer) {
            ...
            a.length && (ImajnetPlugin.removeFeatures(this.imajnetDragFeaturesLayer, a),
            this.deleteFeatureWrapperObject(this.FEATURE_TYPE_MEASUREMENT));
            a = this.getFeatureWrappersByType(this.FEATURE_TYPE_POLYLIGNE);
            a.length && (ImajnetPlugin.removeFeatures(this.imajnetDragFeaturesLayer, a),
            this.deleteFeatureWrapperObject(this.FEATURE_TYPE_POLYLIGNE));
            a = this.getFeatureWrappersByType(this.FEATURE_TYPE_POLYGON);
            a.length && (ImajnetPlugin.removeFeatures(this.imajnetDragFeaturesLayer, a),
            this.deleteFeatureWrapperObject(this.FEATURE_TYPE_POLYGON))
        }
    ...
    drawPolylignePoints: function(a) {
        for (var b = 0; b < a.points.length; b++)
            ImajnetMap.addPoint(a.points[b].id, a.type, a.points[b].photogrammetryPosition3D.coordinates, a.points[b].linkToNext)
    },
    drawPhotogrammetryObjects: function() {
        for (var a = 0; a < ImageControler.currentPhotogrammetry.objects.length; a++)
            for (var b = 0; b < ImageControler.currentPhotogrammetry.objects[a].data.length; b++)
                if (Nigsys.isPolyligneMode() && ImajnetMap.clearPhotogrammetryObject(ImageControler.currentPhotogrammetry.objects[a].data[b].id),
                0 == ImageControler.currentPhotogrammetry.objects[a].data[b].id)
                ...
                else if (void 0 !== ImageControler.currentPhotogrammetry.objects[a].data[b].photogrammetryPosition3D)
                    ImajnetMap.addPoint(ImageControler.currentPhotogrammetry.objects[a].data[b].id, ImageControler.currentPhotogrammetry.objects[a].data[b].type, ImageControler.currentPhotogrammetry.objects[a].data[b].photogrammetryPosition3D.coordinates, ImageControler.currentPhotogrammetry.objects[a].data[b].linkToNext);
                else if (void 0 !== ImageControler.currentPhotogrammetry.objects[a].data[b].measurementResult)
                    ImajnetMap.addLineFeature(ImageControler.currentPhotogrammetry.objects[a].data[b].id, [Nigsys.lonLatToXY(ImageControler.currentPhotogrammetry.objects[a].data[b].measurementResult.firstPoint), Nigsys.lonLatToXY(ImageControler.currentPhotogrammetry.objects[a].data[b].measurementResult.secondPoint)], ImajnetMap.FEATURE_TYPE_MEASUREMENT);
                    ...
                    for (var c = [], d = 0; d < ImageControler.currentPhotogrammetry.objects[a].data[b].points.length; d++)
                        c.push(Nigsys.lonLatToXY(ImageControler.currentPhotogrammetry.objects[a].data[b].points[d].photogrammetryPosition3D.coordinates));
    ...
    POIImajnetPositionChangeHandler: function() {
        if (ImajnetMap.POIArray) {
            for (var a = "", b = 0; b < ImajnetMap.POIArray.length; b++)
                ImajnetMap.currentPosition && ImajnetMap.POIArray[b].position.id == ImajnetMap.currentPosition.id && (a = b);
    ...
    POIChanged: function(a) {
        a = a.val();
        "" != a && (a = this.POIArray[a]) && ("undefined" !== typeof ImajnetUI && Nigsys.showLoading(ImajnetUI.imageContainer),
        ImajnetZoom.left = -1,
        ImajnetAPI.setImajnetImage({
            position: a.position
        }),
        ImajnetPlugin.centerMapToPosition(a.position),
    ...
    onPOIReceived: function(a) {
        a = JSON.parse(a);
        ImajnetUI.showItem(ImajnetUI.imageContainerId);
        if (!a || !a.poi || 1 > a.poi.length)
            jQuery("#imajnetPOI").length && jQuery("#imajnetPOI").html('\x3coption value\x3d""\x3e' + jQuery.imajnet.map.poi.optionDefault + "\x3c/option\x3e");
        else if (ImajnetMap.POIArray = a.poi,
        jQuery("#imajnetPOI").length) {
            a = '\x3coption value\x3d""\x3e' + jQuery.imajnet.map.poi.optionDefault + "\x3c/option\x3e";
            for (var b = 0; b < ImajnetMap.POIArray.length; b++)
                a += '\x3coption value\x3d"' + b + '"' + (ImajnetMap.currentPosition && ImajnetMap.POIArray[b].position.lat == ImajnetMap.currentPosition.lat && ImajnetMap.POIArray[b].position.lon == ImajnetMap.currentPosition.lon ? 'selected\x3d"selected"' : "") + "\x3e" + ImajnetMap.POIArray[b].description + "\x3c/option\x3e";
    ...
    initLRSUrl: function() {
        var a = "/carto/" + ImajnetMap.key + "/wms";
        ImajnetMap.LRSUrl = null;
        if (ImajnetMap.cartographicServerDomains) {
            ImajnetMap.LRSUrl = [];
            for (var b in ImajnetMap.cartographicServerDomains)
                ImajnetMap.LRSUrl[b] = ImajnetMap.cartographicServerDomains[b] + a
        } else
            ImajnetMap.LRSUrl = Imajnet.cartographicServerUrl + a
    },
    registerToMap: function() {
        ImajnetMap.imajnetLayer && (ImajnetPlugin.removeLayerFromMap(ImajnetMap.imajnetLayer),
        ImajnetMap.imajnetLayer = null);
        ...
        ImajnetMap.imajboxMarkerLayer = ImajnetPlugin.addMarkerLayerToMap(ImajnetMap.imajboxMarkerLayerName);
    ...
    unregisterFromMap: function() {
        ...
        this.imajnetLayer && (ImajnetPlugin.removeLayerFromMap(this.imajnetLayer),
        this.imajnetLayer = null);
        this.imajnetDragFeaturesLayer && (ImajnetPlugin.removeLayerFromMap(this.imajnetDragFeaturesLayer),
        this.imajnetDragFeaturesLayer = null);
        this.roadLayer && (ImajnetPlugin.removeLayerFromMap(this.roadLayer),
        this.roadLayer = null);
        this.prLayer && (ImajnetPlugin.removeLayerFromMap(this.prLayer),
        this.prLayer = null);
        this.allWFS && (ImajnetPlugin.removeLayerFromMap(this.allWFS),
        this.allWFS = null);
        this.imajnetSurveyTraceLayer && (ImajnetPlugin.removeLayerFromMap(this.imajnetSurveyTraceLayer),
        this.imajnetSurveyTraceLayer = null);
        this.imajnetImageSwitcherLayer && (ImajnetPlugin.removeLayerFromMap(this.imajnetImageSwitcherLayer),
        this.imajnetImageSwitcherLayer = null);
        this.clearPhotogrammetryObjects();
        ImageControler.currentPhotogrammetry && ImageControler.currentPhotogrammetry.clear();
        this.photogrammetryPositionsLayer && (ImajnetPlugin.removeLayerFromMap(this.photogrammetryPositionsLayer),
        this.photogrammetryPositionsLayer = null);
        this.imajnetOrientationLayer && (ImajnetPlugin.removeLayerFromMap(this.imajnetOrientationLayer),
        this.imajnetOrientationLayer = null);
        ImajnetPlugin.unregisterMapEvents();
        this.setCurrentPosition(null);
        ImajnetPlugin.onImajnetDeactivated()
    }
};
var lastLoadedImageId = ""
  , ImajnetAPI = {
    ...
    getPreviousImageFromCache: function(a) {
        for (var b = 0; b < ImajnetAPI.previousPositionCache.length; b++)
            if (ImajnetAPI.previousPositionCache[b].imageId == a)
                return ImajnetAPI.previousPositionCache[b].orderImagePosition;
        return null
    },
    getNextImageFromCache: function(a) {
        for (var b = 0; b < ImajnetAPI.nextPositionCache.length; b++)
            if (ImajnetAPI.nextPositionCache[b].imageId == a)
                return ImajnetAPI.nextPositionCache[b].orderImagePosition;
        return null
    },
    buildImageURLWithResolution: function(a, b, c) {
        if (a && b)
            return a = new ImajnetData.imageParameter(a.id,b,c),
            a = JSON.stringify(a),
            a = encodeURI(a),
            null !== ImajnetAPI.imageServerDomains ? (a = "/service/api/image/" + a,
            ImajnetMap.selectUrl(a, ImajnetAPI.imageServerDomains) + a) : Imajnet.serverUrl + "/api/image/" + a
    },
    ...
    shouldNavigate: function() {
        if (!ImajnetMap.currentPosition)
            return !0;
        if (ImajnetAPI.lastNavigationPositionImageId == ImajnetMap.currentPosition.id)
            return !1;
    ...
    loadImageType: function(a) {
        var b = jQuery.Deferred();
        if (ImajnetZoom.canZoom())
            return ImajnetUI.stopSwipeNavigation(!0),
            b.resolve(null),
            b.promise();
        ImajnetAPI.doImajnetRequestDeferred("GET", "/api/sequence/photogrammetryInfo?traceId\x3d" + a.traceId, null, null, null, null, null, !0, null).done(function(a, d) {
            ...
            ImageControler.setCurrentImageControl({
                imageType: "flat"
            });
            b.resolve(null)
        });
    ...
    onSetImajnetImage: function(a, b) {
        if (ImajnetUI) {
            ...
            if (a)
                if (Imajnet.activateImajnet(),
                a.position)
                    ImajnetMap.setCurrentPosition(a.position),
                    ImageControler.currentPhotogrammetry.init(),
                    ImageControler.currentImageControl.loadImage(a);
                else {
                    ...
                    var c = "";
                    a.parameter && a.parameter.order ? (Nigsys.isPositionMode() ? ImajnetPosition.showHidePositionDenied() : Nigsys.isMeasurementMode() ? ImajnetMeasurement.showHideMeasurementDenied() : Nigsys.isPolyligneMode() && ImajnetPolyligne.showHideDenied(),
                    c = jQuery.imajnet.map.errors.unableToNavigate) : (ImajnetUI.showItem(ImajnetUI.imageContainerId),
                    ImageControler.currentImageControl.loadImage({
                        position: null
                    }),
                    c = jQuery.imajnet.map.errors.noImajnetImageAtPosition);
                    Nigsys.hideLoading(ImajnetUI.imageContainer);
                    ImajnetUI.showError(c, !1);
                    setTimeout("ImajnetUI.hideError()", 3E3)
                }
            else
                ImajnetMap.setCurrentPosition(null),
                ImajnetMap.setCurrentPosition(a && a.parameter && a.parameter.order ? ImajnetMap.currentPosition : null);
            ImajnetUI.showItem(ImajnetUI.imageContainerId);
            jQuery(ImajnetEvents.mappingObject).trigger({
                type: ImajnetEvents.positionChangeEventName
            })
        }
    },
    isImageValid: function(a) {
        if (!ImajnetAPI.lastOrderType)
            return !0;
        for (var b = 0; b < ImajnetAPI.orderedImagesId.length; b++)
            if (ImajnetAPI.orderedImagesId[b] == a)
                return ImajnetAPI.orderedImagesId.splice(0, b + 1),
                !0;
        return !1
    },
    ...
    setImajnetImage: function(a, b) {
        var c = jQuery.Deferred();
        if (!a || !a.position)
            return ImajnetAPI.orderedImagesId = [],
            ImageControler.currentImageControl && (ImageControler.setCurrentImageControl({
                imageType: "flat"
            }),
            ImajnetAPI.onSetImajnetImage(a, b)),
            c.resolve(),
            c.promise();
        a.parameter && a.parameter.order && ImajnetAPI.lastOrderType == a.parameter.order ? ImajnetAPI.orderedImagesId.push(a.position.id) : (ImajnetAPI.lastOrderType = "",
        ImajnetAPI.orderedImagesId = []);
        ImajnetAPI.loadImageType(a.position).done(function(d) {
            d && (ImajnetZoom.HIGH_RESOLUTION_WIDTH = d.nativeImageSize.width,
            ImajnetZoom.HIGH_RESOLUTION_HEIGHT = d.nativeImageSize.height,
            ImajnetUI.fullSizeAspectRatio = ImajnetZoom.HIGH_RESOLUTION_WIDTH / ImajnetZoom.HIGH_RESOLUTION_HEIGHT,
            ImajnetZoom.LOW_RESOLUTION_WIDTH = d.lowRezolutionImageSize.width,
            ImajnetZoom.LOW_RESOLUTION_HEIGHT = d.lowRezolutionImageSize.height,
            ImajnetZoom.MEDIUM_RESOLUTION_WIDTH = d.mediumRezolutionImageSize.width,
            ImajnetZoom.MEDIUM_RESOLUTION_HEIGHT = d.mediumRezolutionImageSize.height);
            ImajnetAPI.onSetImajnetImage(a, b);
            c.resolve()
        });
        return c.promise()
    ...
    getClosestPosition: function(a, b, c, d, f, h) {
        ...
        ImajnetAPI.imajnetClosestPositionRequest = ImajnetAPI.doImajnetRequest("GET", "/api/positions/closest/", a, function(a, b) {
    ...
    doOnPositionOrderReceived: function(a) {
        if (ImajnetZoom.canZoom())
            ...
            try {
                var b = JSON.parse(a);
                b && b.position && b.parameter && b.parameter.order && !b.parameter.useCameraOrientation && (ImajnetAPI.previousPositionCache.length >= ImajnetAPI.MAX_CACHE_IMAGE_POSITIONS && (ImajnetAPI.previousPositionCache = []),
                ImajnetAPI.nextPositionCache.length >= ImajnetAPI.MAX_CACHE_IMAGE_POSITIONS && (ImajnetAPI.nextPositionCache = []),
                ...
                ImajnetAPI.nextPositionCache.push({
                    imageId: b.position.id,
                    orderImagePosition: b.parameter.position
                })));
    ...
    getByOrder: function(a, b) {
        ...
        if (ImajnetZoom.canZoom())
            ImajnetUI.stopSwipeNavigation(!0);
        else if (ImajnetMap.currentPosition && ImajnetAPI.shouldNavigate()) {
            "onDragEnd" != arguments.callee.caller.arguments.callee.caller.name && ImajnetUI.stopSwipeNavigation(!1);
            ImajnetAPI.lastOrderType = a;
            if (!b) {
                var c = null;
                a == this.NEXT ? c = ImajnetAPI.getNextImageFromCache(ImajnetMap.currentPosition.id) : a == this.PREVIOUS && (c = ImajnetAPI.getPreviousImageFromCache(ImajnetMap.currentPosition.id));
                if (c) {
                    ImajnetAPI.setImajnetImage({
                        position: c,
                        parameter: {
    ...
    getHorizontalAngle: function(a, b) {
        if (a) {
            var c = null
              , c = "CUBE" == ImageControler.currentImageType ? CubePlugin.getRealImageCoordinatesFromMousePosition(a.x, a.y) : ImajnetZoom.getRealImageCoordinates(a.x, a.y)
              , d = {};
            d.imagePoint = {
                img: b,
                imgCoord: c
    ...
    horizontalAngleReceived: function(a) {
        if (a = JSON.parse(a)) {
            var b = a.parameter.imagePoint.img
              , c = b.orientation.yaw
              , b = Nigsys.transformImajnetOrientationPoint(Object({
                x: b.lon,
                y: b.lat
            }), new Proj4js.Proj("EPSG:4326"), new Proj4js.Proj("EPSG:900913"))
              , d = ImajnetMap.imajboxTriangleDimension
              , d = ImajnetPlugin.getMapScale() / d * 3
              , d = ImajnetAPI.getHorizontalAngleCoordinates(b, d);
            Nigsys.rotatePoint(c - a.angle, b, d[1]);
            for (a = 0; a < d.length; ++a)
                d[a] = Nigsys.transformImajnetOrientationPoint(d[a], new Proj4js.Proj("EPSG:900913"), new Proj4js.Proj("EPSG:4326"));
            ImajnetAPI.clearHorizontalAngle();
    ...
    clearHorizontalAngle: function() {
        ImajnetAPI.angleWrapper && (ImajnetPlugin.removeFeatures(ImajnetMap.imajnetDragFeaturesLayer, [ImajnetAPI.angleWrapper]),
        ImajnetAPI.angleWrapper = null)
    },
    ...
    getImajnetRequestUrl: function(a) {
        null !== ImajnetAPI.apiServerDomains && 0 !== ImajnetAPI.apiServerDomains.length ? (a = "/service" + a,
        requestUrl = ImajnetMap.selectUrl(a, ImajnetAPI.apiServerDomains) + a) : requestUrl = Imajnet.serverUrl + a;
        if (a = window.location.hostname)
            requestUrl = -1 === requestUrl.indexOf("?") ? requestUrl + "?" : requestUrl + "\x26",
            requestUrl += "param\x3d" + a;
        return requestUrl
    },
    getImajnetRequestParams: function(a, b, c, d, f, h, k, g, e) {
        var l = ""
          , m = "";
        c && (l = JSON.stringify(c),
            ...
            complete: function(a) {
                ...
                if (200 == a.status)
                    if ("function" === typeof d) {
                        ...
                        e && e.resolve(a.responseText, g);
                else {
                    if (401 != a.status)
                        if (403 == a.status)
                            ImajnetAPI.onError(a, g),
                            "function" === typeof f && f(a, g);
                        else if ("function" === typeof f) {
                            if ("/api/positions/closest/" == b)
                                ImajnetAPI.onError(a, g);
                            f(a, g)
                        }
                    e && e.reject(null, g)
...
var ImajnetProtocol = {
    ...
    buildHeaders: function(a, b, c, d) {
        ...
        //a.setRequestHeader("imajnet-app-key", Imajnet.applicationKey);
    ...
    loginTimeout: function() {
        Nigsys.loginNotification && Nigsys.loginNotification.isOpen && (Nigsys.showLoginError(jQuery.imajnet.login.error.unknown),
    ...
    imajnetLogin: function(a, b, c) {
        ...
        if (!Imajnet.serverUrl)
            return console.error("Imajnet server url not defined"),
            d.reject(),
            d.promise();
        jQuery.ajax({
            type: "GET",
            url: ImajnetAPI.getImajnetRequestUrl("/api/user/userdetails" + (ImajnetProtocol.loginRememberMe ? "?remember-me\x3don" : "")),
            cache: !1,
            dataType: "json",
            ...
            complete: function(a, b) {
                ...
                if (ImajnetProtocol.loginStatus == ImajnetResponse.OK) {
                    ...
                    //var f = JSON.parse('{"user":{"login":"guest01","firstName":"guest","lastName":"guest","email":"kiyoung.kim@wipco.co.kr","role":{"name":"user"},"cartographicKey":"imajnet2","bingKey":null,"unit":"m","lastLogin":"01-11-2017 09:07:29","subscriptionType":"FULL"}}');
                    ImajnetUser.setData(f.user);
                    "undefined" !== typeof ImajnetMap && ImajnetMap && (ImajnetMap.key = ImajnetUser.data.cartographicKey ? ImajnetUser.data.cartographicKey : "imajnet1",
                    ImajnetMap.initLRSUrl());
                    "undefined" !== typeof ImajnetSettings && ImajnetSettings && LRS.checkIfLRSAccess().done(function() {
                        ImajnetSettings.init();
                        ImajnetSettings.getSettings().done(function() {
                    ...
                    ImajnetPlugin.imajnetLoginError(a),
                    d.reject();
    ...
    imajnetLogout: function(a) {
        var b = jQuery.Deferred();
        if ("undefined" !== typeof ImajnetPolyligne)
            ImajnetPolyligne.onFinish();
        if (!Imajnet.serverUrl)
            return console.error("Imajnet server url not defined"),
            b.reject(),
            b.promise();
        ...
        a && "undefined" !== typeof ImajnetUrl && (ImajnetUrl.deleteUrlParams(),
        ImajnetUrl.applyUrlParams(!0));
        ImajnetProtocol.loginStatus != ImajnetResponse.OK && b.resolve();
        return b.promise()
    },
    forgotPassword: function() {
        -1 != applicationDomain.indexOf("test.imajnet.net") || -1 != applicationDomain.indexOf("web.imajnet.net") ? window.open("https://imajnet.net/forgotPassword") : window.open("http://" + window.location.hostname + "/forgotPassword")
    },
    requestAccess: function() {
        -1 != applicationDomain.indexOf("test.imajnet.net") || -1 != applicationDomain.indexOf("web.imajnet.net") ? window.open("https://imajnet.net/registration") : window.open("http://" + window.location.hostname + "/registration")
    },
    doLogin: function() {
        ...
        jQuery("#imajnetLoginForgotPassword").prop("disabled", !0);
        ...
        return ImajnetProtocol.imajnetLogin(jQuery("#username").val(), jQuery("#password").val(), !Imajnet.options || Imajnet.options.activateImajnet)
    }
};
var ImajnetSettings = {
    rangeAddress: 3E3,
    ...
    getImageResolution: function() {
        return ImajnetMap.currentPosition && -1 !== ImajnetZoom.zoomedImagesCache.indexOf(ImajnetMap.currentPosition.id) ? this.imajnetImageResolutions[3] : this.imajnetSettings ? this.imajnetImageResolutions[this.imajnetSettings.imageQuality] : null
    },
    getImajnetSettingsPopupHTML: function() {
        var a = "", b;
        for (b in ImajnetSettings.imageRetrievalOptions)
            a += '\x3cdiv\x3e\x3cinput type\x3d"radio" name\x3d"imageRetrievalOptions" value\x3d"' + ImajnetSettings.imageRetrievalOptions[b] + '" /\x3e\x26nbsp;' + jQuery.imajnet.settings.imageOptions[ImajnetSettings.imageRetrievalOptions[b]] + "\x3c/div\x3e";
        return '\x3cdiv class\x3d"optionsGroup"\x3e\x3cspan class\x3d"popupContentContainerTitle"\x3e' + jQuery.imajnet.settings.imageSectionTitle + '\x3c/span\x3e\x3cdiv style\x3d"margin-top: -10px;"\x3e\x3cdiv class\x3d"left"\x3e\x3cdiv id\x3d"popupContentContainer"\x3e\x3cdiv class\x3d"left settingsSearchLeft"\x3e' + jQuery.imajnet.settings.imageQuality + '\x3c/div\x3e\x3cdiv class\x3d"left"\x3e\x3cdiv class\x3d"sliderTopTitleSmall"\x3e\x3cdiv class\x3d"left" style\x3d"width: 30px; margin-left: -10px; text-align: center;"\x3e' + jQuery.imajnet.settings.imageQualityLow + '\x3c/div\x3e\x3cdiv class\x3d"left" style\x3d"width: 190px; text-align: center;"\x3e' + jQuery.imajnet.settings.imageQualityMedium + '\x3c/div\x3e\x3cdiv class\x3d"left" style\x3d"width: 40px; text-align: center;"\x3e' + jQuery.imajnet.settings.imageQualityHigh + '\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv id\x3d"imajnetSettingsImageQualitySlider" style\x3d"width: 240px;"\x3e\x3cdiv class\x3d"ui-slider-handle"\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft" style\x3d"height: 5px;"\x3e\x3c/div\x3e\x3cdiv class\x3d"left settingsSearchLeft"\x3e' + jQuery.imajnet.settings.surveyTrace + '\x3c/div\x3e\x3cdiv class\x3d"left"\x3e\x3cdiv class\x3d"sliderTopTitleSmall"\x3e\x3cdiv class\x3d"left" style\x3d"width: 30px; margin-left: -10px; text-align: center;"\x3e' + jQuery.imajnet.settings.surveyTraceLow + '\x3c/div\x3e\x3cdiv class\x3d"left" style\x3d"width: 185px; text-align: center;"\x3e\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left" style\x3d"width: 50px; text-align: center;"\x3e' + jQuery.imajnet.settings.surveyTraceHight + '\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv id\x3d"imajnetSettingsVisibleImagesSlider" style\x3d"width: 240px;"\x3e\x3cdiv class\x3d"ui-slider-handle"\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft" style\x3d"height: 5px;"\x3e\x3c/div\x3e\x3cdiv class\x3d"left settingsSearchLeft"\x3e' + jQuery.imajnet.settings.imageSwitcher + '\x3c/div\x3e\x3cdiv class\x3d"left"\x3e\x3cdiv class\x3d"sliderTopTitleSmall"\x3e\x3cdiv class\x3d"left" style\x3d"width: 30px; margin-left: -10px; text-align: center;"\x3e' + jQuery.imajnet.settings.imageSwitcherLow + '\x3c/div\x3e\x3cdiv class\x3d"left" style\x3d"width: 185px; text-align: center;"\x3e\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left" style\x3d"width: 50px; text-align: center;"\x3e' + jQuery.imajnet.settings.imageSwitcherHight + '\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv id\x3d"imajnetSettingsImageSwitcherSlider" style\x3d"width: 240px;"\x3e\x3cdiv class\x3d"ui-slider-handle"\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft" style\x3d"height: 10px;"\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"left optionsGroupRight" style\x3d"display: none;"\x3e\x3cdiv style\x3d"text-decoration: underline; margin-bottom: 5px;"\x3e' + jQuery.imajnet.settings.imageOptions.title + "\x3c/div\x3e" + a + '\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"optionsGroup"\x3e\x3cspan class\x3d"popupContentContainerTitle"\x3e' + jQuery.imajnet.settings.mapSectionTitle + '\x3c/span\x3e\x3cdiv id\x3d"popupContentContainer" style\x3d"margin-top: -10px;"\x3e\x3cdiv class\x3d"left settingsSearchLeft"\x3e' + jQuery.imajnet.settings.orientedImages + '\x3c/div\x3e\x3cdiv class\x3d"left"\x3e\x3cdiv class\x3d"sliderTopTitle"\x3e\x3cdiv class\x3d"left" style\x3d"width: 30px; margin-left: -10px; text-align: center;"\x3e' + jQuery.imajnet.settings.orientedImagesLow + '\x3c/div\x3e\x3cdiv class\x3d"left" style\x3d"width: 355px; text-align: center;"\x3e\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left" style\x3d"width: 50px; text-align: center;"\x3e' + jQuery.imajnet.settings.orientedImagesHight + '\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv id\x3d"imajnetSettingsOrientedImagesSlider" style\x3d"width: 410px;"\x3e\x3cdiv class\x3d"ui-slider-handle"\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft" style\x3d"height: 10px;"\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"optionsGroup"\x3e\x3cspan class\x3d"popupContentContainerTitle"\x3e' + jQuery.imajnet.settings.projectionSectionTitle + '\x3c/span\x3e\x3cdiv id\x3d"popupContentContainer" style\x3d"margin-top: -10px;"\x3e\x3cdiv class\x3d"left settingsSearchLeft"\x3e' + jQuery.imajnet.settings.projection + '\x3c/div\x3e\x3cdiv class\x3d"left"\x3e\x3cdiv class\x3d"sliderTopTitle"\x3e\x3cdiv class\x3d"left" style\x3d"width: 30px; margin-left: -10px; text-align: center;"\x3e' + jQuery.imajnet.settings.projectionLow + '\x3c/div\x3e\x3cdiv class\x3d"left" style\x3d"width: 355px; text-align: center;"\x3e\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left" style\x3d"width: 50px; text-align: center;"\x3e' + jQuery.imajnet.settings.projectionHigh + '\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv id\x3d"imajnetSettingsProjectionSlider" style\x3d"width: 410px;"\x3e\x3cdiv class\x3d"ui-slider-handle"\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft" style\x3d"height: 10px;"\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"optionsGroup"\x3e\x3cspan class\x3d"popupContentContainerTitle"\x3e' + jQuery.imajnet.settings.units.title + '\x3c/span\x3e\x3cdiv id\x3d"popupContentContainer" style\x3d"margin-top: -10px;"\x3e\x3cdiv class\x3d"left settingsSearchLeft"\x3e' + jQuery.imajnet.settings.units.unit + '\x3c/div\x3e\x3cdiv class\x3d"left"\x3e\x3cselect id\x3d"imajnetSettingsUnit" style\x3d"margin-top: 12px;"\x3e\x3coption value\x3d"m" title\x3d"' + jQuery.imajnet.settings.units.m + '"\x3em\x3c/option\x3e\x3coption value\x3d"feet" title\x3d"' + jQuery.imajnet.settings.units.feet + '"\x3efeet\x3c/option\x3e\x3c/select\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft" style\x3d"height: 10px;"\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv style\x3d"text-align: center; margin-top: 3px;"\x3e\x3cinput type\x3d"button" value\x3d"' + jQuery.imajnet.settings.resetDefaultButton + '" onclick\x3d"ImajnetSettings.resetSettingsToDefault();" class\x3d"dialogButton"\x3e\x3cinput type\x3d"button" value\x3d"' + jQuery.imajnet.settings.saveSettingsButton + '" onclick\x3d"ImajnetSettings.saveSettings();" class\x3d"dialogButton dialogButtonSave"\x3e\x3c/div\x3e'
    },
    ...
    resetSettingsToDefault: function() {
        for (var a in this.defaultImajnetSettings)
            "imageRetrievalOptions" == a ? Nigsys.setRadioValue(a, this.defaultImajnetSettings[a]) : this.sliders[a].slider("value", this.defaultImajnetSettings[a]);
    ...
    getSettingsFromCookie: function() {
        ...
        if (a)
            for (var b in a)
                this.imajnetSettings[b] = "imageRetrievalOptions" == b && this.imageRetrievalOptions[a[b]] || "unit" == b ? a[b] : a[b] >= this.rangeImajnetSettings[b].low && a[b] <= this.rangeImajnetSettings[b].high ? a[b] : this.defaultImajnetSettings[b];
...
var ImajnetUserSettings = {
    lrsRoadType: 0,
    mapExtent: null,
    onUserSettingsReceived: function(a) {
        a = JSON.parse(a);
        a.options && (ImajnetUserSettings.lrsRoadType = a.options.lrsRoadType,
        ImajnetUserSettings.mapExtent = a.options.mapExtent)
    },
...
var ImajnetLRSSettings = {
    ...
    resetLRSSettingsToDefault: function() {
        for (var a in this.defaultLRSSettings)
            if ("display" != a)
                for (var b in this.defaultLRSSettings[a])
                    for (var c in this.defaultLRSSettings[a][b])
                        jQuery("#" + a + "_" + b + "_" + c).val(this.defaultLRSSettings[a][b][c]);
    ...
    getLRSSettingsFromCookie: function() {
        ...
        if (a)
            for (var b in a)
                for (var c in a[b])
                    for (var d in a[b][c])
                        this.LRSSettings[b][c][d] = a[b][c][d];
        else
            ImajnetLRSSettings.LRSSettings.display.addressAndLRS.showRoads = !0,
            ImajnetLRSSettings.LRSSettings.display.addressAndLRS.showPR = !0,
            ImajnetLRSSettings.LRSSettings.display.addressAndLRS.showLabels = !0
    },
    getLRSSettingsFromPopup: function() {
        for (var a in this.LRSSettings)
            if ("display" != a)
                for (var b in this.LRSSettings[a])
                    for (var c in this.LRSSettings[a][b])
                        this.LRSSettings[a][b][c] = jQuery("#" + a + "_" + b + "_" + c).val();
        ...
        this.LRSSettings.display.addressAndLRS.showLabels = jQuery("#display_addressAndLRS_showLabels").is(":checked")
    },
    ...
    updateReferential: function() {
        ...
        if (a) {
            ...
            ImajnetLRSSettings.LRSSettings.display.addressAndLRS.imajnetSettingsLRSShowCumulated ? b.parent().show() : b.parent().hide()
        }
    },
    updateLabels: function() {
        "undefined" !== typeof Address && (Address.init(),
        Address.getAddressFromCoordinates(ImajnetMap.currentPosition));
    ...
    getLRSSettingsPopupHTML: function() {
        var a = '\x3cdiv id\x3d"' + ("undefined" === typeof ImajnetUI ? "" : ImajnetUI.settingsLRSContainerId) + '"\x3e\x3cdiv class\x3d"LRSSubtitle"\x3e' + jQuery.imajnet.settings.display.title + '\x3c/div\x3e\x3cdiv class\x3d"optionsGroup left LRSSettingsReferentialItemContainer"\x3e\x3cspan class\x3d"popupContentContainerTitle"\x3e' + jQuery.imajnet.settings.display.image + '\x3c/span\x3e\x3cdiv\x3e\x3cdiv class\x3d"left"\x3e' + jQuery.imajnet.settings.display.LRSShowCumulated + ':\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left showCumulated"\x3e' + Nigsys.getCheckboxHTML("display_addressAndLRS_imajnetSettingsLRSShowCumulated", null, null, null, ImajnetLRSSettings.LRSSettings.display.addressAndLRS.imajnetSettingsLRSShowCumulated) + '\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv id\x3d"ImjnetLRSSettingsSearchAddressContainer" style\x3d"margin-top: 3px;"\x3e\x3cdiv class\x3d"left"\x3e' + jQuery.imajnet.settings.display.addressInLRS + ':\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left"\x3e\x3cinput type\x3d"checkbox" id\x3d"display_addressAndLRS_imajnetSettingsAddressInLRS"' + (ImajnetLRSSettings.LRSSettings.display.addressAndLRS.imajnetSettingsAddressInLRS ? ' checked\x3d"checked"' : "") + ' /\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv style\x3d"margin-top: 3px;"\x3e\x3cdiv class\x3d"left"\x3e' + jQuery.imajnet.settings.display.addressDisplayType.title + ':\x26nbsp;\x3c/div\x3e\x3cdiv\x3e\x3cselect id\x3d"display_addressAndLRS_imajnetSettingsAddressDisplayType" style\x3d"margin-left: 3px;"\x3e\x3coption value\x3d"FULL"' + (ImajnetLRSSettings.LRSSettings.display.addressAndLRS.imajnetSettingsAddressDisplayType == this.ADDRESS_MODE.FULL ? ' selected\x3d"selected"' : "") + "\x3e" + jQuery.imajnet.settings.display.addressDisplayType.full + '\x3c/option\x3e\x3coption value\x3d"CITY"' + (ImajnetLRSSettings.LRSSettings.display.addressAndLRS.imajnetSettingsAddressDisplayType == this.ADDRESS_MODE.CITY ? ' selected\x3d"selected"' : "") + "\x3e" + jQuery.imajnet.settings.display.addressDisplayType.city + '\x3c/option\x3e\x3c/select\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv id\x3d"imajnetWebShowRoadsAndPR" class\x3d"optionsGroup left LRSSettingsReferentialItemContainer" style\x3d"margin-left: 5px;"\x3e\x3cspan class\x3d"popupContentContainerTitle"\x3e' + jQuery.imajnet.settings.display.carto + '\x3c/span\x3e\x3cdiv\x3e\x3cdiv class\x3d"left"\x3e' + jQuery.imajnet.settings.display.showRoads + ':\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left showCumulated"\x3e' + Nigsys.getCheckboxHTML("display_addressAndLRS_showRoads", null, null, ' onchange\x3d"ImajnetLRSSettings.showLayersChanged();"', ImajnetLRSSettings.LRSSettings.display.addressAndLRS.showRoads) + '\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv id\x3d"ImjnetLRSSettingsSearchAddressContainer" style\x3d"margin-top: 3px;"\x3e\x3cdiv class\x3d"left"\x3e' + jQuery.imajnet.settings.display.showPR + ':\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left showCumulated"\x3e' + Nigsys.getCheckboxHTML("display_addressAndLRS_showPR", null, null, ' onchange\x3d"ImajnetLRSSettings.showLayersChanged();"', ImajnetLRSSettings.LRSSettings.display.addressAndLRS.showPR) + '\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv style\x3d"margin-top: 3px;"\x3e\x3cdiv class\x3d"left"\x3e' + jQuery.imajnet.settings.display.showLabels + ':\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left showCumulated"\x3e' + Nigsys.getCheckboxHTML("display_addressAndLRS_showLabels", null, null, null, ImajnetLRSSettings.LRSSettings.display.addressAndLRS.showLabels) + '\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e', b = Object.keys(ImajnetLRSSettings.LRSSettings).length, c = 0, d;
        for (d in this.LRSSettings)
            if ("display" != d)
                for (var e in this.LRSSettings[d])
                    0 == c % 2 && (0 != c && (a += '\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e'),
                    a += '\x3cdiv class\x3d"LRSItemContainer"\x3e\x3cdiv class\x3d"LRSSubtitle"\x3e' + jQuery.imajnet.settings.LRS[d] + '\x3c/div\x3e\x3cdiv class\x3d"LRSSettingsReferentialContainer"\x3e'),
                    a += ImajnetLRSSettingType.getSettingHTML(d, e, this.LRSSettings[d][e], c),
                    c == b && (a += '\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e'),
                    c++;
        return a + '\x3cdiv id\x3d"ImajnetLRSSettingsSaveButtonsContainer" style\x3d"text-align: center; margin-top: 5px;"\x3e\x3cinput type\x3d"button" value\x3d"' + jQuery.imajnet.settings.resetDefaultButton + '" onclick\x3d"ImajnetLRSSettings.resetLRSSettingsToDefault();" class\x3d"dialogButton"\x3e\x3cinput type\x3d"button" value\x3d"' + jQuery.imajnet.settings.saveSettingsButton + '" onclick\x3d"ImajnetLRSSettings.saveLRSSettings();" class\x3d"dialogButton dialogButtonSave"\x3e\x3c/div\x3e\x3c/div\x3e'
    },
...
var ImajnetLRSSettingType = {
    getSettingHTML: function(c, f, d, b) {
        ...
        var e = 0, a;
        for (a in d) {
            if ("referential" != c || 2 != e)
                b += '\x3cdiv class\x3d"left settingsLeft"\x3e' + jQuery.imajnet.settings.LRS[a].label + '\x3c/div\x3e\x3cdiv class\x3d"left settingsRight"\x3e\x3cselect id\x3d"' + c + "_" + f + "_" + a + '"' + ("search" == c && 0 < e ? 'disabled\x3d"disabled"' : "") + ' class\x3d"LRSSettingsSelect"\x3e\x3coption value\x3d"1" ' + (1 == d[a] ? 'selected\x3d"selected"' : "") + "\x3e" + jQuery.imajnet.settings.LRS[a][1] + '\x3c/option\x3e\x3coption value\x3d"2" ' + (2 == d[a] ? 'selected\x3d"selected"' : "") + "\x3e" + jQuery.imajnet.settings.LRS[a][2] + '\x3c/option\x3e\x3c/select\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft" style\x3d"height: 5px;"\x3e\x3c/div\x3e';
            e++
        }
...
var ImajnetZoom = {
    ...
    setDraggableContainment: function() {
        ...
        var b = parseInt(a.left + ImajnetUI.imajnetImageContainerSize.width - this.width)
          , c = parseInt(a.top + ImajnetUI.imajnetImageContainerSize.height - this.height)
          , e = parseInt(a.left)
          , a = parseInt(a.top);
        try {
            ImajnetUI.imajnetImage.draggable("option", "containment", [b, c, e, a])
        } catch (d) {}
    },
    resetZoom: function() {
        ...
        this.isZoomMode() || (ImajnetZoom.doWhenDeactivateZoom(),
        ImajnetUI.imajnetImageContainer.off("vmousedown", ImajnetZoom.onShiftZoomStart),
    ...
    getRealImageSize: function() {
        return {
            width: ImajnetZoom.HIGH_RESOLUTION_WIDTH,
            height: ImajnetZoom.HIGH_RESOLUTION_HEIGHT
        }
    },
    getRealImageCoordinates: function(a, b) {
        var c = ImajnetZoom.getCoordinatesOnScreen(a, b)
          , e = ImajnetZoom.getRealImageSize();
        return {
            x: e.width / ImajnetUI.imajnetImageContainerInitialSize.width * c.x,
            y: e.height / ImajnetUI.imajnetImageContainerInitialSize.height * c.y
        }
    },
    getCoordinatesOnScreen: function(a, b) {
        var c = Math.abs(ImajnetZoom.top) + b
          , e = Math.abs(ImajnetZoom.left) + a
          , d = this.getCurrentZoomFactor();
        return {
            x: e / d,
            y: c / d
        }
    ...
    getCoordinatesFromRealAtCurrentZoom: function(a) {
        ...
        return {
            x: parseInt(a.x - Math.abs(this.left)),
            y: parseInt(a.y - Math.abs(this.top))
        }
    },
    onShiftZoomStart: function(a) {
        if (1 != a.which && !Nigsys.onMobile())
            return a.preventDefault(),
            a.stopPropagation(),
            Nigsys.disableEventPropagation(a),
            !1;
        var b = jQuery(a.target).parent();
        b && Nigsys.stringContains(b.attr("class"), "imajnetControlsLayerButtonsItem") || !ImajnetMap.currentPosition || (b = ImajnetUI.imajnetImageContainer.offset(),
        ImajnetZoom.shiftZoomStart.x = a.clientX,
        ImajnetZoom.shiftZoomStart.y = a.clientY,
        ImajnetUI.imajnetZoomOnShiftBoxOffset.x = ImajnetZoom.shiftZoomStart.x - b.left,
        ImajnetUI.imajnetZoomOnShiftBoxOffset.y = ImajnetZoom.shiftZoomStart.y - b.top,
        ImajnetUI.imajnetZoomOnShiftBox.css("left", ImajnetUI.imajnetZoomOnShiftBoxOffset.x).css("top", ImajnetUI.imajnetZoomOnShiftBoxOffset.y).show(),
        ImajnetZoom.imageWasDragged = !0)
    },
    imageDragStart: function(a, b) {
    ...
    shiftZoomMouseMove: function(a) {
        if ((ImajnetZoom.canZoom() || ImajnetZoom.isZoomMode()) && ImajnetUI.imajnetZoomOnShiftBox.is(":visible")) {
            ...
            0 > a && (e += a,
            a *= -1);
            ImajnetUI.imajnetZoomOnShiftBox.css("left", c).css("top", e).css("width", b).css("height", a)
        } else
            ImajnetUI.hideShiftBox()
    },
    ...
    imageDragReachEnd: function() {
        return 0 == ImajnetZoom.zoomLevel && (ImajnetImageSwitcher.dragRightPosition && ImajnetZoom.imageDragRightReachEnd() || ImajnetImageSwitcher.dragLeftPosition && 0 == ImajnetUI.imajnetImage.position().left)
    },
    imageDrag: function(a, b) {
        ImajnetUI.dragImageSliderCount = 0;
        ImajnetZoom.imageDragOutsideContainer() || (ImajnetZoom.imageDragRightReachEnd() || 0 == ImajnetUI.imajnetImage.position().left) && !ImajnetUI.popupImajnetControlsLayer.hasClass("ui-draggable-dragging") || (this.moveToPosition(ImajnetZoom.left + a.clientX - ImajnetZoom.startScrollLeft, ImajnetZoom.top + a.clientY - ImajnetZoom.startScrollTop, !0),
        ImajnetZoom.startScrollLeft = a.clientX,
        ImajnetZoom.startScrollTop = a.clientY,
        this.updateProjections(),
    ...
    onImageDragStop: function(a, b) {
        ImajnetZoom.imageDragReachEnd() && (ImajnetUI.enableDraggable(ImajnetUI.imajnetImageSliderInnerContainer),
        ImajnetUI.disableImageDrag())
    },
    imageDragStop: function(a, b) {
        ImajnetZoom.onImageDragStop(a, b);
        ImajnetZoom.imageDragOutsideContainer() || (this.left = b.position.left,
        this.top = b.position.top,
        Nigsys.browserIsIE() && this.updateProjections(),
        this.imageWasDragged = !0)
    },
    shiftZoomEnd: function(a) {
        if ("undefined" !== typeof ImajnetUI && ImajnetUI && ImajnetUI.imajnetZoomOnShiftBox) {
            var b = ImajnetUI.imajnetZoomOnShiftBox.width()
              , c = ImajnetUI.imajnetZoomOnShiftBox.height();
            if (!ImajnetZoom.canZoom() && !ImajnetZoom.isZoomMode() || .5 > b || .5 > c)
                ImajnetUI.hideShiftBox(),
                ImajnetUI.imajnetZoomOnShiftBox.hide();
            else {
                var e = ImajnetUI.imajnetImageContainer.offset()
                  , d = ImajnetUI.imajnetZoomOnShiftBox.offset()
                  , f = a.clientX;
                a = a.clientY;
                Math.round(d.left) + 1 < ImajnetZoom.shiftZoomStart.x && (ImajnetZoom.shiftZoomStart.x = f,
                ImajnetUI.imajnetZoomOnShiftBoxOffset.x = ImajnetZoom.shiftZoomStart.x - e.left);
                Math.round(d.top) + 1 < ImajnetZoom.shiftZoomStart.y && (ImajnetZoom.shiftZoomStart.y = a,
                ImajnetUI.imajnetZoomOnShiftBoxOffset.y = ImajnetZoom.shiftZoomStart.y - e.top);
                ImajnetUI.hideShiftBox();
    ...
    onZoomAddHighImageSuccess: function(a, b, c) {
        a.unbind({
            error: ImajnetZoom.onZoomAddHighImageError,
            load: ImajnetZoom.onZoomAddHighImageSuccess
        });
    ...
    zoomOnScroll: function(a, b) {
        if (!Nigsys.scrollDeltaIsValid(b) || null != this.lastZoomLevel && this.lastZoomLevel == this.zoomLevel && (ImajnetZoom.zoomLevel != this.lastZoomLevel || 0 != this.zoomLevel))
            return !1;
        if (!(0 < b && this.zoomLevel == this.maxZoomLevel)) {
            ...
            var c = ImajnetUI.imajnetImageContainer.offset()
              , e = a.originalEvent.clientX - c.left
              , c = a.originalEvent.clientY - c.top
              , d = this.getCoordinatesOnScreen(e, c);
            if (0 < b)
                -1 !== ImajnetUI.imajnetImage.attr("src").indexOf(ImajnetSettings.imajnetImageResolutions[3]) || this.zoomBigImageLoaded || ImajnetAPI.preloadImage(ImajnetUI.imajnetImage, ImajnetAPI.buildImageURLWithResolution(ImajnetMap.currentPosition, ImajnetSettings.imajnetImageResolutions[3]), this.onZoomAddHighImageSuccess, this.onZoomAddHighImageError),
                this.zoomLevel++;
            else {
                if (1 >= this.zoomLevel) {
                    this.resetZoom();
            ...
            ImageControler.currentSurveyTrace.hideTrace();
            var f = this.getCurrentZoomFactor()
              , d = this.getCoordinatesAtCurrentZoom(d, f)
              , g = ImajnetUI.imajnetImageContainerInitialSize.height * f;
            this.width = Math.max(ImajnetUI.imajnetImageContainerInitialSize.width, ImajnetUI.imajnetImageContainerInitialSize.width * f);
    ...
    zoomOnShift: function(a, b) {
        for (var c = ImajnetUI.imajnetZoomOnShiftBoxOffset.x + a / 2, e = ImajnetUI.imajnetZoomOnShiftBoxOffset.y + b / 2, d = 0; d < this.maxZoomLevel; d++) {
            var f = Math.pow(ImajnetZoom.zoomRatio, d + 1)
              , g = b * f;
            if (a * f >= ImajnetUI.imajnetImageContainerSize.width || g >= ImajnetUI.imajnetImageContainerSize.height)
                break;
    ...
    bindHideDragDisabledVisual: function() {
        if (ImajnetUI.imajnetImageSliderInnerContainer)
            ImajnetUI.imajnetImageSliderInnerContainer.on("dragstart", ImajnetZoom.hideDragDisabledVisual)
    },
    ...
    deactivateZoom: function() {
        ...
        jQuery(".popupImajnetImage").removeClass("zoomCursor");
        ImajnetUI.imajnetImageContainer && (ImajnetUI.imajnetImageContainer.off("vmousedown", ImajnetZoom.onShiftZoomStart),
        ImajnetUI.imajnetImageContainer.off("vmousemove", ImajnetZoom.shiftZoomMouseMove))
    },
    isZoomMode: function() {
    ...
    activateDeactivateZoom: function(a) {
        ImajnetZoom.isZoomMode() ? (ImajnetZoom.deactivateZoom(),
        0 == ImajnetZoom.zoomLevel ? ImajnetUI.enableDraggable(ImajnetUI.imajnetImageSliderInnerContainer) : (ImajnetUI.enableImageAllDrag(),
        ImajnetUI.imajnetImageContainer.off("vmousedown", ImajnetZoom.onShiftZoomStart))) : ImajnetZoom.activateZoom()
    },
    ...
    zoomOnPinch: function(a, b, c, e) {
        ...
        for (d = 0; d < e; d++)
            ImajnetZoom.zoomOnScrollHandler(a, c);
        ImajnetUI.enableImageAllDrag()
    },
    zoomOnScrollHandler: function(a, b) {
        if (a.target && (Nigsys.stringContains(a.target.className, "textareaEditComment") || Nigsys.stringContains(a.target.className, "imajnetImageSwitcherImageItem") || Nigsys.stringContains(a.target.className, "imajnetImageSwitcherOrderedImageItemImage") || Nigsys.stringContains(a.target.className, "orderedImageDate") || Nigsys.stringContains(a.target.className, "scrollOrderedImagesLeftImage") || Nigsys.stringContains(a.target.className, "scrollOrderedImagesRightImage") || Nigsys.stringContains(a.target.id, "imajnetImageSwitcherCenterImage")))
            return !1;
        var c = jQuery(a.target).parent();
        if (c && Nigsys.stringContains(c.attr("class"), "imajnetControlsLayerButtonsItem"))
            return !1;
        b = Nigsys.getDelta(a, b);
        ImajnetZoom.canZoom() || ImajnetZoom.isZoomMode() || Nigsys.onMobile() ? (ImajnetZoom.zoomOnScroll(a, b),
        ImajnetZoom.updateProjections()) : (clearTimeout(ImageControler.currentImageControl.fastNavigationTimeout),
        ImageControler.currentImageControl.setFastNavigation(),
        ImageControler.currentImageControl.fastNavigationTimeout = setTimeout("ImajnetZoom.scrollEndTimeout()", 300),
        0 > b ? ImageControler.currentImageControl.getPrevious(!1) : ImageControler.currentImageControl.getNext(!1));
        a.preventDefault();
        return !0
    },
    registerEvents: function() {
        ImajnetUI.imajnetImageContainer.on("mousewheel DOMMouseScroll", ImajnetZoom.zoomOnScrollHandler)
    },
...
var ImajnetClickMode = {
    ...
    addClickedPointToPhotogrammetry: function() {
        if (null !== ImajnetMap.currentPosition && (ImageControler.currentPhotogrammetry.removeMapClickedPoint(),
        null !== this.requestedPosition)) {
            var a = {
                id: 0,
                position: ImajnetMap.currentPosition,
                photogrammetryPosition3D: {
                    coordinates: this.requestedPosition
                },
                type: ImajnetMap.MARKER_TYPE_CLICKED_POINT
            };
    ...
    drawOrientedImages: function(a) {
        if (null !== this.positions && null !== this.requestedPosition)
            for (var d = ImageControler.currentPhotogrammetry.getLastObjectId(), e = -1, c = !1, b = 0; b < this.positions.length; b++) {
                var f = Nigsys.distanceBetweenPoints(this.requestedPosition, this.positions[b]);
                !c && 25 < f && (e = 0,
                this.positions[b].wrapperId = d + e + 1,
                ImajnetMap.setOrientationMarker(this.positions[0], ImajnetMap.imajboxOrientedImagesDimension, "#00FF00", this.positions[b].wrapperId),
                a && ("undefined" !== typeof ImajnetUI && (ImajnetUI.showItem(ImajnetUI.imageContainerId),
                Nigsys.showLoading(ImajnetUI.imageContainer)),
                ImajnetZoom.left = -1,
                ImajnetAPI.setImajnetImage({
                ...
                !c && 4 < f && (e = b,
                this.positions[b].wrapperId = d + e + 1,
                ImajnetMap.setOrientationMarker(this.positions[b], ImajnetMap.imajboxOrientedImagesDimension, "#00FF00", this.positions[b].wrapperId),
                a && ("undefined" !== typeof ImajnetUI && (ImajnetUI.showItem(ImajnetUI.imageContainerId),
                Nigsys.showLoading(ImajnetUI.imageContainer)),
                ImajnetZoom.left = -1,
                ImajnetAPI.setImajnetImage({
                    position: this.positions[b]
                })),
                c = !0);
                b != e && (this.positions[b].wrapperId = d + b + 1,
                ImajnetMap.setOrientationMarker(this.positions[b], ImajnetMap.imajboxOrientedImagesDimension, "#00FF00", this.positions[b].wrapperId))
            }
    },
    ...
    orientedImagesReceived: function(a) {
        ...
        ImajnetMap.hideOrientation();
        a = JSON.parse(a);
        a.positions && (ImajnetClickMode.positions = a.positions,
        ImajnetClickMode.addClickMode(!0));
        ImajnetClickMode.redrawClickedPointOnMap()
    },
    ...
    getOrientedImages: function(a, d, e, c, b) {
        ImajnetAPI.mustAbortRequests && null !== this.orientedImagesAjaxRequest && this.orientedImagesAjaxRequest.abort();
    ...
    showOrientedImages: function(a, d, e, c, b) {
        ...
        this.getOrientedImages(this.requestedPosition.lon, this.requestedPosition.lat, e, c, b)
    },
    hideOrientedImages: function() {
        ImajnetMap.clearClickedPointFromMap();
...
var ImajnetPosition = {
    ...
    hidePosition: function(a) {
        ...
        ImageControler.currentPhotogrammetry && (ImageControler.currentPhotogrammetry.currentStep = 1,
        ImageControler.currentPhotogrammetry.setRedStep(ImageControler.currentPhotogrammetry.currentStep - 1),
        ImageControler.currentPhotogrammetry.firstImagePosition = null,
        ImageControler.currentPhotogrammetry.constraintParameter = null,
        a ? (ImageControler.currentPhotogrammetry.redraw(!1),
    ...
    showHidePosition: function() {
        jQuery("#imajnetPositionButtonContainer").hasClass("buttonActive") ? (this.hidePosition(!0),
        LRS.cachedPoints[ImajnetMap.currentPosition.lat + ":" + ImajnetMap.currentPosition.lon + ":" + ImajnetMap.currentPosition.height] && ImajnetUI.LRSGUI.draw(LRS.cachedPoints[ImajnetMap.currentPosition.lat + ":" + ImajnetMap.currentPosition.lon + ":" + ImajnetMap.currentPosition.height]),
        Address.showAddress(),
        LRS.showLRS(),
        ImajnetUI.showDateContainer(),
        ImageControler.currentPhotogrammetry.redraw(!1)) : this.showPosition(!0)
    },
    showHidePositionDenied: function() {
        ImageControler.currentPhotogrammetry.photogrammetryIsDenied() ? jQuery("#positionDenied").show() : (jQuery("#positionDenied").hide(),
        ImageControler.currentPhotogrammetry.getConstraint())
    },
    reload: function() {
        jQuery("#imajnetPositionButtonContainer").hasClass("buttonActive") && (this.hidePosition(!1),
        this.showPosition(!1),
        ImajnetZoom.imageWasDragged = !1)
    },
    pinPointPositionReceived: function(a, b) {
        ...
        if ((a = JSON.parse(a)) && a.parameter && a.parameter.imagePoint && a.parameter.imagePoint.img1) {
            ...
            //ImajnetPlugin.addPinPoint(a.parameter.imagePoint.img1);
            ImajnetAPI.setImajnetImage({
                position: a.parameter.imagePoint.img1
            });
            ImageControler.currentPhotogrammetry.getObjectLRS(a);
            ImajnetPlugin.onPinPointCreated({
                id: d.id,
                point: a.photogrammetryPosition3D
            })
        } else
            ImajnetUI.showError(jQuery.imajnet.map.position.errorPosition, !0)
    },
    pinPointPositionComplete: function(a) {
        200 !== a.status && (ImajnetPosition.showHidePosition(),
        ImajnetUI.showError(jQuery.imajnet.map.position.errorPosition, !0))
    },
    positionObject: function(a, b, d) {
        ...
        case 1:
            ...
            var c = null;
            "FLAT" == ImageControler.currentImageType ? (ImajnetUI.previewImage.attr("src", ImajnetAPI.buildImageURL(ImageControler.currentPhotogrammetry.firstImagePosition, ImajnetUI.getPreviewImageResolution())),
            c = ImajnetZoom.getRealImageCoordinates(a, b)) : (ImajnetUI.previewImage.attr("src", ImajnetAPI.buildImageURL(ImageControler.currentPhotogrammetry.firstImagePosition, ImajnetUI.getPreviewImageResolution()), e),
            c = {
                x: a,
                y: b
            });
        ...
        case 2:
            ...
            ImajnetZoom.imageQuality = "HIGH_RESOLUTION",
            c = "FLAT" == ImageControler.currentImageType ? ImajnetZoom.getRealImageCoordinates(a, b) : {
                x: a,
                y: b
            },
            ImageControler.currentGraphic.clearConstraints(),
            this.positionAjaxRequest = ImajnetAPI.doImajnetRequest("GET", "/api/photogrammetry/position3D/", {
                imagePoint: {
            ...
            }, this.pinPointPositionReceived, null, this.pinPointPositionComplete, null, null, d),
            Address.showAddress(),
            ImageControler.currentPhotogrammetry.currentStep++
        }
    }
...
var ImajnetProjection = {
    imajnetProjections: null,
    userProjections: null,
    projectedLayers: [],
    draw: function() {
        if (!ImajnetMap.currentPosition || Nigsys.isPositionMode() || Nigsys.isMeasurementMode())
            return jQuery.Deferred().resolve().promise();
    ...
    getAllProjections: function(a) {
        if (!ImajnetMap.currentPosition || a && a.parameter.pointOfView.id != ImajnetMap.currentPosition.id)
            return null;
        ...
        if (!a)
            return c ? {
                parameter: {
                    pointOfView: {
                        id: c.parameter.pointOfView.id
                    }
                },
                projection: c.projection
            } : null;
        if (a.projection.pointProjections) {
            for (var b = 0; b < a.projection.pointProjections.length; b++)
                a.projection.pointProjections[b] || (a.projection.pointProjections.splice(b, 1),
                b--);
            a.projection.pointProjections.length || delete a.projection.pointProjections
        }
        if (a.projection.shapeProjections) {
            for (b = 0; b < a.projection.shapeProjections.length; b++)
                a.projection.shapeProjections[b] || (a.projection.shapeProjections.splice(b, 1),
                b--);
        ...
        if (c) {
            var d = []
              , e = [];
            if ((!Nigsys.isPolyligneMode() || 1 != ImageControler.currentPhotogrammetry.currentStep % 2) && a.projection.pointProjections)
                if (c.projection.pointProjections)
                    for (b = 0; b < a.projection.pointProjections.length; b++)
                        if (f = ImageControler.currentPhotogrammetry.getObjectById(a.projection.pointProjections[b].id)) {
                            for (var f = !1, g = 0; g < c.projection.pointProjections.length; g++)
                                if (c.projection.pointProjections[g] && c.projection.pointProjections[g].id == a.projection.pointProjections[b].id) {
                                    f = !0;
                                    break
                                }
                            f || (c.projection.pointProjections || (c.projection.pointProjections = []),
                            c.projection.pointProjections.push(a.projection.pointProjections[b]))
                        } else
                            d.push(a.projection.pointProjections[b]);
                else
                    for (b = 0; b < a.projection.pointProjections.length; b++)
                        (f = ImageControler.currentPhotogrammetry.getObjectById(a.projection.pointProjections[b].id)) ? (c.projection.pointProjections || (c.projection.pointProjections = []),
                        c.projection.pointProjections.push(a.projection.pointProjections[b])) : d.push(a.projection.pointProjections[b]);
            if (a.projection.shapeProjections)
                if (c.projection.shapeProjections)
                    for (b = 0; b < a.projection.shapeProjections.length; b++)
                        if (a.projection.shapeProjections[b]) {
                            if (f = ImageControler.currentPhotogrammetry.getObjectById(a.projection.shapeProjections[b].id)) {
                                f = !1;
                                for (g = 0; g < c.projection.shapeProjections.length; g++)
                                    if (c.projection.shapeProjections[g] && c.projection.shapeProjections[g].id == a.projection.shapeProjections[b].id && (f = !0,
                                    !Nigsys.isPolyligneMode() || c.projection.shapeProjections[g].id == ImajnetPolyligne.currentAddObjectId)) {
                                        var h = ImajnetMap.getFeatureWrapperById(a.projection.shapeProjections[b].id);
                                        if (h && h.getType() == ImajnetMap.FEATURE_TYPE_PROJECTION)
                                            c.projection.shapeProjections[g] = a.projection.shapeProjections[b];
                                        else if (c.projection.shapeProjections[g].projections && a.projection.shapeProjections[b].projections) {
                                            for (var h = [], k = 0; k < a.projection.shapeProjections[b].projections.length; k++) {
                                                for (var m = !1, l = 0; l < c.projection.shapeProjections[g].projections.length; l++)
                                                    if (c.projection.shapeProjections[g].projections[l].id == a.projection.shapeProjections[b].projections[k].id) {
                                                        m = !0;
                                                        break
                                                    }
                                ...
                                f || (c.projection.shapeProjections || (c.projection.shapeProjections = []),
                                c.projection.shapeProjections.push(a.projection.shapeProjections[b]))
                            }
                        } else
                            e.push(a.projection.shapeProjections[b]);
                else
                    for (b = 0; b < a.projection.shapeProjections.length; b++)
                        (f = ImageControler.currentPhotogrammetry.getObjectById(a.projection.shapeProjections[b].id)) ? (c.projection.shapeProjections || (c.projection.shapeProjections = []),
                        c.projection.shapeProjections.push(a.projection.shapeProjections[b])) : e.push(a.projection.shapeProjections[b]);
        ...
        if (!a.projection.pointProjections && !a.projection.shapeProjections)
            return null;
        c = {
            parameter: {
                pointOfView: {
                    id: a.parameter.pointOfView.id
                }
            },
            projection: {}
        };
        ...
        if (!Nigsys.isPolyligneMode()) {
            ...
            if (a.projection.pointProjections) {
                for (b = 0; b < a.projection.pointProjections.length; b++) {
                    var f = ImageControler.currentPhotogrammetry.getObjectById(a.projection.pointProjections[b].id);
                    f || (a.projection.pointProjections.splice(b, 1),
                    b--)
                }
                a.projection.pointProjections.length || delete a.projection.pointProjections
            }
            if (a.projection.shapeProjections) {
                for (b = 0; b < a.projection.shapeProjections.length; b++)
                    f = ImageControler.currentPhotogrammetry.getObjectById(a.projection.shapeProjections[b].id),
                    f || (a.projection.shapeProjections.splice(b, 1),
                    b--);
                a.projection.shapeProjections.length || delete a.projection.shapeProjections
            }
            (a.projection.pointProjections || a.projection.shapeProjections) && ImageControler.currentPhotogrammetry.existingProjections.push(c)
        }
        return c
    },
    projectionReceived: function(a) {
        if ((a = ImajnetProjection.getAllProjections(a)) && !Nigsys.isPositionMode() && !Nigsys.isMeasurementMode() && ImajnetMap.currentPosition && ImajnetMap.currentPosition.id == a.parameter.pointOfView.id && void 0 !== a.projection) {
            if (a.projection.pointProjections && !Nigsys.isPolyligneMode()) {
                ...
                c.sort(function(b, a) {
                    return Nigsys.compareAscending(b, a, "id")
                });
                for (var b = 0; b < c.length; b++)
                    if (c[b]) {
                        var d = parseInt(c[b].id);
                        isNaN(d) || (c[b].id = d);
                        if ((d = ImajnetMap.getFeatureWrapperById(c[b].id)) && 0 <= c[b].coordinates.z)
                            if (0 == c[b].id)
                                ImageControler.currentPhotogrammetry.appendMapMarker(c[b].id, c[b].coordinates);
                            else {
                                if (d.type == ImajnetMap.MARKER_TYPE_POSITION || d.type == ImajnetMap.MARKER_TYPE_POLYLIGNE_POSITION) {
                                    var e = c[b].linkToNext
                                      , f = ImageControler.currentPhotogrammetry.getObjectById(c[b].id);
                                    e && (e = ImageControler.currentPhotogrammetry.getImageNextObject(c[b].id)) && c[b].featureWrapper && e.type != f.type && (e = !1)
                                }
            ...
            if (a.projection.shapeProjections)
                for (b = 0; b < a.projection.shapeProjections.length; b++)
                    ...
                    isNaN(d) || (a.projection.shapeProjections[b].id = d),
                    d = ImajnetMap.getFeatureWrapperById(a.projection.shapeProjections[b].id),
                    c = ImageControler.currentPhotogrammetry.getObjectById(a.projection.shapeProjections[b].id),
                    !c || (c.parameter.imagePoint1 ? c.parameter.imagePoint1.img1 : c.parameter.imagePoint.img1).traceId == ImajnetMap.currentPosition.traceId || d.type != ImajnetMap.FEATURE_TYPE_MEASUREMENT && d.type != ImajnetMap.MARKER_TYPE_POSITION && d.type != ImajnetMap.MARKER_TYPE_POLYLIGNE_POSITION && -1 === jQuery.inArray(d.type.replace("Feature", ""), ImajnetPolyligne.typesArray) ? a.projection.shapeProjections[b] && void 0 !== a.projection.shapeProjections[b].projections && 0 <= a.projection.shapeProjections[b].projections[0].coordinates.z && ImageControler.currentPhotogrammetry.drawLine(d, a.projection.shapeProjections[b].projections) : (ImageControler.currentPhotogrammetry.objectIsMeasurement(a.projection.shapeProjections[b].id),
                    a.projection.shapeProjections[b].projections[0] && a.projection.shapeProjections[b].projections[1] && ImageControler.currentPhotogrammetry.drawLine(ImajnetMap.getFeatureWrapperById(a.projection.shapeProjections[b].id), [a.projection.shapeProjections[b].projections[0], a.projection.shapeProjections[b].projections[1]]),
                    a.projection.shapeProjections[b].projections[2] && a.projection.shapeProjections[b].projections[3] && ImageControler.currentPhotogrammetry.drawLine(ImajnetMap.getFeatureWrapperById(a.projection.shapeProjections[b].id), [a.projection.shapeProjections[b].projections[2], a.projection.shapeProjections[b].projections[3]])))
        }
    },
    projectUserData: function(a, c) {
        if (!c || !c.length)
            return ImajnetProjection.projectDataRequest(null);
        if (Nigsys.isPositionMode() || Nigsys.isMeasurementMode() || Nigsys.isPolyligneMode())
            return jQuery.Deferred().resolve().promise();
        for (var b = {}, d = 0; d < c.length; d++)
            if (c[d].geometry) {
                var e = c[d].layerId;
                if (e && !b[e]) {
                    var f = ImajnetProjection.getProjectedLayerById(e);
                    f ? b[e] = {
                        points: [],
                        shapes: [],
                        groundProjection: f.groundProjection,
                        heightOffset: f.heightOffset
                    } : (console.warn("Layer not fount in ImajnetProjection.projectedLayers"),
                    e = "allProjections")
                } else
                    e || (e = "allProjections");
                "allProjections" != e || b.allProjections || (b.allProjections = {
                    points: [],
                    shapes: [],
                    groundProjection: !0,
                    heightOffset: 0
                });
                if (1 == c[d].geometry.length)
                    b[e].points.push({
                        coordinates: c[d].geometry[0],
                        linkToNext: !1,
                        objectId: "PointProjection_" + (d + 1)
                    });
                else {
                    for (var f = [], g = 0; g < c[d].geometry.length; g++)
                        f.push({
                            coordinates: c[d].geometry[g],
                            linkToNext: g < c[d].geometry.length - 1 ? !0 : !1,
                            objectId: "PointProjection_" + (d + 1).toString() + g.toString()
                        });
                    b[e].shapes.push({
                        id: "LineProjection_" + (d + 1),
                        points: f
                    })
                }
                ImajnetMap.addToFeatureWrappers({
                    feature: c[d].feature,
                    id: 1 == c[d].geometry.length ? "PointProjection_" + (d + 1) : "LineProjection_" + (d + 1),
                    style: c[d].style,
        ...
        e = [];
        for (d in b)
            0 == b[d].points.length && delete b[d].points,
            0 == b[d].shapes.length && delete b[d].shapes,
            e.push(b[d]);
    ...
    projectUserDataRequest: function() {
        ...
        ImajnetPlugin.drawUserProjections(ImajnetMap.currentPosition.id).done(function(c, b) {
            b && jQuery.each(b, function(b, a) {
                if (ImajnetMap.getFeatureWrapperById(a.id))
                    for (var c = 0; c < ImajnetMap.featureWrappers.length; c++)
                        if (ImajnetMap.featureWrappers[c].id == a.id) {
    ...
    projectDataRequest: function(a) {
        var c = jQuery.Deferred();
        ImageControler.currentPhotogrammetry.imajnetProjectionsDataObject && (a ? a.projectionData = ImageControler.currentPhotogrammetry.imajnetProjectionsDataObject.projectionData.concat(a.projectionData) : a = ImageControler.currentPhotogrammetry.imajnetProjectionsDataObject);
        jQuery.when(this.projectImajnetDataRequest(a), this.projectUserDataRequest()).always(function() {
            var a = ImajnetProjection.imajnetProjections
              , d = ImajnetProjection.userProjections;
            if (!a)
                a = ImajnetProjection.userProjections;
            else if (d && (d.projection.pointProjections || d.projection.shapeProjections)) {
                var e = a.projection
                  , d = d.projection;
    ...
    getProjectedLayerById: function(a) {
        for (var c = 0; c < ImajnetProjection.projectedLayers.length; c++)
            if (ImajnetProjection.projectedLayers[c].id == a)
                return ImajnetProjection.projectedLayers[c];
        return null
    },
    addProjectedLayer: function(a) {
        ImajnetProjection.projectedLayers.push(a)
    },
    updateProjectedLayer: function(a) {
        for (var c = 0; c < ImajnetProjection.projectedLayers.length; c++)
            ImajnetProjection.projectedLayers[c].id == a.id && (ImajnetProjection.projectedLayers[c] = a)
    },
    removeProjectedLayer: function(a) {
        for (var c = 0; c < ImajnetProjection.projectedLayers.length; c++)
            ImajnetProjection.projectedLayers[c].id == a && ImajnetProjection.projectedLayers.splice(c, 1)
    }
};
var OpenLayersForProjection = {
    ...
    Class: function() {
        ...
        ;
        1 < a ? (a = [d, b].concat(Array.prototype.slice.call(arguments).slice(1, a - 1), c),
        OpenLayersForProjection.inherit.apply(null, a)) : d.prototype = c;
        return d
    },
    inherit: function(a, b) {
        ...
        for (d = arguments.length; c < d; c++)
            ...
            OpenLayersForProjection.Util.extend(a.prototype, e)
    },
    Number: {
        decimalSeparator: ".",
        thousandsSeparator: ",",
        ...
        format: function(a, b, c, d) {
            ...
            c = "undefined" != typeof c ? c : OpenLayersForProjection.Number.thousandsSeparator;
...
OpenLayersForProjection.Date = {
    ...
    toISOString: function() {
        ...
        : function(a) {
            return isNaN(a.getTime()) ? "Invalid Date" : a.getUTCFullYear() + "-" + OpenLayersForProjection.Number.zeroPad(a.getUTCMonth() + 1, 2) + "-" + OpenLayersForProjection.Number.zeroPad(a.getUTCDate(), 2) + "T" + OpenLayersForProjection.Number.zeroPad(a.getUTCHours(), 2) + ":" + OpenLayersForProjection.Number.zeroPad(a.getUTCMinutes(), 2) + ":" + OpenLayersForProjection.Number.zeroPad(a.getUTCSeconds(), 2) + "." + OpenLayersForProjection.Number.zeroPad(a.getUTCMilliseconds(), 3) + "Z"
        }
    }(),
    parse: function(a) {
        var b;
...
OpenLayersForProjection.Bounds = OpenLayersForProjection.Class({
    ...
    initialize: function(a, b, c, d) {
        OpenLayersForProjection.Util.isArray(a) && (d = a[3],
        c = a[2],
        b = a[1],
        a = a[0]);
...
OpenLayersForProjection.LonLat = OpenLayersForProjection.Class({
    ...
    lat: 0,
    initialize: function(a, b) {
        OpenLayersForProjection.Util.isArray(a) && (b = a[1],
        a = a[0]);
...
OpenLayersForProjection.Projection = OpenLayersForProjection.Class({
    ...
    equals: function(a) {
        var b = !1;
        a && (a instanceof OpenLayersForProjection.Projection || (a = new OpenLayersForProjection.Projection(a)),
        "object" == typeof Proj4js && this.proj.defData && a.proj.defData ? b = this.proj.defData.replace(this.titleRegEx, "") == a.proj.defData.replace(this.titleRegEx, "") : a.getCode && (b = this.getCode(),
        a = a.getCode(),
    ...
    transform: function(a, b, c) {
        if (b && c)
            if (b instanceof OpenLayers.Projection || (b = new OpenLayers.Projection(b)),
...
OpenLayersForProjection.Renderer = OpenLayersForProjection.Class({
    ...
    applyDefaultSymbolizer: function(a) {
        var b = OpenLayersForProjection.Util.extend({}, OpenLayersForProjection.Renderer.defaultSymbolizer);
        !1 === a.stroke && (delete b.strokeWidth,
...
OpenLayersForProjection.Renderer.Elements = OpenLayersForProjection.Class(OpenLayersForProjection.Renderer, {
    ...
    setExtent: function(a, b) {
        var c = OpenLayersForProjection.Renderer.prototype.setExtent.apply(this, arguments)
    ...
    drawGeometry: function(a, b, c) {
        ...
        0 == e && (b = document.getElementById(a.id)) && (b._style.backgroundGraphic && (d = !0),
    ...
    nodeFactory: function(a, b) {
        ...
        c ? this.nodeTypeCompare(c, b) || (c.parentNode.removeChild(c),
        c = this.nodeFactory(a, b)) : c = this.createNode(b, a);
        return c
    },
...
OpenLayersForProjection.Renderer.Canvas = OpenLayersForProjection.Class(OpenLayersForProjection.Renderer, {
    ...
    setSize: function(a) {
        ...
        b.height = a.h;
        this.resolution = null;
        this.hitDetection && (b = this.hitCanvas,
        b.style.width = a.w + "px",
        b.style.height = a.h + "px",
        b.width = a.w,
        b.height = a.h)
    ...
    drawFeature: function(a, b) {
        ...
        this.pendingRedraw && !this.locked && (this.redraw(),
    ...
    drawExternalGraphic: function(a, b, c) {
        ...
        var f = b.graphicWidth || b.graphicHeight
          ...
          , h = void 0 != b.graphicXOffset ? b.graphicXOffset : -(.5 * f)
          , k = void 0 != b.graphicYOffset ? b.graphicYOffset : -(.5 * g)
        ...
        d.onload = OpenLayersForProjection.Function.bind(function() {
            if (this.features[c]) {
                ...
                if (!isNaN(e) && !isNaN(b)) {
                    ...
                    this.hitDetection && (this.setHitContextStyle("fill", c),
    ...
    drawNamedSymbol: function(a, b, c) {
        ...
        if (!(!h.length || 2 > h.length || (a = this.getLocalXY(a),
        e = a[0],
        g = a[1],
        isNaN(e) || isNaN(g)))) {
            this.canvas.lineCap = "round";
            this.canvas.lineJoin = "round";
            this.hitDetection && (this.hitContext.lineCap = "round",
            ...
            if (b.graphicName in this.cachedSymbolBounds)
                ...
                for (a = 0; a < h.length; a += 2)
                    d.extend(new OpenLayersForProjection.LonLat(h[a],h[a + 1]));
            ...
            a = f * b.rotation;
            isNaN(a) || (this.canvas.rotate(a),
            this.hitDetection && this.hitContext.rotate(a));
    ...
    setCanvasStyle: function(a, b) {
        "fill" === a ? (this.canvas.globalAlpha = b.fillOpacity,
        this.canvas.fillStyle = b.fillColor) : "stroke" === a ? (this.canvas.globalAlpha = b.strokeOpacity,
        this.canvas.strokeStyle = b.strokeColor,
        this.canvas.lineWidth = b.strokeWidth) : (this.canvas.globalAlpha = 0,
        this.canvas.lineWidth = 1)
    },
    featureIdToHex: function(a) {
        a = Number(a.split("_").pop()) + 1;
        16777216 <= a && (this.hitOverflow = a - 16777215,
        a = a % 16777216 + 1);
    ...
    setHitContextStyle: function(a, b, c, d) {
        ...
        "fill" == a ? (this.hitContext.globalAlpha = 1,
        this.hitContext.fillStyle = b) : "stroke" == a ? (this.hitContext.globalAlpha = 1,
        this.hitContext.strokeStyle = b,
        "undefined" === typeof d ? this.hitContext.lineWidth = c.strokeWidth + 2 : isNaN(d) || (this.hitContext.lineWidth = c.strokeWidth + 2 / d)) : (this.hitContext.globalAlpha = 0,
        ...
        if (!1 !== b.graphic)
            if (b.externalGraphic)
                ...
                if (!isNaN(a) && !isNaN(d)) {
                    var e = 2 * Math.PI
                      , f = b.pointRadius;
                    !1 !== b.fill && (this.setCanvasStyle("fill", b),
                    this.canvas.beginPath(),
                    this.canvas.arc(a, d, f, 0, e, !0),
                    this.canvas.fill(),
                    this.hitDetection && (this.setHitContextStyle("fill", c, b),
                    this.hitContext.beginPath(),
                    this.hitContext.arc(a, d, f, 0, e, !0),
                    this.hitContext.fill()));
                    !1 !== b.stroke && (this.setCanvasStyle("stroke", b),
                    this.canvas.beginPath(),
                    this.canvas.arc(a, d, f, 0, e, !0),
                    this.canvas.stroke(),
                    this.hitDetection && (this.setHitContextStyle("stroke", c, b),
                    this.hitContext.beginPath(),
                    this.hitContext.arc(a, d, f, 0, e, !0),
                    this.hitContext.stroke()),
                    this.setCanvasStyle("reset"))
    ...
    drawLineString: function(a, b, c) {
        b = OpenLayersForProjection.Util.applyDefaults({
            fill: !1
        }, b);
        this.drawLinearRing(a, b, c)
    },
    ...
    drawPolygon: function(a, b, c) {
        ...
        for (var e = 1; e < d; ++e)
            ...
            this.drawLinearRing(a[e], OpenLayersForProjection.Util.applyDefaults({
                stroke: !1,
                fillOpacity: 1
            }, b), c),
    ...
    drawText: function(a, b) {
        ...
        if (this.canvas.fillText) {
            ...
            this.canvas.textBaseline = OpenLayersForProjection.Renderer.Canvas.LABEL_ALIGN[b.labelAlign[1]] || "middle";
            ...
            c[1] += d * g * (f - 1);
            for (g = 0; g < f; g++)
                b.labelOutlineWidth && (this.canvas.save(),
    ...
    getFeatureIdFromEvent: function(a) {
        var b;
        if (this.hitDetection && "none" !== this.root.style.display && !this.map.dragging && (a = a.xy,
    ...
    redraw: function() {
        if (!this.locked) {
            ...
            for (f in this.features)
                this.features.hasOwnProperty(f) && (b = this.features[f][0],
                c = b.geometry,
...
OpenLayersForProjection.Renderer.Canvas.LABEL_ALIGN = {
    l: "left",
    r: "right",
    t: "top",
    b: "bottom"
};
OpenLayersForProjection.Renderer.Canvas.LABEL_FACTOR = {
    l: 0,
    r: -1,
    t: 0,
    b: -1
...
OpenLayersForProjection.Renderer.SVG = OpenLayersForProjection.Class(OpenLayersForProjection.Renderer.Elements, {
    ...
    initialize: function(a) {
        this.supported() && (OpenLayersForProjection.Renderer.Elements.prototype.initialize.apply(this, arguments),
    ...
    createImagePattern: function(a, b, c) {
        if (this.container && this.container.id) {
            ...
            if (!e) {
                ...
                f.onload = OpenLayers.Function.bind(function() {
                    ...
                    var f = this.nodeFactory(null, "image");
                    e.appendChild(f);
    ...
    setStyle: function(a, b, c) {
        "circle" == a.nodeName && (b.pointRadius || (b.pointRadius = 6),
        b.pointerEvents || (b.pointerEvents = "visiblePainted"));
        b = b || a._style;
        c = c || a._options;
        ...
        if (d) {
            ...
            0 < e.length ? e[0].firstChild.textContent = d : (e = this.nodeFactory(null, "title"),
            e.textContent = d,
            a.appendChild(e))
        }
        ...
        if (-1 !== a._geometryClass.indexOf("Geometry.Point") && e) {
            ...
            if (!1 === b.graphic)
                ...
                var e = b.graphicWidth || b.size || 30
                  , g = b.graphicHeight || b.size || 30
                  , e = e ? e : 2 * b.pointRadius
                  , g = g ? g : 2 * b.pointRadius
                  , h = void 0 != b.graphicYOffset ? b.graphicYOffset : -(.5 * g)
                ...
                var e = 3 * b.pointRadius
                  , g = 2 * e
                  , l = null;
                Nigsys.graphicIsFont(b.graphicName) ? (l = StyleEditor.drawRuleFontImageOnWFS(b),
                d = 1,
                a.setAttributeNS(null, "viewBox", "-10 -10 30 30"),
                a.firstChild && a.removeChild(a.firstChild),
                a.appendChild(l)) : (l = this.importSymbol(b.graphicName),
            ...
            e = b.rotation;
            void 0 === e && void 0 === a._rotation || !f || (a._rotation = e,
            e |= 0,
            "svg" !== a.nodeName ? a.setAttributeNS(null, "transform", "rotate(" + e + " " + f.x + " " + f.y + ")") : (f = this.symbolMetrics[l.id]) ? a.firstChild.setAttributeNS(null, "transform", "rotate(" + e + " " + f[1] + " " + f[2] + ")") : a.firstChild.setAttributeNS(null, "transform", "rotate(" + e + " 5 5)"))
        }
        c.isFilled ? b.externalGraphic ? (g = b.size ? b.size : b.pointRadius,
        f = OpenLayersForProjection.Renderer.SVG.prototype.createImagePattern(b, g, g),
        a.setAttributeNS(null, "fill", "url(#" + f + ")"),
        a.setAttributeNS(null, "fill-opacity", b.graphicOpacity)) : b.graphicName && -1 !== b.graphicName.indexOf("shape://") && "OpenLayers.Geometry.Polygon" === a._geometryClass ? (OpenLayersForProjection.Console.error("WellKnownName is not yet supported as GraphicFill by the SVG renderer!"),
        b.externalGraphic = applicationUrl + "resources/img/pattern.png?" + Imajnet.version,
        f = OpenLayersForProjection.Renderer.SVG.prototype.createImagePattern(b, 58, 58),
        a.setAttributeNS(null, "fill", "url(#" + f + ")"),
        a.setAttributeNS(null, "fill-opacity", b.patternstrokeOpacity)) : (a.setAttributeNS(null, "fill", b.fillColor),
        a.setAttributeNS(null, "fill-opacity", b.fillOpacity)) : a.setAttributeNS(null, "fill", "none");
        c.isStroked ? (a.setAttributeNS(null, "stroke", b.strokeColor),
        ...
        b.strokeDashstyle && a.setAttributeNS(null, "stroke-dasharray", this.dashStyle(b, d))) : a.setAttributeNS(null, "stroke", "none");
    ...
    drawCircle: function(a, b, c) {
        ...
        b = this.top - b.y / d;
        return this.inValidRange(e, b) ? (a.setAttributeNS(null, "cx", e),
    ...
    importSymbol: function(a) {
        ...
        a.appendChild(e);
        for (var c = new OpenLayersForProjection.Bounds(Number.MAX_VALUE,Number.MAX_VALUE,0,0), f = [], g, h, k = 0; k < d.length; k += 2)
            g = d[k],
            h = d[k + 1],
    ...
    drawText: function(a, b, c) {
        ...
        !0 === b.labelSelect ? (f.setAttributeNS(null, "pointer-events", "visible"),
        f._featureId = a) : f.setAttributeNS(null, "pointer-events", "none");
        ...
        for (var l = 0; l < k; l++) {
            ...
            !0 === b.labelSelect && (m._featureId = a,
            m._geometry = c,
...
OpenLayersForProjection.Renderer.SVG.LABEL_ALIGN = {
    l: "start",
    r: "end",
    b: "bottom",
    t: "hanging"
};
OpenLayersForProjection.Renderer.SVG.LABEL_VFACTOR = {
    t: 0,
    b: -1
};
OpenLayersForProjection.Renderer.VML = OpenLayersForProjection.Class(OpenLayersForProjection.Renderer.Elements, {
    ...
    initialize: function(a) {
        if (this.supported()) {
            ...
            OpenLayersForProjection.Renderer.Elements.prototype.initialize.apply(this, arguments)
        }
    },
    supported: function() {
    ...
    setStyle: function(a, b, c, d) {
        ...
        if ("OpenLayers.Geometry.Point" === a._geometryClass)
            if (b.externalGraphic) {
                ...
                var e = b.graphicWidth || b.graphicHeight
                  ...
                  , f = f ? f : 2 * b.pointRadius
                  , g = this.getResolution()
                  , h = void 0 != b.graphicXOffset ? b.graphicXOffset : -(.5 * e)
                  , k = void 0 != b.graphicYOffset ? b.graphicYOffset : -(.5 * f);
                ...
                this.isComplexSymbol(b.graphicName) ? (f = this.importSymbol(b.graphicName),
                a.path = f.path,
                a.coordorigin = f.left + "," + f.bottom,
                f = f.size,
                a.coordsize = f + "," + f,
                this.drawCircle(a, d, b.pointRadius),
                a.style.flip = "y") : this.drawCircle(a, d, b.pointRadius);
        c.isFilled ? a.fillcolor = e : a.filled = "false";
        d = a.getElementsByTagName("fill");
        d = 0 == d.length ? null : d[0];
        c.isFilled ? (d || (d = this.createNode("olv:fill", a.id + "_fill")),
        d.opacity = b.fillOpacity,
        "OpenLayers.Geometry.Point" === a._geometryClass && b.externalGraphic && (b.graphicOpacity && (d.opacity = b.graphicOpacity),
        d.src = b.externalGraphic,
        d.type = "frame",
        b.graphicWidth && b.graphicHeight || (d.aspect = "atmost")),
        d.parentNode != a && a.appendChild(d)) : d && a.removeChild(d);
        e = b.rotation;
        if (void 0 !== e || void 0 !== a._rotation)
            a._rotation = e,
            b.externalGraphic ? (this.graphicRotate(a, h, k, b),
            d.opacity = 0) : "OpenLayers.Geometry.Point" === a._geometryClass && (a.style.rotation = e || 0);
        h = a.getElementsByTagName("stroke");
        h = 0 == h.length ? null : h[0];
        c.isStroked ? (h || (h = this.createNode("olv:stroke", a.id + "_stroke"),
        a.appendChild(h)),
        h.on = !0,
        ...
        b.strokeDashstyle && (h.dashstyle = this.dashStyle(b))) : (a.stroked = !1,
        h && (h.on = !1));
...
OpenLayersForProjection.Event = {
    ...
    findElement: function(a, b) {
        for (var c = OpenLayersForProjection.Event.element(a); c.parentNode && (!c.tagName || c.tagName.toUpperCase() != b.toUpperCase()); )
            c = c.parentNode;
        return c
    },
    ...
    stopObserving: function(a, b, c, d) {
        ...
        var f = !1
          , g = OpenLayersForProjection.Event.observers[e];
        if (g)
    ...
    unloadCache: function() {
        if (OpenLayersForProjection.Event && OpenLayersForProjection.Event.observers) {
            for (var a in OpenLayersForProjection.Event.observers)
                OpenLayersForProjection.Event._removeElementObservers.apply(this, [OpenLayersForProjection.Event.observers[a]]);
            OpenLayersForProjection.Event.observers = !1
        }
    },
...
OpenLayersForProjection.Events = OpenLayersForProjection.Class({
    ...
    destroy: function() {
        ...
        this.element && (OpenLayersForProjection.Event.stopObservingElement(this.element),
        this.element.hasScrollEvent && OpenLayersForProjection.Event.stopObserving(window, "scroll", this.clearMouseListener));
    ...
    attachToElement: function(a) {
        this.element ? OpenLayersForProjection.Event.stopObservingElement(this.element) : (this.eventHandler = OpenLayersForProjection.Function.bindAsEventListener(this.handleBrowserEvent, this),
        this.clearMouseListener = OpenLayersForProjection.Function.bind(this.clearMouseCache, this));
        this.element = a;
        for (var b = !!window.navigator.msMaxTouchPoints, c, d = 0, e = this.BROWSER_EVENTS.length; d < e; d++)
            c = this.BROWSER_EVENTS[d],
            OpenLayersForProjection.Event.observe(a, c, this.eventHandler),
    ...
    register: function(a, b, c, d) {
        ...
        if (null != c) {
            ...
            e || (e = [],
            this.listeners[a] = e,
            this.extensionCount[a] = 0);
            b = {
                obj: b,
                func: c
            };
            d ? (e.splice(this.extensionCount[a], 0, b),
            "object" === typeof d && d.extension && this.extensionCount[a]++) : e.push(b)
        }
    },
    ...
    triggerEvent: function(a, b) {
        ...
        if (c && 0 != c.length) {
            ...
            b.type || (b.type = a);
            for (var c = c.slice(), d, e = 0, f = c.length; e < f && (d = c[e],
    ...
    getMousePosition: function(a) {
        this.includeXY ? this.element.hasScrollEvent || (OpenLayersForProjection.Event.observe(window, "scroll", this.clearMouseListener),
    ...
    addMsTouchListenerStart: function(a, b, c) {
        ...
        OpenLayersForProjection.Event.observe(a, "MSPointerDown", function(a) {
...
OpenLayersForProjection.Format.XML = OpenLayersForProjection.Class(OpenLayersForProjection.Format, {
    ...
    getAttributeNodeNS: function(a, b, c) {
        ...
        if (a.getAttributeNodeNS)
            ...
            for (var e, f, g = 0, h = a.length; g < h; ++g)
                if (e = a[g],
                e.namespaceURI == b && (f = e.prefix ? e.prefix + ":" + c : c,
                f == e.nodeName)) {
                    d = e;
                    break
                }
    ...
    contentType: function(a) {
        var b = !1
          , c = !1
          , d = OpenLayersForProjection.Format.XML.CONTENT_TYPE.EMPTY;
        for (a = a.firstChild; a; a = a.nextSibling) {
            switch (a.nodeType) {
            case 1:
                c = !0;
        ...
        if (c && b)
            d = OpenLayersForProjection.Format.XML.CONTENT_TYPE.MIXED;
        else {
            if (c)
                return OpenLayersForProjection.Format.XML.CONTENT_TYPE.COMPLEX;
            if (b)
                return OpenLayersForProjection.Format.XML.CONTENT_TYPE.SIMPLE
        }
        return d
    },
    ...
    setAttributeNS: function(a, b, c, d) {
        if (a.setAttributeNS)
            ...
            b ? (b = a.ownerDocument.createNode(2, c, b),
            b.nodeValue = d,
            a.setAttributeNode(b)) : a.setAttribute(c, d);
        else
    ...
    setAttributes: function(a, b) {
        var c, d, e;
        for (e in b)
            null != b[e] && b[e].toString && (c = b[e].toString(),
    ...
    writeNode: function(a, b, c) {
        var d, e = a.indexOf(":");
        0 < e ? (d = a.substring(0, e),
        a = a.substring(e + 1)) : d = c ? this.namespaceAlias[c.namespaceURI] : this.defaultPrefix;
    ...
    getXMLDoc: function() {
        OpenLayersForProjection.Format.XML.document || this.xmldom || (document.implementation && document.implementation.createDocument ? OpenLayersForProjection.Format.XML.document = document.implementation.createDocument("", "", null) : !this.xmldom && window.ActiveXObject && (this.xmldom = new ActiveXObject("Microsoft.XMLDOM")));
...
OpenLayersForProjection.Format.KML = OpenLayersForProjection.Class(OpenLayersForProjection.Format.XML, {
    ...
    parseLinks: function(a, b) {
        ...
        for (var d = 0, e = a.length; d < e; d++) {
            ...
            f && !this.fetched[f] && (this.fetched[f] = !0,
    ...
    parseStyle: function(a) {
        for (var b = {}, c = ["LineStyle", "PolyStyle", "IconStyle", "BalloonStyle", "LabelStyle"], d, e, f = 0, g = c.length; f < g; ++f)
            if (d = c[f],
            e = this.getElementsByTagNameNS(a, "*", d)[0])
                ...
                case "iconstyle":
                    ...
                    if (l) {
                        ...
                        if (m) {
                            ...
                            !OpenLayersForProjection.String.startsWith(m, "http://maps.google.com/mapfiles/kml") || n || p || (p = n = 64,
                            h /= 2);
                            n = n || p;
                            p = p || n;
                            n && (d = parseInt(n) * h);
                    ...
                    break;
                case "balloonstyle":
                    (e = OpenLayersForProjection.Util.getXmlNodeValue(e)) && (b.balloonStyle = e.replace(this.regExes.straightBracket, "${$1}"));
                    break;
                case "labelstyle":
                    if (d = this.parseProperty(e, "*", "color"),
    ...
    parseStyleMaps: function(a, b) {
        for (var c = 0, d = a.length; c < d; c++)
            for (var e = a[c], f = this.getElementsByTagNameNS(e, "*", "Pair"), e = e.getAttribute("id"), g = 0, h = f.length; g < h; g++) {
                ...
                (k = this.parseProperty(k, "*", "styleUrl")) && "normal" == l && (this.styles[(b.styleBaseUrl || "") + "#" + e] = this.styles[(b.styleBaseUrl || "") + k])
            }
    },
    parseFeatures: function(a, b) {
        for (var c = [], d = 0, e = a.length; d < e; d++) {
            ...
            if (g) {
                ...
                this.readNode(f[0], g),
                0 < g.features.length && c.push.apply(c, g.features)) : c.push(g)
            } else
    ...
    getStyle: function(a, b) {
        var c = OpenLayersForProjection.Util.removeTail(a)
          , d = OpenLayersForProjection.Util.extend({}, b);
        d.depth++;
        d.styleBaseUrl = c;
    ...
    parseGeometry: {
        point: function(a) {
            ...
            if (1 < a.length)
                2 == a.length && (a[2] = null),
                b = new OpenLayersForProjection.Geometry.Point(a[0],a[1],a[2]);
            else
        ...
        linestring: function(a, b) {
            ...
            if (0 < c.length) {
                for (var c = this.getChildValue(c[0]), c = c.replace(this.regExes.trimSpace, ""), c = c.replace(this.regExes.trimComma, ","), d = c.split(this.regExes.splitSpace), e = d.length, f = Array(e), g, h, k = 0; k < e; ++k)
                    ...
                    1 < h)
                        2 == g.length && (g[2] = null),
                        f[k] = new OpenLayersForProjection.Geometry.Point(g[0],g[1],g[2]);
                    else
                        throw "Bad LineString point coordinates: " + d[k];
                if (e)
                    d = b ? new OpenLayersForProjection.Geometry.LinearRing(f) : new OpenLayersForProjection.Geometry.LineString(f);
                else
        ...
        multigeometry: function(a) {
            for (var b, c = [], d = a.childNodes, e = 0, f = d.length; e < f; ++e)
                a = d[e],
                1 == a.nodeType && (b = a.prefix ? a.nodeName.split(":")[1] : a.nodeName,
    ...
    parseAttributes: function(a) {
        ...
        for (var c = 0, g = a.length; c < g; ++c)
            if (d = a[c],
            1 == d.nodeType && (e = d.childNodes,
            1 <= e.length && 3 >= e.length)) {
                switch (e.length) {
                case 1:
                    f = e[0];
                    break;
                ...
                if (3 == f.nodeType || 4 == f.nodeType)
                    if (d = d.prefix ? d.nodeName.split(":")[1] : d.nodeName,
                    f = OpenLayersForProjection.Util.getXmlNodeValue(f))
    ...
    parseExtendedData: function(a) {
        ...
        for (d = g.length; c < d; c++) {
            ...
            this.kvpAttributes ? b[f] = h.value : (e = e.getElementsByTagName("displayName"),
        ...
        for (d = a.length; c < d; c++)
            ...
            this.kvpAttributes ? b[f] = h.value : (h.displayName = f,
            b[f] = h);
        return b
    },
    ...
    createFolderXML: function() {
        ...
        this.foldersDesc && (b = this.createElementNS(this.kmlns, "description"),
    ...
    buildCoordinates: function(a) {
        this.internalProjection && this.externalProjection && (a = a.clone(),
        ...
        for (c in a)
            if (a[c] && "name" != c && "description" != c && "styleUrl" != c) {
                ...
                if ("object" == typeof a[c]) {
                    if (a[c].value && e.appendChild(this.createTextNode(a[c].value)),
                    a[c].displayName) {
...
var ImageControler = {
    ...
    setCurrentImageControl: function(a) {
        a.type && "FLAT" != a.type ? "CUBE" == a.type && (ImageControler.currentImageType = "CUBE",
        ImageControler.currentImageControl = CubeImage,
        ImageControler.currentSurveyTrace = CubeSurveyTrace,
        ImageControler.currentPhotogrammetry = CubePhotogrammetry,
        ImageControler.currentGraphic = CubeGraphic) : (ImageControler.currentImageType = "FLAT",
        ImageControler.currentImageControl = FlatImage,
        ImageControler.currentSurveyTrace = FlatSurveyTrace,
        ImageControler.currentPhotogrammetry = FlatPhotogrammetry,
        ImageControler.currentGraphic = FlatGraphic)
    }
};
function animate() {
...
var CubePlugin = {
    ...
    init: function() {
        ...
        this.pinPointsObject = new THREE.Object3D;
        ...
        this.renderer.domElement.id = "cubeContainer";
        ...
        jQuery("#cubeContainer").swipe({
            ...
            threshold: 10,
            pinchIn: function(a, b, d, e, f, h, g) {
                ...
                for (b = 0; b < d; b++)
                    CubePlugin.onDocumentMouseWheel(a, !0, 1)
            },
    ...
    loadCubeImages: function(a) {
        for (var c = this.getFaceOrderFromAngle(), b = 0; b < c.length; b++)
            this.changeFaceImage(c[b], a)
    },
    ...
    getRealImageCoordinatesFromMousePosition: function(a, c) {
        var b = CubePlugin.getIntersection(CubePlugin.scene, a, c)
          , d = CubePlugin.getFaceFromPoint(b)
    ...
    getCubeCoordinatesFromEvent: function(a) {
        return (a = CubePlugin.getIntersection(CubePlugin.scene, a.originalEvent.offsetX, a.originalEvent.offsetY)) ? a.point : null
    },
    getFaceFromPoint: function(a) {
        if (a)
            return this.cubeFacesArray[a.face.materialIndex]
    },
    ...
    setRotationLimit: function(a) {
        a && a.orientation && (a = a.orientation.viewAngle - this.FOV,
        this.maxRotation.left = -a / 2,
        this.maxRotation.right = a / 2)
    },
    onDocumentMouseClick: function(a) {
        if (1 == CubePlugin.mouseMoved)
            CubePlugin.mouseMoved = !1;
        else {
            var c = CubePlugin.getIntersection(CubePlugin.scene, a.offsetX, a.offsetY)
              , b = c.point
              , d = Math.acos(b.y / Math.hypot(b.x, b.y, b.z))
              , b = THREE.Math.radToDeg(Math.atan2(b.z, b.x))
            ...
            switch (ImajnetUI.activeControlButton) {
            case "imajnetPosition":
                ImajnetPosition.positionObject(c.x, c.y, {
                    face: d
                });
                break;
            case "imajnetMeasurement":
                ImajnetMeasurement.measureObject(c.x, c.y, {
                    face: d
                });
                break;
            case "imajnetPolyligne":
                ImajnetMeasurement.onClick(c.x, c.y, {
                    face: d
                })
            }
            ImageControler.currentPhotogrammetry.clearCommentTextarea(a)
    ...
    onDocumentMouseMove: function(a) {
        if (!0 === CubePlugin.isUserInteracting) {
            CubePlugin.mouseMoved = !0;
            var c = CubePlugin.cubeContainer.width() / CubePlugin.cubeContainer.height()
              , c = 500 / CubePlugin.cubeContainer.width() * c
              , b = CubePlugin.camera.fov / 4
              , b = .008 * b + 5E-4 * (b - 1)
    ...
    onDocumentTouchStart: function(a) {
        ...
        CubePlugin.onPointerDownPointerX = a.touches[0].pageX,
        CubePlugin.onPointerDownPointerY = a.touches[0].pageY,
        CubePlugin.onPointerDownLon = CubePlugin.yow,
        CubePlugin.onPointerDownLat = CubePlugin.pitch)
    },
    ...
    onDocumentMouseWheel: function(a, c, b) {
        b || (b = Nigsys.getDelta(a, b));
        if (!c && !ImajnetZoom.canZoom() && !ImajnetZoom.isZoomMode())
            0 < b ? ImageControler.currentImageControl.getNext(!1) : ImageControler.currentImageControl.getPrevious(!1);
        else if (b) {
            if (a = CubePlugin.getIntersection(CubePlugin.scene, a.originalEvent.offsetX, a.originalEvent.offsetY)) {
                a = a.point;
                if (0 < b) {
                    if (ImajnetZoom.zoomLevel >= ImajnetZoom.maxZoomLevel)
                        return;
                    ImajnetZoom.zoomLevel++;
                    if (4 == CubePlugin.camera.fov)
                        return;
                    ImajnetZoom.firstZoom && (CubePlugin.loadCubeImages("high"),
                    ImajnetZoom.firstZoom = !1);
                    ...
                    var d = Math.abs(a - CubePlugin.pitch)
                      , d = d / (CubePlugin.camera.fov / 2)
    ...
    onWindowResize: function() {
        ...
        CubePlugin.camera.updateProjectionMatrix();
        CubePlugin.renderer.setSize(this.container.innerWidth(), this.container.innerHeight())
    },
    update: function() {
...
var ImageControl = {
    ...
    doOnLoadImage: function(a, b) {
        ...
        if (ImajnetZoom.canZoom())
            ...
            c.resolve(!1),
            c.promise();
        if (!ImajnetAPI.isImageValid(a.id))
            return c.resolve(!1),
            c.promise();
        ImajnetZoom.firstZoom = !0;
    ...
    doRequests: function(a) {
        ...
        LRS.loadLRS(a);
        Nigsys.isPositionMode() ? (ImageControler.currentPhotogrammetry.firstImagePosition && ImageControler.currentPhotogrammetry.firstImagePosition.traceId != ImajnetMap.currentPosition.traceId ? ImajnetPosition.reload() : ImajnetPosition.showHidePositionDenied(),
        ImajnetImageSwitcher.initSliderImagesDimension()) : Nigsys.isMeasurementMode() ? ImageControler.currentPhotogrammetry.firstImagePosition && ImageControler.currentPhotogrammetry.firstImagePosition.traceId != ImajnetMap.currentPosition.traceId ? ImajnetMeasurement.reload() : ImajnetMeasurement.showHideMeasurementDenied() : Nigsys.isPolyligneMode() ? ImageControler.currentPhotogrammetry.firstImagePosition && ImageControler.currentPhotogrammetry.firstImagePosition.traceId != ImajnetMap.currentPosition.traceId ? ImajnetPolyligne.reload() : ImajnetPolyligne.showHideDenied() : ImajnetImageSwitcher.show();
    ...
    setCurrentImage: function(a, b) {
        ...
        ImajnetAPI.clearHorizontalAngle();
        Nigsys.isPositionMode() || Nigsys.isMeasurementMode() || Nigsys.isPolyligneMode() || ImajnetZoom.deactivateZoom();
        this.imageChange(a);
        a ? (b && (b.requestUrl && ImajnetUI.appendImage(b.requestUrl),
        b.materials && CubePlugin.addCube(b.materials)),
        ImajnetUI.showImajnetControls(),
        ImajnetAPI.orderedImagesId.length && a.id != ImajnetAPI.orderedImagesId[ImajnetAPI.orderedImagesId.length - 1] || ImageControler.currentImageControl.isFastNavigation || ImageControler.currentImageControl.doRequests(a)) : (ImajnetUI.hideImageElements(),
        ImajnetMap.hideOrientation());
        Nigsys.hideLoading(ImajnetUI.imageContainer);
        ImajnetMap.setImajboxMarkerPosition({
            position: a
...
FlatImage.loadImage = function(a) {
    var c = ""
      , b = a.position;
    b ? (c = ImajnetAPI.buildImageURL(b),
    ...
    ,
    a.onload = function() {
        ImageControler.currentImageControl.doOnLoadImage(b, {
            requestUrl: c
        })
    }
    ,
    a.src = c,
    ImajnetUI.imagesLoadQueue.push(a)) : ImajnetAPI.loadDefaultImage(null)
}
;
FlatImage.doOnLoadImage = function(a, c) {
    ImageControl.doOnLoadImage(a, c).done(function(b) {
        b && (CubeImage.hidecubeContainer(),
        FlatImage.showImageSliderContainer(),
        ImajnetImageSwitcher.rotateImageSwitcher(0),
        FlatImage.setCurrentImage(a, c))
    })
}
;
...
CubeImage.loadImage = function(a) {
    ...
    if (b) {
        ImajnetAPI.imageLoadQueue.push(b.id);
        if (CubePlugin.cubeMesh)
            CubePlugin.loadCubeImages();
        else {
            CubePlugin.init();
            animate();
            var c = Array(6)
              , d = [];
            for (a = 0; a < CubePlugin.cubeFacesArray.length; a++)
                d.push(CubePlugin.getMaterialFromUrlDeferred(ImajnetAPI.buildImageURL(b, null, CubePlugin.cubeFacesArray[a]), {
                    position: a
                }).done(function(a, b) {
                    c[b.position] = a
                }))
        ...
        ImajnetAPI.loadDefaultImage(null)
}
;
CubeImage.doOnLoadImage = function(a, b) {
    ImageControl.doOnLoadImage(a, b).done(function(c) {
        c && (CubePlugin.setRotationLimit(a),
        FlatImage.hideImageSliderContainer(),
        CubeImage.showcubeContainer(),
        ImageControler.currentImageControl.setCurrentImage(a, b))
    })
}
;
...
var SurveyTrace = {
    ...
    draw: function(a) {
        ...
        a && (!SurveyTrace.surveyTraceIsActive || Nigsys.isPositionMode() || Nigsys.isMeasurementMode() || Nigsys.isPolyligneMode() || this.getSurveyTrace(a.id, {
            draw: !0
        }),
        this.currentPositionId = a.id,
        this.viewerCurrentPosition = a,
        ImageControler.currentSurveyTrace.customDraw())
    },
    showHideSurveyTrace: function() {
        SurveyTrace.surveyTraceIsActive ? this.hideTrace() : this.getSurveyTrace(this.currentPositionId, {
            draw: !0
        });
    ...
    getSurveyTrace: function(a, b) {
        if (!(Nigsys.isPositionMode() || Nigsys.isMeasurementMode() || Nigsys.isPolyligneMode()) && (ImajnetZoom.deactivateZoom(),
        ImajnetAPI.mustAbortRequests && null !== this.surveyTraceAjaxRequest && this.surveyTraceAjaxRequest.abort(),
        a)) {
            var c = {
                position: {
                    id: a
    ...
    surveyTraceReceived: function(a, b) {
        ...
        b.draw ? (jQuery("#imajnetTraceSurveyButtonContainer").addClass("buttonActive"),
        ImageControler.currentSurveyTrace.drawSurveyTrace(a)) : (ImageControler.currentSurveyTrace.projections = a.projections,
        ImageControler.currentSurveyTrace.positions = a.positions,
        ImageControler.currentSurveyTrace.goToClickPosition(b.event))) : ImageControler.currentSurveyTrace.surveyTraceError()
    },
    ...
    calculateOrientationIndex: function(a, b) {
        var c = this.computeImageAngle(a, b)
          , c = Math.round(c / 45);
        return 8 == c ? 0 : c
    },
    getPositionByIndexInArray: function(a) {
    ...
    clearSurveyTraceMapMarkerIfNeeded: function() {
        this.mustClearSequenceTraceMapMarker && this.hideSequenceTraceMapMarker()
    },
...
FlatSurveyTrace.restoreTrace = function() {
    !this.container || Nigsys.isPositionMode() || Nigsys.isMeasurementMode() || Nigsys.isPolyligneMode() || (this.container.html(this.currentSurveyTraceHTML),
    jQuery("#imajnetTraceSurveyButtonContainer").addClass("buttonActive"))
}
;
FlatSurveyTrace.hideTrace = function() {
    jQuery("#imajnetTraceSurveyButtonContainer").removeClass("buttonActive");
    null !== this.container && ("" != this.container.html() && (this.currentSurveyTraceHTML = this.container.html()),
    this.container.html(""))
}
;
...
FlatSurveyTrace.drawSurveyTrace = function(a) {
    if (!(Nigsys.isPositionMode() || Nigsys.isMeasurementMode() || Nigsys.isPolyligneMode()) && (this.container && this.container.html(""),
    void 0 === a ? a = this.currentSurveyTraceResponse : this.currentSurveyTraceResponse = a,
    SurveyTrace.realImageSize && a.projections && a.positions)) {
...
FlatSurveyTrace.onImageDbClick = function(a) {
    SurveyTrace.surveyTraceIsActive ? ImageControler.currentSurveyTrace.goToClickPosition(a) : ImageControler.currentSurveyTrace.getSurveyTrace(ImajnetMap.currentPosition.id, {
        event: a
    })
}
;
FlatSurveyTrace.goToClickPosition = function(a) {
    if (ImageControler.currentSurveyTrace.positions) {
        ...
        for (var f = ImajnetZoom.getRealImageSize().height, k = ImajnetMap.currentPosition.traceId, c = null, d = 999999, e = 0; e < ImageControler.currentSurveyTrace.positions.length; e++)
            if (k == ImageControler.currentSurveyTrace.positions[e].traceId) {
                var b = Math.abs(ImageControler.currentSurveyTrace.projections[e].coordinates.y - a.y);
                !(b > f) && b < d && (c = ImageControler.currentSurveyTrace.positions[e],
                d = b)
            }
        ImajnetAPI.setImajnetImage({
            position: c
...
var Photogrammetry = {
    ...
    onFeatureMouseOver: function(a, b, c) {
        ...
        d || a.getType() != ImajnetMap.MARKER_TYPE_POSITION && a.getType() != ImajnetMap.MARKER_TYPE_POLYLIGNE_POSITION && a.getType() != ImajnetMap.MARKER_TYPE_TARGET_POINT ? (ImajnetPlugin.selectFeature(ImajnetMap.imajnetDragFeaturesLayer, a),
        ImajnetPlugin.selectPolygonFeature(ImajnetMap.imajnetDragFeaturesLayer, a),
        ImajnetPlugin.setFeatureColor(ImajnetMap.imajnetDragFeaturesLayer, a, Nigsys.hoverObjectsColor),
        ImajnetPlugin.setFeatureStrokeColor(ImajnetMap.imajnetDragFeaturesLayer, a, Nigsys.hoverObjectsColor)) : ImajnetPlugin.selectMarker(ImajnetMap.photogrammetryPositionsLayer, a);
        ImajnetPlugin.onFeatureMouseOver(a, b, c)
    },
    onFeatureMouseOut: function(a) {
        var b = ImajnetPolyligne.isPolyligneObject(a.getId());
        b && (a = ImajnetMap.getPolyligneFeatureWrapper(a));
        b || a.getType() != ImajnetMap.MARKER_TYPE_POSITION && a.getType() != ImajnetMap.MARKER_TYPE_POLYLIGNE_POSITION && a.getType() != ImajnetMap.MARKER_TYPE_TARGET_POINT ? (ImajnetPlugin.unselectFeature(ImajnetMap.imajnetDragFeaturesLayer, a),
        ImajnetPlugin.unselectPolygonFeature(ImajnetMap.imajnetDragFeaturesLayer, a),
        ImajnetPlugin.setFeatureColor(ImajnetMap.imajnetDragFeaturesLayer, a, Nigsys.defaultObjectsColor),
        ImajnetPlugin.setFeatureStrokeColor(ImajnetMap.imajnetDragFeaturesLayer, a, Nigsys.defaultObjectsColor)) : ImajnetPlugin.unselectMarker(ImajnetMap.photogrammetryPositionsLayer, a);
    ...
    onPhotogrammetryItemMouseOver: function(a, b, c, d) {
        ...
        e && (ImageControler.currentPhotogrammetry.showLRS(b, d, a, c),
        ImajnetPlugin.highlightFeatureOnImage(e),
        ImageControler.currentPhotogrammetry.onFeatureMouseOver(e, b, d))
    },
    onPhotogrammetryItemMouseOut: function(a) {
        var b = ImajnetMap.getFeatureWrapperById(a);
        b && (jQuery("#imajnetPhotogrammetryLRS_" + a).hide(),
        ImajnetPlugin.unHighlightFeatureOnImage(b),
        ImageControler.currentPhotogrammetry.onFeatureMouseOut(b))
    },
    onPhotogrammetryItemClick: function(a) {
        ImageControler.currentPhotogrammetry.zoomToObject(a)
    },
    init: function() {
        if (!this.objects.length && (this.clipboardEmpty(),
        Photogrammetry.clipboardActive)) {
            var a = Nigsys.getCookie("IMAJNET", "CLIPBOARD");
            Nigsys.setCookie("IMAJNET", "CLIPBOARD", null);
            if (a)
                for (var b = 0; b < a.length; b++)
                    for (var c = 0; c < a[b].data.length; c++) {
    ...
    enableClipboard: function() {
        Photogrammetry.clipboardActive = !0
    },
    ...
    getExportContent: function() {
        return '\x3cdiv\x3e\x3cdiv class\x3d"popupContentContainer optionsGroup"\x3e\x3cdiv class\x3d"popupContentContainerTitle"\x3e' + jQuery.imajnet.map.clipboard.popupExport.email + '\x3c/div\x3e\x3cdiv\x3e\x3cdiv class\x3d"leftLabel left"\x3e' + jQuery.imajnet.map.clipboard.popupExport.from + ':\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left"\x3e\x3cinput type\x3d"text" id\x3d"imajnetExportFrom" value\x3d"' + ImajnetUser.getEmail() + '" /\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv id\x3d"imajnetExportToContainer"\x3e\x3cb\x3e' + this.exportToItemContent + '\x3c/b\x3e\x3cdiv class\x3d"left"\x3e\x3cinput type\x3d"button" value\x3d"+" onclick\x3d"ImageControler.currentPhotogrammetry.exportAddToItem();" /\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"popupContentContainerTitle"\x3e' + jQuery.imajnet.map.clipboard.popupExport.message + '\x3c/div\x3e\x3cdiv\x3e\x3ctextarea id\x3d"imajnetExportMessage" rows\x3d"5" cols\x3d"45"\x3e\x3c/textarea\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"popupContentContainer optionsGroup"\x3e\x3cdiv class\x3d"popupContentContainerTitle" style\x3d"top: -13px;"\x3e' + jQuery.imajnet.map.clipboard.popupExport.fileType + '\x3c/div\x3e\x3cinput type\x3d"radio" name\x3d"imajnetExportType" value\x3d"kml" /\x3eKML\x26nbsp;\x3cinput type\x3d"radio" name\x3d"imajnetExportType" value\x3d"kmz" checked\x3d"checked" /\x3eKMZ\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"popupContentContainer optionsGroup"\x3e\x3cdiv class\x3d"popupContentContainerTitle" style\x3d"top: -11px;"\x3e' + jQuery.imajnet.map.clipboard.popupExport.exportStatus + '\x3c/div\x3e\x3cdiv id\x3d"imajnetExportStatus"\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv id\x3d"imajnetExportButtons"\x3e\x3cinput type\x3d"button" value\x3d"' + jQuery.imajnet.map.clipboard.popupExport.send + '" onclick\x3d"ImageControler.currentPhotogrammetry.exportObjects(true);" class\x3d"dialogButton buttonSend" /\x3e\x26nbsp;\x3cinput type\x3d"button" value\x3d"' + jQuery.imajnet.map.clipboard.popupExport.download + '" onclick\x3d"ImageControler.currentPhotogrammetry.exportObjects(false);" class\x3d"dialogButton buttonDownload" /\x3e\x3c/div\x3e\x3c/div\x3e'
    },
    getImageObjectList: function(a) {
        for (var b = 0; b < ImageControler.currentPhotogrammetry.objects.length; b++)
            if (void 0 !== a && ImageControler.currentPhotogrammetry.objects[b].positionId == a.id)
                return ImageControler.currentPhotogrammetry.objects[b].data;
        return null
    },
    getImagePreviousObject: function(a) {
        for (var b = 0; b < ImageControler.currentPhotogrammetry.objects.length; b++)
            for (var c = 0; c < ImageControler.currentPhotogrammetry.objects[b].data.length; c++)
                if (-1 !== jQuery.inArray(ImageControler.currentPhotogrammetry.objects[b].data[c].type, ImajnetPolyligne.typesArray) && ImageControler.currentPhotogrammetry.objects[b].data[c].id == a - 1)
                    return ImageControler.currentPhotogrammetry.objects[b].data[c];
        return null
    },
    ...
    getImageObjectLinkToNext: function(a, b) {
        for (var c = [], d = 0; d < ImageControler.currentPhotogrammetry.objects.length; d++)
            for (var e = 0; e < ImageControler.currentPhotogrammetry.objects[d].data.length; e++)
                -1 !== jQuery.inArray(ImageControler.currentPhotogrammetry.objects[d].data[e].type, ImajnetPolyligne.typesArray) && ImageControler.currentPhotogrammetry.objects[d].data[e].type == b && (ImageControler.currentPhotogrammetry.objects[d].data[e].id == a + 1 ? c.push(ImageControler.currentPhotogrammetry.objects[d].data[e]) : ImageControler.currentPhotogrammetry.objects[d].data[e].id == a - 1 && c.push(ImageControler.currentPhotogrammetry.objects[d].data[e]));
        return c
    },
    getMesurementValueById: function(a) {
        for (var b = 0; b < this.objects.length; b++)
            for (var c = 0; c < this.objects[b].data.length; c++)
                if (this.objects[b].data[c].id == a && this.objects[b].data[c].measurementResult && this.objects[b].data[c].measurementResult.measurement)
                    return this.objects[b].data[c].measurementResult.measurement;
        return ""
    },
    objectIsMeasurement: function(a) {
        for (var b = 0; b < this.objects.length; b++)
            for (var c = 0; c < this.objects[b].data.length; c++)
                if (this.objects[b].data[c].id == a && this.objects[b].data[c].photogrammetryPosition3D)
                    return !0;
        return !1
    },
    objectIsDifferentTracePinPointProjection: function(a) {
        if (ImajnetMap.currentPosition) {
            for (var b = 0; b < this.existingProjections.length; b++)
                if (this.existingProjections[b].parameter.pointOfView.id == ImajnetMap.currentPosition.id && this.existingProjections[b].projection.shapeProjections)
                    for (var c = 0; c < this.existingProjections[b].projection.shapeProjections.length; c++)
                        if (this.existingProjections[b].projection.shapeProjections[c] && this.existingProjections[b].projection.shapeProjections[c].id == a && this.existingProjections[b].projection.shapeProjections[c].projections)
                            return !0;
            return !1
        }
    },
    getPanelCoordinatesFromHighCoordinates: function(a) {
        var b = ImajnetUI.previewImageContainer.width()
          , c = ImajnetUI.previewImageContainer.height();
        return {
            x: a.x / (ImajnetZoom.HIGH_RESOLUTION_WIDTH / b),
            y: a.y / (ImajnetZoom.HIGH_RESOLUTION_HEIGHT / c)
        }
    },
    getPreviewPanelPoint: function(a, b, c) {
        ...
        return {
            x: a.x - Math.abs(c.left),
            y: a.y - Math.abs(c.top)
        }
    },
    getImageIndexInCacheArrayByImageId: function(a) {
        for (var b = 0; b < ImageControler.currentPhotogrammetry.existingProjections.length; b++)
            if (ImageControler.currentPhotogrammetry.existingProjections[b].parameter.pointOfView.id == a)
                return ImageControler.currentPhotogrammetry.existingProjections[b];
        return null
    },
    ...
    getPositionFromObject: function(a) {
        return 0 == a.id || void 0 !== a.coordinates ? a.position : a.parameter.imagePoint ? a.parameter.imagePoint.img1 : a.parameter.imagePoint1.img1
    },
    getObjectById: function(a) {
        for (var b = 0; b < this.objects.length; b++)
            for (var c = 0; c < this.objects[b].data.length; c++)
                if (this.objects[b].data[c].id == a)
                    return this.objects[b].data[c];
        return null
    },
    setRedStep: function(a) {
        for (var b = 1; 3 >= b; b++)
            b == a ? (jQuery("#imajnetPreviewPanelItem" + b).addClass("redStep"),
            jQuery("#imajnetPreviewPanelItemArrow" + b).css("background-image", "url('" + Imajnet.imajnetPath + "img/imageIcons/arrowRight.png')")) : (jQuery("#imajnetPreviewPanelItem" + b).removeClass("redStep"),
    ...
    setIdByPosition: function(a) {
        var b = ""
          , c = ImageControler.currentPhotogrammetry.getImageObjectList(a);
        if (null !== c)
            for (var d = c.length - 1; -1 < d; d--) {
                var e = null;
                void 0 !== c[d].photogrammetryPosition3D ? e = c[d].photogrammetryPosition3D.coordinates : void 0 !== c[d].measurementResult ? e = Nigsys.getClosestPoint(ImajnetMap.currentPosition, c[d].measurementResult.firstPoint, c[d].measurementResult.secondPoint) : void 0 !== c[d].position && (e = c[d].position);
    ...
    setPreviewPanelVisibleRegion: function(a, b) {
        var c = ImajnetUI.previewImageContainer.width()
          , d = ImajnetUI.previewImageContainer.height()
          , e = c * b
          , f = d * b
          , h = this.getPanelCoordinatesFromHighCoordinates(a)
          , h = ImajnetZoom.getCoordinatesAtCurrentZoom(h, b)
          , g = h.x - c / 2;
    ...
    onResize: function(a, b) {
        ...
        Nigsys.isMeasurementMode() ? (ImajnetMeasurement.onImageResize(),
        this.drawConstraints()) : Nigsys.isPositionMode() ? this.drawConstraints() : this.redraw(!1)
    },
    showLRS: function(a, b, c, d) {
        var e = jQuery("#imajnetPhotogrammetryLRS_" + c);
        if (!e.length || "" != e.html())
            if (d == ImajnetUI.clipboardContainerId) {
                var f = jQuery("#LRSClipboard_" + c);
                0 != f.length ? (Nigsys.positionExistingElement(a, b, d, f),
                f.show()) : (c = '\x3cdiv id\x3d"LRSClipboard_' + c + '" class\x3d"photogrammetryClipboardPopup"\x3e' + e.html() + "\x3c/div\x3e",
                Nigsys.addElement(a, b, ImajnetUI.clipboardContainerId, c))
            } else
                Nigsys.positionExistingElement(a, b, d, e),
                e.show()
    },
    addImageTag: function(a) {
        ...
        a = {
            position: ImajnetMap.currentPosition,
            coordinates: ImajnetZoom.getRealImageCoordinates(a.clientX - b.left, a.clientY - b.top),
            type: ImajnetMap.MARKER_TYPE_IMAGE_TAG,
            linkToNext: !1
        };
        ...
        this.getObjectLRS({
            id: b.id,
            photogrammetryPosition3D: {
                coordinates: ImajnetMap.currentPosition
            }
        });
    ...
    showComment: function(a, b, c, d, e) {
        if (0 != c) {
            var f = jQuery("#LRSDoubleClickComment_" + c)
              , f = 0 != f.length ? f.html() : "";
            Nigsys.addElement(a, b, d, '\x3ctextarea id\x3d"' + e + c + '" class\x3d"textareaEditComment" onkeydown\x3d"ImageControler.currentPhotogrammetry.saveComment(event, \'' + c + "', '" + e + '\');" cols\x3d"25" style\x3d"height: 28px;"\x3e' + f + "\x3c/textarea\x3e");
    ...
    showCommentInClipboard: function(a, b) {
        ...
        var c = jQuery("#LRSDoubleClickComment_" + b)
          , c = 0 != c.length ? c.html() : ""
          , d = jQuery("textarea#textAreaEditClipboardComment_" + b);
        d.val(c);
        jQuery("#imajnetClipboardTextareaComment_" + b).show();
        d.focus()
    },
    ...
    saveComment: function(a, b, c) {
        ...
        13 == d ? (ImageControler.currentPhotogrammetry.appendCommentOnPhotogrammetryItemContainer(b, jQuery("textarea#" + c + b).val()),
        ImageControler.currentPhotogrammetry.updateCache(),
        "textareaEditComment_" == c ? jQuery("#" + c + b).remove() : ImageControler.currentPhotogrammetry.closeTextarea(b)) : 27 == d && (ImageControler.currentPhotogrammetry.closeTextarea(b),
        Nigsys.disableEventPropagation(a))
    },
    imageMouseMovePreviewPanel: function(a) {
        var b = ImajnetUI.imajnetImageContainer.offset();
        !(Nigsys.isPositionMode() && 2 == ImageControler.currentPhotogrammetry.currentStep || Nigsys.isMeasurementMode() && 2 == ImageControler.currentPhotogrammetry.currentStep || Nigsys.isPolyligneMode() && 0 == ImageControler.currentPhotogrammetry.currentStep % 2) || a.clientX - b.left >= ImajnetUI.imajnetImageContainerSize.width - ImajnetUI.previewImageContainer.width() && a.clientY - b.top >= ImajnetUI.imajnetImageContainerSize.height - ImajnetUI.previewImageContainer.height() ? ImajnetUI.previewImageContainer.hide() : ImageControler.currentPhotogrammetry.showPreviewPanel()
    },
    ...
    updateCache: function() {
        if (Photogrammetry.clipboardActive) {
            for (var a = [], b = 0; b < this.objects.length; b++) {
                for (var c = {
                    positionId: this.objects[b].positionId,
                    data: []
                }, d = 0; d < this.objects[b].data.length; d++)
                    this.objects[b].data[d].type != ImajnetMap.MARKER_TYPE_CLICKED_POINT && c.data.push(this.objects[b].data[d]);
    ...
    getLastObjectId: function() {
        for (var a = 1, b = 0; b < this.objects.length; b++)
            for (var c = 0; c < this.objects[b].data.length; c++)
                if (this.objects[b].data[c].id >= a && (a = this.objects[b].data[c].id + 1),
                this.objects[b].data[c].points)
                    for (var d = 0; d < this.objects[b].data[c].points.length; d++)
                        this.objects[b].data[c].points[d].id >= a && (a = this.objects[b].data[c].points[d].id + 1);
        return a
    },
    addObject: function(a, b, c, d, e) {
        ...
        0 != b.id || b.photogrammetryPosition3D.coordinates.height || (b.photogrammetryPosition3D.coordinates.height = 0);
    ...
    appendLRSContainer: function(a, b) {
        ...
        c || (c = b);
        jQuery("#popupImajnetControlsLayer").append('\x3cdiv id\x3d"imajnetPhotogrammetryLRS_' + c + '" class\x3d"photogrammetryPopup"\x3e' + (0 == c ? "" : '\x3cdiv class\x3d"LRSDoubleClickMessage LRSDoubleClickMessage_' + c + '"\x3e' + jQuery.imajnet.map.clipboard.doubleClick + "\x3c/div\x3e") + "\x3c/div\x3e");
    ...
    getObjectLRS: function(a) {
        if (a.coordinates || a.photogrammetryPosition3D && a.photogrammetryPosition3D.coordinates) {
            var b = ""
              ...
              , b = {
                ...
                height: a.position ? a.position.height : a.photogrammetryPosition3D.coordinates.height,
            ...
            "polyligne" == a.type ? (b = ImajnetPolyligne.getCurrentObjectMiddlePoint(a),
            this.appendLRSContainer({
                id: b.id,
                traceId: b.traceId,
                height: b.height,
                lat: b.lat,
                lon: b.lon
            }, a.id)) : "polygon" == a.type && (b = ImajnetPolyligne.getCurrentObjectMiddlePoint(a),
            this.appendLRSContainer({
                id: b.id,
                traceId: b.traceId,
                height: b.height,
        ...
        ImageControler.currentPhotogrammetry.appendCommentOnPhotogrammetryItemContainer(a.id, a.comment)
    },
    draw: function() {
        jQuery(".photogrammetryPopup").hide();
        Nigsys.isPositionMode() || Nigsys.isMeasurementMode() || (this.drawPhotogrammetryObjects(),
        this.getImajnetObjectsToProject())
    },
    redraw: function(a) {
        if (Nigsys.isPositionMode() || Nigsys.isMeasurementMode())
    ...
    zoomToObject: function(a) {
        if (a = ImajnetMap.getFeatureWrapperById(a))
            ImajnetPlugin.zoomMapToFeatureWrapper(a),
            ImajnetPlugin.onFeatureClick(a)
    },
    drawConstraints: function() {
        ImageControler.currentGraphic.clearConstraints();
        if (this.currentConstraintData && jQuery.isArray(this.currentConstraintData) && this.firstImagePosition && !this.photogrammetryIsDenied() && (!Nigsys.isPolyligneMode() || 1 != ImageControler.currentPhotogrammetry.currentStep % 2))
            for (var a = 0; a < this.currentConstraintData.length; a++)
                ImageControler.currentGraphic.drawConstraint(this.currentConstraintData[a])
    },
        ...
        try {
            if ((a = JSON.parse(a)) && a.parameter && a.parameter.targetImage && a.parameter.targetImage.id == ImajnetMap.currentPosition.id && a.constraints && jQuery.isArray(a.constraints)) {
                ...
                for (var b = 0; b < a.constraints.length; b++)
                    ImageControler.currentPhotogrammetry.currentConstraintData.push(a.constraints[b]),
                    ImageControler.currentGraphic.drawConstraint(a.constraints[b])
            }
        } catch (c) {}
    },
    getConstraint: function() {
        ...
        this.constraintParameter && this.firstImagePosition.id != ImajnetMap.currentPosition.id && (this.constraintParameter.density = 1,
        this.constraintParameter.sourceImage = this.firstImagePosition,
        this.constraintParameter.targetImage = ImajnetMap.currentPosition,
        this.constraintAjaxRequest = ImajnetAPI.doImajnetRequest("GET", "/api/photogrammetry/constraint/", this.constraintParameter, this.constraintReceived, null, null, null, !0))
    },
    ...
    getMeasurementArray: function(a) {
        if (a.measurementResult)
            return a.measurementResult.measurement;
        if (a.points) {
            if ("polygon" == a.type) {
    ...
    getMeasurementInUnits: function(a, b) {
    ...
    drawPhotogrammetryObjects: function() {
        if (null !== ImajnetMap.currentPosition) {
            ...
            if (null != a && (!Nigsys.isPolyligneMode() || -1 != ImajnetPolyligne.currentAddObjectId)) {
                var b = 0;
                a: for (; b < a.length; b++) {
                    var c = ImajnetMap.getFeatureWrapperById(a[b].id);
                    if (a[b].coordinates)
                        Nigsys.isPolyligneMode() || ImageControler.currentPhotogrammetry.appendImageTag(a[b].id, a[b].coordinates);
                    else if (void 0 !== a[b].photogrammetryPosition3D)
                        Nigsys.isPolyligneMode() || 0 != a[b].id && ImageControler.currentGraphic.appendPinPoint(a[b].parameter.imagePoint.imgCoord1, c);
                    else if (ImajnetPolyligne.objectIsPolyligneOrPolygon(a[b].id)) {
                        if ((!Nigsys.isPolyligneMode() || a[b].id == ImajnetPolyligne.currentAddObjectId) && a[b].points) {
                            for (var d = [], e = 0; e < a[b].points.length; e++) {
                                if (a[b].points[e].parameter.imagePoint.img1.id !== ImajnetMap.currentPosition.id)
                                    continue a;
                                d.push({
                                    id: a[b].points[e].id,
                                    coordinates: a[b].points[e].parameter.imagePoint.imgCoord1
                                })
                            }
                            ImageControler.currentPhotogrammetry.drawLine(c, d)
                        }
                    } else
                        Nigsys.isPolyligneMode() || (ImageControler.currentGraphic.init(),
                        ImageControler.currentPhotogrammetry.drawLine(ImajnetMap.getFeatureWrapperById(a[b].id), [{
                            coordinates: a[b].parameter.imagePoint1.imgCoord1
                        }, {
    ...
    objectFromCurrentImage: function(a, b) {
        if (this.objects[a].positionId != ImajnetMap.currentPosition.id)
            return !1;
        if (!ImajnetPolyligne.isPolyligneOrPolygon(this.objects[a].data[b].type))
            return !0;
        for (var c = 0; c < this.objects[a].data[b].points.length; c++)
            if (this.objects[a].data[b].points[c].parameter.imagePoint.img1.id != ImajnetMap.currentPosition.id)
                return !1;
        return !0
    },
    ...
    getImajnetObjectsToProject: function() {
        ...
        if (null != ImajnetMap.currentPosition && 0 < this.objects.length) {
            for (var a = [], b = [], c = [], d = ImageControler.currentPhotogrammetry.getImageIndexInCacheArrayByImageId(ImajnetMap.currentPosition.id), e = 0; e < this.objects.length; e++)
                for (var f = 0; f < this.objects[e].data.length; f++)
                    if (!this.objectFromCurrentImage(e, f)) {
                        var h = !1;
                        if (this.objects[e].data[f].photogrammetryPosition3D && -1 === jQuery.inArray(this.objects[e].data[f].type, ImajnetPolyligne.typesArray)) {
                            if (d)
                                if (d.projection && d.projection.pointProjections)
                                    for (var g = 0; g < d.projection.pointProjections.length; g++) {
                                        if (d.projection.pointProjections[g] && d.projection.pointProjections[g].id == this.objects[e].data[f].id) {
                                            h = !0;
                                            break
                                        }
                                    }
                                else if (d.projection && d.projection.shapeProjections)
                                    for (g = 0; g < d.projection.shapeProjections.length; g++)
                                        if (d.projection.shapeProjections[g] && d.projection.shapeProjections[g].projections && d.projection.shapeProjections[g].id == this.objects[e].data[f].id && 0 <= d.projection.shapeProjections[g].projections[0].coordinates.z) {
                                            h = !0;
                                            break
                                        }
                            !h && void 0 !== this.objects[e].data[f].photogrammetryPosition3D.coordinates && Nigsys.distanceBetweenPoints(ImajnetMap.currentPosition, this.objects[e].data[f].photogrammetryPosition3D.coordinates) <= ImajnetSettings.imajnetSettings.projection && (0 == this.objects[e].data[f].id ? c.push({
                                ...
                                imagePointReference: {
                                    image: {
                                        id: this.objects[e].data[f].parameter.imagePoint.img1.id
                                    },
                                    imageCoordinates: {
                            ...
                            if (d && d.projection && d.projection.shapeProjections)
                                for (g = 0; g < d.projection.shapeProjections.length; g++)
                                    if (d.projection.shapeProjections[g] && d.projection.shapeProjections[g].projections && d.projection.shapeProjections[g].id == this.objects[e].data[f].id && 0 <= d.projection.shapeProjections[g].projections[0].coordinates.z) {
                                        h = !0;
                                        break
                                    }
                            h || Nigsys.distanceBetweenPoints(ImajnetMap.currentPosition, this.objects[e].data[f].measurementResult.firstPoint) > ImajnetSettings.imajnetSettings.projection || (h = [],
                            this.objects[e].data[f].parameter.imagePoint1.img1.traceId != ImajnetMap.currentPosition.traceId ? (g = this.getDifferentTracePointObject(this.objects[e].data[f].id, this.objects[e].data[f].measurementResult.firstPoint),
                            h.push(g[0]),
                            h.push(g[1]),
                            g = this.getDifferentTracePointObject(this.objects[e].data[f].id, this.objects[e].data[f].measurementResult.secondPoint),
                            h.push(g[0]),
                            h.push(g[1])) : (h.push({
                                linkToNext: !0,
                                ...
                                imagePointReference: {
                                    image: {
                                        id: this.objects[e].data[f].parameter.imagePoint1.img1.id
                                    },
                                    imageCoordinates: {
                            ...
                            h.push({
                                ...
                                imagePointReference: {
                                    image: {
                                        id: this.objects[e].data[f].parameter.imagePoint2.img1.id
                                    },
                                    imageCoordinates: {
                            ...
                            if (d && d.projection && d.projection.shapeProjections && d.projection.shapeProjections.length) {
                                for (var k = null, g = 0; g < d.projection.shapeProjections.length; g++)
                                    if (d.projection.shapeProjections[g].id == this.objects[e].data[f].id) {
                                        k = d.projection.shapeProjections[g].projections;
                                        break
                                    }
                                h = !0;
                                for (g = 0; g < this.objects[e].data[f].points.length; g++)
                                    if (!(Nigsys.distanceBetweenPoints(ImajnetMap.currentPosition, this.objects[e].data[f].points[g].parameter.imagePoint.img1) > ImajnetSettings.imajnetSettings.projection)) {
                                        var m = !1;
                                        if (k)
                                            for (var l = 0; l < k.length; l++)
                                                if (k[l].id == this.objects[e].data[f].points[g].id) {
                                                    m = !0;
                                                    break
                                                }
                                        if (!m) {
                            ...
                            if (!h) {
                                h = [];
                                for (k = 0; k < this.objects[e].data[f].points.length; k++)
                                    Nigsys.distanceBetweenPoints(ImajnetMap.currentPosition, this.objects[e].data[f].points[k].parameter.imagePoint.img1) > ImajnetSettings.imajnetSettings.projection || (this.objects[e].data[f].parameter.imagePoint.img1.traceId != ImajnetMap.currentPosition.traceId ? (g = this.getDifferentTracePointObject(this.objects[e].data[f].points[k].id, this.objects[e].data[f].points[k].photogrammetryPosition3D.coordinates),
                                    h.push(g[0]),
                                    h.push(g[1])) : h.push({
                                        ...
                                        imagePointReference: {
                                            image: {
                                                id: this.objects[e].data[f].points[k].parameter.imagePoint.img1.id
                                            },
                                            imageCoordinates: {
            ...
            if (0 < a.length || 0 < b.length)
                ...
                0 < a.length && (c.points = a),
                0 < b.length && (c.shapes = b),
                d.push(c);
        ...
        for (var b = 0; b < this.objects.length; b++)
            for (var c = 0; c < this.objects[b].data.length; c++)
                if (this.objects[b].data[c].id == a) {
                    ImajnetZoom.left = -1;
                    ImajnetAPI.setImajnetImage({
                        position: ImageControler.currentPhotogrammetry.getPositionFromObject(this.objects[b].data[c])
                    });
                    return
                }
    },
    deleteItemAtIndex: function(a, b, c, d) {
        a && (a[c] && (1 == a[c][b].length ? a.splice(c, 1) : a[c][b].splice(d, 1)),
        "data" == b && 1 == a.length && 1 == a[0][b].length && 0 == a[0][b][0].id && this.clipboardEmpty())
    },
    deleteProjectionItem: function(a) {
        for (var b = 0; b < ImageControler.currentPhotogrammetry.existingProjections.length; b++)
            if (ImageControler.currentPhotogrammetry.existingProjections[b].projection) {
                var c = !1;
                if (ImageControler.currentPhotogrammetry.existingProjections[b].projection.pointProjections)
                    for (var d = 0; d < ImageControler.currentPhotogrammetry.existingProjections[b].projection.pointProjections.length; d++)
                        if (ImageControler.currentPhotogrammetry.existingProjections[b].projection.pointProjections[d] && ImageControler.currentPhotogrammetry.existingProjections[b].projection.pointProjections[d].id == a) {
                            ImageControler.currentPhotogrammetry.existingProjections[b].projection.pointProjections.splice(d, 1);
                            c = !0;
                            break
                        }
                if (!c && ImageControler.currentPhotogrammetry.existingProjections[b].projection.shapeProjections)
                    for (d = 0; d < ImageControler.currentPhotogrammetry.existingProjections[b].projection.shapeProjections.length; d++)
                        if (ImageControler.currentPhotogrammetry.existingProjections[b].projection.shapeProjections[d] && ImageControler.currentPhotogrammetry.existingProjections[b].projection.shapeProjections[d].id == a) {
    ...
    getClipboardEmptyContent: function() {
        return '\x3cdiv style\x3d"width: 100%; text-align: center; margin-top: 10px;"\x3e' + jQuery.imajnet.map.clipboard.noItems + "\x3c/div\x3e"
    },
    ...
    deletePhotogrammetryObjects: function(a) {
        ...
        for (var b = 0; b < a.length; b++)
            jQuery(a[b]).trigger("click")
    },
    exportAddToItem: function() {
        jQuery("#imajnetExportToContainer").append(this.exportToItemContent + '\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e')
    },
    showExport: function() {
    ...
    onExportSuccess: function(a) {
        ...
        a && a.exportResult && a.exportResult.link && "ok" != a.exportResult.link.toString().toLowerCase() && (b += ':\x26nbsp;\x3cb\x3e\x3ca href\x3d"' + Imajnet.serverUrl + a.exportResult.link + '" target\x3d"_blank"\x3e' + jQuery.imajnet.map.clipboard.popupExport.donwloadFile + "\x3c/a\x3e\x3c/b\x3e");
    ...
    getDataToExport: function() {
        ...
        jQuery.each(this.objects, function(e, h) {
            jQuery.each(h.data, function(e, f) {
                if (void 0 !== f.coordinates)
                    a.push(f);
                else if (f.photogrammetryPosition3D)
                    0 != f.id && b.push({
                    ...
                    for (var h = [], l = 0; l < f.points.length; l++)
                        h.push({
    ...
    exportObjects: function(a) {
        ...
        var b = ""
          , c = null
          , d = ""
          , e = jQuery('input[name\x3d"imajnetExportType"]:checked').val();
        void 0 !== a && null !== a && a && (b = jQuery("#imajnetExportFrom").val(),
        c = [],
        jQuery.each(jQuery(".imajnetExportTo"), function(a, b) {
            var d = b.value;
            "" != d && c.push(d)
        }),
        ...
        ImajnetAPI.doImajnetRequest("POST", "/api/export/" + e + "/", a, this.onExportSuccess, this.onExportError, null, "data")
    },
    redrawClipboard: function() {
        ...
        if (Photogrammetry.clipboardActive)
            for (var a = 0; a < ImageControler.currentPhotogrammetry.objects.length; a++)
                for (var b = 0; b < ImageControler.currentPhotogrammetry.objects[a].data.length; b++)
                    ImageControler.currentPhotogrammetry.objects[a].data[b].objectId && (ImageControler.currentPhotogrammetry.objects[a].data[b].id = ImageControler.currentPhotogrammetry.objects[a].data[b].objectId),
                    ImageControler.currentPhotogrammetry.drawObjectClipboard(ImageControler.currentPhotogrammetry.objects[a].data[b], !1)
    },
    drawObjectClipboard: function(a, b) {
        if (Photogrammetry.clipboardActive && void 0 !== a && null !== a && 0 != a.id) {
            ...
            if (a.photogrammetryPosition3D || a.measurementResult) {
                ...
                if (0 > e || 1 < e)
                    d = '\x3cdiv title\x3d"' + jQuery.imajnet.map.clipboard.precisionUnknown + '"\x3e?\x3c/div\x3e';
                else
                    for (var e = Math.round(5 * e), f = 0; 5 > f; f++)
                        d += "\x3cdiv style\x3d\"background-image: url('" + Imajnet.imajnetPath + "img/" + (f < e ? "ratingFullStar" : "ratingEmptyStar") + '.png\');" class\x3d"left imajnetClipboardStarImage" title\x3d"' + jQuery.imajnet.map.clipboard.precisionRating + '"\x3e\x3c/div\x3e'
            }
            e = "";
            e = ImajnetPolyligne.objectIsPolyligneOrPolygon(a.id) ? jQuery.imajnet.map.clipboard.titleItem[a.type] + " (" + ImageControler.currentPhotogrammetry.getMeasurementInUnitsByObjectId(a.id, "measurementClipboardText_") + ")" : void 0 !== a.coordinates ? jQuery.imajnet.map.clipboard.imageTag : void 0 !== a.photogrammetryPosition3D ? jQuery.imajnet.map.clipboard.position3D : ImageControler.currentPhotogrammetry.getMeasurementInUnitsByObjectId(a.id, "measurementClipboardText_");
            f = void 0 !== a.comment ? a.comment : "";
            c += '\x3cdiv id\x3d"imajnetClipboardItem_' + a.id + '" class\x3d"imajnetClipboardItem' + (1 == a.id % 2 ? " imajnetClipboardItemEven" : "") + '" onclick\x3d"ImageControler.currentPhotogrammetry.ImajnetClipboardItemClick(' + a.id + ', event);"\x3e\x3cdiv onmousemove\x3d"ImageControler.currentPhotogrammetry.showLRS(event, null, ' + a.id + ", '" + ImajnetUI.clipboardContainerId + "');\" onmouseout\x3d\"jQuery('#LRSClipboard_" + a.id + '\').hide();"\x3e\x3cdiv class\x3d"imajnetClipboardItemImage left"\x3e\x3cimg src\x3d"' + ImajnetAPI.buildImageURL(ImageControler.currentPhotogrammetry.getPositionFromObject(a)) + '" width\x3d"35" height\x3d"32" /\x3e\x3c/div\x3e\x3cdiv class\x3d"left imajnetClipboardComment"\x3e\x3cdiv id\x3d"imajnetClipboardComment_' + a.id + '" class\x3d"imajnetClipboardCommentContainer" style\x3d"width: ' + (void 0 === a.coordinates ? 180 : 270) + 'px;" ondblclick\x3d"ImageControler.currentPhotogrammetry.showCommentInClipboard(event, ' + a.id + ');"\x3e\x3cdiv id\x3d"measurementClipboardText_' + a.id + '"\x3e\x3cb\x3e' + e + '\x3c/b\x3e\x3c/div\x3e\x3cdiv\x3e\x3cdiv class\x3d"left"\x3e\x3cb\x3e' + jQuery.imajnet.map.clipboard.comment + '\x3c/b\x3e:\x26nbsp;\x3c/div\x3e\x3cdiv id\x3d"imajnetClipboardCommentContainer_' + a.id + '" class\x3d"left imajnetClipboardCommentContainer" style\x3d"width: ' + (void 0 === a.coordinates ? 95 : 180) + 'px;"\x3e' + f + '\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv id\x3d"imajnetClipboardTextareaComment_' + a.id + '" class\x3d"imajnetClipboardTextareaComment" style\x3d"display: none;"\x3e\x3ctextarea id\x3d"textAreaEditClipboardComment_' + a.id + '" class\x3d"textAreaEditClipboardComment" onkeydown\x3d"ImageControler.currentPhotogrammetry.saveComment(event, ' + a.id + ", 'textAreaEditClipboardComment_');\" cols\x3d\"" + (void 0 === a.coordinates ? 21 : 34) + '"\x3e\x3c/textarea\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"right imajnetClipboardDelete"\x3e\x3cimage src\x3d"' + Imajnet.imajnetPath + "img/deleteClipboardItem.png?" + Imajnet.version + '" class\x3d"deleteClipboardItem" onclick\x3d"ImageControler.currentPhotogrammetry.deletePhotogrammetryItem(' + a.id + ');" width\x3d"20" height\x3d"20" style\x3d"margin-top: 5px;" title\x3d"' + jQuery.imajnet.map.clipboard.deleteItem + '" /\x3e\x3c/div\x3e' + (void 0 === a.coordinates ? '\x3cdiv class\x3d"right imajnetClipboardPrecision"\x3e' + d + '\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e' : "") + '\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e';
            jQuery("#" + ImajnetUI.clipboardContainerId + "Content").click(function(a, b) {
                Nigsys.stringContains(a.target.className, "textAreaEditClipboardComment") || (jQuery(".imajnetClipboardTextareaComment").hide(),
                jQuery(".imajnetClipboardCommentContainer").show())
            });
            ...
            b && (ImajnetUI.showNotificationInfo(jQuery.imajnet.map.clipboard.notify.title, jQuery.imajnet.map.clipboard.notify.text, "rightBottom", null, null, function() {
    ...
    clear: function() {
        ...
        ImajnetProjection.userProjections = null;
        ImageControler.currentGraphic ? (ImageControler.currentGraphic.firstClickCoordinates = null,
        ImageControler.currentGraphic.lastClickCoordinates = null) : (Graphic.firstClickCoordinates = null,
        Graphic.lastClickCoordinates = null);
        Nigsys.isPositionMode() || Nigsys.isMeasurementMode() || Nigsys.isPolyligneMode() || this.hidePreviewPanel();
    ...
    hidePreviewPanel: function() {
        ImageControler.currentGraphic ? (ImageControler.currentGraphic.clearConstraints(),
        ImageControler.currentGraphic.clearPreviewPanel()) : (Graphic.clearConstraints(),
        Graphic.clearPreviewPanel());
        jQuery(".zoomImageClickedPoint").remove();
        ImajnetUI.previewImage && (ImajnetUI.previewImage.attr("src", ""),
        ImajnetUI.previewImageContainer.hide());
        ImajnetMap.currentPosition && Address.showAddress()
    },
    getProjectionConstraint: function(a) {
        if (ImajnetMap.currentPosition)
            return ImajnetMap.getTriangle(a, ImajnetSettings.imajnetSettings.projection, ImajnetMap.currentPosition.orientation.viewAngle, ImajnetMap.currentPosition.orientation.yaw)
    }
};
...
FlatPhotogrammetry.drawLine = function(a, b) {
    ...
    for (var e = "", d = [], c = 0; c < b.length; c++) {
        ...
        var f = ""
          , g = ImajnetZoom.getCoordinatesFromRealAtCurrentZoom(b[c].coordinates);
        d.push(g);
        f = 0 == c ? " M" : " L";
        e += f + g.x + " " + g.y
    }
    a && (a.style || (a.style = Array({
        strokeColor: Nigsys.defaultObjectsColor
    })),
    a.getType() == ImajnetMap.FEATURE_TYPE_POLYGON ? jQuery.each(a.style, function(b, c) {
    ...
    ImajnetUI.popupImajnetControlsLayer.append('\x3cdiv id\x3d"measurementText_' + a.getId() + '" class\x3d"measurementText" style\x3d"top: ' + d.y + "px; left:" + d.x + 'px;" onclick\x3d"ImageControler.currentPhotogrammetry.onPhotogrammetryItemClick(\'' + a.getId() + "');\" onmouseover\x3d\"ImageControler.currentPhotogrammetry.onPhotogrammetryItemMouseOver('" + a.getId() + "', event, 'imajnetImageLayer', jQuery(this));\" onmouseout\x3d\"ImageControler.currentPhotogrammetry.onPhotogrammetryItemMouseOut('" + a.getId() + "');\" ondblclick\x3d\"ImageControler.currentPhotogrammetry.showComment(event, jQuery(this), '" + a.getId() + "', 'popupImajnetControlsLayer', 'textareaEditComment_');\"\x3e" + c + "\x3c/div\x3e"))
}
;
FlatPhotogrammetry.clearItem = function(a) {
    var b = ImajnetMap.getFeatureWrapperById(a);
    if (b)
        if (-1 !== jQuery.inArray(b.getType().replace("Feature", ""), ImajnetPolyligne.typesArray)) {
            if (a = ImajnetMap.getPolyligneFeatureWrappers(a))
                for (b = 0; b < a.length; b++)
                    ImageControler.currentGraphic.clearItem(a[b].getId())
        } else
            ImageControler.currentGraphic.clearItem(a);
    else
        ImageControler.currentGraphic.clearItem(a)
}
;
...
var Graphic = {
    ...
    initConstraint: function() {
        this.constraintSVG = this.initSVG("popupImajnetControlsLayer", this.constraintSVG);
        if (!Nigsys.isPolyligneMode())
            jQuery(this.constraintSVG.canvas).on("click", ImajnetUI.onImageClick)
    },
    ...
    getConstraintColor: function(a) {
        var b = 0
          , b = .75 < a ? parseInt(127 + 512 * (1 - a) / 3) : parseInt(1020 * a / 3);
        return "rgb(" + Math.min(parseInt(340 * (1 - a)), 255) + ", " + b + ", 0)"
    },
    ...
    getPoint: function(a, b) {
        return "portrait" == a.orientation ? b : {
            x: b.y,
            y: b.x
        }
    },
    drawLRSGUIRoad: function(a) {
        ...
        "portrait" == a.orientation ? (startX = a.roadXOffset,
        startY = 0,
        endX = a.roadXOffset,
        endY = a.containerHeight) : (startX = 0,
        startY = a.roadXOffset,
        endX = a.containerHeight,
        endY = a.roadXOffset);
    ...
    drawLRSGUILine: function(a, b, d, c, e) {
        ...
        if ("1" == a.roadType)
        ...
        else if ("2" == a.roadType) {
            this.drawLRSGUIRoad(a);
            e = c = null;
            for (d = 0; d < a.containerHeight; d += 20)
                c = this.getPoint(a, {
                    x: a.roadXOffset - 7,
                    y: d
                }),
            ...
            a.LRSGUISVG.path(b).attr({
                stroke: "#000000",
                "stroke-width": a.trainStrokeWidth
            })
            ...
            b = "M " + c.x + " " + c.y + " ";
            for (d = 0; d < a.containerHeight; d += 40)
                c = [this.getPoint(a, {
                    x: a.roadXOffset - 10,
                    y: d + 20
                }), this.getPoint(a, {
                ...
                b += "C " + c[0].x + " " + c[0].y + " " + c[1].x + " " + c[1].y + " " + c[2].x + " " + c[2].y + " ";
            a.LRSGUISVG.path(b).attr({
                stroke: "#0000FF",
                "stroke-width": a.roadStrokeWidth,
                "stroke-opacity": 1
            })
        }
    },
    ...
    drawPR: function(a, b, d, c) {
        c = [this.getPoint(a, {
            ...
            x: Math.round(b.x + a.prSize / 2 + a.PRDivisionOffset),
            y: b.y
        })];
        ...
        a.LRSGUISVG.text(b.x, b.y, d).attr({
            "font-size": a.PRFontSize,
            "text-anchor": "middle",
            "font-weight": "bold"
        })
    },
    getDivisionStep: function(a, b) {
        var d = b / a;
        if (d <= Graphic.LRSGUIPRDivisionsMinLength)
            return Graphic.LRSGUIPRDivisionsMinLength;
    ...
    drawPRDivisions: function(a, b, d, c) {
        ...
        1 > e && (e = 1);
        c = Graphic.getPRDivisions(a.currentZoomLevel - (a.maxZoomLevel - a.zeroBasedMaxZoomLevel), c, e);
        for (e = 0; e < c.count; e++) {
            var f = e * c.step
              , g = Math.round(b.y + d / c.count * e);
            ...
            "landscape" == a.orientation && (a.PRDivisionWidth = f.getBBox().width,
            f.transform("t-" + a.PRDivisionWidth / 2 + ",0R90")))
        }
    },
    onDrawLRSGUIImageOrientation: function(a, b) {
        var d = this.getPoint(a, b);
        a.LRSGUISVG.circle(d.x, d.y, a.positionCircleRadius).data({
            identifier: "imageOrientation"
        }).attr({
            fill: "#00FF00",
            "fill-opacity": .5,
            stroke: "#000000",
        ...
        a.LRSGUISVG.path("M " + d.x + " " + d.y + " L " + c.x + " " + c.y).data({
            identifier: "imageOrientation"
        }).attr({
            stroke: "#FF0000",
            "stroke-width": a.lineIndicatorStrokeWidth,
    ...
    drawLRSGUIImageOrientation: function(a, b, d) {
        a != ImajnetUI.LRSGUI ? "undefined" !== typeof LRSSchematic && LRSSchematic.drawImajnetImagePosition() : ("undefined" !== typeof LRSSchematic && LRSSchematic.drawImajnetImagePosition({
            PRIndexInArray: d,
    ...
    clearLRSGUIImageOrientation: function(a) {
        "undefined" !== typeof LRSSchematic && a === ImajnetUI.LRSGUI && (LRSSchematic.imajnetImageData = null);
        if (a && a.LRSGUISVG) {
            if (a === ImajnetUI.LRSGUI && "undefined" !== typeof LRSSchematic && LRSSchematic.LRSGUI && !LRSSchematic.isMinimized() && a.currentRoadId == LRSSchematic.LRSGUI.currentRoadId)
                this.onClearLRSGUIImageOrientation(LRSSchematic.LRSGUI);
    ...
    setLRSGUISize: function(a, b, d) {
        a.LRSGUI && a.LRSGUI.LRSGUISVG && (a.itemWidth = b,
        a.itemHeight = d,
        a.LRSGUI.initSize({
            width: b,
            height: d
        }),
        a.LRSGUI.LRSGUISVG.setSize(b, d))
    },
    ...
    drawRoadBoundsAndCenterLine: function(a) {
        var b = 0
          , d = 0;
        "portrait" == LRSSchematic.orientation ? (b = LRSSchematic.itemWidth,
        d = LRSSchematic.itemHeight) : (b = LRSSchematic.itemHeight,
        d = LRSSchematic.itemWidth);
        var c = [this.getPoint(a, {
            x: 0,
            y: 0
        }), this.getPoint(a, {
            x: 0,
    ...
    drawFeaturePoint: function(a, b, d, c, e) {
        b = this.getPoint({
            orientation: LRSSchematic.orientation
        }, {
            x: b.x,
            y: b.y
        });
        e ? (c.featureSize = LRSSchematic.featurePointSize,
        c.layerStyle = d,
        StyleEditor.drawFeaturePoint(d, c, b)) : LRSSchematic.pushDraggableFeature({
            layerName: d,
            featureId: c.getId(),
            container: this.drawFeatureDefaultPoint(a, b, c.getId())[0]
        })
    },
    drawFeatureLinePoint: function(a, b) {
        return a.LRSGUISVG.circle(b.x, b.y, 7).attr({
            fill: Nigsys.hoverObjectsColor
        })
    },
    onDrawFeatureLine: function(a, b, d, c, e, f, g) {
        ...
        g && a.node.setAttribute("id", "featureGraphicElements_" + f.getId().replace(".", "_"));
        return a
    },
    ...
    recalculateInCaseOfRotation: function(a) {
        var b = a.rotation;
        b && 0 !== b % 90 && (b = parseInt(b) / 90,
        .5 < b && (b = 1 - b),
        a.pointRadius -= b * this.recalculateWithRotation(a.pointRadius) + 2,
        a.strokeWidth && (a.strokeWidth -= 2 * b * this.recalculateWithRotation(a.strokeWidth)))
    },
...
FlatGraphic.drawLine = function(a, b, c) {
    ...
    this.svg.path(a).attr(d).data("object", {
        id: b.getId()
        ...
        ImageControler.currentPhotogrammetry.showComment(a, null, this.data("object").id, "popupImajnetControlsLayer", "textareaEditComment_")
    })
}
;
...
FlatGraphic.clearConstraints = function() {
    null !== this.constraintSVG && (this.constraintSVG.remove(),
    this.constraintSVG = null)
}
;
...
FlatGraphic.mouseMove = function(a) {
    if (a && ImageControler.currentGraphic.firstClickCoordinates) {
        ...
        ImageControler.currentGraphic.drawIntermediateLine(a.x, a.y, ImageControler.currentGraphic.lastClickCoordinates.x, ImageControler.currentGraphic.lastClickCoordinates.y)
    }
}
;
FlatGraphic.onDrawFeatureImage = function(a, b, c) {
    if (b.style) {
        ...
        jQuery.each(d, function(a, c) {
            style = c;
            style.externalGraphic && (style.strokeWidth = 0,
            f = !0,
            delete style.graphicXOffset,
            delete style.graphicYOffset);
            if (style && "none" != style.display) {
                style.strokeWidth && (style.stroke = !0);
                if (!style.stroke || style.stroke && !style.strokeWidth)
                    style.strokeWidth = 0;
        ...
        k && jQuery.each(d, function(d, f) {
            var e = b.featureOL;
            if ("application/chart" == f.graphicFormat)
                return !0;
            if (f.label && c) {
                ...
                jQuery.each(f, function(a, b) {
                    if ("label" != a && "fill" != a) {
                        var c = a
                          , d = b;
                        "fontSize" == c ? (c = "font-size",
                        d = "10px") : "fillColor" == c ? c = "color" : "fontWeight" == c ? c = "font-weight" : "fontStyle" == c && (c = "font-style");
                        n.css(c, d)
                    }
                });
            ...
            if (1 >= g) {
                ...
                var h = 2 * e.style.pointRadius / b.featureSize
                  , l = 2 * e.style.strokeWidth / b.featureSize
                  , p = (h + l) / g
                  , m = 0 < l ? h / l : h;
                l > h && (m = l / h);
                h = (1 - g) * b.featureSize / (2 * (0 == e.style.strokeWidth ? m : m + 1));
                ...
                e.style.pointRadius /= g,
                e.style.strokeWidth && (e.style.strokeWidth /= g);
            ImageControler.currentGraphic.recalculateInCaseOfRotation(e.style);
            if (Nigsys.graphicIsFont(e.style.graphicName))
                return a.children(0).append(StyleEditor.drawRuleFontImageOnImajnetImage(e.style)),
                !0;
            k.drawFeature(e)
        })
    }
...
FlatGraphic.drawFeatureImage = function(a) {
    ...
    if (a && 0 != b.length)
        this.onDrawFeatureImage(b, a, null)
}
;
...
FlatPhotogrammetry.appendMapMarker = function(a, b) {
    var c = b.z ? 40 - b.z / 2.5 : 40
      , c = 12 < c ? c : 12
      , d = void 0 === b.z ? 120 + b.z / 4 : 120
      , g = ImajnetZoom.getCoordinatesFromRealAtCurrentZoom(b);
    ImajnetUI.popupImajnetControlsLayer.append('\x3cdiv id\x3d"photogrammetryItem_' + a + '" class\x3d"photogrammetryItem" style\x3d"position: absolute; top: ' + Math.round(g.y - d) + "px; left: " + Math.round(g.x - c / 2) + 'px;" onclick\x3d"ImageControler.currentPhotogrammetry.onPhotogrammetryItemClick(\'' + a + "');\" onmouseover\x3d\"ImageControler.currentPhotogrammetry.onPhotogrammetryItemMouseOver('" + a + "',event,  'imajnetImageLayer', jQuery(this));\" onmouseout\x3d\"ImageControler.currentPhotogrammetry.onPhotogrammetryItemMouseOut('" + a + "', jQuery(this));\" ondblclick\x3d\"ImageControler.currentPhotogrammetry.showComment(event, jQuery(this), '" + a + "', 'popupImajnetControlsLayer', 'textareaEditComment_');\"\x3e\x3cimg src\x3d\"" + Imajnet.imajnetPath + "img/targetIconMarker16x36.png?" + Imajnet.version + '" width\x3d"' + c + '" height\x3d"' + d + '" /\x3e\x3c/div\x3e')
}
;
FlatGraphic.appendPinPoint = function(a, b) {
    if (b) {
        var c = b.getId()
          , d = ImajnetZoom.getCoordinatesFromRealAtCurrentZoom(a)
          , g = 0
          , f = 0;
        b.getType() != ImajnetMap.FEATURE_TYPE_PROJECTION ? b.getType() == ImajnetMap.MARKER_TYPE_POSITION ? (f = a.z ? 32 - Math.round(a.z / 3) : 32,
        g = d.y - f) : (f = 5,
        g = d.y - 2 * f) : (f = 52,
        a.z && (f = a.z / 1.5 > f - 6 ? 6 : Math.round(f - a.z / 1.5)),
        g = d.y - f / 2);
        var k = '\x3cdiv id\x3d"photogrammetryItem_' + c + '" class\x3d"left" style\x3d"width: ' + f + "px; height: " + f + 'px;"\x3e' + (b.getType() != ImajnetMap.FEATURE_TYPE_PROJECTION ? '\x3cimg src\x3d"' + Imajnet.imajnetPath + "img/" + (b.getType() == ImajnetMap.MARKER_TYPE_POSITION ? "pinpoint" : "polyligne") + ".png?" + Imajnet.version + '" width\x3d"' + f + '" height\x3d"' + f + '" align\x3d"center" /\x3e' : "") + "\x3c/div\x3e"
          , q = '\x3cdiv id\x3d"labelOnFeature_' + c + '" class\x3d"left" style\x3d"padding-top: ' + f / 3 + 'px;"\x3e\x3c/div\x3e';
        ImajnetUI.popupImajnetControlsLayer.append("\x3cdiv onmouseover\x3d\"ImageControler.currentPhotogrammetry.onPhotogrammetryItemMouseOver('" + b.id + "', event, 'imajnetImageLayer', jQuery(this));\" onmouseout\x3d\"ImageControler.currentPhotogrammetry.onPhotogrammetryItemMouseOut('" + b.id + "');\" onclick\x3d\"ImageControler.currentPhotogrammetry.onPhotogrammetryItemClick('" + b.id + '\');" class\x3d"photogrammetryItem" style\x3d"position: absolute; width: ' + f + "px; height: " + f + "px; top: " + Math.round(g) + "px; left: " + Math.round(d.x - f / 2) + "px; z-index: " + (b.getType() == ImajnetMap.FEATURE_TYPE_PROJECTION ? Math.round(2 * ImajnetSettings.imajnetSettings.projection - a.z) : 1) + ';"\x3e' + k + q + "\x3c/div\x3e");
        b.getType() != ImajnetMap.FEATURE_TYPE_PROJECTION ? jQuery("#photogrammetryItem_" + c).dblclick({
            id: c
        }, function(a) {
            ImageControler.currentPhotogrammetry.showComment(a, jQuery(this), a.data.id, "popupImajnetControlsLayer", "textareaEditComment_")
        }) : (b.featureSize = f,
        b.zIndex = a.z,
        b.featureId = c,
        this.drawFeatureImage(b))
    } else
        console.error("Null featureWrapper: ")
}
;
FlatGraphic.createRenderer = function(a, b, c) {
    ...
    if (!d)
        for (var g = 0, f = this.renderers.length; g < f; ++g)
            if ((c = OpenLayersForProjection.Renderer[this.renderers[g]]) && c.prototype.supported()) {
                try {
                    d = new c(a)
                } catch (k) {
                    return null
    ...
    b && (d.setSize(new OpenLayersForProjection.Size(b.width,b.height)),
    d.setExtent(new OpenLayersForProjection.Bounds(-b.width / 2,-b.height / 2,b.width / 2,b.height / 2), !0));
    return d
}
;
...
CubeGraphic.drawLine = function(a, b, c, d, e, f) {
    ...
    this.svg.path("M " + a + " " + b + " L " + c + " " + d).attr({
        ...
        this.attr({
            stroke: Nigsys.differentTracePinPointHoverColor
        })) : (ImageControler.currentPhotogrammetry.highlightMeasurement(this.objectIdToHighlight),
        this.attr({
            stroke: Nigsys.hoverObjectsColor
        }))
    }).mouseout(function() {
        var a = this.attr();
        jQuery("#imajnetPhotogrammetryLRS_" + this.data("id")).hide();
        a.stroke == Nigsys.differentTracePinPointHoverColor ? (ImageControler.currentPhotogrammetry.deselectHighlightPinPoint(this.objectIdToHighlight),
        this.attr({
            stroke: Nigsys.differentTracePinPointColor
        })) : (ImageControler.currentPhotogrammetry.deselectHighlightMeasurement(this.objectIdToHighlight),
        this.attr({
            stroke: Nigsys.defaultObjectsColor
        }));
...
CubeGraphic.drawConstraint = function(a, b) {
    this.initConstraint();
    for (var c = ImajnetZoom.getCoordinatesFromRealAtCurrentZoom(a.point[0]), d = "M " + c.x + " " + c.y, e = 1; e < a.point.length - 1; e++)
        c = ImajnetZoom.getCoordinatesFromRealAtCurrentZoom(a.point[e]),
        d += " L " + c.x + " " + c.y;
    this.drawConstraintLine(d, this.getConstraintColor(a.precision))
}
;
...
CubeGraphic.mouseMove = function(a) {
    a && (ImageControler.currentGraphic.clearGraphicObjects(),
    ImageControler.currentGraphic.lastClickCoordinates = CubePlugin.getCubeCoordinatesFromEvent(a),
    a = CubePlugin.getCubeCoordinatesFromImageCoordinates(ImageControler.currentGraphic.firstClickCoordinates),
    ImageControler.currentGraphic.lastClickCoordinates && a && ImageControler.currentGraphic.drawIntermediateLine(a, ImageControler.currentGraphic.lastClickCoordinates))
}
;
...
CubeGraphic.createRenderer = function(a, b, c) {
    ...
    c && (c = OpenLayersForProjection.Renderer[c]) && c.prototype.supported() && (d = new c(a));
    if (!d)
        for (var e = 0, f = this.renderers.length; e < f; ++e)
            if ((c = OpenLayersForProjection.Renderer[this.renderers[e]]) && c.prototype.supported()) {
                d = new c(a);
                break
            }
    d.map = {
...
var ImajnetMeasurement = {
    ...
    addPreviewPanel: function() {
        jQuery("#imajnetPreviewPanel").html('\x3cdiv id\x3d"imajnetPreviewPanelContent"\x3e\x3cdiv class\x3d"imajnetPreviewPanelItem imageTrace" id\x3d"imajnetPreviewPanelItem1"\x3e\x3cb\x3e' + jQuery.imajnet.map.measurement.step + "\x26nbsp;1\x3c/b\x3e\x3cbr/\x3e" + jQuery.imajnet.map.measurement.step1Content + '\x3c/div\x3e\x3cdiv class\x3d"imajnetPreviewPanelItemArrow" id\x3d"imajnetPreviewPanelItemArrow1"\x3e\x3c/div\x3e\x3cdiv class\x3d"imajnetPreviewPanelItem imageTrace" id\x3d"imajnetPreviewPanelItem2"\x3e\x3cb\x3e' + jQuery.imajnet.map.measurement.step + "\x26nbsp;2\x3c/b\x3e\x3cbr/\x3e" + jQuery.imajnet.map.measurement.step2Content + '\x3c/div\x3e\x3cdiv class\x3d"imajnetPreviewPanelItemArrow" id\x3d"imajnetPreviewPanelItemArrow2"\x3e\x3c/div\x3e\x3cdiv class\x3d"imajnetPreviewPanelItem imageTrace" id\x3d"imajnetPreviewPanelItem3"\x3e\x3cb\x3e' + jQuery.imajnet.map.measurement.step + "\x26nbsp;3\x3c/b\x3e\x3cbr/\x3e" + jQuery.imajnet.map.measurement.step3Content + "\x3c/div\x3e\x3c/div\x3e");
        Nigsys.browserIsIE7() || Nigsys.browserIsIE8() || jQuery(".imajnetPreviewPanelItem").corner("5px");
    ...
    hideMeasurement: function(a) {
        ...
        ImageControler.currentPhotogrammetry && (this.noOfClickedPoints = ImageControler.currentPhotogrammetry.currentStep = 1,
        ImageControler.currentPhotogrammetry.setRedStep(ImageControler.currentPhotogrammetry.currentStep - 1),
        ImageControler.currentPhotogrammetry.firstImagePosition = null,
        ImageControler.currentPhotogrammetry.constraintParameter = null,
        a ? (ImageControler.currentPhotogrammetry.redraw(!1),
    ...
    showHideMeasurement: function() {
        jQuery("#imajnetMeasurementButtonContainer").hasClass("buttonActive") ? (this.hideMeasurement(!0),
        LRS.cachedPoints[ImajnetMap.currentPosition.lat + ":" + ImajnetMap.currentPosition.lon + ":" + ImajnetMap.currentPosition.height] && ImajnetUI.LRSGUI.draw(LRS.cachedPoints[ImajnetMap.currentPosition.lat + ":" + ImajnetMap.currentPosition.lon + ":" + ImajnetMap.currentPosition.height]),
        Address.showAddress(),
        LRS.showLRS(),
        ImajnetUI.showDateContainer(),
        ImageControler.currentPhotogrammetry.redraw(!1)) : this.showMeasurement(!0)
    },
    showHideMeasurementDenied: function() {
        this.noOfClickedPoints = 1;
        ImageControler.currentPhotogrammetry.photogrammetryIsDenied() ? jQuery("#measurementDenied").show() : (jQuery("#measurementDenied").hide(),
        Nigsys.onMobile() || ImajnetUI.imajnetImageContainer.bind("mousemove", ImageControler.currentPhotogrammetry.imageMouseMovePreviewPanel).bind("mousemove", ImageControler.currentGraphic.mouseMove),
        ImageControler.currentPhotogrammetry.getConstraint())
    },
    reload: function(a) {
        jQuery("#imajnetMeasurementButtonContainer").hasClass("buttonActive") && (this.hideMeasurement(!1),
    ...
    measurementReceived: function(a) {
        ...
        if ((a = JSON.parse(a)) && a.parameter && a.parameter.imagePoint1 && a.parameter.imagePoint1.img1) {
            ...
            ImajnetAPI.setImajnetImage({
                position: a.parameter.imagePoint1.img1
            });
            ImageControler.currentPhotogrammetry.getObjectLRS(a);
            ImajnetPlugin.onMeasurementCreated({
                id: c.id,
                measurement: a.measurementResult
            })
        } else
            ImajnetUI.showError(jQuery.imajnet.map.measurement.errorMeasurement, !0)
    },
    measurementComplete: function(a) {
        200 !== a.status && (ImajnetMeasurement.showHideMeasurement(),
        ImageControler.currentPhotogrammetry.redraw(!1),
        ImajnetUI.showError(jQuery.imajnet.map.measurement.errorMeasurement, !0))
    },
    drawPreviewPanelLineAgain: function() {
        if (null !== ImajnetMeasurement.firstImageClick1 && null !== ImajnetMeasurement.firstImageClick2) {
            ...
            var a = {
                ...
                y: this.firstImageClick1.y == this.firstImageClick2.y ? this.firstImageClick1.y : Math.abs(this.firstImageClick1.y + this.firstImageClick2.y) / 2
            }
    ...
    measureObject: function(a, c, b) {
        if (jQuery("#imajnetMeasurementButtonContainer").hasClass("buttonActive")) {
            ImajnetAPI.mustAbortRequests && null !== this.measurementAjaxRequest && this.measurementAjaxRequest.abort();
            var d = null;
            b && b.face && (d = b.face);
            ImajnetZoom.imageQuality = "HIGH_RESOLUTION";
            b = null;
            "FLAT" == ImageControler.currentImageType ? (ImajnetUI.previewImage.attr("src", ImajnetAPI.buildImageURL(ImageControler.currentPhotogrammetry.firstImagePosition, ImajnetUI.getPreviewImageResolution())),
            b = ImajnetZoom.getRealImageCoordinates(a, c)) : (ImajnetUI.previewImage.attr("src", ImajnetAPI.buildImageURL(ImageControler.currentPhotogrammetry.firstImagePosition, ImajnetUI.getPreviewImageResolution()), d),
            b = {
                x: a,
                y: c
            });
            ...
            case 1:
                ...
                case 1:
                    ...
                    Nigsys.onMobile() || ("FLAT" == ImageControler.currentImageType ? ImajnetUI.imajnetImageContainer.bind("mousemove", ImageControler.currentPhotogrammetry.imageMouseMovePreviewPanel).bind("mousemove", ImageControler.currentGraphic.mouseMove) : CubePlugin.cubeContainer.bind("mousemove", ImageControler.currentPhotogrammetry.imageMouseMovePreviewPanel).bind("mousemove", ImageControler.currentGraphic.mouseMove));
                    break;
                case 2:
                    ImajnetUI.previewImage.attr("src", ImajnetAPI.buildImageURL(ImageControler.currentPhotogrammetry.firstImagePosition, ImajnetUI.getPreviewImageResolution())),
                    c = {
                        x: this.firstImageClick1.x == b.x ? this.firstImageClick1.x : Math.abs(this.firstImageClick1.x + b.x) / 2,
                        y: this.firstImageClick1.y == b.y ? this.firstImageClick1.y : Math.abs(this.firstImageClick1.y + b.y) / 2
                    },
                    a = this.getPreviewPanelZoomFactor(this.firstImageClick1, b),
                    c = ImageControler.currentPhotogrammetry.setPreviewPanelVisibleRegion(c, a),
                    this.drawPreviewPanelLine(this.firstImageClick1, b, a, c),
                    ImageControler.currentPhotogrammetry.showPreviewPanel(),
                    ImageControler.currentPhotogrammetry.setRedStep(ImageControler.currentPhotogrammetry.currentStep),
                    this.firstImageClick2 = {
                        imageId: ImageControler.currentPhotogrammetry.firstImagePosition.id,
                        x: b.x,
                        y: b.y
                    },
                    ImageControler.currentPhotogrammetry.constraintParameter = Object({
                        points: [Object({
                            ...
                            x: this.firstImageClick2.x,
                            y: this.firstImageClick2.y
                        })]
                    }),
                    this.noOfClickedPoints = 1,
                    ImageControler.currentPhotogrammetry.currentStep++,
                    ImageControler.currentImageControl.getPrevious(!0),
                    ImageControler.currentGraphic.firstClickCoordinates = null
                }
                break;
            case 2:
                switch (this.noOfClickedPoints) {
                case 1:
                    ...
                    this.secondImageClick1 = {
                        imageId: ImajnetMap.currentPosition.id,
                        x: b.x,
                        y: b.y
                    };
                    this.noOfClickedPoints++;
                ...
                case 2:
                    ...
                    ImageControler.currentPhotogrammetry.setRedStep(ImageControler.currentPhotogrammetry.currentStep),
                    ImageControler.currentGraphic.clearConstraints(),
                    this.measurementAjaxRequest = ImajnetAPI.doImajnetRequest("GET", "/api/photogrammetry/measurement/free/", {
                        imagePoint1: {
                            img1: ImageControler.currentPhotogrammetry.firstImagePosition,
                            img2: ImajnetMap.currentPosition,
                            imgCoord1: {
                            ...
                            imgCoord2: {
                                x: this.secondImageClick1.x,
                                y: this.secondImageClick1.y
                            }
                        },
                        imagePoint2: {
                            img1: ImageControler.currentPhotogrammetry.firstImagePosition,
                    ...
                    }, this.measurementReceived, null, this.measurementComplete),
                    Address.showAddress(),
                    this.noOfClickedPoints = 1,
                    ImageControler.currentPhotogrammetry.currentStep++
                }
...
var ImajnetPolyligne = {
    type: "",
    typesArray: ["polyligne", "polygon"],
    currentAddObjectId: -1,
    isPolyligneObject: function(a) {
    ...
    addPreviewPanel: function() {
        jQuery("#imajnetPreviewPanel").html('\x3cdiv id\x3d"imajnetPreviewPanelContent"\x3e\x3cdiv class\x3d"imajnetPreviewPanelItem imageTrace" id\x3d"imajnetPreviewPanelItem1"\x3e\x3cb\x3e' + jQuery.imajnet.map[ImajnetPolyligne.type].step + "\x26nbsp;1\x3c/b\x3e\x3cbr/\x3e" + jQuery.imajnet.map[ImajnetPolyligne.type].step1Content + '\x3c/div\x3e\x3cdiv class\x3d"imajnetPreviewPanelItemArrow" id\x3d"imajnetPreviewPanelItemArrow1"\x3e\x3c/div\x3e\x3cdiv class\x3d"imajnetPreviewPanelItem imageTrace" id\x3d"imajnetPreviewPanelItem2"\x3e\x3cb\x3e' + jQuery.imajnet.map[ImajnetPolyligne.type].step + "\x26nbsp;2\x3c/b\x3e\x3cbr/\x3e" + jQuery.imajnet.map[ImajnetPolyligne.type].step2Content + '\x3c/div\x3e\x3cdiv class\x3d"imajnetPreviewPanelItemArrow" id\x3d"imajnetPreviewPanelItemArrow2"\x3e\x3c/div\x3e\x3cdiv class\x3d"imajnetPreviewPanelItem imageTrace" id\x3d"imajnetPreviewPanelItem3" onclick\x3d"ImajnetPolyligne.onFinishClick(); return false;" style\x3d"cursor: pointer; z-index: 2; position: relative;"\x3e\x3cb\x3e' + jQuery.imajnet.map[ImajnetPolyligne.type].step + "\x26nbsp;3\x3c/b\x3e\x3cbr/\x3e" + jQuery.imajnet.map[ImajnetPolyligne.type].step3Content + "\x3c/div\x3e\x3c/div\x3e");
        Nigsys.browserIsIE7() || Nigsys.browserIsIE8() || jQuery(".imajnetPreviewPanelItem").corner("5px");
    ...
    hide: function(a, c) {
        if (ImajnetPolyligne.type && !c)
            ImajnetPolyligne.onFinish(c);
        ImajnetUI.activeControlButton = "";
        jQuery("#imajnetPreviewPanel").hide();
    ...
    showHide: function(a) {
        ImajnetPolyligne.type && a != ImajnetPolyligne.type || !jQuery("#imajnetPolyligneButtonContainer" + ImajnetPolyligne.type).hasClass("buttonActive") ? (this.hide(!1, !1),
        ImajnetPolyligne.type = a,
        this.show(!0)) : (this.hide(!0, !1),
        LRS.cachedPoints[ImajnetMap.currentPosition.lat + ":" + ImajnetMap.currentPosition.lon + ":" + ImajnetMap.currentPosition.height] && ImajnetUI.LRSGUI.draw(LRS.cachedPoints[ImajnetMap.currentPosition.lat + ":" + ImajnetMap.currentPosition.lon + ":" + ImajnetMap.currentPosition.height]),
        Address.showAddress(),
        LRS.showLRS(),
        ImajnetUI.showDateContainer(),
    ...
    showHideDenied: function() {
        ImageControler.currentPhotogrammetry.photogrammetryIsDenied() ? jQuery("#polyligneDenied").show() : (jQuery("#polyligneDenied").hide(),
        Nigsys.isPolyligneMode() && 0 == ImageControler.currentPhotogrammetry.currentStep % 2 && ImageControler.currentPhotogrammetry.getConstraint())
    },
    reload: function(a) {
        jQuery("#imajnetPolyligneButtonContainer" + ImajnetPolyligne.type).hasClass("buttonActive") && (this.deleteLastSessionObjects(),
        a = ImajnetPolyligne.type,
        this.hide(!1, !0),
        ImajnetPolyligne.type = a,
        this.show(!1),
        ImajnetZoom.imageWasDragged = !1)
    ...
    getAllObjectsId: function(a) {
        for (var c = [], b = 0; b < ImageControler.currentPhotogrammetry.objects.length; b++)
            for (var d = 0; d < ImageControler.currentPhotogrammetry.objects[b].data.length; d++)
                if (-1 !== jQuery.inArray(ImageControler.currentPhotogrammetry.objects[b].data[d].type, ImajnetPolyligne.typesArray)) {
                    c.push(ImageControler.currentPhotogrammetry.objects[b].data[d].id);
                    var e = !1;
                    ImageControler.currentPhotogrammetry.objects[b].data[d].id == a && (e = !0);
                    for (var f = 0; f < ImageControler.currentPhotogrammetry.objects[b].data[d].points.length; f++)
                        c.push(ImageControler.currentPhotogrammetry.objects[b].data[d].points[f].id),
                        ImageControler.currentPhotogrammetry.objects[b].data[d].points[f].id == a && (e = !0);
                    if (e)
                        return c;
                    c = []
                }
    ...
    getTotalDistance: function(a) {
        for (var c = 0, b = 0; b < a.points.length; b++)
            "undefined" === typeof a.points[b].distance || isNaN(a.points[b].distance) || (c += a.points[b].distance);
        return c
    },
    getCurrentObjectMiddlePoint: function(a) {
        for (var c = ImajnetPolyligne.getTotalDistance(a) / 2, b = 0, d = 0; d < a.points.length; d++)
            if ("undefined" !== typeof a.points[d].distance && !isNaN(a.points[d].distance)) {
                if (b + a.points[d].distance > c)
                    return !a.points[d + 1] || b + a.points[d].distance / 2 > c ? a.points[d].photogrammetryPosition3D.coordinates : a.points[d + 1].photogrammetryPosition3D.coordinates;
    ...
    pointPositionComplete: function(a) {
        200 !== a.status && (ImajnetPolyligne.pointPositionError(),
        ImajnetUI.showError(jQuery.imajnet.map.position.errorPosition, !0))
    },
    positionObject: function(a, c, b) {
        ...
        if (1 == ImageControler.currentPhotogrammetry.currentStep % 2) {
            ...
            var e = null;
            "FLAT" == ImageControler.currentImageType ? (ImajnetUI.previewImage.attr("src", ImajnetAPI.buildImageURL(ImageControler.currentPhotogrammetry.firstImagePosition, ImajnetUI.getPreviewImageResolution())),
            e = ImajnetZoom.getRealImageCoordinates(a, c)) : (ImajnetUI.previewImage.attr("src", ImajnetAPI.buildImageURL(ImageControler.currentPhotogrammetry.firstImagePosition, ImajnetUI.getPreviewImageResolution()), d),
            e = {
                x: a,
                y: c
            });
            ...
            ImageControler.currentPhotogrammetry.hidePreviewPanel(),
            ImajnetZoom.imageQuality = "HIGH_RESOLUTION",
            e = "FLAT" == ImageControler.currentImageType ? ImajnetZoom.getRealImageCoordinates(a, c) : {
                x: a,
                y: c
            },
            ImageControler.currentGraphic.clearConstraints(),
    ...
    onFinish: function(a) {
        if (Imajnet.imajnetIsActive() && -1 != ImajnetPolyligne.currentAddObjectId)
            if (ImageControler.currentPhotogrammetry && ImageControler.currentPhotogrammetry.setRedStep(3),
            a = ImageControler.currentPhotogrammetry.getObjectById(ImajnetPolyligne.currentAddObjectId),
            ImajnetPolyligne.currentAddObjectId = -1,
            "polyligne" == ImajnetPolyligne.type && 2 > a.points.length || "polygon" == ImajnetPolyligne.type && 3 > a.points.length)
                ImageControler.currentPhotogrammetry.deletePhotogrammetryItem(a.id);
            else {
                ImageControler.currentPhotogrammetry.getObjectLRS(a);
                for (var c = [], b = 0; b < a.points.length; b++)
                    c.push({
                        x: a.points[b].photogrammetryPosition3D.coordinates.lon,
                        y: a.points[b].photogrammetryPosition3D.coordinates.lat
                    });
                "polygon" == ImajnetPolyligne.type && (a.points[a.points.length - 1].distance = ImageControler.currentPhotogrammetry.computeDistanceBetweenPoints(a.points[a.points.length - 1].photogrammetryPosition3D.coordinates, a.points[0].photogrammetryPosition3D.coordinates),
                c.push(c[0]));
                ...
                ImageControler.currentPhotogrammetry.drawObjectClipboard(a, !0);
                ImageControler.currentPhotogrammetry.updateCache()
            }
    }
};
var ImajnetImageSwitcher = {
    ...
    imageMouseScroll: function(a, b) {
        ...
        if (!(2 > ImajnetImageSwitcher.orientedImages[d].length)) {
            ...
            0 < b ? (ImajnetImageSwitcher.mouseScrollIndex++,
            ImajnetImageSwitcher.mouseScrollIndex >= c && (ImajnetImageSwitcher.mouseScrollIndex = 0)) : (ImajnetImageSwitcher.mouseScrollIndex--,
            0 > ImajnetImageSwitcher.mouseScrollIndex && (ImajnetImageSwitcher.mouseScrollIndex = c - 1));
    ...
    getOneImageFormEachSecquenceTraceTimestampOrdered: function() {
        if (!this.orientedImages || !this.orientedImages[0])
            return null;
        var a = Nigsys.cloneObject(ImajnetMap.currentPosition);
        a.imageIndex = 0;
        var b = Array(a);
        jQuery.each(this.orientedImages[0], function(a, c) {
            for (var e = !1, g = 0; g < b.length; g++)
                if (b[g].traceId == c.traceId) {
                    e = !0;
                    break
                }
            e || c.traceId == ImajnetMap.currentPosition.traceId || (e = Nigsys.cloneObject(c),
            e.imageIndex = a,
            b.push(e))
        });
    ...
    loadImageForSlider: function(a, b) {
        var d = ImajnetAPI.buildImageURL(b)
          , c = new Image;
    ...
    loadImage: function(a, b, d) {
        ...
        var c = null
          , c = d && 0 == a && -1 == b ? ImajnetMap.currentPosition : this.orientedImages[a][b]
        ...
        ImajnetMap.hideImageSwitcher();
        ImajnetMap.setOrientationMarker(c, ImajnetMap.imajboxOrientedImagesDimension, "#FF0000", -3);
    ...
    goToImage: function(a) {
        ...
        this.orientedImages[a][b] && (Nigsys.showLoading(ImajnetUI.imageContainer),
        ImajnetAPI.setImajnetImage({
            position: this.orientedImages[a][b]
        }))
    },
    goToOrderedImage: function(a) {
        ...
        this.orderedImages[a] && (Nigsys.showLoading(ImajnetUI.imageContainer),
        ImajnetAPI.setImajnetImage({
            position: this.orderedImages[a]
        }))
    },
    ...
    applySmallStyleToOrderedImages: function() {
        ...
        jQuery(".scrollOrderedImagesLeftImage").width(9).height(ImajnetImageSwitcher.ORDERED_IMAGE_HEIGHT).css("background-image", 'url("' + Imajnet.imajnetPath + "img/imageIcons/imageSwitcherLeftArrow.png?" + Imajnet.version + '")').css("margin-top", ImajnetImageSwitcher.ORDERED_IMAGE_HEIGHT / 2 - 25);
        jQuery(".scrollOrderedImagesRight").width(9).height(ImajnetImageSwitcher.ORDERED_IMAGE_HEIGHT);
        jQuery(".scrollOrderedImagesRightImage").width(9).height(ImajnetImageSwitcher.ORDERED_IMAGE_HEIGHT).css("background-image", 'url("' + Imajnet.imajnetPath + "img/imageIcons/imageSwitcherRightArrow.png?" + Imajnet.version + '")').css("margin-top", ImajnetImageSwitcher.ORDERED_IMAGE_HEIGHT / 2 - 25);
        var a = 1;
        ...
        ImajnetImageSwitcher.orderedImagesMainContainer.width(ImajnetImageSwitcher.ORDERED_IMAGES_NO * ImajnetImageSwitcher.ORDERED_IMAGE_WIDTH + 20).height(ImajnetImageSwitcher.ORDERED_IMAGE_HEIGHT + ImajnetImageSwitcher.ORDERED_IMAGE_DATE_HEIGHT + 2);
    ...
    centerImageMouseOver: function() {
        ...
        jQuery.each(this.orderedImages, function(b, d) {
            var c = d.imageIndex;
            d.traceId == ImajnetMap.currentPosition.traceId && (a = b,
            c = -1,
            0 == b && ImajnetImageSwitcher.orderedImagesLength < ImajnetImageSwitcher.ORDERED_IMAGES_NO && (ImajnetImageSwitcher.orderedImagesContainer.append(ImajnetImageSwitcher.getOrderedImageHtml(-2, Imajnet.imajnetPath + "img/imageIcons/imageSwitcherNoImageLeft.png?" + Imajnet.version, "")),
            ImajnetImageSwitcher.orderedImagesLength++));
            ImajnetImageSwitcher.orderedImagesContainer.append(ImajnetImageSwitcher.getOrderedImageHtml(c, "", d.timestamp, b));
            var e = ImajnetAPI.buildImageURL(d)
              , c = new Image;
            jQuery(c).bind("error", {
                id: b,
                url: e
            ...
            b == ImajnetImageSwitcher.orderedImages.length - 1 && ImajnetImageSwitcher.orderedImagesLength < ImajnetImageSwitcher.ORDERED_IMAGES_NO && (ImajnetImageSwitcher.orderedImagesContainer.append(ImajnetImageSwitcher.getOrderedImageHtml(-2, Imajnet.imajnetPath + "img/imageIcons/imageSwitcherNoImageRight.png?" + Imajnet.version, "")),
            ImajnetImageSwitcher.orderedImagesLength++)
        });
    ...
    applyBigStyleToOrderedImages: function() {
        ...
        jQuery(".scrollOrderedImagesLeftImage").width(50).height(50).css("background-image", 'url("' + Imajnet.imajnetPath + "img/imageIcons/imageSwitcherLeftArrow.png?" + Imajnet.version + '")').css("margin-top", ImajnetImageSwitcher.ORDERED_IMAGE_BIG_HEIGHT / 2 - 25);
        ...
        a.removeAttr("title");
        a.width(ImajnetImageSwitcher.ORDERED_IMAGE_BIG_WIDTH).height(ImajnetImageSwitcher.ORDERED_IMAGE_DATE_BIG_HEIGHT).css("font-size", ImajnetImageSwitcher.ORDERED_IMAGE_DATE_BIG_HEIGHT - 1);
        for (var b = 0; b < a.length; b++)
            a[b].innerHTML = Nigsys.formatImajnetImageDate(a[b].innerHTML);
        ...
        ImajnetImageSwitcher.orderedImagesContainer.width(this.orderedImagesLength * this.ORDERED_IMAGE_BIG_WIDTH).height(ImajnetImageSwitcher.ORDERED_IMAGE_BIG_HEIGHT + ImajnetImageSwitcher.ORDERED_IMAGE_DATE_BIG_HEIGHT + 2);
        ...
        ImajnetImageSwitcher.orderedImagesMainContainer.width(ImajnetImageSwitcher.ORDERED_IMAGES_NO * ImajnetImageSwitcher.ORDERED_IMAGE_BIG_WIDTH + 60).height(ImajnetImageSwitcher.ORDERED_IMAGE_BIG_HEIGHT + ImajnetImageSwitcher.ORDERED_IMAGE_DATE_BIG_HEIGHT + 2);
    ...
    centerImageClick: function(a) {
        a.relatedTarget || (ImajnetImageSwitcher.isBigMode = !0,
        ImajnetImageSwitcher.applyBigStyleToOrderedImages(),
        jQuery.colorbox({
    ...
    orderedImageMouseOver: function(a, b) {
        ...
        -1 > a || (ImajnetImageSwitcher.orderedImagesMainContainer.show(),
        this.loadImage(0, a, !0))
    },
    ...
    scrollOrderedImages: function(a) {
        ...
        if (!(ImajnetImageSwitcher.orderedImagesContainer.width() <= ImajnetImageSwitcher.ORDERED_IMAGES_NO * b)) {
            var d = jQuery(".imajnetImageSwitcherOrderedImagesInnerContainer")
              , c = d.scrollLeft();
            a == ImajnetAPI.PREVIOUS ? (c -= b,
            0 >= c && jQuery(".scrollOrderedImagesLeftImage").addClass("opacity0"),
            jQuery(".scrollOrderedImagesRightImage").removeClass("opacity0")) : (c += b,
            c >= ImajnetImageSwitcher.orderedImagesContainer.width() - ImajnetImageSwitcher.ORDERED_IMAGES_NO * b && jQuery(".scrollOrderedImagesRightImage").addClass("opacity0"),
            jQuery(".scrollOrderedImagesLeftImage").removeClass("opacity0"));
            d.scrollLeft(c)
        }
    },
    ...
    dragSliderLeft: function() {
        ImajnetImageSwitcher.dragLeftPosition && (ImajnetZoom.left = -1,
        ImajnetUI.imajnetImageSliderInnerContainer.css("left", 0),
        Nigsys.showLoading(ImajnetUI.imageContainer),
        ImajnetAPI.setImajnetImage({
            position: ImajnetImageSwitcher.dragLeftPosition
        }))
    },
    dragSliderRight: function() {
        ImajnetImageSwitcher.dragRightPosition && (ImajnetZoom.left = -1,
        ImajnetUI.imajnetImageSliderInnerContainer.css("left", -2 * (ImajnetUI.imageContainer.width() + ImajnetImageSwitcher.dragArrowWidth)),
        Nigsys.showLoading(ImajnetUI.imageContainer),
        ImajnetAPI.setImajnetImage({
            position: ImajnetImageSwitcher.dragRightPosition
        }))
    },
        ...
        if (ImajnetMap.currentPosition) {
            ...
            jQuery.each(a, function(a, f) {
                if (f.id != ImajnetMap.currentPosition.id) {
                    ...
                    0 == h ? f.traceId == ImajnetMap.currentPosition.traceId ? parseInt(f.id) < parseInt(ImajnetMap.currentPosition.id) ? b.push(f) : ImajnetImageSwitcher.frontOrientedImages.push(f) : d.push(f) : 1 != h || g ? 2 != h || k ? 6 != h || e ? 7 != h || c || (c = f) : e = f : k = f : g = f
                }
            });
            c ? (ImajnetImageSwitcher.dragLeftPosition = c,
            jQuery("#imajnetLayerLeftArrowImage").attr("src", Imajnet.imajnetPath + "img/imageSwitcher/7.png?" + Imajnet.version)) : (ImajnetImageSwitcher.dragLeftPosition = e,
            jQuery("#imajnetLayerLeftArrowImage").attr("src", Imajnet.imajnetPath + "img/imageSwitcher/6.png?" + Imajnet.version));
            g ? (ImajnetImageSwitcher.dragRightPosition = g,
            jQuery("#imajnetLayerRightArrowImage").attr("src", Imajnet.imajnetPath + "img/imageSwitcher/1.png?" + Imajnet.version)) : (ImajnetImageSwitcher.dragRightPosition = k,
            jQuery("#imajnetLayerRightArrowImage").attr("src", Imajnet.imajnetPath + "img/imageSwitcher/2.png?" + Imajnet.version));
            ...
            for (a = 0; a < d.length; a++)
                ImajnetImageSwitcher.frontOrientedImages.push(d[a]);
            b.sort(ImajnetImageSwitcher.compareImageId);
            for (a = 0; a < b.length; a++)
                ImajnetImageSwitcher.frontOrientedImages.push(b[a]);
            a = "";
    ...
    onClosestImagesReceived: function(a) {
        ...
        ImajnetUI.enableImageDrag();
        if (a && (a = JSON.parse(a),
        a.parameter && a.positions && ImajnetMap.currentPosition && a.parameter.coordinates.id == ImajnetMap.currentPosition.id)) {
            jQuery("#imajnetImageSwitcher").html(ImajnetImageSwitcher.getImageSwitcherHtml(a.positions));
            for (a = 0; 8 > a; a++)
                jQuery("#orientedImage_" + a).on("mousewheel DOMMouseScroll", a, function(a, d) {
            ...
            ImajnetImageSwitcher.orientedImages[0] && ImajnetImageSwitcher.orderedImages && 1 < ImajnetImageSwitcher.orderedImages.length ? jQuery("#imajnetImageSwitcherCenterImage").bind({
                ...
                mouseout: function(a) {
                    a.relatedTarget && Nigsys.stringContains(a.relatedTarget.className, "orderedImageDate") || ImajnetImageSwitcher.centerImageMouseOut()
                },
            ...
            ImajnetImageSwitcher.orderedImagesMainContainer.mouseout(function(a) {
                a.relatedTarget && Nigsys.stringContains(a.relatedTarget.className, "imageSwitcherItem") && ImajnetImageSwitcher.orderedImagesMouseOut(a)
            });
    ...
    loadImageSwitcher: function(a) {
        ...
        this.closestImagesAjaxRequest = ImajnetAPI.doImajnetRequest("GET", "/api/positions/proximity/", a, this.onClosestImagesReceived, this.onClosestImagesError, null, null, !0, null, null)
    },
    clearSlider: function() {
        ImajnetUI.sliderLeftImage && (ImajnetUI.sliderLeftImage.remove(),
        ImajnetUI.sliderLeftImage = null);
        ImajnetUI.sliderRightImage && (ImajnetUI.sliderRightImage.remove(),
        ImajnetUI.sliderRightImage = null);
    ...
    clearImageSwitcher: function() {
        ...
        ImajnetUI.imageSwitcherImage && ImajnetUI.imageSwitcherImage.attr("src", "");
        ImajnetUI.imageSwitcherImageContainer && (ImajnetUI.imageSwitcherImageContainer.hide(),
...
var Base64 = {
    ...
    _utf8_decode: function(c) {
        for (var a = "", d = 0, b = c1 = c2 = 0; d < c.length; )
            b = c.charCodeAt(d),
            128 > b ? (a += String.fromCharCode(b),
            d++) : 191 < b && 224 > b ? (c2 = c.charCodeAt(d + 1),
            a += String.fromCharCode((b & 31) << 6 | c2 & 63),
            d += 2) : (c2 = c.charCodeAt(d + 1),
            c3 = c.charCodeAt(d + 2),
...
var ImajnetNews = {
    ...
    showTooltip: function(a, b) {
        for (var c = 0; c < ImajnetNews.newsData.length; c++)
            if (ImajnetNews.newsData[c].id == b) {
                Nigsys.showTooltip(a, ImajnetNews.getNewsItemHTML(ImajnetNews.newsData[c], !0, !1));
                break
            }
    },
    getNewsItemHTML: function(a, b, c, d) {
        return '\x3cdiv class\x3d"newsItemMainContainer' + (c ? " oldNewsItem" : "") + (0 !== d % 2 ? " itemOdd" : "") + '"' + (b ? "" : " onmouseover\x3d\"ImajnetNews.showTooltip(event, '" + a.id + '\');" onmouseout\x3d"Nigsys.hideTooltip();"') + '\x3e\x3cdiv class\x3d"left newsImageContainer"\x3e\x3cimg src\x3d"' + Imajnet.imajnetPath + "img/news/" + a.type + ".png?" + Imajnet.version + '" class\x3d"newsImage" /\x3e\x3c/div\x3e\x3cdiv class\x3d"left newsItemContainer"\x3e\x3cdiv class\x3d"newsTitle' + (b ? "" : " noOverflow") + '"\x3e' + this.getTitleDate(a.created) + a.title + '\x3c/div\x3e\x3cdiv class\x3d"newsContent' + (b ? "" : " noOverflow") + '"\x3e' + a.content + '\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e'
    },
    formatServerDate: function(a) {
        if (!a)
    ...
    onNewsReceived: function(a, b) {
        ...
        if (!b.isFirstLoad || d)
            ImajnetUI.newsContainer.html(c ? c : jQuery.imajnet.noNews),
            b.isFirstLoad && Imajnet.activateImajnetControl(jQuery("#newsContainerIdButton"), "showNews"),
            ImajnetUI.showItem(ImajnetUI.newsContainerId, 530, 500)
    },
    checkForNews: function(a) {
        ImajnetAPI.doImajnetRequest("GET", "/api/news/latest.json", null, ImajnetNews.onNewsReceived, null, null, null, null, {
            isFirstLoad: a
        })
    },
    init: function(a) {
...
Address = {
    ...
    init: function() {
        if (ImajnetUI.imageContainer) {
            this.initContainers();
            this.addressContainer || (ImajnetUI.imageContainer.append('\x3cdiv id\x3d"addressContainerDiv" class\x3d"address addressAndLRS"\x3e\x3c/div\x3e'),
            this.addressContainer = jQuery("#addressContainerDiv"));
            var a = "";
            ...
            ImajnetLRSSettings.LRSSettings.display.addressAndLRS.imajnetSettingsAddressInLRS ? (this.addressContainer.removeClass("addressLeft"),
            this.addressContainer.addClass("addressRight").width(190),
            LRS.LRSContainer && LRS.LRSContainer.is(":visible") && (a = "bottom")) : (this.addressContainer.removeClass("addressRight"),
            this.addressContainer.addClass("addressLeft"));
    ...
    initSearchAddress: function() {
        ...
        this.currentSearchOption == this.OPTIONS_OSM ? a += '\x3cdiv class\x3d"left" style\x3d"margin: 0 30px 0 10px;"\x3e\x3cinput type\x3d"text" id\x3d"searchAddressInput" size\x3d"37" style\x3d"padding-left: 10px;" /\x3e\x3c/div\x3e' : this.currentSearchOption == this.OPTIONS_SPECTRUM && (a += '\x3cdiv\x3e\x3cdiv class\x3d"left" style\x3d"width: 100px;"\x3e' + jQuery.imajnet.map.popupSearchAddress.spectrumStreet + '\x3c/div\x3e\x3cdiv class\x3d"left"\x3e\x3cinput type\x3d"text" id\x3d"searchAddressStreetInput" size\x3d"29" /\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3cdiv\x3e\x3cdiv class\x3d"left" style\x3d"width: 100px;"\x3e' + jQuery.imajnet.map.popupSearchAddress.spectrumCity + '\x3c/div\x3e\x3cdiv class\x3d"left"\x3e\x3cinput type\x3d"text" id\x3d"searchAddressCityInput" size\x3d"29" /\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3cdiv\x3e\x3cdiv class\x3d"left" style\x3d"width: 100px;"\x3e' + jQuery.imajnet.map.popupSearchAddress.spectrumCountry + '\x3c/div\x3e\x3cdiv class\x3d"left"\x3e\x3cinput type\x3d"text" id\x3d"searchAddressCountryInput" size\x3d"29" value\x3d"France" /\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e');
        a += '\x3cdiv class\x3d"left" style\x3d"margin-bottom: 10px;"\x3e\x3cinput type\x3d"button" value\x3d"' + jQuery.app.button.cancel + '" onclick\x3d"Dialog.hideDialog(\'' + ImajnetUI.searchAddressContainerId + '\');" class\x3d"dialogButton dialogButtonCancel"\x3e\x3cinput type\x3d"button" id\x3d"searchAddress" value\x3d"' + jQuery.imajnet.map.popupSearchAddress.buttonSearchName + '" onclick\x3d"Address.getAddressFromString();" class\x3d"dialogButton buttonSearch" /\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv id\x3d"searchResultsDiv" class\x3d"clearLeft light14Blue"\x3e\x3c/div\x3e\x3c/div\x3e';
    ...
    setAddress: function(a, c) {
        a && "" != jQuery.trim(a) ? this.addressContainer && (this.addressContainer.html(a),
        this.addressContainer.attr("title", c ? c : a),
        Nigsys.isPositionMode() || Nigsys.isMeasurementMode() || Nigsys.isPolyligneMode() || jQuery("#imajnetPhotogrammetryZoomedImageContainer").is(":visible") || (this.addressContainer.show(),
        this.init(),
    ...
    getSpectrumAddress: function(a) {
        ...
        this.addressRequest = jQuery.ajax({
            ...
            success: function(a, b, e) {
                ...
                null !== b ? (a = (void 0 !== b.AddressLine1 ? b.AddressLine1 + ", " : "") + (void 0 !== b.City ? b.City + ", " : "") + (void 0 !== b.County ? b.County + ", " : "") + (void 0 !== b.StateProvince ? b.StateProvince + ", " : "") + "France",
                "France" != a ? Address.setAddress(a) : Address.hideAddress()) : Address.hideAddress()
            },
        ...
        this.addressRequest = jQuery.ajax({
            ...
            success: function(a) {
                ...
                if (!jQuery.isEmptyObject(a) && jQuery.isArray(a)) {
                    var b = 0;
                    jQuery.each(a, function(a, d) {
                        "" != d.lon && "" != d.lat && jQuery("#searchResultsDiv").append("\x3cdiv onclick\x3d\"Address.onAddressClick('" + d.lon + "','" + d.lat + "');\"" + (0 == b % 2 ? ' class\x3d"searchAddressItemContainer itemOdd"' : ' class\x3d"searchAddressItemContainer itemEven"') + '\x3e\x3cdiv class\x3d"searchAddressItemImageContainer left"\x3e\x3cimg src\x3d"' + applicationUrl + "resources/img/buttons/BTN-FF1.PNG?" + Imajnet.version + '" class\x3d"searchAddressItemImage" /\x3e\x3c/div\x3e\x3cdiv class\x3d"left searchAddressItemDescriptionContainer"\x3e' + (void 0 !== d.display_name && "" != jQuery.trim(d.display_name) ? '\x3cdiv style\x3d"font-weight: bold;"\x3e' + d.display_name + "\x3c/div\x3e" : "") + "\x3cdiv\x3e" + jQuery.imajnet.map.popupSearchAddress.longitude + ": " + d.lon + "\x3c/div\x3e\x3cdiv\x3e" + jQuery.imajnet.map.popupSearchAddress.latitude + ": " + d.lat + '\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e');
                        b++
                    });
                    1 == b && (Address.onAddressClick(a[0].lon, a[0].lat),
                    Address.closeSearchDialog())
                } else
                    jQuery("#searchResultsDiv").html('\x3cdiv class\x3d"error"\x3e' + jQuery.imajnet.map.popupSearchAddress.noResultsFound + "\x3c/div\x3e");
                    ...
                    if (null !== b) {
                        ...
                        jQuery.each(b, function(a, b) {
                            if (void 0 != b.Latitude && "" != b.Longitude && void 0 != b.Latitude && "" != b.Latitude) {
                                var c = (void 0 !== b.AddressLine1 && "" !== b.AddressLine1 ? b.AddressLine1 + ", " : "") + (void 0 !== b.City && "" !== b.City ? b.City + ", " : "") + (void 0 !== b.County && "" !== b.County ? b.County + ", " : "") + (void 0 !== b.StateProvince && "" !== b.StateProvince ? b.StateProvince + ", " : "") + (void 0 !== b.Country && "" !== b.Country ? b.Country + ", " : "");
                                jQuery("#searchResultsDiv").append("\x3cdiv onclick\x3d\"Address.onAddressClick('" + b.Longitude + "','" + b.Latitude + "');\"" + (0 == f % 2 ? ' class\x3d"itemOdd"' : ' class\x3d"itemEven"') + "\x3e" + ("" != jQuery.trim(c) ? '\x3cdiv style\x3d"font-weight: bold;"\x3e' + c + "\x3c/div\x3e" : "") + "\x3cdiv\x3e" + jQuery.imajnet.map.popupSearchAddress.longitude + ": " + b.Longitude + "\x3c/div\x3e\x3cdiv\x3e" + jQuery.imajnet.map.popupSearchAddress.latitude + ": " + b.Latitude + "\x3c/div\x3e\x3c/div\x3e");
                                k = !0
                            }
                            0 == f && (g = b.Longitude,
                            h = b.Latitude);
                        ...
                        k ? g && h && (Address.onAddressClick(g, h),
                        Address.closeSearchDialog()) : jQuery("#searchResultsDiv").html('\x3cdiv class\x3d"error"\x3e' + jQuery.imajnet.map.popupSearchAddress.noResultsFound + "\x3c/div\x3e")
                    } else
                        jQuery("#searchResultsDiv").html('\x3cdiv class\x3d"error"\x3e' + jQuery.imajnet.map.popupSearchAddress.error + "\x3c/div\x3e")
                }
                Nigsys.hideLoading(jQuery("#searchResultsDiv"))
    ...
    getAddressFromString: function(a) {
        ...
        if (this.currentSearchOption == this.OPTIONS_OSM)
            a = jQuery.trim(jQuery("#searchAddressInput").val()),
            "" !== a ? this.getAddressOSMForString(a) : jQuery("#searchResultsDiv").html('\x3cdiv class\x3d"error"\x3e' + jQuery.imajnet.map.popupSearchAddress.noResultsFound + "\x3c/div\x3e");
        else if (this.currentSearchOption == this.OPTIONS_SPECTRUM) {
            a = jQuery.trim(jQuery("#searchAddressStreetInput").val());
    ...
    openSearchDialog: function() {
        ...
        ImajnetUI.showItem(ImajnetUI.searchAddressContainerId, Nigsys.browserIsIE7() ? 425 : null)
    },
...
LRS = {
    ...
    maxRoadsInSelect: 100,
    checkIfLRSAccess: function() {
        var a = jQuery.Deferred();
        LRSRequest.onGetLRSRoads(0, null, function(b, c) {
    ...
    transformToSquareMeters: function(a, b) {
    ...
    getRoadType: function(a) {
        if (!LRS.roadsData || !LRS.roadsData.roads)
            return LRS.defaultUnit;
        for (var b = 0; b < LRS.roadsData.roads.length; b++)
            if (LRS.roadsData.roads[b].id == a)
                return LRS.roadsData.roads[b].unit;
        return LRS.defaultUnit
    },
    getCachedLRSByObjectId: function(a) {
        for (var b in LRS.cachedPoints)
            if (LRS.cachedPoints[b].id == a)
                return LRS.cachedPoints[b];
        return null
    },
    transformReceivedLinearPositionItem: function(a) {
        a && a.road && !a.road.unit && (a.road.unit = LRS.defaultUnit);
        a && a.road && a.road.unit && (a.lateralOffset = LRS.transformFromMeters(a.lateralOffset, LRS.getRoadUnitType(a.road.unit)),
        a.relativeAbscisa = LRS.transformFromMeters(a.relativeAbscisa, LRS.getRoadUnitType(a.road.unit)),
        a.cumulatedAbscisa = LRS.transformFromMeters(a.cumulatedAbscisa, LRS.getRoadUnitType(a.road.unit)))
    },
    transformReceivedLinearPosition: function(a) {
        if (jQuery.isArray(a))
            for (var b = 0; b < a.length; b++)
                LRS.transformReceivedLinearPositionItem(a[b]);
        else
            LRS.transformReceivedLinearPositionItem(a)
    },
    getTopologyRequestData: function(a) {
        var b = {
            prNumber: a.startPR,
            relativeAbscisa: a.startAbscisa ? a.startAbscisa : 0
        }
          , c = {
            prNumber: a.endPR,
            relativeAbscisa: a.endAbscisa ? a.endAbscisa : 0
        };
        if (b.prNumber > c.prNumber || b.prNumber == c.prNumber && b.relativeAbscisa > c.relativeAbscisa)
            var d = b
              , b = c
              , c = d;
        return {
    ...
    getSelectedLRSType: function() {
        ...
        jQuery.each(jQuery("input:image[name\x3dLRSType]"), function(b, c) {
            if (-1 !== c.className.indexOf("opacity60"))
                return a = c.value,
                !1
        });
        return a
    ...
    init: function() {
        ...
        var a = "5"
          , b = "";
        ImajnetLRSSettings.LRSSettings.display.addressAndLRS.imajnetSettingsAddressInLRS && Address.addressContainer && Address.addressContainer.is(":visible") && (b = "top",
        a = ImajnetLRSSettings.LRSSettings.display.addressAndLRS.imajnetSettingsAddressDisplayType == ImajnetLRSSettings.ADDRESS_MODE.FULL ? 47 : 22);
    ...
    showLRS: function() {
        "" != LRS.LRSContainer.html() && LRS.LRSContainer.html() != jQuery.imajnet.loading && LRS.LRSContainer.show()
    },
    setImajnetImageLRS: function(a) {
        this.init();
        var b = LRSRequest.fillLRSContent(a, !0);
        this.LRSContainer.html(b.HTML);
        Nigsys.isPositionMode() || Nigsys.isMeasurementMode() || Nigsys.isPolyligneMode() || (ImajnetUI.LRSGUI.draw(a),
        this.LRSContainer.show(),
        "undefined" !== typeof Address && Address.init())
    },
    ...
    onGetLRSSuccess: function(a, b) {
        if (a && a.linearPosition)
            ImajnetUI.LRSGUI.isDragMode = !1,
            ImajnetUI.LRSGUI.isZoomMode = !1,
            a.parameter && a.parameter.position ? (ImajnetMap.currentPosition && (a.parameter.position.id = ImajnetMap.currentPosition.id),
            LRS.cachedPoints[a.parameter.position.lat + ":" + a.parameter.position.lon + ":" + a.parameter.position.height] = a,
            ("undefined" === typeof ImajnetMap || ImajnetMap.currentPosition && ImajnetMap.currentPosition.lon == a.parameter.position.lon && ImajnetMap.currentPosition.lat == a.parameter.position.lat && ImajnetMap.currentPosition.height == a.parameter.position.height) && LRS.setImajnetImageLRS(a)) : LRS.hideLRS();
        else
            LRS.onGetLRSError()
    },
    ...
    loadLRS: function(a) {
        if (a)
            LRS.getLRS(a, LRS.onGetLRSSuccess, LRS.onGetLRSError, {
                LRSObject: ImajnetUI.LRSGUI
            });
        else if ("function" == typeof LRS.onGetLRSError)
            LRS.onGetLRSError()
    },
    ...
    getLRS: function(a, b, c, d) {
        ...
        void 0 !== e && e ? b(e, d) : (e = {},
        e.position = a,
        e.range = ImajnetSettings.rangeLRS,
        LRSRequest.getLRS(JSON.stringify(e), b, c, d))
    },
    getLRSForGPS: function(a, b, c) {
        ...
        void 0 !== d && d ? b(d) : (d = {},
        d.position = a,
        d.range = ImajnetSettings.rangeLRS,
        LRSRequest.getLRSForGPS(JSON.stringify(d), b, c))
    },
    ...
    hideLRSContainer: function() {
        this.LRSContainer && (LRS.currentImageLRS = null,
        this.LRSContainer.hide())
    },
    removeLRS: function() {
        jQuery("#imajnetImageLRSInTitle").hide();
    ...
    search: function() {
        ...
        if (a.roadIdentifier) {
            a.prNumber = jQuery("#LRSPRSelect").val();
    ...
    onGetRoadSuccess: function(a) {
        var b = jQuery("#LRSPRSelect")
          , c = '\x3coption value\x3d""\x3e\x3c/option\x3e';
        if (a && a.pr) {
            for (var d = "", e = "", f = 0; f < a.pr.length; f++)
                0 == f ? (d = ' selected\x3d"selected"',
                e = a.pr[f].prNumber,
                LRS.changeLRSPR(a.pr[f].prNumber)) : d = "",
                c += '\x3coption value\x3d"' + a.pr[f].prNumber + '"' + d + "\x3e" + a.pr[f].prNumber + "\x3c/option\x3e";
    ...
    changeLRSRoad: function(a) {
        var b = jQuery("#LRSPRSelect");
        "" !== a.val() ? (Nigsys.getComboboxInputContainer(b).val(""),
        b.html('\x3coption value\x3d""\x3e\x3c/option\x3e'),
        LRSRequest.getRoad(a.val(), this.onGetRoadSuccess, this.onGetRoadError),
        Nigsys.changeComboboxDisabledState(b, !1),
        b.prop("disabled", !1),
        jQuery("#LRSSearchCumulated").prop("disabled", !1)) : (Nigsys.changeComboboxDisabledState(b, !0),
        b.prop("disabled", !0),
        jQuery("#LRSSearchRelative").prop("disabled", !0),
    ...
    changeLRSPR: function(a) {
        "" !== a ? (LRS.isSearchRelative = !0,
        jQuery("#LRSSearchRelative").val("0"),
        jQuery("#LRSSearchRelative").prop("disabled", !1),
        jQuery("#LRSSearchCumulated").val("")) : (jQuery("#LRSSearchRelative").val(""),
        jQuery("#LRSSearchCumulated").val(""),
        jQuery("#LRSSearchRelative").prop("disabled", !0));
        jQuery("#searchLRSSubmit").prop("disabled", !0);
    ...
    numbersOnly: function(a, b) {
        jQuery("#searchLRSSubmit").prop("disabled", !1);
        if ("searchRelative" == b)
            LRS.isSearchRelative = !0;
        else if ("searchCumulated" == b) {
            LRS.isSearchRelative = !1;
    ...
    getLabelsValueFromSettings: function(a, b) {
        if (!ImajnetLRSSettings.LRSSettings)
            return null;
        var c = jQuery.imajnet.settings.LRS.road
          , d = "road";
        2 == a && (c = jQuery.imajnet.settings.LRS.train,
        d = "train");
        return {
            roadLabel: c,
    ...
    addLRSDialog: function() {
        ...
        jQuery(".ui-combobox-LRSRoadSelect .ui-combobox-input").attr("placeholder", jQuery.imajnet.map.popupSearchLRS.roadInputPlaceholder);
    ...
    getFirstLRS: function(a) {
        ...
        a.linearPosition && a.linearPosition[0] && (b = a.linearPosition[0]);
        return b
    },
    ...
    getLRSForPointsHTML: function(a, b, c) {
        var d = '\x3cdiv class\x3d"popupContentContainer optionsGroup LRSFeatures"\x3e\x3cdiv class\x3d"popupContentContainerTitle"\x3e' + jQuery.imajnet.settings.LRS.title + '\x3c/div\x3e\x3cdiv class\x3d"featureLRSContentContainer"\x3e';
        "addFeature" != a.type || a.feature || (a.feature = new ol.Feature(null));
        if (!b)
            return "addFeature" == a.type || "editFeature" == a.type ? d : jQuery.app.notifications.noLRS;
        Feature.imajnetLRSObjectToFeatureObject(a.feature, b, c);
        "addFeature" == a.type && (Feature.addNewFeatureFirstLRS = jQuery.extend(Feature.addNewFeatureFirstLRS, a.feature.getProperties()));
        a = LRS.getLabelsValueFromSettings(b.road.type, "referential");
        b.road.name && (d += '\x3cdiv class\x3d"left LRSFeatureItemName featureLRSRoadLabel"\x3e\x3cb\x3e' + a.roadLabel + '\x3c/b\x3e:\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left"\x3e' + b.road.name + '\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e');
        LRS.getRoadUnitType(b.road.unit);
        b.cumulatedAbscisa && (d += '\x3cdiv class\x3d"featureLRSCumulatedAbscisaLabel"' + (ImajnetLRSSettings.LRSSettings.display.addressAndLRS.imajnetSettingsLRSShowCumulated ? "" : ' style\x3d"display: none;"') + '\x3e\x3cdiv class\x3d"left LRSFeatureItemName"\x3e\x3cb\x3e' + a.cumulatedAbscisaLabel + '\x3c/b\x3e:\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left"\x3e' + Math.round(b.cumulatedAbscisa) + '\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e');
    ...
    getCoordinatesFromRelativeLRS: function(a, b, c) {
        ...
        ImajnetAPI.doImajnetRequest("GET", a, null, null, null, null, null, null, null).done(function(a) {
    ...
    getCoordinatesFromLRS: function(a, b) {
        var c = jQuery.Deferred();
        if (!a || !a.roadIdentifier && !a.roadName)
            return c.reject();
        var d = "/api/lrs/"
          , e = {};
        a.roadIdentifier && (e.roadIdentifier = a.roadIdentifier);
        e.roadName = a.roadName;
        LRS.isSearchRelative || b ? (e.prNumber = a.prNumber ? a.prNumber : 0,
        e.relativeAbscisa = a.relativeAbscisa ? a.relativeAbscisa : 0,
        d += "relative/") : (e.cumulatedAbscisa = a.cumulatedAbscisa ? a.cumulatedAbscisa : 0,
        d += "absolute/");
        d += encodeURIComponent(JSON.stringify(e));
        searchLRSAjaxRequest = ImajnetAPI.doImajnetRequest("GET", d, null, null, null, null, null, null, null).done(function(a) {
...
LRSRequest = {
    ...
    getLRSFieldsCondensed: function(a, d) {
        ...
        if (!a)
            return {
                roadName: "",
                HTML: jQuery.imajnet.map.errors.noLRS
            };
        ...
        var c = "";
        a.road.name && (c += '\x3cdiv class\x3d"LRSImageItemRoad"\x3e' + a.road.name + "\x3c/div\x3e");
    ...
    getLRSFields: function(a, d) {
        ...
        a.cumulatedAbscisa && (b += '\x3cdiv class\x3d"LRSImageItem"' + (ImajnetLRSSettings.LRSSettings.display.addressAndLRS.imajnetSettingsLRSShowCumulated ? "" : ' style\x3d"display: none;"') + '\x3e\x3cdiv id\x3d"imajnetImageLRSCumulatedAbscisaLabel" class\x3d"left LRSItemName"\x3e\x3cb\x3e' + c.cumulatedAbscisaLabel + '\x3c/b\x3e:\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left LRSItemValue"\x3e' + Math.floor(a.cumulatedAbscisa + .5) + '\x3c/div\x3e\x3cdiv class\x3d"clearLeft"\x3e\x3c/div\x3e\x3c/div\x3e');
        a.relativeAbscisa && (b += '\x3cdiv class\x3d"LRSImageItem"\x3e\x3cdiv class\x3d"left LRSItemName"\x3e\x3cb\x3e' + c.relativePointLabel + '\x3c/b\x3e:\x26nbsp;\x3c/div\x3e\x3cdiv class\x3d"left LRSItemValue"\x3e(' + a.keyPoint.prNumber + "+" + Math.floor(a.relativeAbscisa + .5) + ")\x3c/div\x3e\x3c/div\x3e");
        return {
            roadName: a.road.name,
            HTML: b
        }
    ...
    doLinearPositionRequest: function(a, d, c, b) {
        if (LRS.noRoads)
            ...
            return ImajnetAPI.doImajnetRequest("GET", "/api/lrs/linearposition/" + encodeURIComponent(a), null, function(a, c) {
                "function" === typeof d && (a = JSON.parse(a),
                LRS.transformReceivedLinearPosition(a.linearPosition),
                d(a, c))
            }, function(a, b) {
    ...
    getLRS: function(a, d, c, b) {
        ...
        this.LRSAjaxRequest = LRSRequest.doLinearPositionRequest(a, function(a, c) {
            "function" !== typeof d ? e.resolve() : (d(a, c),
            e.resolve(a, c))
        }, function(a, b) {
            "function" !== typeof c ? e.reject() : (c(a, status, b),
            e.reject(a, b))
        }, b);
        return e.promise()
    },
    getLRSForGPS: function(a, d, c) {
        this.abortLRSForGPSRequest && this.LRSAjaxRequest && this.LRSAjaxRequest.abort();
        this.LRSAjaxRequest = LRSRequest.doLinearPositionRequest(a, function(a, c) {
            LRSRequest.abortedLRSForGPSRequests = 0;
            LRSRequest.abortLRSForGPSRequest = !0;
            "function" === typeof d && d(a)
        }, function(a, d) {
            "abort" == a.statusText || "timeout" == a.statusText ? (LRSRequest.abortedLRSForGPSRequests++,
            5 < LRSRequest.abortedLRSForGPSRequests && (LRSRequest.abortLRSForGPSRequest = !1)) : "function" === typeof c && c(a, a.status)
        }, {
            timeout: Nigsys.requestsTimeout
        })
    },
    appendLRSForPosition: function(a, d) {
    ...
    getLRSForPosition: function(a, d) {
        ImajnetAPI.mustAbortRequests && null !== this.LRSPhotogrammetryAjaxRequest && this.LRSPhotogrammetryAjaxRequest.abort();
        this.LRSPhotogrammetryAjaxRequest = LRSRequest.doLinearPositionRequest(a, function(a, b) {
            a.linearPosition && (a.parameter.position.id = d,
            a.id = d,
            LRS.cachedPoints[a.parameter.position.lat + ":" + a.parameter.position.lon + ":" + a.parameter.position.height] = a,
            LRSRequest.appendLRSForPosition(a, d))
        }, null, null)
    },
    ...
    getLRSForPointRequest: function(a, d, c) {
        var b = jQuery.Deferred();
        if (LRS.noRoads)
            return b.reject(),
            b.promise();
        this.LRSFeatureAjaxRequest = ImajnetAPI.doImajnetRequestDeferred("POST", "/api/lrs/linearposition/batch/", null, null, null, null, null, !1, {
            ...
            if (!a.linearPosition)
                ...
                !1;
            if (c)
                for (var f = 0; f < a.linearPosition.length; f++)
                    LRS.transformReceivedLinearPosition(a.linearPosition[f].linearPosition);
            d && a.linearPosition[0] ? b.resolve(a.linearPosition[0]) : b.resolve(a.linearPosition)
        }).fail(function(a, c) {
            b.reject()
        });
        return b.promise()
    ...
    onGetLRSRoadsSuccess: function(a) {
        ...
        if (void 0 !== LRS.roadsData && null !== LRS.roadsData && void 0 != LRS.roadsData.roads && null !== LRS.roadsData.roads)
            jQuery.each(LRS.roadsData.roads, function(a, b) {
                d.append('\x3coption value\x3d"' + b.id + '"\x3e' + b.name + "\x3c/option\x3e")
            });
        else
            LRSRequest.onGetLRSRoadsError()
    },
    ...
    search: function(a, d) {
        var c = "/api/lrs/"
          , b = {};
        LRS.isSearchRelative || d ? (b.roadIdentifier = a.roadIdentifier,
        b.prNumber = a.prNumber,
        b.relativeAbscisa = a.relativeAbscisa,
        c += "relative/" + encodeURIComponent(JSON.stringify(b))) : (b.roadIdentifier = a.roadIdentifier,
        b.cumulatedAbscisa = a.cumulatedAbscisa,
        c += "absolute/" + encodeURIComponent(JSON.stringify(b)));
