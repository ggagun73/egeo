/**************************************************************************************************************
 * PathMeasure 클래스
 * @namespace {Object} NUTs.Handler.PathMeasure
 * 
...
NUTs.Handler.PathMeasure = OpenLayers.Class(OpenLayers.Handler.Path, {
	...
	/**
	* @memberof NUTs.Handler.PathMeasure
	* @method
	* @description 거리측정 전용 팝업 개체
	*/
	popup : null,
	...
	*/
	 ...
	 * 수정일				수정자			수정내용
	 * ----------------------------------------------------------------------
	 * 2010.06.21		연구개발센터		최초 생성
	 * 								마우스 다운 시 feature, popup 생성
	 * 2011.04.25		연구개발센터		지도 API 작업에 맞게 수정								
	 * 
	 **********************************************************************************/
	 ...
	 * 수정일				수정자			수정내용
	 * ----------------------------------------------------------------------
	 * 2011.04.25		연구개발센터		측정 결과를 마우스 포인터를 따라 다니게 한다.
	 * 
	 **********************************************************************************/
	 ...
	 * 수정일				수정자			수정내용
	 * ----------------------------------------------------------------------
	 * 2010.04.07		연구개발센터		마우스 포인터에 따라다니는 팝업 삭제
	 * 
	 **********************************************************************************/
