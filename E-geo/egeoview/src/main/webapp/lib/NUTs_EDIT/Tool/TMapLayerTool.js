/**************************************************************************************************************
 * TMapLayerTool 클래스   
 * @namespace {Object} NUTs.Tool.TMapLayerTool
 * 
...
NUTs.Tool.TMapLayerTool = OpenLayers.Class({
	...
	/**
	* 주제도(TMap) 그룹 객체들의 배열
	* @memberof NUTs.Tool.TMapLayerTool
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description LayerManagerTool 객체 생성
	* @param {Array} layer : 배열(레이어객체)
	* @param {Array} tMaps : 배열(주제도객체)
	* @param {Array} groups : 배열(주제도그룹객체)
	* @param {String} tMapId : 현재주제도 아이디
	*/
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description 주제도 이름으로 현재 주제도 설정
	* @param {String} name : 주제도 이름
	*/	
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description 주제도 아이디로 현재 주제도 설정
	* @param {String} id : 주제도 아이디
	*/
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description  레이어 리스트를 리턴 
	* @param {Object} options (조건)
	* 	options = {
	* 		con : 조건이 되는 필드명
	* 		conVal : 찾는 조건 값
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description  현재 주제도 Theme 리스트 반환 
	* @param {String} order('asc' : 오름차순, 'desc' : 내림차순)
	*/
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description  현재 주제도에서 화면에 보여 주고 있는(ON 상태인) Theme 리스트 반환 
	* @param {String} order('asc' : 오름차순, 'desc' : 내림차순)
	*/
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description  현재 주제도에서 화면에 보여 주고 있는(ON 상태인) table 리스트 반환 
	* @param {String} order('asc' : 오름차순, 'desc' : 내림차순)
	*/
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description  현재 주제도 Alias 리스트 반환
	* @param {String} order('asc' : 오름차순, 'desc' : 내림차순)
	*/
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description  현재 주제도 table 리스트 반환
	* @param {String} order('asc' : 오름차순, 'desc' : 내림차순)
	*/
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description 현재 layer 리스트의 크기를 반환
	*/
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description 특정 조건에 부합하는 레이어의 속성 설정
	* @param {Object} options : 조건 조합 obj
	* 	options = {
	* 		con : 조건이 되는 필드명
	* 		conVal : 찾는 조건 값
	...
	* @param {String} field (기준 필드명) 
	* @param {String} order (정렬 기준 : asc[오름차순], desc[내림차순])
	*/
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description 배열에 포함된 -1 값을 null 값으로 변환
	* @param {Array} arr (기준 배열) 
	*/
	...
	getSld_body : function(ruleView, baseLayer) {
		...
		for(var i in this.layers) {
			if(this.layers[i].show != 1) {
				delLayers.push(this.layers[i].table);
			}
		}
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description 그룹 이동시 해당 레이어의 Seq값 변경을 위한 함수
	* 		  기준 그룹의 Seq값을 타겟 그룹의 Seq값으로 변경 후 타겟그룹과 그 두 그룹 사이에 있는
	* 		  그룹들의 Seq값을 1씩 증가 또는 1씩 감소 시켜준다.
	* @param {String}  aGroupId (이동할 기준 그룹의 ID값)
	* @param {String}  bGroupId (타겟이 되는 그룹의 ID값)
	*/
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description 변경된 그룹의 Seq에 의해 그룹내에 포함된 레이어들(this.layers)의 Seq값도 변경해주는 함수
	* @param {Array}  layerGroups (레이어 그룹 배열) 
	*/
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description 레이어 이동시 해당 레이어의 Seq값을 변경해주는 함수
	 * 		  기준 레이어의 Seq값을 타겟 레이어의 Seq값으로 변경해주고 두 레이어 사이에 있는
	 * 		  레이어들의 Seq값을 1씩 증가 또는 1씩 감소시켜준다.
	* @param {String}  layerId (기준 레이어 ID값) 
	* @param {String}  targetId (타겟 레이어 ID값) 
	*/
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description LayerGroups 객체의 클론 객체를 생성하는 함수
	* @param {Object}  obj (LayerGroups 객체)  
	*/
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description Layers 객체의 클론 객체를 생성하는 함수
	* @param {Object}  obj (Layer 객체)  
	*/
	...
	* @memberof NUTs.Tool.TMapLayerTool
	* @method
	* @description 새로운 객체안에 인자로 들어간 obj의 값들을 하나씩 넣어주는 함수
