						...
						<div class="Table_left" style="height:210px">
							<table>
								...
								<tr>
				                    ...
				                    <th>원형관구경</th>
									<td><input type="text" name="SPH_DIP" id="SPH_DIP" value="<c:out value="${result.sphDip}"/>" class="input MX_4 CS_4 DT_INT" />
								</tr>
								<tr>
									<th>역사이펀형태</th>
				                    ...
				                    <th>가로길이</th>
									<td><input type="text" name="SPH_HOL" id="SPH_HOL" value='<c:out value="${result.sphHol}"/>' class="input MX_4 CS_4 DT_INT" /> m</td>
								</tr>
								<tr>
								 	<th>역사이펀재질</th>
									...
									<th>세로길이</th>
									<td><input type="text" name="SPH_VEL" id="SPH_VEL" value='<c:out value="${result.sphVel}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>									
								</tr>
								<tr>
									<th>역사이펀연장</th>
									<td><input type="text" name="SPH_LEN" id="SPH_LEN" value='<c:out value="${result.sphLen}"/>' class="input MX_7 DT_FLOAT DD_2" /> m</td>									
									<th>역사이펀관저고</th>
									<td><input type="text" name="SPH_HSL" id="SPH_HSL" value='<c:out value="${result.sphHsl}"/>' class="input MX_7 DT_FLOAT DD_2" /> m</td>									
								</tr>	
								<tr>
									<th>차선통로수(관의수량)</th>
									<td><input type="text" name="SPH_LIN" id="SPH_LIN" value='<c:out value="${result.sphLin}"/>' class="input MX_2 DT_INT" /> </td>									
									<th>경사</th>
									<td><input type="text" name="SPH_SLP" id="SPH_SLP" value='<c:out value="${result.sphSlp}"/>' class="input MX_5 DT_FLOAT DD_2" /> %</td>									
								</tr>	
								<tr>
									<th>방향각</th>
									<td colspan="3"><input type="text" name="ANG_DIR" id="ANG_DIR" value='<c:out value="${result.angDir}"/>' class="input MX_3 DT_INT" /> </td>															
								</tr>							
							</table>
						</div>
					</div>
