        ...
        <table class="tbprint" summary="대 장">
			...
			<tbody>
				...
				<tr>
					...
					<th scope="row">형태</th>
					<td><c:out value="${result.sbsCdeNm}"/></td>
					<th scope="row">저수용량</th>
					<td><c:out value="${result.ctnVol}"/> ㎥</td>					
				</tr>
				<tr>
					...
					<th scope="row">계획홍수위</th>
					<td><c:out value="${result.prnWal}"/> m</td>					
				</tr>
				<tr>
