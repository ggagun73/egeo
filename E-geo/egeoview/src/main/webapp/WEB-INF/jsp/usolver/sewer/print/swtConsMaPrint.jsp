	...
	<div id="form_wrap">
        ...
        <table class="tbprint" summary="대 장">
			...
			<tbody>
				...
				<c:forEach var="subdataCost" items="${swtCostDtList}">
                <tr>
					<td class="lnone ac" scope="col"><c:out value="${subdataCost.pty_cde_nm}"/></td>
                    <td class="lnone ac" scope="col"><c:out value="${subdataCost.pay_ymd}"/></td>
                    <td class="lnone ar" scope="col" colspan="4" ><c:out value="${subdataCost.pay_amt}"/></td>
				</tr> 
				</c:forEach>	
				<c:forEach begin="${fn:length(swtCostDtList) > 0 ?  fn:length(swtCostDtList): 0}"  end="${fn:length(swtCostDtList) > 12 ?  fn:length(swtCostDtList): 12}">
					<tr>
				...
				<c:forEach var="subdataFlaw" items="${swtFlawDtList}">
	                <tr>
				...
				<c:forEach begin="${fn:length(swtFlawDtList) > 0 ?  fn:length(swtFlawDtList): 0}"  end="${fn:length(swtFlawDtList) > 12 ?  fn:length(swtFlawDtList): 12}">
					<tr>
						<td class="lnone"  scope="col" style="min-height:22px"></td>
	                    <td class="lnone"  scope="col"></td>
	                    <td class="lnone"  scope="col" colspan="4"></td>
				...
				<c:forEach var="subdataChng" items="${swtChngDtList}">
	                <tr>
	                    ...
	                    <td class="lnone ar"  scope="col"><c:out value="${subdataChng.chgDes}"/></td>
	                    <td class="lnone ar"  scope="col"><c:out value="${subdataChng.cgvDes}"/></td>
					</tr>
				</c:forEach>
				<c:forEach begin="${fn:length(swtChngDtList) > 0 ?  fn:length(swtChngDtList): 0}"  end="${fn:length(swtChngDtList) > 12 ?  fn:length(swtChngDtList): 12}">
					<tr>
						<td class="lnone"  scope="col" style="min-height:22px"></td>
	                    <td class="lnone"  scope="col"></td>
	                    <td class="lnone"  scope="col"></td>
				...
				<c:forEach var="subdataSubc" items="${swtSubcDtList}">
	                <tr>
						<td class="lnone ac"  scope="col"><c:out value="${subdataSubc.subNam}"/></td>
	                    <td class="lnone ac"  scope="col"><c:out value="${subdataSubc.psbNam}"/></td>
	                    <td class="lnone ac"  scope="col"><c:out value="${subdataSubc.subTel}"/></td>
	                    <td class="lnone"  scope="col" colspan="3"><c:out value="${subdataSubc.subAdr}"/></td>
					</tr>
				</c:forEach>	
				<c:forEach begin="${fn:length(swtSubcDtList) > 0 ?  fn:length(swtSubcDtList): 0}"  end="${fn:length(swtSubcDtList) > 10 ?  fn:length(swtSubcDtList): 10}">
					<tr>
						<td class="lnone"  scope="col" style="min-height:22px"></td>
	                    <td class="lnone"  scope="col"></td>
	                    <td class="lnone"  scope="col"></td>
