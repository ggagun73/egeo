			...
			<tbody>
              ...
              <tr>
				...
				<tr>
					...
					<td colspan="2"><c:out value="${result.crsYmd}"/></td>
					<th scope="row">신호등유무</th>
					<td colspan="3"><c:out value="${result.sgbCdeNm}"/></td>
				</tr> 			
				<tr>
					<th scope="row">장애인시설유무</th>
					<td><c:out value="${result.hndCdeNm}"/></td>
					<th scope="row">보도턱낮춤유무</th>
					<td colspan="2"><c:out value="${result.bdnCdeNm}"/></td>
					<th rowspan="2" scope="row">횡단보도방식</th>
					<td rowspan="2"><c:out value="${result.crwCdeNm}"/></td>
				</tr> 			
				<tr>
					<th scope="row">횡단보도폭</th>
					<td><c:out value="${result.crsWid}"/>m</td>
					<th scope="row">횡단보도길이</th>
					<td colspan="2"><c:out value="${result.crsLen}"/>m</td>
				</tr> 				
				<tr>
				...
				<c:forEach begin="${fn:length(rdtPrsvDtList) > 0 ?  fn:length(rdtPrsvDtList): 0}"  end="${fn:length(rdtPrsvDtList) > 17 ?  fn:length(rdtPrsvDtList): 17}">			
					<tr>
