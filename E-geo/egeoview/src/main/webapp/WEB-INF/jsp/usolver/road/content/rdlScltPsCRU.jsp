...
<head>
	...
	$( document ).ready(function() {
		...
		// 1 )달력
		BOOK.fn_create_datepicker("frm_detail","BOA_YMD", 10); // 사용개시일자
						...
						<div class="Table_left" style="height:169px">	
							<table>
								...
								<tr>
									...
									<th>설치일자</th>
									<td><input type="text" name="BOA_YMD" id="BOA_YMD" value="<c:out value="${result.boaYmd}"/>" class="input DT_DATE" />
								</tr>
								<tr>
									<th>행정읍/면/동</th>
					...
					<div class="Table_LBx">
						...
						<div class="Table_left" style="height:169px">	
							<table>
								...
								<tr>
									<th>등기구모형</th>
									<td><select name="LSH_CDE" id="LSH_CDE"  class="select" >
											<option value=""></option>
								...
								<tr>
									<th>광원용량</th>
									<td colspan="3"><input type="text" name="LCP_EXP" id="LCP_EXP" style="width:380px"  value='<c:out value="${result.lcpExp}"/>' class="input MX_50 CS_50" /></td>			                    
								</tr>										
							</table>
						</div>
					</div>
