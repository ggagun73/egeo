	...
	<div id="form_wrap">
        ...
        <table class="tbprint" summary="대 장">
			...
			<tbody>
                ...
                <tr>
					<th scope="row">취수장명</th>
					<td><c:out value="${result.gaiNam}"/></td>
				...
				<tr>
					...
					<td><c:out value="${result.gaiAra}"/>㎡</td>
					<th scope="row">취수량</th>
					<td colspan="3"><b>평균 :</b> <c:out value="${result.agaVol}"/>㎥/일  <b>최대</b> : <c:out value="${result.hgaVol}"/> ㎥/일</td>
				</tr>
				<tr>
					<th scope="row">수계명</th>
					<td colspan="2"><c:out value="${result.wssNam}"/></td>
					<th scope="row">펌프대수</th>
					<td colspan="2"><c:out value="${result.pmpCnt}"/></td>
				</tr>
				<tr>
					<th scope="row">도수방법</th>
					<td colspan="2"><c:out value="${result.wrwCdeNm}"/></td>
					<th scope="row">취수방법</th>
					<td colspan="2"><c:out value="${result.wgwCdeNm}"/></td>
				</tr>				
				<tr>
				...
				<c:forEach begin="${fn:length(wttAttaDtList) > 0 ?  fn:length(wttAttaDtList): 0}"  end="${fn:length(wttAttaDtList) > 18 ?  fn:length(wttAttaDtList): 18}">			
					<tr>
						<td class="lnone" scope="col" colspan="2" style="min-height:20px"></td>
