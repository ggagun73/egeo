...
<%
  /**
  * @Class Name : 
  * @Description :  WTL_FIRE_PS  소방시설관리 
									...
									<table>
										...
										<tr>
											...
											<td><select name="FTR_CDE" id="FTR_CDE" class="select" >
													...
													<c:if test="${ selectData.CODE eq 'SA118' || selectData.CODE eq 'SA119' }">
							...
							<div class="Table_LBx">
								<div class="Table_left" style="height:100px">
									<table>
										...
										<tr>
											<th>소화전구경</th>
											<td><input type="text" name="FIR_DIP" id="FIR_DIP" value='<c:out value="${result.firDip}"/>' class="input MX_4 CS_4 DT_INT DD_0" /> mm</td>
											<th>배수관구경</th>
											<td><input type="text" name="PIP_DIP" id="PIP_DIP" value='<c:out value="${result.pipDip}"/>' class="input MX_4 CS_4 DT_INT DD_0" /> mm</td>
										</tr>
										<tr>
											<th>급수탑높이</th>
											<td><input type="text" name="SUP_HIT" id="SUP_HIT" value='<c:out value="${result.supHit}"/>' class="input MX_5 CS_5 DT_FLOAT DD_2" /> m</td>
											<th>방향각</th>
