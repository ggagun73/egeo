			...
			<tbody>
              ...
              <tr>
                ...
                <tr>
					...
					<td><c:out value="${result.wolYmd}"/></td>
				</tr> 
				<tr>
					<th scope="row">방지책종류</th>
					<td colspan="2"><c:out value="${result.aedCdeNm}"/></td>
					<th scope="row">재질</th>
					<td colspan="3"><c:out value="${result.smgCdeNm}"/></td>
				</tr> 
				<tr>
					<th scope="row">연장</th>
					<td colspan="2"><c:out value="${result.wolLen}"/>m</td>
					<th scope="row">높이</th>
					<td colspan="3"><c:out value="${result.wolHit}"/>m</td>
				</tr> 
				<tr>
