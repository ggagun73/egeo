...
<input type="hidden" id="FTR_CDE" name="FTR_CDE" value="<c:out value="AD004"/>"/>
			...
			<div class="TabArea">
				<div class="TabBx">
					<ul class="Tabs">
						...
						<li class="_Tab3"><a href="#" class="Tab">노견</a></li>
						<li class="_Tab4"><a href="#" class="Tab">도로경계석</a></li>
				...
				<div class="Btn_pd2">
					...
					<div class="Btn visInsert"><a href="#" class="Btn_03 btnClassEdit" onclick="BOOK.fn_insert_gridAddInfo('<c:out value='${TABLENAME}'/>','AD004')">저장</a></div>
					...
					<div class="Table_LBx">
						<div class="Table_left"  style="height:100px">
							<table>
								...
								<tr>
									<th>왕복차로수</th>
									<td><input type="text" name="LAN_CNT" id="LAN_CNT" value='<c:out value="${result.lanCnt}"/>' class="input MX_2 DT_INT" /></td>		
				                    <th>차도재질</th>
								...
								<tr>
									<th>도로법면연장</th>
									<td><input type="text" name="ICL_LEN" id="ICL_LEN" value='<c:out value="${result.iclLen}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>		
				                    <th>차도구간연장</th>
									<td><input type="text" name="JYG_LEN" id="JYG_LEN" value='<c:out value="${result.jygLen}"/>' class="inputMX_5 DT_FLOAT DD_2" /> m</td>				                    
								</tr>
								<tr>
									<th>도로법면면적</th>
									<td><input type="text" name="ICL_ARA" id="ICL_ARA" value='<c:out value="${result.iclAra}"/>' class="input MX_10 DT_FLOAT DD_2" />  ㎡</td>		
				                    <th>차도구간면적</th>
									<td><input type="text" name="JYG_ARA" id="JYG_ARA" value='<c:out value="${result.jygAra}"/>' class="inputMX_10 DT_FLOAT DD_2" /> ㎡</td>				                    
								</tr>
							</table>
						</div>
					</div>
					...
					<div class="Table_LBx">
						<div class="Table_left"  style="height:100px">
							<table>
								...
								<tr>
									<th>좌연장</th>
									<td><input type="text" name="NOL_LEN" id="NOL_LEN" value='<c:out value="${result.nolLen}"/>' class="inputMX_5 DT_FLOAT DD_2" /> m</td>		
									<th>우연장</th>
									<td><input type="text" name="NOR_LEN" id="NOR_LEN" value='<c:out value="${result.norLen}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>				                   		                    
								</tr>
								<tr>									
				                    <th>좌면적</th>
									<td><input type="text" name="NOL_ARA" id="NOL_ARA" value='<c:out value="${result.nolAra}"/>' class="inputMX_10 DT_FLOAT DD_2" /> ㎡</td>		
									<th>우면적</th>
									<td><input type="text" name="NOR_ARA" id="NOR_ARA" value='<c:out value="${result.norAra}"/>' class="input MX_10 DT_FLOAT DD_2" /> ㎡</td>				                    
								</tr>
								<tr>									
				                    <th>좌폭</th>
									<td><input type="text" name="NOL_WID" id="NOL_WID" value='<c:out value="${result.nolWid}"/>' class="inputMX_5 DT_FLOAT DD_2" /> m</td>
									<th>우폭</th>
									<td><input type="text" name="NOR_WID" id="NOR_WID" value='<c:out value="${result.norWid}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>						                    
								</tr>								
							</table>
						</div>
					</div>
						...
						<div class="Table_left"  style="height:100px">
							<table>
								...
								<tr>
				                    ...
				                    <th>우재질</th>
									<td><select name="RMA_CDE" id="RMA_CDE" class="select">
		                            <option value=""></option>
				                    	<c:forEach var="selectData" items="${rma_cde_list}">
											<option value="${selectData.CODE}" <c:if test = "${selectData.CODE == result.rmaCde}"> selected="selected" </c:if> >${selectData.VAL}</option>
										</c:forEach>
				                    </select></td>				                    
								</tr>
								<tr>									
				                    <th>좌연장</th>
									<td><input type="text" name="LRL_LEN" id="LRL_LEN" value='<c:out value="${result.lrlLen}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>		
									<th>우연장</th>
									<td><input type="text" name="RRL_LEN" id="RRL_LEN" value='<c:out value="${result.rrlLen}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>				                    
								</tr>
							</table>
						</div>
					</div>
