              ...
              <tr>
                ...
                <tr>
				 ...
				 <tr>
					...
					<td colspan="2"><c:out value="${result.sttYmd}"/></td>
					<th scope="row">정류장명</th>
					<td colspan="3"><c:out value="${result.sttNam}"/></td>
				</tr> 
				 <tr>
					<th scope="row">정류장종류</th>
					<td colspan="2"><c:out value="${result.aeeCdeNm}"/></td>
					<th scope="row">정류장유형</th>
					<td colspan="3"><c:out value="${result.sttCdeNm}"/></td>
				</tr> 				
				<tr>
