        ...
        <table class="tbprint" summary="대 장">
			...
			<tbody>
				...
				<tr>
					...
					<td colspan="2"><c:out value="${result.pipDip}"/> mm</td>
				</tr>
				<tr>
					<th scope="row">소화전형식</th>
					<td><c:out value="${result.mofCdeNm}"/>mm</td>
					<th scope="row">소화전구경</th>
					<td><c:out value="${result.firDip}"/>mm</td>
					<th scope="row">급수탑높이</th>
					<td><c:out value="${result.supHit}"/>m</td>
				</tr>
				<tr>
