        ...
        <table class="tbprint" summary="대 장">
			...
			<tbody>
              ...
              <tr>
				...
				<tr>
					<th scope="row">식재일자</th>
					<td colspan="2"><c:out value="${result.treYmd}"/></td>
					<th scope="row">수종</th>
					<td colspan="3"><c:out value="${result.treCdeNm}"/></td>
				</tr> 
				<tr>
					<th scope="row">가로수직경</th>
					<td colspan="2"><c:out value="${result.treDia}"/>m</td>
					<th scope="row">수목보호판유무</th>
					<td colspan="3"><c:out value="${result.ptcCdeNm}"/>m</td>
				</tr> 
				<tr>
