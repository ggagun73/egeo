            ...
            <div class="headerBx1">
                <div class="ABx">
                    ...
                    <ul>
                    	...
                    	<!-- <li><label><input id="check_dawul" type="radio" name="mashupType" checked="checked" value="dawul"/>다울</label></li>  -->
                    </ul>
                </div>
                <div class="BBx">
                    <ul>
...
<script type="text/javascript" src="<c:url value='/lib/gmap/lib/gcontrol/GSelectFeature.js'/>"></script>
...
<script type="text/javascript" src="<c:url value='/lib/gmap/lib/gedit/gcontrol/GDrawPolygon.js'/>"></script>
<script type="text/javascript" src="<c:url value='/lib/gmap/lib/gedit/gcontrol/GDrawHole.js'/>"></script>
<script type="text/javascript" src="<c:url value='/lib/gmap/lib/gedit/gcontrol/GDeleteVertex.js'/>"></script>
...
<!-- 다음 API -->
<!-- <script type="text/javascript" src="http://apis.daum.net/maps/maps3.js?apikey=431e8245023646b848fc21e6579003df&libraries=services"></script> -->
...
$(document).ready(function(e){
	...
	*/
	...
	orgLayerTool = new GTMapLayerTool(oOrgLayerInfoList, null, null, oOrgLayerGroups, { 
		tMapId : sOrgTMapId, 
		serviceUrl : CONFIG.fn_get_serviceUrl(), 
		callback : function(_oRes, _bUserStyle){
			saveTool = new GSaveTool(map);
		},
		sync : true,
		userStyle : ""
	}); 
