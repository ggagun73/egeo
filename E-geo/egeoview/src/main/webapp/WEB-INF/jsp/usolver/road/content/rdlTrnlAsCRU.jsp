					...
					<div class="Table_LBx">
						...
						<div class="Table_left" style="overflow-x:hidden;height:175px;">				
							<table>
								...
								<tr>
									<th>터널명</th>
									<td colspan="3"><input type="text" style="width:375px" name="TRN_NAM" id="TRN_NAM" value='<c:out value="${result.trnNam}"/>' class="input MX_30 CS_30" /> </td>											
								</tr>
								<tr>
									<th>관리기관</th>
					...
					<div class="Table_LBx">
						...
						<div class="Table_left" style="overflow-x:hidden;height:175px;">				
							<table>
								...
								<tr>
									<th>폭원-차도</th>
									<td><input type="text" name="CAD_WID" id="CAD_WID" value='<c:out value="${result.cadWid}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>
				                    <th>터널높이</th>
									<td><input type="text" name="TRN_HIT" id="TRN_HIT" value='<c:out value="${result.trnHit}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>
								</tr>
								<tr>
									<th>폭원-좌보도</th>
									<td><input type="text" name="LSW_WID" id="LSW_WID" value='<c:out value="${result.lswWid}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>
				                    <th>통행제한높이</th>
									<td><input type="text" name="LIM_HIT" id="LIM_HIT" value='<c:out value="${result.limHit}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>
								</tr>
								<tr>
									<th>폭원-우보도</th>
									<td><input type="text" name="RSW_WID" id="RSW_WID" value='<c:out value="${result.rswWid}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>		
				                    <th>공-두께</th>
									<td><input type="text" name="SMT_TCK" id="SMT_TCK" value='<c:out value="${result.smtTck}"/>' class="input MX_3 DT_FLOAT DD_2" /> m</td>			                    
								</tr>
								<tr>
									<th>폭원-계</th>
									<td><input type="text" name="TOT_WID" id="TOT_WID" value='<c:out value="${result.totWid}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>		
				                    <th>공-재질</th>
								...
								<tr>
				                    <th>왕복차로수</th>
									<td colspan="3"><input type="text" name="LAN_CNT" id="LAN_CNT" value='<c:out value="${result.lanCnt}"/>' class="input MX_2 DT_INT" /> 차로</td>				                    
								</tr>
								<tr>
				                    <th>총연장</th>
									<td><input type="text" name="TRN_LEN" id="TRN_LEN" value='<c:out value="${result.trnLen}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>
									<th>총면적</th>
									<td><input type="text" name="TRN_ARA" id="TRN_ARA" value='<c:out value="${result.trnAra}"/>' class="input MX_5 DT_FLOAT DD_2" /> ㎡</td>				                    
								</tr>
							</table>
						</div>
					</div>
					...
					<div class="Table_LBx">
						...
						<div class="Table_left" style="overflow-x:hidden;height:175px;">
							<table>
								...
								<tr>
									<th>조명시설-수량</th>
									<td colspan="3"><input type="text" name="LCD_CNT" id="LCD_CNT" value='<c:out value="${result.lcdCnt}"/>' class="input MX_3 DT_INT" /> 개</td>		
								</tr>
								<tr>
				                    <th>조명시설-종류</th>
								...
								<tr>
									<th>구조형식</th>
									<td colspan="3"><input type="text" name="GZO_EXP" id="GZO_EXP" value='<c:out value="${result.gzoExp}"/>' class="input MX_50 CS_50" /></td>		
				                </tr>
								<tr>
				                    <th>환기방식</th>
									<td colspan="3"><input type="text" name="VNT_EXP" id="VNT_EXP" value='<c:out value="${result.vntExp}"/>' class="input MX_50 CS_50" /></td>			                    
								</tr>
								<tr>
									<th>배수시설-종류</th>
									<td colspan="3"><input type="text" name="DNG_EXP" id="DNG_EXP" value='<c:out value="${result.dngExp}"/>' class="input MX_50 CS_50" /></td>
								</tr>
								<tr>	
				                    <th>소화시설-종류</th>
									<td colspan="3"><input type="text" name="FXG_EXP" id="FXG_EXP" value='<c:out value="${result.fxgExp}"/>' class="input MX_50 CS_50" /></td>				                    
								</tr>
							</table>
						</div>
					</div>
