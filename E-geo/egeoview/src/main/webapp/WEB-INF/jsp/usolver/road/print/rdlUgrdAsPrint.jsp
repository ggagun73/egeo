        ...
        <table class="tbprint" summary="대 장">
			...
			<tbody>
				...
				<tr>
					...
					<th scope="row">총연장</th>
					<td colspan="2"><c:out value="${result.trnLen}"/> m</td>
					<th scope="row">총면적</th>
					<td colspan="2"><c:out value="${result.trnAra}"/> ㎡</td>
				</tr> 
				<tr>
					<th scope="row">구체면적</th>
					<td><c:out value="${result.boxAra}"/> ㎡</td>
					<th scope="row">구체높이</th>
					<td colspan="2"><c:out value="${result.boxHit}"/> m</td>
					<th scope="row">구체연장</th>
					<td colspan="2"><c:out value="${result.boxLen}"/> m</td>
				</tr>
				<tr>
					<th scope="row">통행제한높이</th>
					<td colspan="2"><c:out value="${result.limHit}"/> m</td>
					<th scope="row">환기방식</th>
					<td colspan="4"><c:out value="${result.dngExp}"/></td>
				</tr>
				<tr>
					<th scope="col" colspan="5">폭원</th>
					<th scope="col" colspan="3">옹벽</th>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><c:out value="${result.rvtHit}"/> m</td>
					<td><c:out value="${result.rvtLen}"/> m</td>
					<td><c:out value="${result.rvtAra}"/> ㎡</td>
				</tr>
				<tr>
					<th scope="col" colspan="2">조명시설</th>
					<th scope="col" colspan="2">마감재</th>
				...
				<tr>
					...
					<th scope="row">급수시설종류</th>
					<td colspan="3"><c:out value="${result.supExp}"/></td>
				</tr>
				<tr>
