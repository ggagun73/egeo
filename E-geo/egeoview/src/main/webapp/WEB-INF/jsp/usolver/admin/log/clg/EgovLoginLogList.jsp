...
// 페이지 로딩 초기 설정
	...
	function fn_egov_inqire_loginLog(logId){
		...
		window.parent.REGISTER.fn_open_nJDSKWindow("접속로그정보조회",url,454,282,"registerOnHome");
	}

</script>
<title>접속 로그 목록</title>
</head>
<body>
<div id="W_900">
	<!-- favorite -->
            ...
            <div class="ContBx">
                <div class="schbx">
                    <div class="FR" >
                        ...
                        <input type="text" style="height:19px;" id="searchKeyword" name=searchKeyword value="${searchVO.searchKeyword}"  class="input"  onKeyDown="press()"/>
                        <a href="#" class="Btn_sch" onClick="fn_search_list(1)">검색</a>
                    </div>
                </div>
                <table class="tblist" summary="접속로그">
				    <caption>접속로그</caption>
				    <colgroup>
					    <col width="" />
				        <col width="" />
				        <col width="" />
