			...
			<tbody>
              ...
              <tr>
				...
				<tr>
					...
					<td colspan="2"><c:out value="${result.sgnYmd}"/></td>
					<th scope="row">신호등종류</th>
					<td colspan="3"><c:out value="${result.sgnCdeNm}"/></td>
				</tr> 			
				<tr>
					<th scope="row">신호등재질</th>
					<td colspan="2"><c:out value="${result.sgmCdeNm}"/></td>
					<th scope="row">신호등구분</th>
					<td colspan="3"><c:out value="${result.sgbCdeNm}"/></td>
				</tr> 			
				<tr>
					<th scope="row">신호등규격</th>
					<td colspan="2"><c:out value="${result.sgnExp}"/></td>
					<th scope="row">신호등수</th>
					<td colspan="3"><c:out value="${result.sgnCnt}"/> 개</td>
				</tr> 			
				<tr>
					<th colspan="2" scope="row">잔여시간표시기유무</th>
					<td colspan="5"><c:out value="${result.lftCdeNm}"/></td>
				</tr> 				
				<tr>
				...
				<c:forEach begin="${fn:length(rdtPrsvDtList) > 0 ?  fn:length(rdtPrsvDtList): 0}"  end="${fn:length(rdtPrsvDtList) > 16 ?  fn:length(rdtPrsvDtList): 16}">			
					<tr>
