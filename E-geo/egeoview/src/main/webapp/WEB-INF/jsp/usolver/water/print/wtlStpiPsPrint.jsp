...
<form name="Form1" method="post" id="Form1">
	<div id="form_wrap">
        <h1>스 탠 드 파 이 프 대 장</h1>
        <table class="tbprint" summary="대 장">
			<caption>스탠드파이프대장</caption>
			<colgroup>
			...
			<tbody>
                ...
                <tr>
					...
					<th scope="row">재질</th>
					<td><c:out value="${result.stpMopNm}"/></td>
					<th scope="row">구경</th>
					<td><c:out value="${result.stpDip}"/>mm</td>
				</tr>
				<tr>
					<th scope="row">표고</th>
					<td><c:out value="${result.stpAlt}"/>m</td>
					<th scope="row">유량계형식</th>
					<td><c:out value="${result.valMofNm}"/></td>
					<th scope="row">제작회사</th>
					<td><c:out value="${result.prdNam}"/></td>
				</tr>
				<tr>
