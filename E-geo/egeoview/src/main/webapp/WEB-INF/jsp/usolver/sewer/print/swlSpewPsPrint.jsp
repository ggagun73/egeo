        ...
        <table class="tbprint" summary="대 장">
			...
			<tbody>
				...
				<tr>
					...
					<th scope="row">표고</th>
					<td><c:out value="${result.wolHit}"/>m</td>					
				</tr>
				<tr>
					<th scope="row">형태</th>
					<td colspan="2"><c:out value="${result.istYmd}"/></td>
					<th scope="row">평균수위</th>
					<td colspan="2"><c:out value="${result.forCdeNm}"/>m</td>			
				</tr>
				<tr>
					<th scope="row">원형토구내경</th>
					<td><c:out value="${result.istYmd}"/> mm</td>
					<th scope="row">각형토구길이</th>
					<td colspan="3"> 가로 :  <c:out value="${result.forCdeNm}"/> m &nbsp;&nbsp;&nbsp;&nbsp; 세로 :  <c:out value="${result.forCdeNm}"/></td>		
				</tr>
				<tr>
					<th scope="row">방류천명</th>
					<td colspan="2"><c:out value="${result.istYmd}"/></td>
					<th scope="row">계획방류량</th>
					<td colspan="2"><c:out value="${result.forCdeNm}"/> ㎥</td>			
				</tr>
				<tr>
					<th scope="row">배수구역명</th>
					<td colspan="2"><c:out value="${swlAodrAs.adRNam}"/></td>
					<th scope="row">배수면적</th>
					<td colspan="2"><c:out value="${swlAodrAs.adrSiz}"/></td>			
				</tr>
				<tr>
					<th scope="row">처리구역명</th>
					<td colspan="2"><c:out value="${swlAodpAs.adpNam}"/></td>
					<th scope="row">처리면적</th>
					<td colspan="2"><c:out value="${swlAodpAs.adpSiz}"/></td>			
				</tr>
				<tr>
