        ...
        <table class="tbprint" summary="대 장">
			...
			<tbody>
              ...
              <tr>
				...
				<tr>
					<th scope="row">표지종류</th>
					<td colspan="2"><c:out value="${result.aecCdeNm}"/></td>
					<th scope="row">지주형식</th>
					<td colspan="3"><c:out value="${result.ipgCdeNm}"/></td>
				</tr> 
				<tr>
					<th scope="row">규격</th>
					<td colspan="2"><c:out value="${result.dpgExp}"/></td>
					<th scope="row">높이</th>
					<td colspan="3"><c:out value="${result.dpgHit}"/>m</td>
				</tr> 
				<tr>
