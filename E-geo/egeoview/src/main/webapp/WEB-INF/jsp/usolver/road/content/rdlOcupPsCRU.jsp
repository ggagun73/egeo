...
<%
  /**
  * @Class Name : 
  * @Description : RDL_OCUP_PS  점용시설(점)
					...
					<div class="Table_LBx">
						<div class="Table_left" style="height:100px">							
							<table>
								...
								<tr>								
									<th>허가일련번호</th>
									<td colspan="3"><input type="text"  readOnly name="PMS_IDN" id="PMS_IDN" value="<c:out value="${result.pmsIdn}"/>" class="input MX_10 CS_10"  readonly />
