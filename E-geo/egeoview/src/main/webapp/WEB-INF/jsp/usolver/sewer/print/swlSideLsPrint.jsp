        ...
        <table class="tbprint" summary="대 장">
			...
			<tbody>
               ...
               <tr>
					...
					<th scope="row">측구구분</th>
					<td colspan="2"><c:out value="${result.aegCdeNm}"/></td>
				</tr>
               <tr>
					<th scope="row">연장</th>
					<td><c:out value="${result.sidLen}"/></td>
					<th scope="row">재질</th>
					<td><c:out value="${result.MopCdeNm}"/></td>
					<th scope="row">차선통로수</th>
					<td><c:out value="${result.sidLin}"/></td>
				</tr> 
				<tr>
					<th scope="row">규격</th>
					<td colspan="5">가로 : <c:out value="${result.sidHol}"/> m &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 세로 : <c:out value="${result.sidVel}"/> m</td>
				</tr>				
				<tr>
