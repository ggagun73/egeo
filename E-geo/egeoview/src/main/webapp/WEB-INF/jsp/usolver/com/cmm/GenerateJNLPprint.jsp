...
<jnlp
  ...
  <!-- The name of the main class to execute. This does not change-->
   ...
   <!--호스트-->
    ...
    <argument>http://xxx.xxx.xxx.xxx:8087/DataViewerEditor/file.xml</argument>
	<!--실행 대상-->
    <argument>/t</argument>
   ...
   <!-- 
    ...
    <argument>project/suwon.prj</argument>
	--> 
    <argument>project="project/cjgis.prj"</argument>
  ...
  <resources os="Windows" arch="amd64">
   ...
   <resources>
    ...
    <jar href="lib/com.ginno.geogate.updater_1.12.1030.jar"/>
  </resources>
