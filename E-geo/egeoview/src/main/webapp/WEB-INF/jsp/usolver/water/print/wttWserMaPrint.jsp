...
<form name="Form1" method="post" id="Form1">
	<div id="form_wrap">
        <h1>급 수 민 원 접 수 처 리 대 장</h1>
        <table class="tbprint" summary="대 장">
			<caption>급수민원접수처리대장</caption>
			<colgroup>
			...
			<tbody>
                ...
                <tr>
					...
					<td colspan="3"><c:out value="${result.aplHjdNm}"/> <c:out value="${result.aplAdr}"/></td>
				</tr>    
				<tr>
