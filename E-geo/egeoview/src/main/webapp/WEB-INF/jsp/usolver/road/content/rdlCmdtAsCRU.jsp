...
<%
  /**
  * @Class Name : 
  * @Description : RDL_CMDT_AS  공동구 관리 
...
<head>
	...
	$( document ).ready(function() {
		...
		// 1 )달력
		BOOK.fn_create_datepicker("frm_detail","COP_YMD", 10); // 사용개시일자
						...
						<div class="Table_left" style="height:169px">	
							<table>
								...
								<tr>
									...
									<th>설치일자</th>
									<td><input type="text" name="COP_YMD" id="COP_YMD" value="<c:out value="${result.copYmd}"/>" class="input DT_DATE" />
								</tr>
								<tr>
									<th>행정읍/면/동</th>
									...
									<th>관리자</th>
									<td><input type="text" name="MNG_NAM" id="MNG_NAM" value="<c:out value="${result.mngNam}"/>" class="input MX_30 CS_30" />
								</tr>
								<tr>
									<th>공사번호</th>
					...
					<div class="Table_LBx">
						...
						<div class="Table_left" style="height:169px">	
							<table>
								...
								<tr>
									<th>종별</th>
									<td colspan="3"><select name="FAC_CDE" id="FAC_CDE"  class="select" >
											<option value=""></option>
								...
								<tr>
									...
									<th>순찰연장</th>
									<td><input type="text" name="PAT_LEN" id="PAT_LEN" value='<c:out value="${result.patLen}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>		 
								</tr>
								<tr>
									<th>공동구명</th>
									<td colspan="3"><input type="text" name="COP_NAM" id="COP_NAM" style="width:380px"  value='<c:out value="${result.copNam}"/>' class="input MX_30 CS_30" /></td>			                    
								</tr>				
								<tr>
									<th>BOX-폭원</th>
