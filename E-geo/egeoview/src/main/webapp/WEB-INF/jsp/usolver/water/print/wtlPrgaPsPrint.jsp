        ...
        <table class="tbprint" summary="대 장">
			...
			<tbody>
                ...
                <tr>
					...
					<td colspan="2"><c:out value="${result.prdNam}"/></td>
				</tr>
				<tr>
					<th scope="row">종류</th>
					<td><c:out value="${result.pgaCdeNm}"/></td>
					<th scope="row">형식</th>
					<td><c:out value="${result.mofCdeNm}"/></td>
					<th scope="row">배수관경</th>
					<td><c:out value="${result.pipDip}"/>mm</td>
				</tr>
				<tr>
					<th scope="row">설정압력</th>
					<td colspan="3">기준: <c:out value="${result.stdSaf}"/>㎏/㎠  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 평균: <c:out value="${result.avgSaf}"/>㎏/㎠  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 측정: <c:out value="${result.msrSaf}"/>㎏/㎠</td>
					<th scope="row">수압계관경</th>
					<td><c:out value="${result.pgaDip}"/>mm</td>
				</tr>
				<tr>
