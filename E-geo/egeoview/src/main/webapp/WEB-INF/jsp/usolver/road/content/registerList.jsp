...
<input type="hidden" id="callBackFunction" name="callBackFunction" value="" /> <!--대장삭제 때문에 필요함. -->
<!-- 필수 파라메터(END) -->
            ...
            <div class="content_bx">
            	<div class="table_top1">
                	...
                	<div class="TopBx" id="TopFunction">
                    	...
                    	<security:authorize ifAllGranted ="ROLE_ROAD_MAP_VIEW" >
                    	...
                    	<security:authorize ifAllGranted ="ROLE_ROAD_MAP_EDIT" >
                    	...
                    	<div class="Btn" id="btnMaintenance" style="display:none;"><a href="#" class="Btn_01" onclick="REGISTER.fn_insert_maintenance('RDT_PRSV_DT');">보수일괄</a></div>
                    	</security:authorize> 
                    	 <security:authorize ifAllGranted ="ROLE_ROAD_BOOK_VIEW" >
                    	<div id="searchFilterBtn" class="FilterBx" onclick="MAKELIST.fn_open_userList();" style="display :none;"><!-- 검색항목 설정 -->
