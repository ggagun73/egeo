...
<%
  /**
  * @Class Name : 
  * @Description :  SWL_CONN_LS 하수연결관대장
					...
					<div class="Table_LBx">
						<div class="Table_left" style="height:200px">
							<table>
								...
								<tr>
									<th>하수관용도</th>
									<td colspan="3"><select name="SBA_CDE" id="SBA_CDE" class="select">
		                            <option value=""></option>
								...
								<tr>
									<th>관라벨</th>
									<td colspan=3><input type="hidden"  style="width:375px" name="PIP_LBL" id="PIP_LBL"/> <c:out value="${result.pipLbl}"/></td>
								</tr>								
							</table>
						</div>
					</div>
