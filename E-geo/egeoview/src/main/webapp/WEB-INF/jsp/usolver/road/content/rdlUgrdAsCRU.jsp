...
<%
  /**
  * @Class Name : 
  * @Description : RDL_UGRD_AS 지하차도관리
...
<head>
	...
	$( document ).ready(function() {
		...
		if( sAction === "BATCHUP"){
			...
			$('.activeWindow').find('.Table_left').attr('style','height:270px');
			BOOK.fn_edit_mode();
					...
					<div class="Table_LBx">
						...
						<div class="Table_left" style="overflow-x:hidden;height:175px;">				
							<table>
								...
								<tr>
									<th>지하차도명</th>
									<td colspan="3"><input type="text" style="width:375px" name="SCR_NAM" id="SCR_NAM" value='<c:out value="${result.scrNam}"/>' class="input MX_30 CS_30" /> </td>											
								</tr>
								<tr>
									<th>관리기관</th>
						...
						<div class="Table_left" style="overflow-x:hidden;height:175px;">				
							<table>
								...
								<tr>
				                    ...
				                    <th>옹벽-높이</th>
									<td><input type="text" name="RVT_HIT" id="RVT_HIT" value='<c:out value="${result.rvtHit}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>
								</tr>
								<tr>
									<th>옹벽-연장</th>
									<td><input type="text" name="RVT_LEN" id="RVT_LEN" value='<c:out value="${result.rvtLen}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>
				                    <th>옹벽-면적</th>
									<td><input type="text" name="RVT_ARA" id="RVT_ARA" value='<c:out value="${result.rvtAra}"/>' class="input MX_10 DT_FLOAT DD_2" /> ㎡</td>
								</tr>
								<tr>
				                    <th>총연장</th>
									<td><input type="text" name="SCR_LEN" id="SCR_LEN" value='<c:out value="${result.scrLen}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>
									<th>총면적</th>
									<td><input type="text" name="SCR_ARA" id="SCR_ARA" value='<c:out value="${result.scrAra}"/>' class="input MX_10 DT_FLOAT DD_2" /> ㎡</td>				                    
								</tr>
								<tr>
									<th>통행제한높이</th>
								...
								<tr>
									<th>차량대비시설유무</th>
									<td colspan="3"><select name="ESC_CDE" id="ESC_CDE" class="select">
										<option value=""></option>
										<c:forEach var="selectData" items="${esc_cde_list}">
											<option value="${selectData.CODE}" <c:if test = "${selectData.CODE == result.escCde}"> selected="selected" </c:if> >${selectData.VAL}</option>
										</c:forEach>
									</select></td>
								</tr>
							</table>
						...
						<div class="Table_left" style="overflow-x:hidden;height:175px;">
							<table>
								...
								<tr>
									...
									<th>급수시설종류</th>
									<td><input type="text" name="SUP_EXP" id="SUP_EXP" value='<c:out value="${result.supExp}"/>' class="input MX_50 CS_50" /></td>
								</tr>
								<tr>
									<th>배수시설-종류</th>
