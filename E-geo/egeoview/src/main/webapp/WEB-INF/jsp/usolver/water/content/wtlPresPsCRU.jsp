							...
							<div class="Table_LBx">
								<div class="Table_left" style="height:130px">
									<table>
										...
										<tr>
											<th>가압장명</th>
											<td><input type="text" name="PRS_NAM" id="PRS_NAM" value="<c:out value="${result.prsNam}"/>" class="input MX_20 CS_20" /></td>
											<th>관리방법</th>
										...
										<tr>
											<th>부지면적</th>
											<td><input type="text" name="PRS_ARA" id="PRS_ARA"  value="<c:out value="${result.prsAra}"/>" class="input MX_8 CS_8 DT_DOUBLE DD_2" /> ㎡</td>
											<th>가압능력</th>
											<td><input type="text" name="PRS_VOL" id="PRS_VOL"  value="<c:out value="${result.prsVol}"/>" class="input MX_6 CS_6 DT_FLOAT DD_2" /> t/일</td>
										</tr>
										<tr>
											<th>가압장표고</th>
											<td><input type="text" name="PRS_ALT" id="PRS_ALT"  value="<c:out value="${result.prsAlt}"/>" class="input MX_7 CS_7 DT_DOUBLE DD_2" /> m</td>
											<th>가압수혜가구</th>
											<td><input type="text" name="PRS_SAH" id="PRS_SAH" value="<c:out value="${result.prsSah}"/>" class="input MX_8 CS_8 DT_INT" /> 가구</td>
										</tr>										
										<tr>
											<th>가압구역</th>
											<td colspan="3"><input type="text" name="PRS_ARE" id="PRS_ARE"  style="width:475px" value="<c:out value="${result.prsAre}"/>" class="input MX_50 CS_50" /></td>
										</tr>
									</table>
								</div>
							</div>
