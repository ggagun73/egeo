...
<%
  /**
  * @Class Name : 
  * @Description : RDL_OCUP_LS  점용시설(선)
					...
					<div class="Table_LBx">
						<div class="Table_left" style="height:130px">																	
							<table>
								...
								<tr>
									<th>관경</th>
									<td colspan="3"><input type="text" name="PIP_DIP" id="PIP_DIP" value='<c:out value="${result.pipDip}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>
								</tr>
								<tr>
									<th>길이</th>
