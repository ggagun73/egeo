...
<%
  /**
  * @Class Name : 
  * @Description : RDL_RDSN_PS 도로표지판 관리 
						...
						<div class="Table_left" style="height:169px">	
							<table>
								...
								<tr>
									...
									<th>설치일자</th>
									<td><input type="text" name="IPG_YMD" id="IPG_YMD" value="<c:out value="${result.ipgYmd}"/>" class="input DT_DATE" />
								</tr>
								<tr>
									<th>행정읍/면/동</th>
					...
					<div class="Table_LBx">
						...
						<div class="Table_left" style="height:169px">	
							<table>
								...
								<tr>
									<th>표지종류</th>
									<td><select name="AEC_CDE" id="AEC_CDE"  class="select" >
											<option value=""></option>
											<c:forEach var="selectData" items="${aec_cde_list}">
											<option value="${selectData.CODE}" <c:if test = "${selectData.CODE == result.aecCde}"> selected="selected" </c:if> >${selectData.VAL}</option>
											</c:forEach>
										</select></td>	           
				                    <th>높이</th>
									<td><input type="text" name="DPG_HIT" id="DPG_HIT" value='<c:out value="${result.dpgHit}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>		           
								</tr>				
								<tr>
									<th>지주형식</th>
								...
								<tr>
									<th>규격</th>
									<td colspan="3"><input type="text" name="DPG_EXP" id="DPG_EXP" style="width:380px"  value='<c:out value="${result.dpgExp}"/>' class="input MX_50 CS_50" /></td>			                    
								</tr>				
							</table>
						</div>
					</div>
