...
<form name="Form1" method="post" id="Form1">
	<div id="form_wrap">
        ...
        <table class="tbprint" summary="대 장">
			<caption>환기구대장</caption>
			<colgroup>
				<col width="17%" /><col width="17%" /><col width="17%" /><col width="17%" /><col width="17%" /><col width="17%" />
			</colgroup>
			<tbody>
				<tr>
				...
				<tr>
					...
					<th scope="row">구경</th>
					<td><c:out value="${result.vntDip}"/> mm</td>
					<th scope="row">재질</th>
					<td><c:out value="${result.mopCdeNm}"/></td>					
				</tr>
				<tr>
					<th scope="row">흡출기형식</th>
					<td colspan="2"><c:out value="${result.mofCdeNm}"/></td>
					<th scope="row">흡출기재질</th>
					<td colspan="2"><c:out value="${result.hmpCdeNm}"/></td>
				</tr>
				<tr>
