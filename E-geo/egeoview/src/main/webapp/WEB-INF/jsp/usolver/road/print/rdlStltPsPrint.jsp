			...
			<tbody>
              ...
              <tr>
				...
				<tr>
					...
					<td colspan="2"><c:out value="${result.lcdYmd}"/></td>
					<th scope="row">등기구모형</th>
					<td colspan="3"><c:out value="${result.lshCdeNm}"/></td>
				</tr> 
				<tr>
					<th scope="row">등주높이</th>
					<td colspan="2"><c:out value="${result.plsHit}"/>m</td>
					<th scope="row">등주형식</th>
					<td colspan="3"><c:out value="${result.pltCdeNm}"/>m</td>
				</tr> 
					<tr>
					<th scope="row">등주재질</th>
					<td colspan="2"><c:out value="${result.plmCdeNm}"/></td>
					<th scope="row">암길이</th>
					<td colspan="3"><c:out value="${result.armLen}"/></td>
				</tr> 
					<tr>
					<th scope="row">등기구수량</th>
					<td colspan="2"><c:out value="${result.edgCnt}"/></td>
					<th scope="row">광원종류</th>
					<td colspan="3"><c:out value="${result.lcdCdeNm}"/></td>
				</tr> 
				<tr>
