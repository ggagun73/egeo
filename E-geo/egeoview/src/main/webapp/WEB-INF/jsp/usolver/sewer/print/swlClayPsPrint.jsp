...
<form name="Form1" method="post" id="Form1">
	<div id="form_wrap">
        ...
        <table class="tbprint" summary="대 장">
			<caption>우수토실대장</caption>
			<colgroup>
				<col width="16%" /><col width="18%" /><col width="12%" /><col width="5%" /><col width="17%" /><col width="5%" /><col width="12%" /><col width="17%" />
			</colgroup>
			<tbody>
				<tr>
				...
				<tr>
					...
					<th scope="row" colspan="2">형태</th>
					<td><c:out value="${result.forCdeNm}"/></td>
					<th scope="row" colspan="2">월류턱높이</th>
					<td><c:out value="${result.wolHit}"/></td>					
				</tr>
				<tr>
					<th scope="row" rowspan="4">맨홀</th>
					<th scope="col" colspan="2">맨홀여부</th>
					<th scope="col" colspan="3">맨홀표고</th>
					<th scope="col" colspan="2">맨홀종류</th>
					<tr>
						<td colspan="2"><c:out value="${swlManhPs.mahCdeNm}"/></td>
						<td colspan="3"><c:out value="${swlManhPs.mosHsl}"/> m</td>
						<td colspan="2"><c:out value="${swlManhPs.somCdeNm}"/></td>
					</tr>
					<tr>
						<th scope="col" colspan="7">맨 홀 규 격</th>
					</tr>
					<tr>
						<td colspan="7">가로 : <c:out value="${swlManhPs.manHol}"/> m &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 세로 : <c:out value="${swlManhPs.manVel}"/> m &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 구경 : <c:out value="${swlManhPs.manDip}"/> mm</td>
					</tr>
				</tr>					
				<tr>
                ...
                <tr>
                    ...
                    <th scope="col" colspan="4">유지보수내용</th>
                    <th scope="col">시공자</th>
				</tr> 
                ...
                <tr>
                    ...
                    <td class="lnone al" scope="col" colspan="4"><c:out value="${subdata.repDes}"/></td>
