...
<script type="text/javascript">
	...
	$( document ).ready(function() {
		...
		// 1 )달력
		BOOK.fn_create_datepicker("frm_min","RCV_YMD", 10);
		BOOK.fn_create_datepicker("frm_min","DUR_YMD", 10); 
		BOOK.fn_create_datepicker("frm_min","PRO_YMD", 10);
...
<body>
<div id="wrap2">
<form id="frm_min" name="frm_min" method="post" action="">
	<!-- 필수 파라메터(START) -->
