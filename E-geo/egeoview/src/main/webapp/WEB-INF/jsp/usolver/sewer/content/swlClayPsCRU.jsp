		...
		<div id="content2">
			...
			<div class="TabArea">
				...
				<div id="_Tab1" class="PSection on">
					<div class="Table_LBx">
						<div class="Table_left" style="height:120px">
							<table>
								<colgroup>
									<col width="19%" />
									<col width="31%" />
						...
						<div class="Table_left" style="height:120px">
							<table>
								...
								<tr>
				                    ...
				                    <th>하수맨홀지형지물부호</th>
									<td><select name="MAN_CDE" id="MAN_CDE" class="select">
		                            <option value=""></option>
				                    	<c:forEach var="selectData" items="${man_cde_list}">
											<option value="${selectData.CODE}" <c:if test = "${selectData.CODE == result.manCde}"> selected="selected" </c:if> >${selectData.VAL}</option>
										</c:forEach>
				                    </select></td>				                    
								</tr>
								<tr>
				                    ...
				                    <th>하수맨홀관리번호</th>
									<td><input type="text" name="MAN_IDN" id="MAN_IDN" value='<c:out value="${result.manIdn}"/>' class="input CS_10"  readonly /> 
										  <a href="#" onclick="BOOK.fn_open_searchNum('SWL_MANH_PS','MAN_IDN');"><img src="/images/usolver/com/book/btn_search.gif" border="0" class="vmiddle btnClassEdit"/></a>
										  <a href="#" onclick="BOOK.fn_del_searchNum('MAN_IDN','MAN_CDE');"><img src="/images/usolver/com/book/btn_search_del.gif" border="0" class="vmiddle btnClassEdit"/></a>
									</td>									
								</tr>											
							</table>
						</div>
			...
			<div class="Btn_R">
				...
				<div class="Btn disBatchUp"><a href="#" class="Btn_02" onclick="BOOK.fn_view_subRegister('SWL_MANH_PS','MAN_IDN');">하수맨홀</a></div>
