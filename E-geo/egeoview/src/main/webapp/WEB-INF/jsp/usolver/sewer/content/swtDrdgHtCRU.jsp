...
<head>
	...
	<script type="text/javascript">
		...
		$( document ).ready(function() {
			...
			//달력
			BOOK.fn_create_datepicker("frm","DRG_YMD" , 10);					
...
<input type="hidden" id="KEY_COLUMN" name="KEY_COLUMN"  value="DRG_NUM"/>
<!-- 필수 파라메터(END) -->
<!--key//-->
...
<input type="hidden" id="DRG_NUM" name="DRG_NUM" value="<c:out value="${result.drgNum}"/>"/>
		<div class="TxtBg">
			<dl>
				<dt>준설이력일련번호</dt>
				<dd><c:out value="${result.drgNum}"/></dd>
			</dl>
		</div>
		<div class="PSection3">
			<div class="Table_LBx">
				<div class="Table_left">
					<table>
						...
						<tr>
							<th>준설일자</th>
							<td><input type="text" name="DRG_YMD" id="DRG_YMD" value="<c:out value="${result.drgYmd}"/>" class="input DT_DATE" /></td>
						</tr>
						<tr>
							<th>준설자</th>
							<td><input type="text" name="DRG_NAM" id="DRG_NAM"  style="width:200px" value="<c:out value="${result.drgNam}"/>" class="input MX_20 CS_20" /></td>
						</tr>
						<tr>
							<th>준설내용</th>
							<td><input type="text" name="DRG_DES" id="DRG_DES" value="<c:out value="${result.drgDes}"/>" class="MX_500 CS_500" style="width: 95%" /></td>
						</tr>
					</table>
				</div>
			</div>
