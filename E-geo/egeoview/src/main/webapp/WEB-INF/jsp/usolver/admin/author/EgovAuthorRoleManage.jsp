...
function fncSelectAuthorRoleList() {
    ...
    document.listForm.action = "<c:url value='/admin/author/EgovAuthorRoleList.do'/>";
...
function fncSelectAuthorList(){
   ...
   // document.listForm.pageIndex.value = "1";
    ...
    document.listForm.action = "<c:url value='/admin/author/EgovAuthorList.do'/>";
    document.listForm.submit();
}

function fncSelectAuthorRole(roleCode) {
    document.listForm.roleCode.value = roleCode;
    document.listForm.action = "<c:url value='/admin/author/EgovRole.do'/>";
    document.listForm.submit();
}
...
function fncAddAuthorRoleInsert() {
	if(fncManageChecked()) {
	    if(confirm("등록하시겠습니까?")) {
            document.listForm.action = "<c:url value='/admin/author/EgovAuthorRoleInsert.do'/>";
            document.listForm.submit();
	    }
	} else return;
}
...
<table border="0">
  <tr>
    <td width="700">
<form:form name="listForm" action="${pageContext.request.contextPath}/admin/author/EgovAuthorRoleList.do" method="post">
