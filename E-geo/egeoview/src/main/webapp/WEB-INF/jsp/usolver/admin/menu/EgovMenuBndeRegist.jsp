...
function insertMenuManage() {
	if(confirm("메뉴일괄등록을 하시겠습니까?. \n 메뉴정보와  프로그램목록, 프로그램 변경내역 존재시 삭제 하실 수 없습니다.")){
	   if(checkFile()){
		   document.menuManageRegistForm.action ="<c:url value='/admin/menu/EgovMenuBndeRegist.do' />";
...
<div class="TitBx">메뉴 일괄등록</div>
<div id="border" style="width:730px">
<table border="0">
  <tr>
    <td width="700">
<!-- ********** 여기서 부터 본문 내용 *************** -->
<form name="menuManageRegistForm" action ="<c:url value='/admin/menu/EgovMenuBndeRegist.do'/>" method="post" enctype="multipart/form-data">
        ...
        <td width="80%">
          <table border="0" cellspacing="0" cellpadding="0" align="left">
            <tr>
              ...
              <td width="5%"></td>
              <td><div class="Btn"><a href="#" class="Btn_blue" onclick="insertMenuManage(); return false;">일괄등록</a></div></td></td>
            </tr>
          </table>
        </td>
      </tr>
...
<br/>
<span style="color: orange;">* 메뉴 일괄등록시 사용자별 메뉴, 권한별 메뉴 데이터가 삭제되어 재등록이 필요합니다.</span>
