...
<%
  /**
  * @Class Name : 
  * @Description : RDL_EVRD_AS 고가도로관리
...
<head>
	...
	$( document ).ready(function() {
		...
		if( sAction === "BATCHUP"){
			...
			$('.activeWindow').find('.Table_left').attr('style','height:240px');
			BOOK.fn_edit_mode();
					...
					<div class="Table_LBx">
						...
						<div class="Table_left" style="overflow-x:hidden;height:175px;">				
							<table>
								...
								<tr>
									<th>고가도로명</th>
									<td colspan="3"><input type="text" style="width:375px" name="EVR_NAM" id="EVR_NAM" value='<c:out value="${result.evrNam}"/>' class="input MX_30 CS_30" /></td>											
								</tr>
								<tr>
									<th>관리기관</th>
					...
					<div class="Table_LBx">
						...
						<div class="Table_left" style="overflow-x:hidden;height:175px;">				
							<table>
								...
								<tr>
				                    <th>총연장</th>
									<td><input type="text" name="EVR_LEN" id="EVR_LEN" value='<c:out value="${result.evrLen}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>				                    
									<th>조명시설-수량</th>
									<td><input type="text" name="LCD_CNT" id="LCD_CNT" value='<c:out value="${result.lcdCnt}"/>' class="input MX_3 DT_INT" /> 개</td>		
								</tr>
								<tr>
				                    <th>조명시설-종류</th>
									<td colspan="3"><input type="text" name="LCD_EXP" id="LCD_EXP" value='<c:out value="${result.lcdExp}"/>'  style="width:400px" class="input MX_50 CS_50" /></td>				                    
								</tr>
							</table>
						</div>
					</div>
