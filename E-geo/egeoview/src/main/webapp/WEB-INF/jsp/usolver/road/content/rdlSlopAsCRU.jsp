...
<%
  /**
  * @Class Name : 
  * @Description : RDL_SLOP_AS 절개면/성토면 관리 
...
<head>
	...
	$( document ).ready(function() {
		...
		// 1 )달력
		BOOK.fn_create_datepicker("frm_detail","RCT_YMD", 10); // 사용개시일자
					...
					<div class="Table_LBx">
						...
						<div class="Table_left" style="height:169px">	
							<table>
								...
								<tr>
									<th>설치일자</th>
									<td><input type="text" name="RCT_YMD" id="RCT_YMD" value="<c:out value="${result.rctYmd}"/>" class="input DT_DATE" />
									<th>대장초기화여부</th>
					...
					<div class="Table_LBx">
						...
						<div class="Table_left" style="height:169px">	
							<table>
								...
								<tr>
									<th>연장</th>
									<td><input type="text" name="RCT_LEN" id="RCT_LEN" value='<c:out value="${result.rctLen}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>		           
				                    <th>경사</th>
									<td><input type="text" name="RCT_SLP" id="RCT_SLP" value='<c:out value="${result.rctSlp}"/>' class="input MX_5 DT_FLOAT DD_2" /> </td>		           
								</tr>				
								<tr>
									<th>높이-최대</th>
									<td><input type="text" name="MAX_HIT" id="MAX_HIT" value='<c:out value="${result.maxHit}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>		           
									<th>높이-최소</th>
									<td><input type="text" name="MIN_HIT" id="MIN_HIT" value='<c:out value="${result.minHit}"/>' class="input MX_5 DT_FLOAT DD_2" /> m</td>		           		                         
								</tr>			
							</table>
						</div>
					</div>
