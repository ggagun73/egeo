					...
					<div class="Table_LBx">
						<div class="Table_left">
							<table>
								...
								<tr>
									<th>배수분구명</th>
									<td><input type="text" name="DDR_NAM" id="DDR_NAM" value="<c:out value="${result.ddrNam}"/>" class="input MX_20 CS_20 " /></td>
									<th>유입하천명</th>
									<td><input type="text" name="RIV_NAM" id="RIV_NAM" value="<c:out value="${result.rivNam}"/>" class="input MX_20 CS_20 " /></td>
								</tr>
								<tr>
									<th>배수분구면적</th>
									<td><input type="text" name="DDR_SIZ" id="DDR_SIZ" value="<c:out value="${result.ddrSiz}"/>" class="input MX_6 CS_6 DD_INT" /> ㏊</td>
									<th>배수분구인구수</th>
									<td><input type="text" name="DDR_POP" id="DDR_POP" value="<c:out value="${result.ddrPop}"/>" class="input MX_8 CS_8 DD_INT" /> 인</td>
								</tr>
								<tr>
									<th>주거지역면적</th>
									<td><input type="text" name="RES_SIZ" id="RES_SIZ" value="<c:out value="${result.resSiz}"/>" class="input MX_6 CS_6 DD_INT" /> ㏊</td>
									<th>5년빈도 강우강도</th>
									<td><input type="text" name="DDR_SBY" id="DDR_SBY" value="<c:out value="${result.ddrSby}"/>" class="input MX_5 CS_5 DD_INT" /> mm/hr</td>
								</tr>
								<tr>
									<th>상업지역면적</th>
									<td><input type="text" name="COM_SIZ" id="COM_SIZ" value="<c:out value="${result.comSiz}"/>" class="input MX_6 CS_6 DD_INT" /> ㏊</td>
									<th>10년빈도 강우강도</th>
									<td><input type="text" name="DDR_SBZ" id="DDR_SBZ" value="<c:out value="${result.ddrSbz}"/>" class="input MX_5 CS_5 DD_INT" /> mm/hr</td>
								</tr>
								<tr>
									<th>공업지역면적</th>
									<td><input type="text" name="IND_SIZ" id="IND_SIZ" value="<c:out value="${result.indSiz}"/>" class="input MX_6 CS_6 DD_INT" /> ㏊</td>
									<th>유출계수</th>
									<td><input type="text" name="DRN_CNT" id="DRN_CNT" value="<c:out value="${result.drnCnt}"/>" class="input MX_5 CS_5 DT_FLOAT DD_2" /> </td>
								</tr>
								<tr>
									<th>녹지면적</th>
									<td><input type="text" name="NAT_SIZ" id="NAT_SIZ" value="<c:out value="${result.natSiz}"/>" class="input MX_6 CS_6 DD_INT" /> ㏊</td>
									<th>대장초기화여부</th>
