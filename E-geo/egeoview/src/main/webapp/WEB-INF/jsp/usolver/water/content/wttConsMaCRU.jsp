...
<%
	/**
	 * @Class Name : 
	 * @Description :   WTT_CONS_MA  상수공사대장
...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			if( sAction === 'INSERT' ){					
				...
				BOOK.fn_get_gridAddInfo("WTT_COST_DT");			// 공사비 지급내역 
				BOOK.fn_get_gridAddInfo("WTT_CHNG_DT");			// 설계변경내역
				BOOK.fn_get_gridAddInfo("WTT_SUBC_DT");			// 하도급내역
				BOOK.fn_get_gridAddInfo("WTT_FLAW_DT");			// 하자보수내역
		...
		<div id="wrap2">
			<div id="container2"> 
				<div id="content2">
					...
					<div class="TabArea disInsert">
						...
						<div id="_TabSub1" class="PSection on">
							<div class="Btn_pd3">
								<div class="Btn"></div>
								<security:authorize ifAnyGranted ="ROLE_WATER_BOOK_EDIT" >
								<div class="Btn"><a href="#" class="Btn_03"  onclick="BOOK.fn_open_gridAddInfo('WTT_COST_DT');">추가</a></div>
								<div class="Btn"><a href="#" class="Btn_03" onclick="BOOK.fn_open_gridAddInfo('WTT_COST_DT','UPDATE');">수정</a></div>
								<div class="Btn"><a href="#" class="Btn_03" onclick="BOOK.fn_delete_gridAddInfo('WTT_COST_DT');">삭제</a></div>
								</security:authorize>
							</div>
							<div class="TableBx2">
								<div class="Table_list2">
									<table id="gridWttCostDt<c:out value='${nJDSKSubId}'/>"></table>
								</div>
							</div>
						</div>
						<div id="_TabSub2" class="PSection">
							<div class="Btn_pd3">
								<div class="Btn"></div>
								<security:authorize ifAnyGranted ="ROLE_WATER_BOOK_EDIT" >
								<div class="Btn"><a href="#" class="Btn_03"  onclick="BOOK.fn_open_gridAddInfo('WTT_CHNG_DT');">추가</a></div>
								<div class="Btn"><a href="#" class="Btn_03" onclick="BOOK.fn_open_gridAddInfo('WTT_CHNG_DT','UPDATE');">수정</a></div>
								<div class="Btn"><a href="#" class="Btn_03" onclick="BOOK.fn_delete_gridAddInfo('WTT_CHNG_DT');">삭제</a></div>
								</security:authorize>
							</div>
							<div class="TableBx2">
								<div class="Table_list2">
									<table id="gridWttChngDt<c:out value='${nJDSKSubId}'/>"></table>
								</div>
							</div>
						</div>
						<!--  PSection End -->
						<div id="_TabSub3" class="PSection">
							<div class="Btn_pd3">
								<div class="Btn"></div>
								<security:authorize ifAnyGranted ="ROLE_WATER_BOOK_EDIT" >
								<div class="Btn"><a href="#" class="Btn_03"  onclick="BOOK.fn_open_gridAddInfo('WTT_SUBC_DT');">추가</a></div>
								<div class="Btn"><a href="#" class="Btn_03" onclick="BOOK.fn_open_gridAddInfo('WTT_SUBC_DT','UPDATE');">수정</a></div>
								<div class="Btn"><a href="#" class="Btn_03" onclick="BOOK.fn_delete_gridAddInfo('WTT_SUBC_DT');">삭제</a></div>
								</security:authorize>
							</div>
							<div class="TableBx2">
								<div class="Table_list2">
									<table id="gridWttSubcDt<c:out value='${nJDSKSubId}'/>"></table>
								</div>
							</div>
						</div>
						<!--  PSection End -->
						<div id="_TabSub4" class="PSection">
							<div class="Btn_pd3">
								<div class="Btn"></div>
								<security:authorize ifAnyGranted ="ROLE_WATER_BOOK_EDIT" >
								<div class="Btn"><a href="#" class="Btn_03"  onclick="BOOK.fn_open_gridAddInfo('WTT_FLAW_DT');">추가</a></div>
								<div class="Btn"><a href="#" class="Btn_03" onclick="BOOK.fn_open_gridAddInfo('WTT_FLAW_DT','UPDATE');">수정</a></div>
								<div class="Btn"><a href="#" class="Btn_03" onclick="BOOK.fn_delete_gridAddInfo('WTT_FLAW_DT');">삭제</a></div>
								</security:authorize>
							</div>
							<div class="TableBx2">
								<div class="Table_list2">
									<table id="gridWttFlawDt<c:out value='${nJDSKSubId}'/>"></table>
								</div>
							</div>
						</div>
						<!--  PSection End -->
					...
					<div class="Btn_R">
						<div class="Btn disInsert"><a href="#" class="Btn_02"  onclick="BOOK.fn_view_image('','','<c:out value="${result.cntNum}"/>','WTT_IMGE_ET');">도면/사진</a></div>
