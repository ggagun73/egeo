							...
							<div class="Table_LBx">
								<div class="Table_left" style="height:100px">
									<table>
										...
										<tr>
											<th>규격</th>
											<td><input type="text" name="MAN_STD" id="MAN_STD" value="<c:out value="${result.manStd}"/>" class="input MX_20 CS_20" /> 각 m</td>
											<th>방향각</th>
										...
										<tr>
											...
											<th>맨홀형태</th>
											<td><select name="MHS_CDE" id="MHS_CDE"  class="select" >
													<option value=""></option>
													<c:forEach var="selectData" items="${mhs_cde_list}">
													<option value="${selectData.CODE}" <c:if test = "${selectData.CODE == result.mhsCde}"> selected="selected" </c:if> >${selectData.VAL}</option>
													</c:forEach>
												</select></td>
										</tr>
									</table>
