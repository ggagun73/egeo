...
<head>
	<script type="text/javascript">
		...
		var sAuthor = false;
//		var g_userId = 'user';
 		<security:authorize ifAllGranted="ROLE_WATER_BOOK_VIEW">
			sAuthor = true;
		</security:authorize> 
...
<input type="hidden" id="TABLENAME" name="TABLENAME"  value="<c:out value="${param.TABLENAME}"/>"/> <!--신규추출(SYS_CHK=0) 용-->
<div id="wrap_b">         
	<!-- container start -->
	<div id="container_b">
    <div id="left">
            ...
            <div class="content_bx">
            	<div class="table_top1">
                	...
                	<div class="TopBx" id="TopFunction">                		
                		...
                		<security:authorize ifAllGranted ="ROLE_WATER_BOOK_PRINT" > 
                    	...
                    	<security:authorize ifAllGranted ="ROLE_WATER_MAP_VIEW" >
                    	...
                    	<security:authorize ifAllGranted ="ROLE_WATER_MAP_EDIT" >
                    	...
                    	<security:authorize ifAllGranted ="ROLE_WATER_BOOK_EDIT" > 
