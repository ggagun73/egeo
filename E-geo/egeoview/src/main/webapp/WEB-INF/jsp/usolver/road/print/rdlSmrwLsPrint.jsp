			...
			<tbody>
              ...
              <tr>
				...
				<tr>
					...
					<td colspan="2"><c:out value="${result.fncYmd}"/></td>
					<th scope="row">재질</th>
					<td colspan="3"><c:out value="${result.smtCdeNm}"/></td>
				</tr> 
				<tr>
					<th scope="row">연장</th>
					<td colspan="2"><c:out value="${result.fncLen}"/>m</td>
					<th scope="row">폭원</th>
					<td colspan="3"><c:out value="${result.fncWid}"/>m</td>
				</tr> 
				<tr>
					<th rowspan="2" scope="row">높이</th>
					<td>최대</td>
					<td><c:out value="${result.maxHit}"/>m</td>
					<th rowspan="2"  scope="row">구조</th>
					<td rowspan="2"  colspan="3"><c:out value="${result.fncExp}"/>m</td>
				</tr> 
				<tr>
					<td>최소</td>
					<td><c:out value="${result.minHit}"/>m</td>
				</tr> 
				<tr>
