...
<%
  /**
  * @Class Name : 
  * @Description : RDL_BYST_PS 자전거도로 관리 
...
<head>
	...
	$( document ).ready(function() {
		...
		// 1 )달력
		BOOK.fn_create_datepicker("frm_detail","STO_YMD", 10); // 사용개시일자
						...
						<div class="Table_left" style="height:169px">	
							<table>
								...
								<tr>
									...
									<th>보관대수</th>
									<td><input type="text" name="STO_CNT" id="STO_CNT" value="<c:out value="${result.stoCnt}"/>" class="input MX_3 CS_3" />대</td>
								</tr>
								<tr>
									<th>행정읍/면/동</th>
									...
									<th>설치일자</th>
									<td><input type="text" name="STO_YMD" id="STO_YMD" value="<c:out value="${result.stoYmd}"/>" class="input DT_DATE" /></td>										
								</tr>
								<tr>
									<th>공사번호</th>
