...
<script type="text/javascript">
	...
	function fn_egov_search_webLog(pageNo){
...
<div id="W_900">
    ...
    <div id="admin">
        ...
        <div class="admin_content">
        	...
        	<form name="frm_manage"  id="frm_manage" action ="<c:url value='/admin/log/wlg/SelectWebLogListdo'/>" method="post">
            <div class="ContBx">
                <div class="schbx">
                    <div class="FR" >
                    	발생일자 :                        
                        ...
                        <a href="#" class="Btn_sch" onClick="fn_egov_search_webLog(1)">검색</a>
                    </div>
                </div>
                <table class="tblist" summary="웹 로그">
				    ...
				    <tbody>
					    ...
					    <tr class="resultListHover">
                            ...
                            <td><c:out value="${resultList.requstId}"/><%-- <c:out value="${fn:substring(resultList.requstId, 11,20)}"/> --%></td>
                            <td><c:out value="${resultList.occrrncDe}"/>
                            	<fmt:parseDate var="date" value="${resultList.occrrncDe}" pattern="yyyyMMdd"/>
								<fmt:formatDate value="${date}" pattern="yyyy-MM-dd"/>
                            </td>
                            <td class="al"><c:out value="${resultList.url}"/></td>
	                        <td><c:out value="${resultList.rqsterNm}"/></td>
                            <td><c:out value="${resultList.rqesterIp}"/></td>
                            <%-- <td><a href="#" onClick="fn_egov_inqire_webLog('<c:out value="${resultList.requstId}"/>');"><img src="<c:url value='/images/usolver/admin/btn_view.gif'/>" alt="상세보기"	></a></td>
 --%>                  </tr>
                        </c:forEach>
