...
<table width="181" cellpadding="8" class="table-search" border="1">
  <tr>
    <td width="181" class="title_left" >
		...
		<input type="hidden" name="tmp_menuNm" value="${result.menuNo}|${result.upperMenuNo}|${result.menuNm}|${result.relateImagePath}|${result.relateImageNm}|${pageContext.request.contextPath}/${result.chkURL}|"/>
		</c:forEach>
		</div>
