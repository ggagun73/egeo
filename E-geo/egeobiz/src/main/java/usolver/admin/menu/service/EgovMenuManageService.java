...
public interface EgovMenuManageService {
	...
	int selectMenuListTotCnt(MenuManageVO vo) throws Exception;
	 ...
	 * @exception Exception
	 */
	int selectNewMenuNo() throws Exception;
	...
	List selectMainMenu(HashMap<String, Object> paramMap) throws Exception;
	/**
