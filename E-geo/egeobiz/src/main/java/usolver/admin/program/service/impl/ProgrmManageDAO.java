...
public class ProgrmManageDAO extends EgovComAbstractDAO {
	...
	public List selectProgrmList(AdmDefaultVO vo) throws Exception{
	 ...
	 * @exception Exception
	 */
	public ProgrmManageVO selectProgrm(AdmDefaultVO vo)throws Exception{
	 ...
	 * @exception Exception
	 */
	public int selectProgrmNMTotCnt(AdmDefaultVO vo) throws Exception{
	...
	public List selectProgrmChangeRequstList(AdmDefaultVO vo) throws Exception{
	 ...
	 * @exception Exception
	 */
    public int selectProgrmChangeRequstListTotCnt(AdmDefaultVO vo) {
	 ...
	 * @exception Exception
	 */
    public int selectChangeRequstListProcessTotCnt(AdmDefaultVO vo) {
