...
public class AuthorRoleManageDAO extends EgovComAbstractDAO {
	 ...
	 * @exception Exception
	 */
	public  List<EgovMap>  selectAuthorRole(AuthorRoleManageVO authorRoleManageVO) throws Exception {
		return list("authorRoleManageDAO.selectAuthorRole", authorRoleManageVO);
	}
