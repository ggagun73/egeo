...
public class AuthorManageDAO extends EgovComAbstractDAO {
	 ...
	 * @exception Exception
	 */
    public void deleteAllAuthorMenu(AuthorManage authorManage) throws Exception {
        delete("authorManageDAO.deleteAllAuthorMenu", authorManage);
    }
	 ...
	 */
    @SuppressWarnings("unchecked")
	public List<AuthorManageVO> selectAuthorSystem(AuthorManage authorManage) throws Exception {
        return list("authorManageDAO.selectAuthorSystem", authorManage);
    }    
