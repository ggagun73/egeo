...
public class AuthorGroupDAO extends EgovComAbstractDAO {
	...
	public void insertAuthorBasic(AuthorGroup authorGroup) throws Exception {
		insert("authorGroupDAO.insertAuthorBasic", authorGroup);
	}
	...
	public void approveAuthorGroup(AuthorGroup authorGroup) throws Exception {
		update("authorGroupDAO.approveAuthorGroup", authorGroup);
	}
	/**
