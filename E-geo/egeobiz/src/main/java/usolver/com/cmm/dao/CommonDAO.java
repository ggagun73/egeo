...
public class CommonDAO extends EgovAbstractDAO {
	...
	public int getSelectCnt(String sqlMapId, Object parameter){
		...
		try {
			...
			result = (Integer)getSqlMapClientTemplate().queryForObject(sqlMapId, parameter);
	 ...
	 * @exception Exception
	 */
    public String insertData(String sqlMapId, Object parameter) throws Exception {
    	String result = "";

		try {
			long startTime = System.currentTimeMillis();

			result = (String)insert(sqlMapId, parameter);
