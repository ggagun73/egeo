...
public class DefaultVO implements Serializable {
	...
	public String getSystem_user_nm() {
		return system_user_nm;
	}
	public void setSystem_user_nm(String system_user_nm) {
		this.system_user_nm = system_user_nm;
	}
